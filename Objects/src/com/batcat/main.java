...
anywheresoftware.b4a.objects.LabelWrapper _lvm2 = null;
 ...
 //BA.debugLineNum = 98;BA.debugLine="Activity.LoadLayout(\"1\")";
mostCurrent._activity.LoadLayout("1",mostCurrent.activityBA);
 //BA.debugLineNum = 100;BA.debugLine="Activity.Title=pak.GetApplicationLabel(\"com.batca";
mostCurrent._activity.setTitle(BA.ObjectToCharSequence(_pak.GetApplicationLabel("com.batcat")+" - "+_pak.GetVersionName("com.batcat")));
 //BA.debugLineNum = 102;BA.debugLine="ToolbarHelper.Initialize";
mostCurrent._toolbarhelper.Initialize(mostCurrent.activityBA);
 //BA.debugLineNum = 104;BA.debugLine="ToolbarHelper.Hide";
mostCurrent._toolbarhelper.Hide();
 //BA.debugLineNum = 106;BA.debugLine="device.Initialize(\"device\")";
mostCurrent._device.Initialize(processBA,"device");
 //BA.debugLineNum = 107;BA.debugLine="t1.Initialize(\"t1\",1000)";
_t1.Initialize(processBA,"t1",(long) (1000));
 //BA.debugLineNum = 108;BA.debugLine="ra.Initialize(\"ra\")";
mostCurrent._ra.Initialize(processBA,"ra");
 //BA.debugLineNum = 109;BA.debugLine="bat.Initialize";
mostCurrent._bat._initialize(processBA);
 //BA.debugLineNum = 110;BA.debugLine="ct.Initialize";
mostCurrent._ct.Initialize(processBA);
 //BA.debugLineNum = 111;BA.debugLine="List.Initialize";
...
mostCurrent._ffolders.Initialize();
 //BA.debugLineNum = 140;BA.debugLine="xOSStats.Initialize(400, 50, Me, \"myStats\")";
mostCurrent._xosstats._initialize(mostCurrent.activityBA,(int) (400),(int) (50),main.getObject(),"myStats");
 //BA.debugLineNum = 143;BA.debugLine="panel3.AddView(lk,10,5,80%x,50%y)";
...
mostCurrent._lip.AddView((android.view.View)(mostCurrent._lv2.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (1)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (1)),(int) (-1),(int) (-1));
 //BA.debugLineNum = 150;BA.debugLine="cd2.AddView(lip,-1,-1)";
mostCurrent._cd2.AddView((android.view.View)(mostCurrent._lip.getObject()),(int) (-1),(int) (-1));
 //BA.debugLineNum = 151;BA.debugLine="smlp.Enabled=True";
mostCurrent._smlp.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 152;BA.debugLine="showtip.Initialize(\"showtip\")";
mostCurrent._showtip.Initialize(mostCurrent.activityBA,"showtip");
 //BA.debugLineNum = 153;BA.debugLine="ima.Initialize(\"ima\")";
mostCurrent._ima.Initialize(mostCurrent.activityBA,"ima");
 //BA.debugLineNum = 154;BA.debugLine="ima.Bitmap=LoadBitmap(File.DirAssets,\"icon_batcat";
mostCurrent._ima.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"icon_batcat.png").getObject()));
 //BA.debugLineNum = 155;BA.debugLine="panel3.AddView(ima,50,150,450,250)";
mostCurrent._panel3.AddView((android.view.View)(mostCurrent._ima.getObject()),(int) (50),(int) (150),(int) (450),(int) (250));
 //BA.debugLineNum = 158;BA.debugLine="date=DateTime.Date(DateTime.Now)";
mostCurrent._date = anywheresoftware.b4a.keywords.Common.DateTime.Date(anywheresoftware.b4a.keywords.Common.DateTime.getNow());
 //BA.debugLineNum = 159;BA.debugLine="time=DateTime.Time(DateTime.Now)";
...
mostCurrent._activity.AddView((android.view.View)(mostCurrent._fakeactionbar.getObject()),(int) (0),(int) (0),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),_barsize);
 //BA.debugLineNum = 171;BA.debugLine="Activity.AddView(smlp,0,5dip,100%x,65%y)";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._smlp.getObject()),(int) (0),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (65),mostCurrent.activityBA));
 //BA.debugLineNum = 173;BA.debugLine="slm.Initialize(smlp, 250dip, 1, 1, 100, 200)";
...
mostCurrent._lvmenu.AddTwoLinesAndBitmap2(BA.ObjectToCharSequence("System Info"),BA.ObjectToCharSequence("Detail Phone Info"),(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Tag.png").getObject()),(Object)(4));
 //BA.debugLineNum = 188;BA.debugLine="lvMenu.AddTwoLinesAndBitmap2(\"Statistic\",\"Battery";
mostCurrent._lvmenu.AddTwoLinesAndBitmap2(BA.ObjectToCharSequence("Statistic"),BA.ObjectToCharSequence("Battery Cyclus"),(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"chart.png").getObject()),(Object)(3));
 //BA.debugLineNum = 189;BA.debugLine="lvMenu.AddTwoLinesAndBitmap2(\"Power\",\"OS Power Me";
mostCurrent._lvmenu.AddTwoLinesAndBitmap2(BA.ObjectToCharSequence("Power"),BA.ObjectToCharSequence("OS Power Menu"),(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Battery.png").getObject()),(Object)(2));
 //BA.debugLineNum = 190;BA.debugLine="lvMenu.AddTwoLinesAndBitmap2(\"Settings\",\"Options";
mostCurrent._lvmenu.AddTwoLinesAndBitmap2(BA.ObjectToCharSequence("Settings"),BA.ObjectToCharSequence("Options Menu"),(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Control.png").getObject()),(Object)(0));
 //BA.debugLineNum = 191;BA.debugLine="lvMenu.AddTwoLinesAndBitmap2(\"Info\",\"Version Info";
mostCurrent._lvmenu.AddTwoLinesAndBitmap2(BA.ObjectToCharSequence("Info"),BA.ObjectToCharSequence("Version Info, über BC.."),(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Rss.png").getObject()),(Object)(5));
 //BA.debugLineNum = 192;BA.debugLine="lvMenu.AddTwoLinesAndBitmap2(\"Exit\",\"Close the Ap";
mostCurrent._lvmenu.AddTwoLinesAndBitmap2(BA.ObjectToCharSequence("Exit"),BA.ObjectToCharSequence("Close the Application/Service"),(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Power.png").getObject()),(Object)(1));
 //BA.debugLineNum = 193;BA.debugLine="lvMenu.TwoLinesAndBitmap.ItemHeight=95";
mostCurrent._lvmenu.getTwoLinesAndBitmap().setItemHeight((int) (95));
 //BA.debugLineNum = 194;BA.debugLine="lvMenu.Color = Colors.Transparent";
mostCurrent._lvmenu.setColor(anywheresoftware.b4a.keywords.Common.Colors.Transparent);
 //BA.debugLineNum = 195;BA.debugLine="lvMenu.ScrollingBackgroundColor = Colors.Transpar";
mostCurrent._lvmenu.setScrollingBackgroundColor(anywheresoftware.b4a.keywords.Common.Colors.Transparent);
 //BA.debugLineNum = 196;BA.debugLine="slm.Sidebar.AddView(lvMenu, 10dip,9dip, -1, -1)";
...
mostCurrent._kvs4sub._initialize(processBA,anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal(),"datastore_sub_4");
 //BA.debugLineNum = 212;BA.debugLine="kvstemp.Initialize(File.DirDefaultExternal, \"data";
mostCurrent._kvstemp._initialize(processBA,anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal(),"datastore_temp");
 //BA.debugLineNum = 213;BA.debugLine="kvsvolt.Initialize(File.DirDefaultExternal, \"data";
mostCurrent._kvsvolt._initialize(processBA,anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal(),"datastore_volt");
 //BA.debugLineNum = 217;BA.debugLine="logo.Initialize(File.DirAssets,\"icon_batcat.png\")";
mostCurrent._logo.Initialize(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"icon_batcat.png");
 //BA.debugLineNum = 219;BA.debugLine="Label2.Text= temp &\"°C\"";
mostCurrent._label2.setText(BA.ObjectToCharSequence(mostCurrent._temp+"°C"));
 //BA.debugLineNum = 220;BA.debugLine="Label4.Text= Round2(volt,1) &\" V\"";
mostCurrent._label4.setText(BA.ObjectToCharSequence(BA.NumberToString(anywheresoftware.b4a.keywords.Common.Round2((double)(Double.parseDouble(mostCurrent._volt)),(int) (1)))+" V"));
 //BA.debugLineNum = 222;BA.debugLine="If FirstTime Then";
if (_firsttime) { 
 //BA.debugLineNum = 223;BA.debugLine="show_tip";
_show_tip();
 //BA.debugLineNum = 225;BA.debugLine="slm.OpenSidebar";
mostCurrent._slm._opensidebar();
 //BA.debugLineNum = 226;BA.debugLine="Button4.SetVisibleAnimated(300,False)";
mostCurrent._button4.SetVisibleAnimated((int) (300),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 229;BA.debugLine="If File.Exists(File.DirDefaultExternal&\"/mnt/cac";
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal()+"/mnt/cache","1.db")) { 
 ...
 //BA.debugLineNum = 233;BA.debugLine="sql.Initialize(File.DirRootExternal, \"1.db\", Tr";
_sql.Initialize(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"1.db",anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 234;BA.debugLine="File.MakeDir(File.DirDefaultExternal, \"mnt/cach";
anywheresoftware.b4a.keywords.Common.File.MakeDir(anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal(),"mnt/cache");
 //BA.debugLineNum = 235;BA.debugLine="File.MakeDir(File.DirDefaultExternal, \"mnt/data";
anywheresoftware.b4a.keywords.Common.File.MakeDir(anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal(),"mnt/data");
 //BA.debugLineNum = 236;BA.debugLine="File.WriteList(File.DirDefaultExternal&\"/mnt/ca";
...
anywheresoftware.b4a.keywords.Common.File.WriteList(anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal()+"/mnt/cache","APnames.txt",mostCurrent._list3);
 //BA.debugLineNum = 239;BA.debugLine="File.WriteString(File.DirDefaultExternal&\"/mnt/";
...
anywheresoftware.b4a.keywords.Common.File.WriteString(anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal()+"/mnt/data",mostCurrent._ra.getDevice()+".txt",mostCurrent._ra.getBrand());
 //BA.debugLineNum = 242;BA.debugLine="File.WriteList(File.DirDefaultExternal&\"/mnt/ca";
...
anywheresoftware.b4a.keywords.Common.File.WriteList(anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal()+"/mnt/cache","proc.txt",mostCurrent._proc);
 //BA.debugLineNum = 245;BA.debugLine="File.WriteString(File.DirDefaultExternal&\"/mnt/";
anywheresoftware.b4a.keywords.Common.File.WriteString(anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal()+"/mnt/cache","lvl2.txt","0");
 //BA.debugLineNum = 246;BA.debugLine="File.WriteMap(File.DirDefaultExternal&\"/mnt/cac";
anywheresoftware.b4a.keywords.Common.File.WriteMap(anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal()+"/mnt/cache","smap1.txt",mostCurrent._optmap);
 //BA.debugLineNum = 247;BA.debugLine="ToastMessageShow(\"BC Log loaded! \"&date&\", \"&ti";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("BC Log loaded! "+mostCurrent._date+", "+mostCurrent._time),anywheresoftware.b4a.keywords.Common.False);
 ...
 //BA.debugLineNum = 250;BA.debugLine="ToastMessageShow(\"Willkommen\",False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("Willkommen"),anywheresoftware.b4a.keywords.Common.False);
 ...
 //BA.debugLineNum = 253;BA.debugLine="c1=mcl.md_light_blue_A700";
_c1 = mostCurrent._mcl.getmd_light_blue_A700();
 //BA.debugLineNum = 254;BA.debugLine="c2=mcl.md_amber_A700";
_c2 = mostCurrent._mcl.getmd_amber_A700();
 //BA.debugLineNum = 255;BA.debugLine="c3=mcl.md_white_1000";
_c3 = mostCurrent._mcl.getmd_white_1000();
 //BA.debugLineNum = 256;BA.debugLine="c4=mcl.md_teal_A700";
_c4 = mostCurrent._mcl.getmd_teal_A700();
 //BA.debugLineNum = 257;BA.debugLine="c5=mcl.md_deep_purple_A700";
_c5 = mostCurrent._mcl.getmd_deep_purple_A700();
 //BA.debugLineNum = 258;BA.debugLine="c6=mcl.md_red_A700";
_c6 = mostCurrent._mcl.getmd_red_A700();
 //BA.debugLineNum = 259;BA.debugLine="c7=mcl.md_indigo_A700";
_c7 = mostCurrent._mcl.getmd_indigo_A700();
 //BA.debugLineNum = 260;BA.debugLine="c8=mcl.md_blue_A700";
_c8 = mostCurrent._mcl.getmd_blue_A700();
 //BA.debugLineNum = 261;BA.debugLine="c9=mcl.md_orange_A700";
_c9 = mostCurrent._mcl.getmd_orange_A700();
 //BA.debugLineNum = 262;BA.debugLine="c10=mcl.md_grey_700";
_c10 = mostCurrent._mcl.getmd_grey_700();
 //BA.debugLineNum = 263;BA.debugLine="c11=mcl.md_green_A700";
_c11 = mostCurrent._mcl.getmd_green_A700();
 //BA.debugLineNum = 264;BA.debugLine="c12=mcl.md_black_1000";
_c12 = mostCurrent._mcl.getmd_black_1000();
 //BA.debugLineNum = 265;BA.debugLine="c13=mcl.md_yellow_A700";
_c13 = mostCurrent._mcl.getmd_yellow_A700();
 //BA.debugLineNum = 266;BA.debugLine="c14=mcl.md_cyan_A700";
_c14 = mostCurrent._mcl.getmd_cyan_A700();
 //BA.debugLineNum = 267;BA.debugLine="c15=mcl.md_blue_grey_700";
_c15 = mostCurrent._mcl.getmd_blue_grey_700();
 //BA.debugLineNum = 268;BA.debugLine="c16=mcl.md_light_blue_A700";
_c16 = mostCurrent._mcl.getmd_light_blue_A700();
 //BA.debugLineNum = 269;BA.debugLine="Activity.Color=c10";
mostCurrent._activity.setColor(_c10);
 //BA.debugLineNum = 271;BA.debugLine="ra.setLowMemory";
mostCurrent._ra.setLowMemory();
 //BA.debugLineNum = 272;BA.debugLine="apm.FinishedStrokeColor=mcl.md_light_green_A700";
mostCurrent._apm.setFinishedStrokeColor(mostCurrent._mcl.getmd_light_green_A700());
 //BA.debugLineNum = 273;BA.debugLine="apm.Color=Colors.Transparent";
mostCurrent._apm.setColor(anywheresoftware.b4a.keywords.Common.Colors.Transparent);
 //BA.debugLineNum = 274;BA.debugLine="apm.UnfinishedStrokeColor=Colors.ARGB(190,255,255";
mostCurrent._apm.setUnfinishedStrokeColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (190),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 275;BA.debugLine="apm.TextColor=Colors.Black";
mostCurrent._apm.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 276;BA.debugLine="apm.TextSize=55";
mostCurrent._apm.setTextSize((float) (55));
 //BA.debugLineNum = 277;BA.debugLine="apm.StrokeWidth=12dip";
mostCurrent._apm.setStrokeWidth((float) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (12))));
 //BA.debugLineNum = 278;BA.debugLine="apm.ArcAngle=270";
mostCurrent._apm.setArcAngle((float) (270));
 //BA.debugLineNum = 279;BA.debugLine="ims3.Bitmap=LoadBitmap(File.DirAssets,\"ic_brightn";
mostCurrent._ims3.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_brightness_auto_black_24dp.png").getObject()));
 //BA.debugLineNum = 280;BA.debugLine="ims4.Bitmap=LoadBitmap(File.DirAssets,\"ic_sim_car";
mostCurrent._ims4.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_sim_card_white_24dp.png").getObject()));
 //BA.debugLineNum = 283;BA.debugLine="store_check";
_store_check();
 //BA.debugLineNum = 284;BA.debugLine="app_info";
_app_info();
 //BA.debugLineNum = 285;BA.debugLine="label_text";
_label_text();
...
mostCurrent._activity.Finish();
 //BA.debugLineNum = 735;BA.debugLine="SetAnimation.setanimati(\"extra_in\", \"extra_out\")";
mostCurrent._setanimation._setanimati(mostCurrent.activityBA,"extra_in","extra_out");
 //BA.debugLineNum = 736;BA.debugLine="ToastMessageShow(\"BCT - Backround Service\",False";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("BCT - Backround Service"),anywheresoftware.b4a.keywords.Common.False);
 ...
 //BA.debugLineNum = 738;BA.debugLine="Return(True)";
...
public static String  _activity_pause(boolean _userclosed) throws Exception{
 ...
 //BA.debugLineNum = 297;BA.debugLine="xOSStats.EndStats";
...
public static String  _activity_resume() throws Exception{
 ...
 //BA.debugLineNum = 291;BA.debugLine="xOSStats.StartStats";
mostCurrent._xosstats._startstats();
 //BA.debugLineNum = 292;BA.debugLine="store_check";
_store_check();
...
int _i = 0;
int _form = 0;
 //BA.debugLineNum = 839;BA.debugLine="Sub app_info";
 //BA.debugLineNum = 840;BA.debugLine="lv2.Clear";
mostCurrent._lv2.Clear();
 //BA.debugLineNum = 841;BA.debugLine="list3.Clear";
mostCurrent._list3.Clear();
 //BA.debugLineNum = 842;BA.debugLine="datalist.Clear";
mostCurrent._datalist.Clear();
 //BA.debugLineNum = 844;BA.debugLine="list1=pak.GetInstalledPackages";
mostCurrent._list1 = _pak.GetInstalledPackages();
 //BA.debugLineNum = 846;BA.debugLine="Obj1.Target = Obj1.GetContext";
mostCurrent._obj1.Target = (Object)(mostCurrent._obj1.GetContext(processBA));
 //BA.debugLineNum = 847;BA.debugLine="Obj1.Target = Obj1.RunMethod(\"getPackageManager\")";
mostCurrent._obj1.Target = mostCurrent._obj1.RunMethod("getPackageManager");
 //BA.debugLineNum = 848;BA.debugLine="Obj2.Target = Obj1.RunMethod2(\"getInstalledPackag";
mostCurrent._obj2.Target = mostCurrent._obj1.RunMethod2("getInstalledPackages",BA.NumberToString(0),"java.lang.int");
 //BA.debugLineNum = 849;BA.debugLine="size = Obj2.RunMethod(\"size\")";
_size = (int)(BA.ObjectToNumber(mostCurrent._obj2.RunMethod("size")));
 //BA.debugLineNum = 854;BA.debugLine="For i = 0 To size -1";
{
final int step9 = 1;
final int limit9 = (int) (_size-1);
for (_i = (int) (0) ; (step9 > 0 && _i <= limit9) || (step9 < 0 && _i >= limit9); _i = ((int)(0 + _i + step9)) ) {
 //BA.debugLineNum = 855;BA.debugLine="Obj3.Target = Obj2.RunMethod2(\"get\", i, \"java.la";
mostCurrent._obj3.Target = mostCurrent._obj2.RunMethod2("get",BA.NumberToString(_i),"java.lang.int");
 //BA.debugLineNum = 856;BA.debugLine="size = Obj2.RunMethod(\"size\")";
_size = (int)(BA.ObjectToNumber(mostCurrent._obj2.RunMethod("size")));
 //BA.debugLineNum = 858;BA.debugLine="Obj3.Target = Obj3.GetField(\"applicationInfo\") '";
mostCurrent._obj3.Target = mostCurrent._obj3.GetField("applicationInfo");
 //BA.debugLineNum = 859;BA.debugLine="flags = Obj3.GetField(\"flags\")";
_flags = (int)(BA.ObjectToNumber(mostCurrent._obj3.GetField("flags")));
 //BA.debugLineNum = 860;BA.debugLine="packName = Obj3.GetField(\"packageName\")";
mostCurrent._packname = BA.ObjectToString(mostCurrent._obj3.GetField("packageName"));
 //BA.debugLineNum = 862;BA.debugLine="If Bit.And(flags, 1)  = 0 Then";
if (anywheresoftware.b4a.keywords.Common.Bit.And(_flags,(int) (1))==0) { 
 //BA.debugLineNum = 865;BA.debugLine="args(0) = Obj3.Target";
mostCurrent._args[(int) (0)] = mostCurrent._obj3.Target;
 //BA.debugLineNum = 866;BA.debugLine="Types(0) = \"android.content.pm.ApplicationInfo\"";
mostCurrent._types[(int) (0)] = "android.content.pm.ApplicationInfo";
 //BA.debugLineNum = 867;BA.debugLine="name = Obj1.RunMethod4(\"getApplicationLabel\", a";
mostCurrent._name = BA.ObjectToString(mostCurrent._obj1.RunMethod4("getApplicationLabel",mostCurrent._args,mostCurrent._types));
 //BA.debugLineNum = 868;BA.debugLine="icon = Obj1.RunMethod4(\"getApplicationIcon\", ar";
mostCurrent._icon.setObject((android.graphics.drawable.BitmapDrawable)(mostCurrent._obj1.RunMethod4("getApplicationIcon",mostCurrent._args,mostCurrent._types)));
 //BA.debugLineNum = 870;BA.debugLine="list3.Add(packName)";
mostCurrent._list3.Add((Object)(mostCurrent._packname));
 //BA.debugLineNum = 873;BA.debugLine="phlis.Add(icon.Bitmap)";
mostCurrent._phlis.Add((Object)(mostCurrent._icon.getBitmap()));
 //BA.debugLineNum = 876;BA.debugLine="Dim form As Int";
_form = 0;
 //BA.debugLineNum = 877;BA.debugLine="form=File.Size(GetParentPath(GetSourceDir(GetAc";
_form = (int) (anywheresoftware.b4a.keywords.Common.File.Size(_getparentpath(_getsourcedir(_getactivitiesinfo(mostCurrent._packname))),_getfilename(_getsourcedir(_getactivitiesinfo(mostCurrent._packname)))));
 //BA.debugLineNum = 878;BA.debugLine="datalist.Add(form)";
mostCurrent._datalist.Add((Object)(_form));
 //BA.debugLineNum = 879;BA.debugLine="lv2.AddTwoLinesAndBitmap2(name,packName&\" - \"&F";
mostCurrent._lv2.AddTwoLinesAndBitmap2(BA.ObjectToCharSequence(mostCurrent._name),BA.ObjectToCharSequence(mostCurrent._packname+" - "+_formatfilesize((float) (_form))),mostCurrent._icon.getBitmap(),(Object)(mostCurrent._packname));
 //BA.debugLineNum = 880;BA.debugLine="Log(ffolders.Size&\" folder / \"&ffiles.Size&\" fi";
...
public static String  _button1_click() throws Exception{
 //BA.debugLineNum = 712;BA.debugLine="Sub Button1_Click";
 //BA.debugLineNum = 713;BA.debugLine="StartActivity(klo)";
...
public static String  _button3_click() throws Exception{
 //BA.debugLineNum = 742;BA.debugLine="Sub Button3_Click";
 //BA.debugLineNum = 743;BA.debugLine="StartActivity(sys)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._sys.getObject()));
 //BA.debugLineNum = 744;BA.debugLine="SetAnimation.setanimati(\"extra_in\", \"extra_out\")";
mostCurrent._setanimation._setanimati(mostCurrent.activityBA,"extra_in","extra_out");
 //BA.debugLineNum = 745;BA.debugLine="End Sub";
return "";
}
public static String  _button4_click() throws Exception{
 //BA.debugLineNum = 596;BA.debugLine="Sub Button4_Click";
 //BA.debugLineNum = 597;BA.debugLine="StartService(webhost)";
anywheresoftware.b4a.keywords.Common.StartService(mostCurrent.activityBA,(Object)(mostCurrent._webhost.getObject()));
 //BA.debugLineNum = 598;BA.debugLine="StartActivity(cool)";
...
long _size1 = 0L;
String _f = "";
 //BA.debugLineNum = 639;BA.debugLine="Sub CalcSize(Folder As String, recursive As Boolea";
 //BA.debugLineNum = 640;BA.debugLine="Dim size1 As Long";
_size1 = 0L;
 //BA.debugLineNum = 641;BA.debugLine="For Each f As String In File.ListFiles(Folder)";
...
_f = BA.ObjectToString(group2.Get(index2));
 //BA.debugLineNum = 642;BA.debugLine="If recursive Then";
if (_recursive) { 
 //BA.debugLineNum = 643;BA.debugLine="If File.IsDirectory(Folder, f) Then";
if (anywheresoftware.b4a.keywords.Common.File.IsDirectory(_folder,_f)) { 
 //BA.debugLineNum = 644;BA.debugLine="size1 = size1 + CalcSize(File.Combine(Folder,";
_size1 = (long) (_size1+_calcsize(anywheresoftware.b4a.keywords.Common.File.Combine(_folder,_f),_recursive));
 };
 };
 //BA.debugLineNum = 647;BA.debugLine="size1 = size1 + File.Size(Folder, f)";
_size1 = (long) (_size1+anywheresoftware.b4a.keywords.Common.File.Size(_folder,_f));
 }
;
 //BA.debugLineNum = 649;BA.debugLine="Return size1";
...
int _res = 0;
 //BA.debugLineNum = 717;BA.debugLine="Sub cl_click As Boolean";
 //BA.debugLineNum = 718;BA.debugLine="Dim res As Int";
_res = 0;
 //BA.debugLineNum = 719;BA.debugLine="res=Msgbox2(cs.Initialize.Alignment(\"ALIGN_CENTER";
_res = anywheresoftware.b4a.keywords.Common.Msgbox2(BA.ObjectToCharSequence(_cs.Initialize().Alignment(BA.getEnumFromString(android.text.Layout.Alignment.class,"ALIGN_CENTER")).Append(BA.ObjectToCharSequence(("App wird geschlossen Service Icon läuft im Hintergrund Prozess weiter und wird als Info weiterhin in der statusbar ausgeführt., zum deaktivieren bitte 'Settings->Start/stop Notify Service'.!\",\"Bat-CaT beenden:"))).PopAll().getObject()),BA.ObjectToCharSequence(_cs.Initialize().Typeface(anywheresoftware.b4a.keywords.Common.Typeface.DEFAULT).Color((int) (0xff01ff20)).Size((int) (40)).PopAll().getObject()),"ja","Abbruch","",(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Power.png").getObject()),mostCurrent.activityBA);
 //BA.debugLineNum = 721;BA.debugLine="If res=DialogResponse.POSITIVE Then";
if (_res==anywheresoftware.b4a.keywords.Common.DialogResponse.POSITIVE) { 
 //BA.debugLineNum = 722;BA.debugLine="Activity.Finish";
mostCurrent._activity.Finish();
 //BA.debugLineNum = 723;BA.debugLine="SetAnimation.setanimati(\"extra_in\", \"extra_out\")";
mostCurrent._setanimation._setanimati(mostCurrent.activityBA,"extra_in","extra_out");
 }else {
 //BA.debugLineNum = 725;BA.debugLine="If res=DialogResponse.CANCEL Then";
if (_res==anywheresoftware.b4a.keywords.Common.DialogResponse.CANCEL) { 
 //BA.debugLineNum = 726;BA.debugLine="ToastMessageShow(\"zurück..\",False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("zurück.."),anywheresoftware.b4a.keywords.Common.False);
 ...
 //BA.debugLineNum = 729;BA.debugLine="Return(True)";
if (true) return (anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 730;BA.debugLine="End Sub";
return false;
}
public static String  _cli_click() throws Exception{
 //BA.debugLineNum = 899;BA.debugLine="Sub cli_click";
 //BA.debugLineNum = 901;BA.debugLine="StartActivity(cool)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._cool.getObject()));
...
String _f = "";
 //BA.debugLineNum = 652;BA.debugLine="Private Sub CopyFolder(Source As String, targetFol";
 //BA.debugLineNum = 653;BA.debugLine="If File.Exists(targetFolder, \"\") = False Then Fil";
...
anywheresoftware.b4a.keywords.Common.File.MakeDir(_targetfolder,"");};
 //BA.debugLineNum = 654;BA.debugLine="For Each f As String In File.ListFiles(Source)";
final anywheresoftware.b4a.BA.IterableList group2 = anywheresoftware.b4a.keywords.Common.File.ListFiles(_source);
final int groupLen2 = group2.getSize();
for (int index2 = 0;index2 < groupLen2 ;index2++){
_f = BA.ObjectToString(group2.Get(index2));
 //BA.debugLineNum = 655;BA.debugLine="If File.IsDirectory(Source, f) Then";
if (anywheresoftware.b4a.keywords.Common.File.IsDirectory(_source,_f)) { 
 //BA.debugLineNum = 656;BA.debugLine="CopyFolder(File.Combine(Source, f), File.Combin";
_copyfolder(anywheresoftware.b4a.keywords.Common.File.Combine(_source,_f),anywheresoftware.b4a.keywords.Common.File.Combine(_targetfolder,_f));
 //BA.debugLineNum = 657;BA.debugLine="Continue";
if (true) continue;
 };
 //BA.debugLineNum = 659;BA.debugLine="File.Copy(Source, f, targetFolder, f)";
...
int _vol = 0;
int _days = 0;
 //BA.debugLineNum = 748;BA.debugLine="Sub device_BatteryChanged (level As Int, Scale As";
 //BA.debugLineNum = 749;BA.debugLine="ProgressDialogHide";
anywheresoftware.b4a.keywords.Common.ProgressDialogHide();
 //BA.debugLineNum = 750;BA.debugLine="Dim val,hours,minutes,rst,ts,volta,vs As Int";
_val = 0;
_hours = 0;
_minutes = 0;
_rst = 0;
...
_volta = 0;
_vs = 0;
 //BA.debugLineNum = 751;BA.debugLine="volta=Intent.GetExtra(\"voltage\")/1000";
_volta = (int) ((double)(BA.ObjectToNumber(_intent.GetExtra("voltage")))/(double)1000);
 //BA.debugLineNum = 752;BA.debugLine="temp=Intent.GetExtra(\"temperature\")/10";
mostCurrent._temp = BA.NumberToString((double)(BA.ObjectToNumber(_intent.GetExtra("temperature")))/(double)10);
 //BA.debugLineNum = 754;BA.debugLine="Label1.Visible=True";
mostCurrent._label1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 755;BA.debugLine="File.WriteString(File.DirDefaultExternal&\"/mnt/ca";
anywheresoftware.b4a.keywords.Common.File.WriteString(anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal()+"/mnt/cache","lvl.txt",BA.NumberToString(_level));
 //BA.debugLineNum = 756;BA.debugLine="File.WriteString(File.DirDefaultExternal&\"/mnt/ca";
anywheresoftware.b4a.keywords.Common.File.WriteString(anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal()+"/mnt/cache","volt.txt",BA.NumberToString(_volta));
 //BA.debugLineNum = 758;BA.debugLine="prb1.ButtonRadius=Scale";
mostCurrent._prb1.setButtonRadius((float) (_scale));
 //BA.debugLineNum = 759;BA.debugLine="prb1.Color=Colors.ARGB(190,255,255,255)";
mostCurrent._prb1.setColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (190),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 760;BA.debugLine="prb1.BackgroundSecondColor=Colors.Transparent";
mostCurrent._prb1.setBackgroundSecondColor(anywheresoftware.b4a.keywords.Common.Colors.Transparent);
 //BA.debugLineNum = 761;BA.debugLine="prb1.CurrentText=temp&\"°C\"";
mostCurrent._prb1.setCurrentText(BA.ObjectToCharSequence(mostCurrent._temp+"°C"));
 //BA.debugLineNum = 762;BA.debugLine="prb1.MaxProgress=410";
mostCurrent._prb1.setMaxProgress((int) (410));
 //BA.debugLineNum = 763;BA.debugLine="prb1.MinProgress=Intent.GetExtra(\"temperature\")-1";
mostCurrent._prb1.setMinProgress((int) ((double)(BA.ObjectToNumber(_intent.GetExtra("temperature")))-10));
 //BA.debugLineNum = 764;BA.debugLine="prb1.Progress=Intent.GetExtra(\"temperature\")";
mostCurrent._prb1.setProgress((float)(BA.ObjectToNumber(_intent.GetExtra("temperature"))));
 //BA.debugLineNum = 765;BA.debugLine="prb1.TextColor=mcl.md_black_1000";
mostCurrent._prb1.setTextColor(mostCurrent._mcl.getmd_black_1000());
 //BA.debugLineNum = 766;BA.debugLine="prb1.TextCoverColor=Colors.ARGB(199,0,0,0)";
mostCurrent._prb1.setTextCoverColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (199),(int) (0),(int) (0),(int) (0)));
 //BA.debugLineNum = 767;BA.debugLine="prb1.TextSize=18";
mostCurrent._prb1.setTextSize((float) (18));
 //BA.debugLineNum = 768;BA.debugLine="prb1.TheTextSize=18";
mostCurrent._prb1.setTheTextSize((float) (18));
 //BA.debugLineNum = 770;BA.debugLine="apm.Progress=level";
mostCurrent._apm.setProgress(_level);
 //BA.debugLineNum = 771;BA.debugLine="apm.BottomText=Intent.GetExtra(\"technology\")";
mostCurrent._apm.setBottomText(BA.ObjectToString(_intent.GetExtra("technology")));
 //BA.debugLineNum = 772;BA.debugLine="apm.Max=Scale";
mostCurrent._apm.setMax(_scale);
 //BA.debugLineNum = 773;BA.debugLine="rst=Scale-level";
_rst = (int) (_scale-_level);
 //BA.debugLineNum = 774;BA.debugLine="If Plugged=True Then";
if (_plugged==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 775;BA.debugLine="ims2.Bitmap=LoadBitmap(File.DirAssets,\"ic_usb_bl";
mostCurrent._ims2.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_usb_black_24dp.png").getObject()));
 //BA.debugLineNum = 776;BA.debugLine="apm.BottomText=\"Aufladen via USB: \"&volta&\" V\"";
mostCurrent._apm.setBottomText("Aufladen via USB: "+BA.NumberToString(_volta)+" V");
 //BA.debugLineNum = 777;BA.debugLine="Log(\"VOLT: \"&Intent.GetExtra(\"voltage\"))";
anywheresoftware.b4a.keywords.Common.Log("VOLT: "+BA.ObjectToString(_intent.GetExtra("voltage")));
 //BA.debugLineNum = 778;BA.debugLine="val =rst*Intent.GetExtra(\"voltage\") /1000";
_val = (int) (_rst*(double)(BA.ObjectToNumber(_intent.GetExtra("voltage")))/(double)1000);
 //BA.debugLineNum = 779;BA.debugLine="hours = Floor(val / 60)";
_hours = (int) (anywheresoftware.b4a.keywords.Common.Floor(_val/(double)60));
 //BA.debugLineNum = 780;BA.debugLine="minutes = val Mod 60";
_minutes = (int) (_val%60);
 //BA.debugLineNum = 781;BA.debugLine="If level=100 Then";
if (_level==100) { 
 //BA.debugLineNum = 782;BA.debugLine="apm.BottomText=\"Kabel entfernen(USB)!\"";
mostCurrent._apm.setBottomText("Kabel entfernen(USB)!");
 //BA.debugLineNum = 783;BA.debugLine="Label4.Text=\"Batterie voll! Bitte Kabel entfern";
mostCurrent._label4.setText(BA.ObjectToCharSequence("Batterie voll! Bitte Kabel entfernen!"));
 }else {
 //BA.debugLineNum = 786;BA.debugLine="Label4.Text=\"voll in: \"&hours&\"h - \"&minutes&\"mi";
mostCurrent._label4.setText(BA.ObjectToCharSequence("voll in: "+BA.NumberToString(_hours)+"h - "+BA.NumberToString(_minutes)+"min"));
 };
 }else {
 //BA.debugLineNum = 790;BA.debugLine="ims2.Bitmap=LoadBitmap(File.DirAssets,\"ic_data_u";
mostCurrent._ims2.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_data_usage_black_48dp.png").getObject()));
 //BA.debugLineNum = 791;BA.debugLine="If level<=5 Then";
if (_level<=5) { 
 //BA.debugLineNum = 792;BA.debugLine="Label1.TextColor=Colors.Red";
mostCurrent._label1.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Red);
 //BA.debugLineNum = 793;BA.debugLine="Label1.TextSize=15";
mostCurrent._label1.setTextSize((float) (15));
 //BA.debugLineNum = 794;BA.debugLine="Label1.Text=\"Akku laden!\"";
mostCurrent._label1.setText(BA.ObjectToCharSequence("Akku laden!"));
 };
 //BA.debugLineNum = 797;BA.debugLine="Dim vol As Int";
_vol = 0;
 //BA.debugLineNum = 798;BA.debugLine="vol=Intent.GetExtra(\"voltage\")";
_vol = (int)(BA.ObjectToNumber(_intent.GetExtra("voltage")));
 //BA.debugLineNum = 799;BA.debugLine="Dim days As Int";
_days = 0;
 //BA.debugLineNum = 800;BA.debugLine="val = level*1000*60*60/level";
_val = (int) (_level*1000*60*60/(double)_level);
 //BA.debugLineNum = 801;BA.debugLine="days=Floor(val/60/24)";
_days = (int) (anywheresoftware.b4a.keywords.Common.Floor(_val/(double)60/(double)24));
 //BA.debugLineNum = 802;BA.debugLine="hours = Floor(val/60 Mod 24)";
_hours = (int) (anywheresoftware.b4a.keywords.Common.Floor(_val/(double)60%24));
 //BA.debugLineNum = 803;BA.debugLine="minutes = val Mod 60";
_minutes = (int) (_val%60);
 //BA.debugLineNum = 804;BA.debugLine="Label4.Text= \"noch: \"&days&\"d - \"&hours&\"h - \"&m";
mostCurrent._label4.setText(BA.ObjectToCharSequence("noch: "+BA.NumberToString(_days)+"d - "+BA.NumberToString(_hours)+"h - "+BA.NumberToString(_minutes)+"m"));
 ...
 //BA.debugLineNum = 806;BA.debugLine="If temp<=31 Then";
if ((double)(Double.parseDouble(mostCurrent._temp))<=31) { 
 //BA.debugLineNum = 807;BA.debugLine="prb1.Color=mcl.md_lime_A400";
mostCurrent._prb1.setColor(mostCurrent._mcl.getmd_lime_A400());
 //BA.debugLineNum = 808;BA.debugLine="prb1.TextColor=mcl.md_black_1000";
mostCurrent._prb1.setTextColor(mostCurrent._mcl.getmd_black_1000());
 };
 //BA.debugLineNum = 810;BA.debugLine="If temp>=31 Then";
if ((double)(Double.parseDouble(mostCurrent._temp))>=31) { 
 //BA.debugLineNum = 811;BA.debugLine="prb1.Color=mcl.md_amber_A400";
mostCurrent._prb1.setColor(mostCurrent._mcl.getmd_amber_A400());
 //BA.debugLineNum = 812;BA.debugLine="prb1.TextColor=mcl.md_black_1000";
mostCurrent._prb1.setTextColor(mostCurrent._mcl.getmd_black_1000());
 };
 //BA.debugLineNum = 814;BA.debugLine="If temp >=45 Then";
if ((double)(Double.parseDouble(mostCurrent._temp))>=45) { 
 //BA.debugLineNum = 815;BA.debugLine="prb1.Color=mcl.md_red_A400";
...
public static String  _device_devicestorageok(anywheresoftware.b4a.objects.IntentWrapper _intent) throws Exception{
 //BA.debugLineNum = 302;BA.debugLine="Sub  device_DeviceStorageOk (Intent As Intent)";
 //BA.debugLineNum = 303;BA.debugLine="Log(Intent.ExtrasToString)";
...
public static String  _fc_copydone(String _key,boolean _error) throws Exception{
 //BA.debugLineNum = 891;BA.debugLine="Sub fc_CopyDone(Key As String, Error As Boolean)";
 //BA.debugLineNum = 893;BA.debugLine="End Sub";
return "";
}
public static String  _floatingactionbutton1_click() throws Exception{
 //BA.debugLineNum = 2485;BA.debugLine="Sub FloatingActionButton1_Click";
...
double _si = 0;
int _i = 0;
 //BA.debugLineNum = 682;BA.debugLine="Sub FormatFileSize(Bytes As Float) As String";
 //BA.debugLineNum = 684;BA.debugLine="Private Unit() As String = Array As String(\" Byte";
_unit = new String[]{" Byte"," KB"," MB"," GB"," TB"," PB"," EB"," ZB"," YB"};
 //BA.debugLineNum = 686;BA.debugLine="If Bytes = 0 Then";
if (_bytes==0) { 
 //BA.debugLineNum = 688;BA.debugLine="Return \"0 Bytes\"";
if (true) return "0 Bytes";
 }else {
 //BA.debugLineNum = 692;BA.debugLine="Private Po, Si As Double";
_po = 0;
_si = 0;
 //BA.debugLineNum = 693;BA.debugLine="Private I As Int";
_i = 0;
 //BA.debugLineNum = 695;BA.debugLine="Bytes = Abs(Bytes)";
_bytes = (float) (anywheresoftware.b4a.keywords.Common.Abs(_bytes));
 //BA.debugLineNum = 697;BA.debugLine="I = Floor(Logarithm(Bytes, 1024))";
_i = (int) (anywheresoftware.b4a.keywords.Common.Floor(anywheresoftware.b4a.keywords.Common.Logarithm(_bytes,1024)));
 //BA.debugLineNum = 698;BA.debugLine="Po = Power(1024, I)";
_po = anywheresoftware.b4a.keywords.Common.Power(1024,_i);
 //BA.debugLineNum = 699;BA.debugLine="Si = Bytes / Po";
_si = _bytes/(double)_po;
 //BA.debugLineNum = 701;BA.debugLine="Return NumberFormat(Si, 1, 2) & Unit(I)";
...
anywheresoftware.b4a.agraham.reflection.Reflection _r = null;
 //BA.debugLineNum = 923;BA.debugLine="Sub GetActivitiesInfo(package As String) As Object";
 //BA.debugLineNum = 924;BA.debugLine="Dim r As Reflector";
_r = new anywheresoftware.b4a.agraham.reflection.Reflection();
 //BA.debugLineNum = 925;BA.debugLine="r.Target = r.GetContext";
_r.Target = (Object)(_r.GetContext(processBA));
 //BA.debugLineNum = 926;BA.debugLine="r.Target = r.RunMethod(\"getPackageManager\")";
_r.Target = _r.RunMethod("getPackageManager");
 //BA.debugLineNum = 927;BA.debugLine="r.Target = r.RunMethod3(\"getPackageInfo\", package";
_r.Target = _r.RunMethod3("getPackageInfo",_package,"java.lang.String",BA.NumberToString(0x00000001),"java.lang.int");
 //BA.debugLineNum = 928;BA.debugLine="Return r.GetField(\"applicationInfo\")";
...
public static String  _getfilename(String _fullpath) throws Exception{
 //BA.debugLineNum = 895;BA.debugLine="Sub GetFileName(FullPath As String) As String";
 //BA.debugLineNum = 896;BA.debugLine="Return FullPath.SubString(FullPath.LastIndexOf(\"/";
...
String _path1 = "";
 //BA.debugLineNum = 904;BA.debugLine="Sub GetParentPath(Path As String) As String";
 //BA.debugLineNum = 905;BA.debugLine="Dim Path1 As String";
_path1 = "";
 //BA.debugLineNum = 906;BA.debugLine="If Path = \"/\" Then";
if ((_path).equals("/")) { 
 //BA.debugLineNum = 907;BA.debugLine="Return \"/\"";
if (true) return "/";
 };
 //BA.debugLineNum = 909;BA.debugLine="L = Path.LastIndexOf(\"/\")";
mostCurrent._l = BA.NumberToString(_path.lastIndexOf("/"));
 //BA.debugLineNum = 910;BA.debugLine="If L = Path.Length - 1 Then";
if ((mostCurrent._l).equals(BA.NumberToString(_path.length()-1))) { 
 //BA.debugLineNum = 912;BA.debugLine="Path1 = Path.SubString2(0,L)";
_path1 = _path.substring((int) (0),(int)(Double.parseDouble(mostCurrent._l)));
 }else {
 //BA.debugLineNum = 914;BA.debugLine="Path1 = Path";
_path1 = _path;
 };
 //BA.debugLineNum = 916;BA.debugLine="L = Path.LastIndexOf(\"/\")";
mostCurrent._l = BA.NumberToString(_path.lastIndexOf("/"));
 //BA.debugLineNum = 917;BA.debugLine="If L = 0 Then";
if ((mostCurrent._l).equals(BA.NumberToString(0))) { 
 //BA.debugLineNum = 918;BA.debugLine="L = 1";
mostCurrent._l = BA.NumberToString(1);
 };
 //BA.debugLineNum = 920;BA.debugLine="Return Path1.SubString2(0,L)";
...
anywheresoftware.b4a.agraham.reflection.Reflection _r = null;
 //BA.debugLineNum = 931;BA.debugLine="Sub GetSourceDir(AppInfo As Object) As String";
 //BA.debugLineNum = 932;BA.debugLine="Try";
try { //BA.debugLineNum = 933;BA.debugLine="Dim r As Reflector";
_r = new anywheresoftware.b4a.agraham.reflection.Reflection();
 //BA.debugLineNum = 934;BA.debugLine="r.Target = AppInfo";
_r.Target = _appinfo;
 //BA.debugLineNum = 935;BA.debugLine="Return r.GetField(\"sourceDir\")";
if (true) return BA.ObjectToString(_r.GetField("sourceDir"));
 } 
       catch (Exception e6) {
			processBA.setLastException(e6); //BA.debugLineNum = 937;BA.debugLine="Return \"\"";
if (true) return "";
 };
...
mostCurrent._ffolders = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 93;BA.debugLine="Dim xMSOS As MSOS";
mostCurrent._xmsos = new com.maximussoft.msos.MSOS();
 //BA.debugLineNum = 94;BA.debugLine="Dim xOSStats As OSStats";
mostCurrent._xosstats = new b4a.example.osstats();
 //BA.debugLineNum = 95;BA.debugLine="End Sub";
return "";
}
public static String  _label_text() throws Exception{
 //BA.debugLineNum = 616;BA.debugLine="Sub label_text";
 //BA.debugLineNum = 617;BA.debugLine="lk.TextSize=13";
mostCurrent._lk.setTextSize((float) (13));
 //BA.debugLineNum = 618;BA.debugLine="lk.TextColor=Colors.Black";
mostCurrent._lk.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 619;BA.debugLine="lk.Text=\"Version: \"&pak.GetVersionName(\"com.batca";
...
public static String  _label1_click() throws Exception{
 //BA.debugLineNum = 707;BA.debugLine="Sub Label1_Click";
 //BA.debugLineNum = 708;BA.debugLine="StartActivity(sys)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._sys.getObject()));
 //BA.debugLineNum = 709;BA.debugLine="SetAnimation.setanimati(\"extra_in\", \"extra_out\")";
mostCurrent._setanimation._setanimati(mostCurrent.activityBA,"extra_in","extra_out");
 //BA.debugLineNum = 710;BA.debugLine="End Sub";
return "";
}
public static String  _label4_click() throws Exception{
 //BA.debugLineNum = 829;BA.debugLine="Sub Label4_Click";
...
public static String  _listview1_itemclick(int _position,Object _value) throws Exception{
 //BA.debugLineNum = 833;BA.debugLine="Sub listview1_ItemClick (Position As Int, value As";
 //BA.debugLineNum = 834;BA.debugLine="If Position=0 Then";
if (_position==0) { 
 //BA.debugLineNum = 835;BA.debugLine="rl_lo";
_rl_lo();
 };
...
anywheresoftware.b4a.objects.IntentWrapper _i = null;
 //BA.debugLineNum = 543;BA.debugLine="Sub lvMenu_ItemClick (Position As Int, Value As Ob";
 //BA.debugLineNum = 544;BA.debugLine="If Value = 0 Then";
if ((_value).equals((Object)(0))) { 
 //BA.debugLineNum = 545;BA.debugLine="opt_click";
_opt_click();
...
mostCurrent._setanimation._setanimati(mostCurrent.activityBA,"extra_in","extra_out");
 ...
 //BA.debugLineNum = 549;BA.debugLine="If Value=1 Then";
if ((_value).equals((Object)(1))) { 
 //BA.debugLineNum = 550;BA.debugLine="cl_click";
_cl_click();
 //BA.debugLineNum = 551;BA.debugLine="slm.CloseSidebar";
mostCurrent._slm._closesidebar();
 //BA.debugLineNum = 552;BA.debugLine="SetAnimation.setanimati(\"extra_in\", \"extra_out\")";
mostCurrent._setanimation._setanimati(mostCurrent.activityBA,"extra_in","extra_out");
 };
...
mostCurrent._setanimation._setanimati(mostCurrent.activityBA,"extra_in","extra_out");
 //BA.debugLineNum = 559;BA.debugLine="StartActivity(i)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_i.getObject()));
 };
 //BA.debugLineNum = 561;BA.debugLine="If Value=3 Then";
...
mostCurrent._setanimation._setanimati(mostCurrent.activityBA,"extra_in","extra_out");
 //BA.debugLineNum = 564;BA.debugLine="slm.CloseSidebar";
mostCurrent._slm._closesidebar();
 };
 //BA.debugLineNum = 566;BA.debugLine="If Value=4 Then";
...
mostCurrent._setanimation._setanimati(mostCurrent.activityBA,"extra_in","extra_out");
 ...
 //BA.debugLineNum = 571;BA.debugLine="If Value=5 Then";
if ((_value).equals((Object)(5))) { 
 //BA.debugLineNum = 572;BA.debugLine="pci_click";
_pci_click();
 //BA.debugLineNum = 573;BA.debugLine="slm.CloseSidebar";
mostCurrent._slm._closesidebar();
 //BA.debugLineNum = 574;BA.debugLine="SetAnimation.setanimati(\"extra_in\", \"extra_out\")";
mostCurrent._setanimation._setanimati(mostCurrent.activityBA,"extra_in","extra_out");
 };
...
public static String  _menu_onfullyclosed() throws Exception{
 //BA.debugLineNum = 337;BA.debugLine="Sub Menu_onFullyClosed";
 //BA.debugLineNum = 345;BA.debugLine="Label1.SetLayout(40%x,40%y,40%x,90dip)";
mostCurrent._label1.SetLayout(anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (40),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (40),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (40),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (90)));
 //BA.debugLineNum = 346;BA.debugLine="Button4.TextSize=18";
mostCurrent._button4.setTextSize((float) (18));
 //BA.debugLineNum = 348;BA.debugLine="Label2.SetVisibleAnimated(100,True)";
mostCurrent._label2.SetVisibleAnimated((int) (100),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 349;BA.debugLine="Label4.SetVisibleAnimated(100,True)";
mostCurrent._label4.SetVisibleAnimated((int) (100),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 350;BA.debugLine="Button4.SetLayoutAnimated(100,110dip,55%y,95dip,9";
mostCurrent._button4.SetLayoutAnimated((int) (100),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (110)),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (55),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (95)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (90)));
 //BA.debugLineNum = 351;BA.debugLine="Button4.SetVisibleAnimated(80,True)";
mostCurrent._button4.SetVisibleAnimated((int) (80),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 352;BA.debugLine="Button4.BringToFront";
mostCurrent._button4.BringToFront();
 //BA.debugLineNum = 354;BA.debugLine="End Sub";
return "";
}
public static String  _menu_onfullyopen() throws Exception{
 //BA.debugLineNum = 323;BA.debugLine="Sub Menu_onFullyOpen";
 //BA.debugLineNum = 324;BA.debugLine="lvMenu.BringToFront";
mostCurrent._lvmenu.BringToFront();
 //BA.debugLineNum = 325;BA.debugLine="smlp.BringToFront";
mostCurrent._smlp.BringToFront();
 //BA.debugLineNum = 326;BA.debugLine="slm.Sidebar.BringToFront";
mostCurrent._slm._sidebar().BringToFront();
 //BA.debugLineNum = 327;BA.debugLine="lvMenu.BringToFront";
mostCurrent._lvmenu.BringToFront();
 //BA.debugLineNum = 329;BA.debugLine="Button4.SendToBack";
mostCurrent._button4.SendToBack();
 //BA.debugLineNum = 330;BA.debugLine="ProgressBar1.SendToBack";
mostCurrent._progressbar1.SendToBack();
 //BA.debugLineNum = 332;BA.debugLine="Button4.SetVisibleAnimated(150,False)";
mostCurrent._button4.SetVisibleAnimated((int) (150),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 333;BA.debugLine="Label1.SetLayout(40%x,40%y,40%x,90dip)";
mostCurrent._label1.SetLayout(anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (40),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (40),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (40),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (90)));
 //BA.debugLineNum = 334;BA.debugLine="Label2.SetVisibleAnimated(100,False)";
mostCurrent._label2.SetVisibleAnimated((int) (100),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 335;BA.debugLine="Label4.SetVisibleAnimated(100,False)";
...
public static String  _menu_onmove(boolean _isopening) throws Exception{
 //BA.debugLineNum = 356;BA.debugLine="Sub Menu_onMove (IsOpening As Boolean)";
 //BA.debugLineNum = 357;BA.debugLine="If IsOpening=True Then";
if (_isopening==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 358;BA.debugLine="Button4.SetLayoutAnimated(100,1dip,50%y,5%x,180d";
mostCurrent._button4.SetLayoutAnimated((int) (100),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (1)),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (50),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (5),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (180)));
 //BA.debugLineNum = 359;BA.debugLine="Button4.SetVisibleAnimated(80,False)";
...
int _hours = 0;
int _minutes = 0;
 //BA.debugLineNum = 821;BA.debugLine="Sub minutes_hours ( ms As Int ) As String";
 //BA.debugLineNum = 822;BA.debugLine="Dim val,hours,minutes As Int";
_val = 0;
_hours = 0;
_minutes = 0;
 //BA.debugLineNum = 823;BA.debugLine="val = ms";
_val = _ms;
 //BA.debugLineNum = 824;BA.debugLine="hours = Floor(val / 60)";
_hours = (int) (anywheresoftware.b4a.keywords.Common.Floor(_val/(double)60));
 //BA.debugLineNum = 825;BA.debugLine="minutes = val Mod 60";
_minutes = (int) (_val%60);
 //BA.debugLineNum = 826;BA.debugLine="Return NumberFormat(hours, 1, 0) & \":\" & NumberFo";
...
public static String  _mystats_update(float[] _cpuefficiency,float _ramusage) throws Exception{
 //BA.debugLineNum = 634;BA.debugLine="Sub myStats_Update(CPUEfficiency() As Float, RAMUs";
 //BA.debugLineNum = 635;BA.debugLine="ProgressBar1.Progress=RAMUsage";
mostCurrent._progressbar1.setProgress((int) (_ramusage));
 //BA.debugLineNum = 636;BA.debugLine="Label5.Text=NumberFormat2(RAMUsage, 0, 0, 0, Fals";
...
public static String  _opt_click() throws Exception{
 //BA.debugLineNum = 603;BA.debugLine="Sub opt_click";
 //BA.debugLineNum = 604;BA.debugLine="StartActivity(settings)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._settings.getObject()));
 //BA.debugLineNum = 605;BA.debugLine="SetAnimation.setanimati(\"extra_in\", \"extra_out\")";
mostCurrent._setanimation._setanimati(mostCurrent.activityBA,"extra_in","extra_out");
 //BA.debugLineNum = 606;BA.debugLine="End Sub";
return "";
}
public static String  _pci_click() throws Exception{
 //BA.debugLineNum = 622;BA.debugLine="Sub pci_click";
 //BA.debugLineNum = 623;BA.debugLine="cd.AddView(panel3,-1,350)";
mostCurrent._cd.AddView((android.view.View)(mostCurrent._panel3.getObject()),(int) (-1),(int) (350));
 //BA.debugLineNum = 624;BA.debugLine="cd.Show(\"About Batt-Cat: \",\"\",\"Got It\",\"\",LoadBit";
mostCurrent._cd.Show("About Batt-Cat: ","","Got It","",mostCurrent.activityBA,(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Rss.png").getObject()));
 //BA.debugLineNum = 625;BA.debugLine="If Not (cd2.Response=DialogResponse.CANCEL) Then";
if (anywheresoftware.b4a.keywords.Common.Not(mostCurrent._cd2.getResponse()==anywheresoftware.b4a.keywords.Common.DialogResponse.CANCEL)) { 
 //BA.debugLineNum = 626;BA.debugLine="ct.ShowBitmap(\"©2017 SuloMedia™\",30,Gravity.BOTT";
...
int _i = 0;
String _v = "";
 //BA.debugLineNum = 663;BA.debugLine="Sub ReadDir(folder As String, recursive As Boolean";
 //BA.debugLineNum = 665;BA.debugLine="Dim lst As List = File.ListFiles(folder)";
_lst = new anywheresoftware.b4a.objects.collections.List();
_lst = anywheresoftware.b4a.keywords.Common.File.ListFiles(_folder);
 //BA.debugLineNum = 666;BA.debugLine="For i = 0 To lst.Size - 1";
{
final int step2 = 1;
final int limit2 = (int) (_lst.getSize()-1);
for (_i = (int) (0) ; (step2 > 0 && _i <= limit2) || (step2 < 0 && _i >= limit2); _i = ((int)(0 + _i + step2)) ) {
 //BA.debugLineNum = 667;BA.debugLine="If File.IsDirectory(folder,lst.Get(i)) Then";
if (anywheresoftware.b4a.keywords.Common.File.IsDirectory(_folder,BA.ObjectToString(_lst.Get(_i)))) { 
 //BA.debugLineNum = 668;BA.debugLine="Dim v As String";
_v = "";
 //BA.debugLineNum = 669;BA.debugLine="v = folder&\"/\"&lst.Get(i)";
_v = _folder+"/"+BA.ObjectToString(_lst.Get(_i));
 //BA.debugLineNum = 671;BA.debugLine="ffolders.Add(v.SubString(root1.Length+1))";
mostCurrent._ffolders.Add((Object)(_v.substring((int) (mostCurrent._root1.length()+1))));
 //BA.debugLineNum = 672;BA.debugLine="If recursive Then";
if (_recursive) { 
 //BA.debugLineNum = 673;BA.debugLine="ReadDir(v,recursive)";
_readdir(_v,_recursive);
 };
 }else {
 //BA.debugLineNum = 676;BA.debugLine="ffiles.Add(folder&\"/\"&lst.Get(i))";
...
public static String  _rl_lo() throws Exception{
 //BA.debugLineNum = 608;BA.debugLine="Sub rl_lo";
 //BA.debugLineNum = 609;BA.debugLine="cd2.Show(\"User App´s\",\"Check\",\"\",\"\",LoadBitmap(Fi";
mostCurrent._cd2.Show("User App´s","Check","","",mostCurrent.activityBA,(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Android.png").getObject()));
 //BA.debugLineNum = 610;BA.debugLine="If cd2.Response=DialogResponse.POSITIVE Then";
if (mostCurrent._cd2.getResponse()==anywheresoftware.b4a.keywords.Common.DialogResponse.POSITIVE) { 
 //BA.debugLineNum = 611;BA.debugLine="ToastMessageShow(\"closed...\",False)";
...
public static String  _ser_start() throws Exception{
 //BA.debugLineNum = 630;BA.debugLine="Sub ser_start";
 //BA.debugLineNum = 631;BA.debugLine="ProgressDialogShow(\"loading\")";
...
public static String  _show_2() throws Exception{
 //BA.debugLineNum = 314;BA.debugLine="Sub show_2";
 //BA.debugLineNum = 315;BA.debugLine="slm.OpenSidebar";
mostCurrent._slm._opensidebar();
 //BA.debugLineNum = 316;BA.debugLine="showtip.setDelay(400)";
mostCurrent._showtip.setDelay((int) (400));
 //BA.debugLineNum = 317;BA.debugLine="showtip.setCircleColor(Colors.ARGB(195,255,255,25";
mostCurrent._showtip.setCircleColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (195),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 318;BA.debugLine="showtip.setTitle(pak.GetApplicationLabel(\"com.bat";
mostCurrent._showtip.setTitle(_pak.GetApplicationLabel("com.batcat")).build();
 //BA.debugLineNum = 319;BA.debugLine="showtip.build.setDescription(\"Tippe hier um dein";
mostCurrent._showtip.build().setDescription("Tippe hier um dein Akku zu Boosten...");
 //BA.debugLineNum = 320;BA.debugLine="showtip.setTarget(Button4)";
mostCurrent._showtip.setTarget((android.view.View)(mostCurrent._button4.getObject()));
 //BA.debugLineNum = 321;BA.debugLine="showtip.show";
mostCurrent._showtip.show();
 //BA.debugLineNum = 322;BA.debugLine="End Sub";
return "";
}
public static String  _show_tip() throws Exception{
 //BA.debugLineNum = 306;BA.debugLine="Sub show_tip";
 //BA.debugLineNum = 307;BA.debugLine="showtip.setDelay(400)";
mostCurrent._showtip.setDelay((int) (400));
 //BA.debugLineNum = 308;BA.debugLine="showtip.setCircleColor(Colors.ARGB(195,255,255,2";
mostCurrent._showtip.setCircleColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (195),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 309;BA.debugLine="showtip.setTitle(pak.GetApplicationLabel(\"com.ba";
mostCurrent._showtip.setTitle(_pak.GetApplicationLabel("com.batcat")).build();
 //BA.debugLineNum = 310;BA.debugLine="showtip.build.setDescription(\"Swipe nach links z";
mostCurrent._showtip.build().setDescription("Swipe nach links zum öffnen und nach rechts zum schließen des Menü´s");
 //BA.debugLineNum = 311;BA.debugLine="showtip.setTarget(smlp).build";
mostCurrent._showtip.setTarget((android.view.View)(mostCurrent._smlp.getObject())).build();
 //BA.debugLineNum = 312;BA.debugLine="showtip.show";
mostCurrent._showtip.show();
 //BA.debugLineNum = 313;BA.debugLine="End Sub";
return "";
}
public static String  _slem_click() throws Exception{
 //BA.debugLineNum = 532;BA.debugLine="Sub slem_click";
 //BA.debugLineNum = 533;BA.debugLine="If slm.IsSidebarVisible Then";
if (mostCurrent._slm._issidebarvisible()) { 
 //BA.debugLineNum = 534;BA.debugLine="slm.CloseSidebar";
mostCurrent._slm._closesidebar();
 }else {
 //BA.debugLineNum = 537;BA.debugLine="slm.OpenSidebar";
mostCurrent._slm._opensidebar();
 };
...
public static String  _slem1_click() throws Exception{
 //BA.debugLineNum = 528;BA.debugLine="Sub slem1_click";
 //BA.debugLineNum = 529;BA.debugLine="slem_click";
_slem_click();
 //BA.debugLineNum = 530;BA.debugLine="End Sub";
return "";
}
public static String  _st_click() throws Exception{
 //BA.debugLineNum = 591;BA.debugLine="Sub st_click";
 //BA.debugLineNum = 592;BA.debugLine="StartActivity(klo)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._klo.getObject()));
...
public static String  _stat_me() throws Exception{
 //BA.debugLineNum = 581;BA.debugLine="Sub stat_me";
 //BA.debugLineNum = 582;BA.debugLine="StartActivity(klo)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._klo.getObject()));
...
public static String  _store_check() throws Exception{
 //BA.debugLineNum = 364;BA.debugLine="Sub store_check";
 //BA.debugLineNum = 365;BA.debugLine="c1=mcl.md_light_blue_A700";
_c1 = mostCurrent._mcl.getmd_light_blue_A700();
 //BA.debugLineNum = 366;BA.debugLine="c2=mcl.md_amber_A700";
_c2 = mostCurrent._mcl.getmd_amber_A700();
 //BA.debugLineNum = 367;BA.debugLine="c3=mcl.md_white_1000";
_c3 = mostCurrent._mcl.getmd_white_1000();
 //BA.debugLineNum = 368;BA.debugLine="c4=mcl.md_teal_A700";
_c4 = mostCurrent._mcl.getmd_teal_A700();
 //BA.debugLineNum = 369;BA.debugLine="c5=mcl.md_deep_purple_A700";
_c5 = mostCurrent._mcl.getmd_deep_purple_A700();
 //BA.debugLineNum = 370;BA.debugLine="c6=mcl.md_red_A700";
_c6 = mostCurrent._mcl.getmd_red_A700();
 //BA.debugLineNum = 371;BA.debugLine="c7=mcl.md_indigo_A700";
_c7 = mostCurrent._mcl.getmd_indigo_A700();
 //BA.debugLineNum = 372;BA.debugLine="c8=mcl.md_blue_A700";
_c8 = mostCurrent._mcl.getmd_blue_A700();
 //BA.debugLineNum = 373;BA.debugLine="c9=mcl.md_orange_A700";
_c9 = mostCurrent._mcl.getmd_orange_A700();
 //BA.debugLineNum = 374;BA.debugLine="c10=mcl.md_grey_700";
_c10 = mostCurrent._mcl.getmd_grey_700();
 //BA.debugLineNum = 375;BA.debugLine="c11=mcl.md_green_A700";
_c11 = mostCurrent._mcl.getmd_green_A700();
 //BA.debugLineNum = 376;BA.debugLine="c12=mcl.md_black_1000";
_c12 = mostCurrent._mcl.getmd_black_1000();
 //BA.debugLineNum = 377;BA.debugLine="c13=mcl.md_yellow_A700";
_c13 = mostCurrent._mcl.getmd_yellow_A700();
 //BA.debugLineNum = 378;BA.debugLine="c14=mcl.md_cyan_A700";
_c14 = mostCurrent._mcl.getmd_cyan_A700();
 //BA.debugLineNum = 379;BA.debugLine="c15=mcl.md_blue_grey_700";
_c15 = mostCurrent._mcl.getmd_blue_grey_700();
 //BA.debugLineNum = 380;BA.debugLine="c16=mcl.md_light_blue_A700";
_c16 = mostCurrent._mcl.getmd_light_blue_A700();
 //BA.debugLineNum = 381;BA.debugLine="If kvs4sub.ContainsKey(\"off\") Then";
if (mostCurrent._kvs4sub._containskey("off")) { 
 //BA.debugLineNum = 382;BA.debugLine="StopService(Starter)";
anywheresoftware.b4a.keywords.Common.StopService(mostCurrent.activityBA,(Object)(mostCurrent._starter.getObject()));
 };
 //BA.debugLineNum = 384;BA.debugLine="If kvs4.ContainsKey(\"0\")Then";
if (mostCurrent._kvs4._containskey("0")) { 
 //BA.debugLineNum = 385;BA.debugLine="Log(\"AC_true->1\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->1");
 //BA.debugLineNum = 386;BA.debugLine="Activity.Color=c1";
mostCurrent._activity.setColor(_c1);
 //BA.debugLineNum = 387;BA.debugLine="apm.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._apm.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 388;BA.debugLine="Label4.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._label4.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 389;BA.debugLine="Label5.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._label5.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 390;BA.debugLine="Label3.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._label3.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 };
 //BA.debugLineNum = 393;BA.debugLine="If kvs4.ContainsKey(\"1\")Then";
if (mostCurrent._kvs4._containskey("1")) { 
 //BA.debugLineNum = 394;BA.debugLine="Log(\"AC_true->2\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->2");
 //BA.debugLineNum = 395;BA.debugLine="Activity.Color=c2";
mostCurrent._activity.setColor(_c2);
 //BA.debugLineNum = 396;BA.debugLine="apm.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._apm.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 397;BA.debugLine="Label4.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._label4.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 398;BA.debugLine="Label5.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._label5.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 399;BA.debugLine="Label3.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._label3.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 };
 //BA.debugLineNum = 403;BA.debugLine="If kvs4.ContainsKey(\"2\")Then";
if (mostCurrent._kvs4._containskey("2")) { 
 //BA.debugLineNum = 404;BA.debugLine="Log(\"AC_true->3\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->3");
 //BA.debugLineNum = 405;BA.debugLine="Activity.Color=c3";
mostCurrent._activity.setColor(_c3);
 //BA.debugLineNum = 406;BA.debugLine="apm.TextColor=Colors.Black";
mostCurrent._apm.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 407;BA.debugLine="Label4.TextColor=Colors.Black";
mostCurrent._label4.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 408;BA.debugLine="Label5.TextColor=Colors.Black";
mostCurrent._label5.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 409;BA.debugLine="Label3.TextColor=Colors.Black";
mostCurrent._label3.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 };
 //BA.debugLineNum = 412;BA.debugLine="If kvs4.ContainsKey(\"3\")Then";
...
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 414;BA.debugLine="Activity.Color=c4";
mostCurrent._activity.setColor(_c4);
 //BA.debugLineNum = 415;BA.debugLine="apm.TextColor=Colors.Black";
mostCurrent._apm.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 416;BA.debugLine="Label4.TextColor=Colors.Black";
mostCurrent._label4.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 417;BA.debugLine="Label5.TextColor=Colors.Black";
mostCurrent._label5.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 418;BA.debugLine="Label3.TextColor=Colors.Black";
mostCurrent._label3.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 };
 //BA.debugLineNum = 421;BA.debugLine="If kvs4.ContainsKey(\"4\")Then";
if (mostCurrent._kvs4._containskey("4")) { 
 //BA.debugLineNum = 422;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 423;BA.debugLine="Activity.Color=c5";
mostCurrent._activity.setColor(_c5);
 //BA.debugLineNum = 424;BA.debugLine="apm.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._apm.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 425;BA.debugLine="Label4.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._label4.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 426;BA.debugLine="Label5.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._label5.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 427;BA.debugLine="Label3.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._label3.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 };
 //BA.debugLineNum = 430;BA.debugLine="If kvs4.ContainsKey(\"5\")Then";
if (mostCurrent._kvs4._containskey("5")) { 
 //BA.debugLineNum = 431;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 432;BA.debugLine="Activity.Color=c6";
...
mostCurrent._label3.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 ...
 //BA.debugLineNum = 439;BA.debugLine="If kvs4.ContainsKey(\"6\")Then";
if (mostCurrent._kvs4._containskey("6")) { 
 //BA.debugLineNum = 440;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 441;BA.debugLine="Activity.Color=c7";
mostCurrent._activity.setColor(_c7);
 //BA.debugLineNum = 442;BA.debugLine="apm.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._apm.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 443;BA.debugLine="Label4.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._label4.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 444;BA.debugLine="Label5.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._label5.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 445;BA.debugLine="Label3.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._label3.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 };
 //BA.debugLineNum = 448;BA.debugLine="If kvs4.ContainsKey(\"7\")Then";
if (mostCurrent._kvs4._containskey("7")) { 
 //BA.debugLineNum = 449;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 450;BA.debugLine="Activity.Color=c8";
...
mostCurrent._label3.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 ...
 //BA.debugLineNum = 457;BA.debugLine="If kvs4.ContainsKey(\"8\")Then";
if (mostCurrent._kvs4._containskey("8")) { 
 //BA.debugLineNum = 458;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 459;BA.debugLine="Activity.Color=c9";
mostCurrent._activity.setColor(_c9);
 //BA.debugLineNum = 460;BA.debugLine="apm.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._apm.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
...
mostCurrent._label3.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 ...
 //BA.debugLineNum = 466;BA.debugLine="If kvs4.ContainsKey(\"9\")Then";
if (mostCurrent._kvs4._containskey("9")) { 
 //BA.debugLineNum = 467;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 468;BA.debugLine="Activity.Color=c10";
mostCurrent._activity.setColor(_c10);
...
mostCurrent._label3.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 ...
 //BA.debugLineNum = 486;BA.debugLine="If kvs4.ContainsKey(\"11\")Then";
if (mostCurrent._kvs4._containskey("11")) { 
 //BA.debugLineNum = 487;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 488;BA.debugLine="Activity.Color=c12";
...
mostCurrent._label3.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 504;BA.debugLine="panel3.Color=Colors.ARGB(100,0,0,0)";
mostCurrent._panel3.setColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (100),(int) (0),(int) (0),(int) (0)));
 };
 //BA.debugLineNum = 507;BA.debugLine="If kvs4.ContainsKey(\"13\")Then";
if (mostCurrent._kvs4._containskey("13")) { 
 //BA.debugLineNum = 508;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 509;BA.debugLine="Activity.Color=c14";
mostCurrent._activity.setColor(_c14);
 //BA.debugLineNum = 510;BA.debugLine="apm.TextColor=Colors.Black";
mostCurrent._apm.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 511;BA.debugLine="Label4.TextColor=Colors.Black";
mostCurrent._label4.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 512;BA.debugLine="Label5.TextColor=Colors.Black";
mostCurrent._label5.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 513;BA.debugLine="Label3.TextColor=Colors.Black";
mostCurrent._label3.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 };
 //BA.debugLineNum = 516;BA.debugLine="If kvs4.ContainsKey(\"14\")Then";
if (mostCurrent._kvs4._containskey("14")) { 
 //BA.debugLineNum = 517;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 518;BA.debugLine="Activity.Color=c15";
mostCurrent._activity.setColor(_c15);
 //BA.debugLineNum = 519;BA.debugLine="apm.TextColor=Colors.Black";
mostCurrent._apm.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 520;BA.debugLine="Label4.TextColor=Colors.Black";
mostCurrent._label4.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 521;BA.debugLine="Label5.TextColor=Colors.Black";
mostCurrent._label5.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 522;BA.debugLine="Label3.TextColor=Colors.Black";
mostCurrent._label3.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 };
 //BA.debugLineNum = 525;BA.debugLine="Activity.Invalidate";
mostCurrent._activity.Invalidate();
 //BA.debugLineNum = 526;BA.debugLine="End Sub";
return "";
}
public static String  _sy_click() throws Exception{
 //BA.debugLineNum = 586;BA.debugLine="Sub sy_click";
 //BA.debugLineNum = 587;BA.debugLine="StartActivity(sys)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._sys.getObject()));
