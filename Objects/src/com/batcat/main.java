...
public static String  _ab1_click() throws Exception{
 //BA.debugLineNum = 699;BA.debugLine="Sub ab1_Click";
 //BA.debugLineNum = 700;BA.debugLine="Button4_Click";
_button4_click();
...
mostCurrent._apm.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 289;BA.debugLine="apm.TextSize=60";
mostCurrent._apm.setTextSize((float) (60));
 //BA.debugLineNum = 290;BA.debugLine="apm.StrokeWidth=9dip";
...
_store_check();
 //BA.debugLineNum = 296;BA.debugLine="label_text";
_label_text();
 //BA.debugLineNum = 297;BA.debugLine="value_check";
_value_check();
...
mostCurrent._activity.Finish();
 //BA.debugLineNum = 829;BA.debugLine="SetAnimation.setanimati(\"extra_in\", \"extra_out\")";
mostCurrent._setanimation._setanimati(mostCurrent.activityBA,"extra_in","extra_out");
 //BA.debugLineNum = 830;BA.debugLine="ToastMessageShow(\"BCT - Backround Service\",False";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("BCT - Backround Service"),anywheresoftware.b4a.keywords.Common.False);
 ...
 //BA.debugLineNum = 832;BA.debugLine="Return(True)";
...
public static String  _activity_pause(boolean _userclosed) throws Exception{
 ...
 //BA.debugLineNum = 307;BA.debugLine="xOSStats.EndStats";
...
public static String  _activity_resume() throws Exception{
 ...
 //BA.debugLineNum = 301;BA.debugLine="xOSStats.StartStats";
mostCurrent._xosstats._startstats();
 //BA.debugLineNum = 302;BA.debugLine="store_check";
_store_check();
...
public static String  _b1_click() throws Exception{
 //BA.debugLineNum = 692;BA.debugLine="Sub b1_Click";
 //BA.debugLineNum = 693;BA.debugLine="StartService(webhost)";
anywheresoftware.b4a.keywords.Common.StartService(mostCurrent.activityBA,(Object)(mostCurrent._webhost.getObject()));
 //BA.debugLineNum = 694;BA.debugLine="StartActivity(cool)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._cool.getObject()));
 //BA.debugLineNum = 695;BA.debugLine="SetAnimation.setanimati(\"extra_in\", \"extra_out\")";
mostCurrent._setanimation._setanimati(mostCurrent.activityBA,"extra_in","extra_out");
 //BA.debugLineNum = 697;BA.debugLine="End Sub";
return "";
}
public static String  _button1_click() throws Exception{
 //BA.debugLineNum = 803;BA.debugLine="Sub Button1_Click";
 //BA.debugLineNum = 804;BA.debugLine="If slm.IsSidebarVisible Then";
if (mostCurrent._slm._issidebarvisible()) { 
 //BA.debugLineNum = 805;BA.debugLine="slm.CloseSidebar";
mostCurrent._slm._closesidebar();
 }else {
 //BA.debugLineNum = 807;BA.debugLine="slm.OpenSidebar";
mostCurrent._slm._opensidebar();
 };
...
public static String  _button2_click() throws Exception{
 //BA.debugLineNum = 702;BA.debugLine="Sub button2_Click";
 //BA.debugLineNum = 703;BA.debugLine="StartActivity(pman)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._pman.getObject()));
 //BA.debugLineNum = 704;BA.debugLine="SetAnimation.setanimati(\"extra_in\", \"extra_out\")";
mostCurrent._setanimation._setanimati(mostCurrent.activityBA,"extra_in","extra_out");
 //BA.debugLineNum = 705;BA.debugLine="End Sub";
return "";
}
public static String  _button3_click() throws Exception{
 //BA.debugLineNum = 836;BA.debugLine="Sub Button3_Click";
 //BA.debugLineNum = 837;BA.debugLine="StartActivity(settings)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._settings.getObject()));
 //BA.debugLineNum = 838;BA.debugLine="SetAnimation.setanimati(\"extra_in\", \"extra_out\")";
mostCurrent._setanimation._setanimati(mostCurrent.activityBA,"extra_in","extra_out");
 //BA.debugLineNum = 839;BA.debugLine="End Sub";
return "";
}
public static String  _button4_click() throws Exception{
 //BA.debugLineNum = 679;BA.debugLine="Sub Button4_Click";
 //BA.debugLineNum = 681;BA.debugLine="StartService(webhost)";
anywheresoftware.b4a.keywords.Common.StartService(mostCurrent.activityBA,(Object)(mostCurrent._webhost.getObject()));
 //BA.debugLineNum = 682;BA.debugLine="StartActivity(cool)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._cool.getObject()));
 //BA.debugLineNum = 683;BA.debugLine="SetAnimation.setanimati(\"extra_in\", \"extra_out\")";
mostCurrent._setanimation._setanimati(mostCurrent.activityBA,"extra_in","extra_out");
...
long _size1 = 0L;
String _f = "";
 //BA.debugLineNum = 730;BA.debugLine="Sub CalcSize(Folder As String, recursive As Boolea";
 //BA.debugLineNum = 731;BA.debugLine="Dim size1 As Long";
_size1 = 0L;
 //BA.debugLineNum = 732;BA.debugLine="For Each f As String In File.ListFiles(Folder)";
...
_f = BA.ObjectToString(group2.Get(index2));
 //BA.debugLineNum = 733;BA.debugLine="If recursive Then";
if (_recursive) { 
 //BA.debugLineNum = 734;BA.debugLine="If File.IsDirectory(Folder, f) Then";
if (anywheresoftware.b4a.keywords.Common.File.IsDirectory(_folder,_f)) { 
 //BA.debugLineNum = 735;BA.debugLine="size1 = size1 + CalcSize(File.Combine(Folder,";
_size1 = (long) (_size1+_calcsize(anywheresoftware.b4a.keywords.Common.File.Combine(_folder,_f),_recursive));
 };
 };
 //BA.debugLineNum = 738;BA.debugLine="size1 = size1 + File.Size(Folder, f)";
_size1 = (long) (_size1+anywheresoftware.b4a.keywords.Common.File.Size(_folder,_f));
 }
;
 //BA.debugLineNum = 740;BA.debugLine="Return size1";
if (true) return _size1;
 //BA.debugLineNum = 741;BA.debugLine="End Sub";
return 0L;
}
public static String  _cb2_click() throws Exception{
 //BA.debugLineNum = 672;BA.debugLine="Sub cb2_Click";
 //BA.debugLineNum = 673;BA.debugLine="cc.CleanCache";
_cc.CleanCache();
 //BA.debugLineNum = 674;BA.debugLine="StartService(webhost)";
anywheresoftware.b4a.keywords.Common.StartService(mostCurrent.activityBA,(Object)(mostCurrent._webhost.getObject()));
 //BA.debugLineNum = 675;BA.debugLine="StartActivity(cool)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._cool.getObject()));
 //BA.debugLineNum = 676;BA.debugLine="SetAnimation.setanimati(\"extra_in\", \"extra_out\")";
mostCurrent._setanimation._setanimati(mostCurrent.activityBA,"extra_in","extra_out");
...
int _res = 0;
 //BA.debugLineNum = 811;BA.debugLine="Sub cl_click As Boolean";
 //BA.debugLineNum = 812;BA.debugLine="Dim res As Int";
_res = 0;
 //BA.debugLineNum = 813;BA.debugLine="res=Msgbox2(cs.Initialize.Alignment(\"ALIGN_CENTER";
_res = anywheresoftware.b4a.keywords.Common.Msgbox2(BA.ObjectToCharSequence(_cs.Initialize().Alignment(BA.getEnumFromString(android.text.Layout.Alignment.class,"ALIGN_CENTER")).Append(BA.ObjectToCharSequence(("App wird geschlossen Service Icon läuft im Hintergrund Prozess weiter und wird als Info weiterhin in der statusbar ausgeführt., zum deaktivieren bitte 'Settings->Start/stop Notify Service'.!\",\"Bat-CaT beenden:"))).PopAll().getObject()),BA.ObjectToCharSequence(_cs.Initialize().Typeface(anywheresoftware.b4a.keywords.Common.Typeface.DEFAULT).Color((int) (0xff01ff20)).Size((int) (40)).PopAll().getObject()),"ja","Abbruch","",(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Power.png").getObject()),mostCurrent.activityBA);
 //BA.debugLineNum = 815;BA.debugLine="If res=DialogResponse.POSITIVE Then";
if (_res==anywheresoftware.b4a.keywords.Common.DialogResponse.POSITIVE) { 
 //BA.debugLineNum = 816;BA.debugLine="Activity.Finish";
mostCurrent._activity.Finish();
 //BA.debugLineNum = 817;BA.debugLine="SetAnimation.setanimati(\"extra_in\", \"extra_out\")";
mostCurrent._setanimation._setanimati(mostCurrent.activityBA,"extra_in","extra_out");
 }else {
 //BA.debugLineNum = 819;BA.debugLine="If res=DialogResponse.CANCEL Then";
if (_res==anywheresoftware.b4a.keywords.Common.DialogResponse.CANCEL) { 
 //BA.debugLineNum = 820;BA.debugLine="ToastMessageShow(\"zurück..\",False)";
...
String _f = "";
 //BA.debugLineNum = 743;BA.debugLine="Private Sub CopyFolder(Source As String, targetFol";
 //BA.debugLineNum = 744;BA.debugLine="If File.Exists(targetFolder, \"\") = False Then Fil";
...
anywheresoftware.b4a.keywords.Common.File.MakeDir(_targetfolder,"");};
 //BA.debugLineNum = 745;BA.debugLine="For Each f As String In File.ListFiles(Source)";
final anywheresoftware.b4a.BA.IterableList group2 = anywheresoftware.b4a.keywords.Common.File.ListFiles(_source);
final int groupLen2 = group2.getSize();
for (int index2 = 0;index2 < groupLen2 ;index2++){
_f = BA.ObjectToString(group2.Get(index2));
 //BA.debugLineNum = 746;BA.debugLine="If File.IsDirectory(Source, f) Then";
if (anywheresoftware.b4a.keywords.Common.File.IsDirectory(_source,_f)) { 
 //BA.debugLineNum = 747;BA.debugLine="CopyFolder(File.Combine(Source, f), File.Combin";
_copyfolder(anywheresoftware.b4a.keywords.Common.File.Combine(_source,_f),anywheresoftware.b4a.keywords.Common.File.Combine(_targetfolder,_f));
 //BA.debugLineNum = 748;BA.debugLine="Continue";
if (true) continue;
 };
 //BA.debugLineNum = 750;BA.debugLine="File.Copy(Source, f, targetFolder, f)";
...
int _vol = 0;
int _days = 0;
 //BA.debugLineNum = 842;BA.debugLine="Sub device_BatteryChanged (level As Int, Scale As";
 //BA.debugLineNum = 846;BA.debugLine="Dim val,hours,minutes,rst,ts,volta,vs As Int";
_val = 0;
_hours = 0;
_minutes = 0;
_rst = 0;
...
_volta = 0;
_vs = 0;
 //BA.debugLineNum = 847;BA.debugLine="volta=Intent.GetExtra(\"voltage\")/1000";
_volta = (int) ((double)(BA.ObjectToNumber(_intent.GetExtra("voltage")))/(double)1000);
 //BA.debugLineNum = 848;BA.debugLine="temp=Intent.GetExtra(\"temperature\")/10";
mostCurrent._temp = BA.NumberToString((double)(BA.ObjectToNumber(_intent.GetExtra("temperature")))/(double)10);
 //BA.debugLineNum = 850;BA.debugLine="Label1.Visible=True";
mostCurrent._label1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 851;BA.debugLine="File.WriteString(File.DirDefaultExternal&\"/mnt/ca";
...
anywheresoftware.b4a.keywords.Common.File.WriteString(anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal()+"/mnt/cache","volt.txt",BA.NumberToString(_volta));
 //BA.debugLineNum = 856;BA.debugLine="apm.Progress=level";
mostCurrent._apm.setProgress(_level);
 //BA.debugLineNum = 857;BA.debugLine="apm.BottomText=Intent.GetExtra(\"technology\")";
mostCurrent._apm.setBottomText(BA.ObjectToString(_intent.GetExtra("technology")));
 //BA.debugLineNum = 858;BA.debugLine="apm.Max=Scale";
mostCurrent._apm.setMax(_scale);
 //BA.debugLineNum = 859;BA.debugLine="rst=Scale-level";
_rst = (int) (_scale-_level);
 //BA.debugLineNum = 860;BA.debugLine="If Plugged=True Then";
if (_plugged==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 861;BA.debugLine="lvbat.SetVisibleAnimated(100,True)";
mostCurrent._lvbat.SetVisibleAnimated((int) (100),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 862;BA.debugLine="lvbat.startAnim";
mostCurrent._lvbat.startAnim();
 //BA.debugLineNum = 865;BA.debugLine="apm.BottomText=\"Aufladen via USB: \"&volta&\" V\"";
mostCurrent._apm.setBottomText("Aufladen via USB: "+BA.NumberToString(_volta)+" V");
 //BA.debugLineNum = 867;BA.debugLine="val =rst*Intent.GetExtra(\"voltage\") /1000";
_val = (int) (_rst*(double)(BA.ObjectToNumber(_intent.GetExtra("voltage")))/(double)1000);
 //BA.debugLineNum = 868;BA.debugLine="hours = Floor(val / 60)";
_hours = (int) (anywheresoftware.b4a.keywords.Common.Floor(_val/(double)60));
 //BA.debugLineNum = 869;BA.debugLine="minutes = val Mod 60";
_minutes = (int) (_val%60);
 //BA.debugLineNum = 870;BA.debugLine="If level=100 Then";
if (_level==100) { 
 //BA.debugLineNum = 871;BA.debugLine="lvbat.stopAnim";
mostCurrent._lvbat.stopAnim();
 //BA.debugLineNum = 872;BA.debugLine="lvbat.Value=level";
mostCurrent._lvbat.setValue(_level);
 //BA.debugLineNum = 873;BA.debugLine="apm.BottomText=\"Kabel entfernen(USB)!\"";
mostCurrent._apm.setBottomText("Kabel entfernen(USB)!");
 //BA.debugLineNum = 874;BA.debugLine="Label4.Text=\"Batterie voll! Bitte Kabel entfern";
mostCurrent._label4.setText(BA.ObjectToCharSequence("Batterie voll! Bitte Kabel entfernen!"));
 }else {
 //BA.debugLineNum = 877;BA.debugLine="Label4.Text=\"voll in: \"&hours&\"h - \"&minutes&\"mi";
mostCurrent._label4.setText(BA.ObjectToCharSequence("voll in: "+BA.NumberToString(_hours)+"h - "+BA.NumberToString(_minutes)+"min"));
 };
 }else {
 //BA.debugLineNum = 882;BA.debugLine="lvbat.stopAnim";
mostCurrent._lvbat.stopAnim();
 //BA.debugLineNum = 883;BA.debugLine="lvbat.Value=level";
mostCurrent._lvbat.setValue(_level);
 //BA.debugLineNum = 885;BA.debugLine="If level<=5 Then";
if (_level<=5) { 
 //BA.debugLineNum = 886;BA.debugLine="Label1.TextColor=Colors.Red";
mostCurrent._label1.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Red);
 //BA.debugLineNum = 887;BA.debugLine="Label1.TextSize=15";
mostCurrent._label1.setTextSize((float) (15));
 //BA.debugLineNum = 888;BA.debugLine="Label1.Text=\"Akku laden!\"";
mostCurrent._label1.setText(BA.ObjectToCharSequence("Akku laden!"));
 //BA.debugLineNum = 889;BA.debugLine="apm.UnfinishedStrokeColor=mcl.md_red_200";
mostCurrent._apm.setUnfinishedStrokeColor(mostCurrent._mcl.getmd_red_200());
 //BA.debugLineNum = 890;BA.debugLine="apm.FinishedStrokeColor=mcl.md_amber_100";
mostCurrent._apm.setFinishedStrokeColor(mostCurrent._mcl.getmd_amber_100());
 };
 //BA.debugLineNum = 893;BA.debugLine="Dim vol As Int";
_vol = 0;
 //BA.debugLineNum = 894;BA.debugLine="vol=Intent.GetExtra(\"voltage\")";
_vol = (int)(BA.ObjectToNumber(_intent.GetExtra("voltage")));
 //BA.debugLineNum = 895;BA.debugLine="Dim days As Int";
_days = 0;
 //BA.debugLineNum = 896;BA.debugLine="val =Scale/vol*level*1000";
_val = (int) (_scale/(double)_vol*_level*1000);
 //BA.debugLineNum = 897;BA.debugLine="days=Floor(val/60/24)";
_days = (int) (anywheresoftware.b4a.keywords.Common.Floor(_val/(double)60/(double)24));
 //BA.debugLineNum = 898;BA.debugLine="hours = Floor(val/60 Mod 24)";
_hours = (int) (anywheresoftware.b4a.keywords.Common.Floor(_val/(double)60%24));
 //BA.debugLineNum = 899;BA.debugLine="minutes = val Mod 60";
_minutes = (int) (_val%60);
 //BA.debugLineNum = 900;BA.debugLine="Label4.Text= \"noch: \"&days&\"d - \"&hours&\"h - \"&m";
...
if ((double)(Double.parseDouble(mostCurrent._temp))<41) { 
 //BA.debugLineNum = 903;BA.debugLine="store_check";
_store_check();
 };
 //BA.debugLineNum = 906;BA.debugLine="If temp>41 Then";
if ((double)(Double.parseDouble(mostCurrent._temp))>41) { 
 //BA.debugLineNum = 907;BA.debugLine="apm.FinishedStrokeColor=mcl.md_amber_A700";
mostCurrent._apm.setFinishedStrokeColor(mostCurrent._mcl.getmd_amber_A700());
 };
 //BA.debugLineNum = 910;BA.debugLine="If temp >49 Then";
if ((double)(Double.parseDouble(mostCurrent._temp))>49) { 
 //BA.debugLineNum = 911;BA.debugLine="apm.FinishedStrokeColor=mcl.md_red_A700";
...
double _si = 0;
int _i = 0;
 //BA.debugLineNum = 773;BA.debugLine="Sub FormatFileSize(Bytes As Float) As String";
 //BA.debugLineNum = 775;BA.debugLine="Private Unit() As String = Array As String(\" Byte";
_unit = new String[]{" Byte"," KB"," MB"," GB"," TB"," PB"," EB"," ZB"," YB"};
 //BA.debugLineNum = 777;BA.debugLine="If Bytes = 0 Then";
if (_bytes==0) { 
 //BA.debugLineNum = 779;BA.debugLine="Return \"0 Bytes\"";
if (true) return "0 Bytes";
 }else {
 //BA.debugLineNum = 783;BA.debugLine="Private Po, Si As Double";
_po = 0;
_si = 0;
 //BA.debugLineNum = 784;BA.debugLine="Private I As Int";
_i = 0;
 //BA.debugLineNum = 786;BA.debugLine="Bytes = Abs(Bytes)";
_bytes = (float) (anywheresoftware.b4a.keywords.Common.Abs(_bytes));
 //BA.debugLineNum = 788;BA.debugLine="I = Floor(Logarithm(Bytes, 1024))";
_i = (int) (anywheresoftware.b4a.keywords.Common.Floor(anywheresoftware.b4a.keywords.Common.Logarithm(_bytes,1024)));
 //BA.debugLineNum = 789;BA.debugLine="Po = Power(1024, I)";
_po = anywheresoftware.b4a.keywords.Common.Power(1024,_i);
 //BA.debugLineNum = 790;BA.debugLine="Si = Bytes / Po";
_si = _bytes/(double)_po;
 //BA.debugLineNum = 792;BA.debugLine="Return NumberFormat(Si, 1, 2) & Unit(I)";
...
public static String  _info_but_click() throws Exception{
 //BA.debugLineNum = 707;BA.debugLine="Sub info_but_Click";
 //BA.debugLineNum = 708;BA.debugLine="StartActivity(wait)";
...
public static String  _label_text() throws Exception{
 //BA.debugLineNum = 711;BA.debugLine="Sub label_text";
 //BA.debugLineNum = 712;BA.debugLine="lk.TextSize=13";
mostCurrent._lk.setTextSize((float) (13));
 //BA.debugLineNum = 713;BA.debugLine="lk.TextColor=Colors.Black";
mostCurrent._lk.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 714;BA.debugLine="lk.Text=\"Version: \"&pak.GetVersionName(\"com.batca";
...
public static String  _label1_click() throws Exception{
 //BA.debugLineNum = 798;BA.debugLine="Sub Label1_Click";
 //BA.debugLineNum = 799;BA.debugLine="StartActivity(sys)";
...
public static String  _label4_click() throws Exception{
 //BA.debugLineNum = 925;BA.debugLine="Sub Label4_Click";
 //BA.debugLineNum = 926;BA.debugLine="StartActivity(sys)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._sys.getObject()));
 //BA.debugLineNum = 927;BA.debugLine="End Sub";
return "";
}
public static String  _lv3_itemclick(int _position,Object _value) throws Exception{
 //BA.debugLineNum = 391;BA.debugLine="Sub lv3_ItemClick (Position As Int, Value As Objec";
 //BA.debugLineNum = 392;BA.debugLine="If Value=0 Then";
if ((_value).equals((Object)(0))) { 
 //BA.debugLineNum = 393;BA.debugLine="read_log";
_read_log();
 };
...
anywheresoftware.b4a.objects.IntentWrapper _i = null;
 //BA.debugLineNum = 617;BA.debugLine="Sub lvMenu_ItemClick (Position As Int, Value As Ob";
 //BA.debugLineNum = 618;BA.debugLine="If Value = 0 Then";
if ((_value).equals((Object)(0))) { 
 //BA.debugLineNum = 619;BA.debugLine="opt_click";
_opt_click();
 //BA.debugLineNum = 620;BA.debugLine="slm.CloseSidebar";
mostCurrent._slm._closesidebar();
 //BA.debugLineNum = 621;BA.debugLine="SetAnimation.setanimati(\"extra_in\", \"extra_out\")";
mostCurrent._setanimation._setanimati(mostCurrent.activityBA,"extra_in","extra_out");
 };
...
mostCurrent._slm._closesidebar();
 //BA.debugLineNum = 626;BA.debugLine="SetAnimation.setanimati(\"extra_in\", \"extra_out\")";
mostCurrent._setanimation._setanimati(mostCurrent.activityBA,"extra_in","extra_out");
 };
 //BA.debugLineNum = 628;BA.debugLine="If Value=2 Then";
if ((_value).equals((Object)(2))) { 
 //BA.debugLineNum = 629;BA.debugLine="Dim i As Intent";
_i = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 630;BA.debugLine="i.Initialize( \"android.intent.action.POWER_USAGE";
_i.Initialize("android.intent.action.POWER_USAGE_SUMMARY","");
 //BA.debugLineNum = 631;BA.debugLine="slm.CloseSidebar";
mostCurrent._slm._closesidebar();
 //BA.debugLineNum = 632;BA.debugLine="SetAnimation.setanimati(\"extra_in\", \"extra_out\")";
mostCurrent._setanimation._setanimati(mostCurrent.activityBA,"extra_in","extra_out");
 //BA.debugLineNum = 633;BA.debugLine="StartActivity(i)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_i.getObject()));
 };
 //BA.debugLineNum = 635;BA.debugLine="If Value=3 Then";
if ((_value).equals((Object)(3))) { 
 //BA.debugLineNum = 636;BA.debugLine="StartActivity(klo)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._klo.getObject()));
 //BA.debugLineNum = 637;BA.debugLine="SetAnimation.setanimati(\"extra_in\", \"extra_out\")";
mostCurrent._setanimation._setanimati(mostCurrent.activityBA,"extra_in","extra_out");
 //BA.debugLineNum = 638;BA.debugLine="slm.CloseSidebar";
mostCurrent._slm._closesidebar();
 };
 //BA.debugLineNum = 640;BA.debugLine="If Value=4 Then";
if ((_value).equals((Object)(4))) { 
 //BA.debugLineNum = 641;BA.debugLine="StartActivity(sys)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._sys.getObject()));
 //BA.debugLineNum = 642;BA.debugLine="slm.CloseSidebar";
mostCurrent._slm._closesidebar();
 //BA.debugLineNum = 643;BA.debugLine="SetAnimation.setanimati(\"extra_in\", \"extra_out\")";
mostCurrent._setanimation._setanimati(mostCurrent.activityBA,"extra_in","extra_out");
 };
 //BA.debugLineNum = 645;BA.debugLine="If Value=5 Then";
if ((_value).equals((Object)(5))) { 
 //BA.debugLineNum = 646;BA.debugLine="StartActivity(wait)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._wait.getObject()));
 //BA.debugLineNum = 647;BA.debugLine="slm.CloseSidebar";
mostCurrent._slm._closesidebar();
 //BA.debugLineNum = 648;BA.debugLine="SetAnimation.setanimati(\"extra_in\", \"extra_out\")";
mostCurrent._setanimation._setanimati(mostCurrent.activityBA,"extra_in","extra_out");
 };
 //BA.debugLineNum = 650;BA.debugLine="If Value=6 Then";
if ((_value).equals((Object)(6))) { 
 //BA.debugLineNum = 651;BA.debugLine="StartActivity(pman)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._pman.getObject()));
 //BA.debugLineNum = 652;BA.debugLine="slm.CloseSidebar";
mostCurrent._slm._closesidebar();
 //BA.debugLineNum = 653;BA.debugLine="SetAnimation.setanimati(\"extra_in\", \"extra_out\")";
mostCurrent._setanimation._setanimati(mostCurrent.activityBA,"extra_in","extra_out");
 };
...
public static String  _menu_onfullyopen() throws Exception{
 //BA.debugLineNum = 336;BA.debugLine="Sub Menu_onFullyOpen";
 //BA.debugLineNum = 337;BA.debugLine="lvMenu.BringToFront";
mostCurrent._lvmenu.BringToFront();
 //BA.debugLineNum = 338;BA.debugLine="smlp.BringToFront";
mostCurrent._smlp.BringToFront();
 //BA.debugLineNum = 339;BA.debugLine="slm.Sidebar.BringToFront";
mostCurrent._slm._sidebar().BringToFront();
 //BA.debugLineNum = 340;BA.debugLine="lvMenu.BringToFront";
mostCurrent._lvmenu.BringToFront();
 //BA.debugLineNum = 341;BA.debugLine="ProgressBar1.SendToBack";
...
int _hours = 0;
int _minutes = 0;
 //BA.debugLineNum = 917;BA.debugLine="Sub minutes_hours ( ms As Int ) As String";
 //BA.debugLineNum = 918;BA.debugLine="Dim val,hours,minutes As Int";
_val = 0;
_hours = 0;
_minutes = 0;
 //BA.debugLineNum = 919;BA.debugLine="val = ms";
_val = _ms;
 //BA.debugLineNum = 920;BA.debugLine="hours = Floor(val / 60)";
_hours = (int) (anywheresoftware.b4a.keywords.Common.Floor(_val/(double)60));
 //BA.debugLineNum = 921;BA.debugLine="minutes = val Mod 60";
_minutes = (int) (_val%60);
 //BA.debugLineNum = 922;BA.debugLine="Return NumberFormat(hours, 1, 0) & \":\" & NumberFo";
...
public static String  _mystats_update(float[] _cpuefficiency,float _ramusage) throws Exception{
 //BA.debugLineNum = 725;BA.debugLine="Sub myStats_Update(CPUEfficiency() As Float, RAMUs";
 //BA.debugLineNum = 726;BA.debugLine="ProgressBar1.Progress=RAMUsage";
mostCurrent._progressbar1.setProgress((int) (_ramusage));
 //BA.debugLineNum = 727;BA.debugLine="Label5.Text=NumberFormat2(RAMUsage, 0, 0, 0, Fals";
...
public static String  _opt_click() throws Exception{
 //BA.debugLineNum = 687;BA.debugLine="Sub opt_click";
 //BA.debugLineNum = 688;BA.debugLine="StartActivity(settings)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._settings.getObject()));
 //BA.debugLineNum = 689;BA.debugLine="SetAnimation.setanimati(\"extra_in\", \"extra_out\")";
mostCurrent._setanimation._setanimati(mostCurrent.activityBA,"extra_in","extra_out");
 //BA.debugLineNum = 690;BA.debugLine="End Sub";
return "";
}
public static String  _pci_click() throws Exception{
 //BA.debugLineNum = 717;BA.debugLine="Sub pci_click";
 //BA.debugLineNum = 718;BA.debugLine="cd.AddView(panel3,-1,350)";
mostCurrent._cd.AddView((android.view.View)(mostCurrent._panel3.getObject()),(int) (-1),(int) (350));
 //BA.debugLineNum = 719;BA.debugLine="cd.Show(\"About Batt-Cat: \",\"\",\"Ok\",\"\",LoadBitmap(";
mostCurrent._cd.Show("About Batt-Cat: ","","Ok","",mostCurrent.activityBA,(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Rss.png").getObject()));
 //BA.debugLineNum = 720;BA.debugLine="If Not (cd2.Response=DialogResponse.CANCEL) Then";
if (anywheresoftware.b4a.keywords.Common.Not(mostCurrent._cd2.getResponse()==anywheresoftware.b4a.keywords.Common.DialogResponse.CANCEL)) { 
 //BA.debugLineNum = 721;BA.debugLine="ct.ShowBitmap(\"©2017 SuloMedia™\",30,Gravity.BOTT";
...
public static String  _prboost_click() throws Exception{
 //BA.debugLineNum = 400;BA.debugLine="Sub prboost_Click";
 //BA.debugLineNum = 401;BA.debugLine="Button4_Click";
_button4_click();
...
int _h = 0;
 //BA.debugLineNum = 368;BA.debugLine="Sub read_log";
 //BA.debugLineNum = 369;BA.debugLine="logfile=File.ReadList(File.DirDefaultExternal&\"/m";
...
int _i = 0;
String _v = "";
 //BA.debugLineNum = 754;BA.debugLine="Sub ReadDir(folder As String, recursive As Boolean";
 //BA.debugLineNum = 756;BA.debugLine="Dim lst As List = File.ListFiles(folder)";
_lst = new anywheresoftware.b4a.objects.collections.List();
_lst = anywheresoftware.b4a.keywords.Common.File.ListFiles(_folder);
 //BA.debugLineNum = 757;BA.debugLine="For i = 0 To lst.Size - 1";
{
final int step2 = 1;
final int limit2 = (int) (_lst.getSize()-1);
for (_i = (int) (0) ; (step2 > 0 && _i <= limit2) || (step2 < 0 && _i >= limit2); _i = ((int)(0 + _i + step2)) ) {
 //BA.debugLineNum = 758;BA.debugLine="If File.IsDirectory(folder,lst.Get(i)) Then";
if (anywheresoftware.b4a.keywords.Common.File.IsDirectory(_folder,BA.ObjectToString(_lst.Get(_i)))) { 
 //BA.debugLineNum = 759;BA.debugLine="Dim v As String";
_v = "";
 //BA.debugLineNum = 760;BA.debugLine="v = folder&\"/\"&lst.Get(i)";
_v = _folder+"/"+BA.ObjectToString(_lst.Get(_i));
 //BA.debugLineNum = 762;BA.debugLine="ffolders.Add(v.SubString(root1.Length+1))";
mostCurrent._ffolders.Add((Object)(_v.substring((int) (mostCurrent._root1.length()+1))));
 //BA.debugLineNum = 763;BA.debugLine="If recursive Then";
if (_recursive) { 
 //BA.debugLineNum = 764;BA.debugLine="ReadDir(v,recursive)";
_readdir(_v,_recursive);
 };
 }else {
 //BA.debugLineNum = 767;BA.debugLine="ffiles.Add(folder&\"/\"&lst.Get(i))";
...
public static String  _reb_start() throws Exception{
 //BA.debugLineNum = 613;BA.debugLine="Sub reb_start";
...
public static String  _rebound() throws Exception{
 //BA.debugLineNum = 396;BA.debugLine="Sub rebound";
 //BA.debugLineNum = 397;BA.debugLine="CallSubDelayed(pman,\"app_manage\")";
...
String _wel = "";
 //BA.debugLineNum = 310;BA.debugLine="Sub show_tip";
 //BA.debugLineNum = 311;BA.debugLine="prboost.SetVisibleAnimated(100,False)";
mostCurrent._prboost.SetVisibleAnimated((int) (100),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 312;BA.debugLine="Dim diap As BetterDialogs";
_diap = new flm.b4a.betterdialogs.BetterDialogs();
 //BA.debugLineNum = 313;BA.debugLine="Dim answer As Int";
_answer = 0;
 //BA.debugLineNum = 314;BA.debugLine="Dim lzv As LVEatBeans";
_lzv = new de.donmanfred.LVEatBeansWrapper();
 //BA.debugLineNum = 315;BA.debugLine="Dim dbp As Panel";
_dbp = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 316;BA.debugLine="Dim welb As Label";
_welb = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 317;BA.debugLine="welb.Initialize(\"welb\")";
_welb.Initialize(mostCurrent.activityBA,"welb");
 //BA.debugLineNum = 318;BA.debugLine="Dim wel As String = \"Willkommen zu BaTT-CaTT, bei";
_wel = "Willkommen zu BaTT-CaTT, beim ersten Start werden verschiedene Module und Werte geladen dies kann je nach Gerät ein paar Minuten dauern. Swipe nach links um das Hauptmenü zu öffnen oder nutze die 'Short Button' leiste unten am Bildshirmrand.";
 //BA.debugLineNum = 319;BA.debugLine="welb.TextColor=mcl.md_white_1000";
_welb.setTextColor(mostCurrent._mcl.getmd_white_1000());
 //BA.debugLineNum = 320;BA.debugLine="welb.TextSize=20";
_welb.setTextSize((float) (20));
 //BA.debugLineNum = 321;BA.debugLine="welb.Text=wel";
_welb.setText(BA.ObjectToCharSequence(_wel));
 //BA.debugLineNum = 322;BA.debugLine="dbp.Initialize(\"dbp\")";
_dbp.Initialize(mostCurrent.activityBA,"dbp");
 //BA.debugLineNum = 323;BA.debugLine="lzv.Initialize(\"lzv\")";
_lzv.Initialize(processBA,"lzv");
 //BA.debugLineNum = 324;BA.debugLine="dbp.AddView(lzv,0dip,0dip,200dip,80dip)";
_dbp.AddView((android.view.View)(_lzv.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (0)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (0)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (200)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (80)));
 //BA.debugLineNum = 325;BA.debugLine="dbp.AddView(welb,10dip,60dip,-1,-1)";
_dbp.AddView((android.view.View)(_welb.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (60)),(int) (-1),(int) (-1));
 //BA.debugLineNum = 326;BA.debugLine="welb.Padding=Array As Int(2dip,0dip,10dip,0dip)";
_welb.setPadding(new int[]{anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (0)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (0))});
 //BA.debugLineNum = 327;BA.debugLine="lzv.startAnim";
_lzv.startAnim();
 //BA.debugLineNum = 328;BA.debugLine="answer=diap.CustomDialog(\"Information:\",130dip,80";
_answer = _diap.CustomDialog((Object)("Information:"),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (130)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (80)),(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(_dbp.getObject())),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (300)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (350)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)),(Object)(_c10),(Object)("Ok"),(Object)(""),(Object)(""),anywheresoftware.b4a.keywords.Common.False,"diap",mostCurrent.activityBA);
 //BA.debugLineNum = 329;BA.debugLine="If answer= DialogResponse.POSITIVE Then";
if (_answer==anywheresoftware.b4a.keywords.Common.DialogResponse.POSITIVE) { 
 //BA.debugLineNum = 330;BA.debugLine="lzv.stopAnim";
_lzv.stopAnim();
 //BA.debugLineNum = 331;BA.debugLine="lv3.BringToFront";
mostCurrent._lv3.BringToFront();
 //BA.debugLineNum = 332;BA.debugLine="diap.CloseDialog(DialogResponse.POSITIVE)";
...
mostCurrent._slm._closesidebar();
 ...
 //BA.debugLineNum = 608;BA.debugLine="slm.OpenSidebar";
mostCurrent._slm._opensidebar();
 };
...
public static String  _st_click() throws Exception{
 //BA.debugLineNum = 667;BA.debugLine="Sub st_click";
 //BA.debugLineNum = 668;BA.debugLine="StartActivity(klo)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._klo.getObject()));
 //BA.debugLineNum = 669;BA.debugLine="SetAnimation.setanimati(\"extra_in\", \"extra_out\")";
mostCurrent._setanimation._setanimati(mostCurrent.activityBA,"extra_in","extra_out");
 //BA.debugLineNum = 670;BA.debugLine="End Sub";
return "";
}
public static String  _stat_me() throws Exception{
 //BA.debugLineNum = 657;BA.debugLine="Sub stat_me";
 //BA.debugLineNum = 658;BA.debugLine="StartActivity(klo)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._klo.getObject()));
 //BA.debugLineNum = 659;BA.debugLine="SetAnimation.setanimati(\"extra_in\", \"extra_out\")";
mostCurrent._setanimation._setanimati(mostCurrent.activityBA,"extra_in","extra_out");
 //BA.debugLineNum = 660;BA.debugLine="End Sub";
return "";
}
public static String  _store_check() throws Exception{
 //BA.debugLineNum = 404;BA.debugLine="Sub store_check";
 //BA.debugLineNum = 405;BA.debugLine="c1=mcl.md_light_blue_A400";
_c1 = mostCurrent._mcl.getmd_light_blue_A400();
 //BA.debugLineNum = 406;BA.debugLine="c2=mcl.md_amber_A400";
_c2 = mostCurrent._mcl.getmd_amber_A400();
 //BA.debugLineNum = 407;BA.debugLine="c3=mcl.md_white_1000";
_c3 = mostCurrent._mcl.getmd_white_1000();
 //BA.debugLineNum = 408;BA.debugLine="c4=mcl.md_teal_A400";
_c4 = mostCurrent._mcl.getmd_teal_A400();
 //BA.debugLineNum = 409;BA.debugLine="c5=mcl.md_deep_purple_A400";
_c5 = mostCurrent._mcl.getmd_deep_purple_A400();
 //BA.debugLineNum = 410;BA.debugLine="c6=mcl.md_red_A700";
_c6 = mostCurrent._mcl.getmd_red_A700();
 //BA.debugLineNum = 411;BA.debugLine="c7=mcl.md_indigo_A400";
_c7 = mostCurrent._mcl.getmd_indigo_A400();
 //BA.debugLineNum = 412;BA.debugLine="c8=mcl.md_blue_A400";
_c8 = mostCurrent._mcl.getmd_blue_A400();
 //BA.debugLineNum = 413;BA.debugLine="c9=mcl.md_orange_A700";
_c9 = mostCurrent._mcl.getmd_orange_A700();
 //BA.debugLineNum = 414;BA.debugLine="c10=mcl.md_grey_600";
_c10 = mostCurrent._mcl.getmd_grey_600();
 //BA.debugLineNum = 415;BA.debugLine="c11=mcl.md_green_A400";
_c11 = mostCurrent._mcl.getmd_green_A400();
 //BA.debugLineNum = 416;BA.debugLine="c12=mcl.md_black_1000";
_c12 = mostCurrent._mcl.getmd_black_1000();
 //BA.debugLineNum = 417;BA.debugLine="c13=mcl.md_light_green_A400";
_c13 = mostCurrent._mcl.getmd_light_green_A400();
 //BA.debugLineNum = 418;BA.debugLine="c14=mcl.md_cyan_A400";
_c14 = mostCurrent._mcl.getmd_cyan_A400();
 //BA.debugLineNum = 419;BA.debugLine="c15=mcl.md_blue_grey_400";
_c15 = mostCurrent._mcl.getmd_blue_grey_400();
 //BA.debugLineNum = 420;BA.debugLine="c16=mcl.md_light_blue_A400";
_c16 = mostCurrent._mcl.getmd_light_blue_A400();
 //BA.debugLineNum = 421;BA.debugLine="If kvs4sub.ContainsKey(\"off\") Then";
if (mostCurrent._kvs4sub._containskey("off")) { 
 //BA.debugLineNum = 422;BA.debugLine="StopService(Starter)";
anywheresoftware.b4a.keywords.Common.StopService(mostCurrent.activityBA,(Object)(mostCurrent._starter.getObject()));
 };
 //BA.debugLineNum = 424;BA.debugLine="If kvs4.ContainsKey(\"0\")Then";
if (mostCurrent._kvs4._containskey("0")) { 
 //BA.debugLineNum = 425;BA.debugLine="Log(\"AC_true->1\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->1");
 //BA.debugLineNum = 426;BA.debugLine="Activity.Color=c1";
mostCurrent._activity.setColor(_c1);
 //BA.debugLineNum = 427;BA.debugLine="apm.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._apm.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 428;BA.debugLine="Label4.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._label4.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 429;BA.debugLine="Label5.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._label5.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 430;BA.debugLine="Label3.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._label3.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 431;BA.debugLine="apm.UnfinishedStrokeColor=Colors.ARGB(190,255,25";
mostCurrent._apm.setUnfinishedStrokeColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (190),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 432;BA.debugLine="apm.FinishedStrokeColor=mcl.md_light_green_A400";
mostCurrent._apm.setFinishedStrokeColor(mostCurrent._mcl.getmd_light_green_A400());
 };
 //BA.debugLineNum = 435;BA.debugLine="If kvs4.ContainsKey(\"1\")Then";
if (mostCurrent._kvs4._containskey("1")) { 
 //BA.debugLineNum = 436;BA.debugLine="Log(\"AC_true->2\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->2");
 //BA.debugLineNum = 437;BA.debugLine="Activity.Color=c2";
mostCurrent._activity.setColor(_c2);
 //BA.debugLineNum = 438;BA.debugLine="apm.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._apm.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 439;BA.debugLine="Label4.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._label4.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 440;BA.debugLine="Label5.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._label5.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 441;BA.debugLine="Label3.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._label3.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 442;BA.debugLine="apm.UnfinishedStrokeColor=Colors.ARGB(190,255,25";
mostCurrent._apm.setUnfinishedStrokeColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (190),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 443;BA.debugLine="apm.FinishedStrokeColor=mcl.md_light_green_A400";
mostCurrent._apm.setFinishedStrokeColor(mostCurrent._mcl.getmd_light_green_A400());
 };
 //BA.debugLineNum = 447;BA.debugLine="If kvs4.ContainsKey(\"2\")Then";
if (mostCurrent._kvs4._containskey("2")) { 
 //BA.debugLineNum = 448;BA.debugLine="Log(\"AC_true->3\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->3");
 //BA.debugLineNum = 449;BA.debugLine="Activity.Color=c3";
mostCurrent._activity.setColor(_c3);
 //BA.debugLineNum = 450;BA.debugLine="apm.TextColor=Colors.Black";
mostCurrent._apm.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 451;BA.debugLine="Label4.TextColor=Colors.Black";
mostCurrent._label4.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 452;BA.debugLine="Label5.TextColor=Colors.Black";
mostCurrent._label5.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 453;BA.debugLine="Label3.TextColor=Colors.Black";
mostCurrent._label3.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 454;BA.debugLine="Label2.TextColor=Colors.Black";
mostCurrent._label2.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 455;BA.debugLine="Label1.TextColor=Colors.Black";
mostCurrent._label1.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 456;BA.debugLine="apm.UnfinishedStrokeColor=mcl.md_light_blue_100";
mostCurrent._apm.setUnfinishedStrokeColor(mostCurrent._mcl.getmd_light_blue_100());
 //BA.debugLineNum = 457;BA.debugLine="apm.FinishedStrokeColor=mcl.md_light_green_A400";
mostCurrent._apm.setFinishedStrokeColor(mostCurrent._mcl.getmd_light_green_A400());
 };
...
mostCurrent._label3.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 466;BA.debugLine="apm.UnfinishedStrokeColor=mcl.md_light_green_100";
mostCurrent._apm.setUnfinishedStrokeColor(mostCurrent._mcl.getmd_light_green_100());
 //BA.debugLineNum = 467;BA.debugLine="apm.finishedStrokeColor=Colors.ARGB(190,255,255,";
...
mostCurrent._label3.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 477;BA.debugLine="apm.UnfinishedStrokeColor=Colors.ARGB(190,255,25";
mostCurrent._apm.setUnfinishedStrokeColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (190),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 478;BA.debugLine="apm.FinishedStrokeColor=mcl.md_light_green_A400";
mostCurrent._apm.setFinishedStrokeColor(mostCurrent._mcl.getmd_light_green_A400());
 };
 //BA.debugLineNum = 481;BA.debugLine="If kvs4.ContainsKey(\"5\")Then";
if (mostCurrent._kvs4._containskey("5")) { 
 //BA.debugLineNum = 482;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 483;BA.debugLine="Activity.Color=c6";
mostCurrent._activity.setColor(_c6);
 //BA.debugLineNum = 484;BA.debugLine="apm.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._apm.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 485;BA.debugLine="Label4.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._label4.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 486;BA.debugLine="Label5.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._label5.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 487;BA.debugLine="Label3.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._label3.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 488;BA.debugLine="apm.UnfinishedStrokeColor=Colors.ARGB(190,255,25";
mostCurrent._apm.setUnfinishedStrokeColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (190),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 489;BA.debugLine="apm.FinishedStrokeColor=mcl.md_light_green_A400";
mostCurrent._apm.setFinishedStrokeColor(mostCurrent._mcl.getmd_light_green_A400());
 };
 //BA.debugLineNum = 492;BA.debugLine="If kvs4.ContainsKey(\"6\")Then";
if (mostCurrent._kvs4._containskey("6")) { 
 //BA.debugLineNum = 493;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 494;BA.debugLine="Activity.Color=c7";
...
mostCurrent._label3.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 499;BA.debugLine="apm.UnfinishedStrokeColor=Colors.ARGB(190,255,25";
mostCurrent._apm.setUnfinishedStrokeColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (190),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 500;BA.debugLine="apm.FinishedStrokeColor=mcl.md_light_green_A400";
mostCurrent._apm.setFinishedStrokeColor(mostCurrent._mcl.getmd_light_green_A400());
 };
 //BA.debugLineNum = 503;BA.debugLine="If kvs4.ContainsKey(\"7\")Then";
if (mostCurrent._kvs4._containskey("7")) { 
 //BA.debugLineNum = 504;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 505;BA.debugLine="Activity.Color=c8";
mostCurrent._activity.setColor(_c8);
 //BA.debugLineNum = 506;BA.debugLine="apm.TextColor=Colors.Black";
mostCurrent._apm.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 507;BA.debugLine="Label4.TextColor=Colors.Black";
mostCurrent._label4.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 508;BA.debugLine="Label5.TextColor=Colors.Black";
mostCurrent._label5.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 509;BA.debugLine="Label3.TextColor=Colors.Black";
mostCurrent._label3.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 510;BA.debugLine="apm.UnfinishedStrokeColor=Colors.ARGB(190,255,25";
mostCurrent._apm.setUnfinishedStrokeColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (190),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 511;BA.debugLine="apm.FinishedStrokeColor=mcl.md_light_green_A400";
mostCurrent._apm.setFinishedStrokeColor(mostCurrent._mcl.getmd_light_green_A400());
 };
 //BA.debugLineNum = 514;BA.debugLine="If kvs4.ContainsKey(\"8\")Then";
if (mostCurrent._kvs4._containskey("8")) { 
 //BA.debugLineNum = 515;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 516;BA.debugLine="Activity.Color=c9";
mostCurrent._activity.setColor(_c9);
 //BA.debugLineNum = 517;BA.debugLine="apm.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._apm.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 518;BA.debugLine="Label4.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._label4.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 519;BA.debugLine="Label5.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._label5.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 520;BA.debugLine="Label3.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._label3.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 521;BA.debugLine="apm.UnfinishedStrokeColor=Colors.ARGB(190,255,25";
mostCurrent._apm.setUnfinishedStrokeColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (190),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 522;BA.debugLine="apm.FinishedStrokeColor=mcl.md_light_green_A400";
mostCurrent._apm.setFinishedStrokeColor(mostCurrent._mcl.getmd_light_green_A400());
 };
 //BA.debugLineNum = 525;BA.debugLine="If kvs4.ContainsKey(\"9\")Then";
if (mostCurrent._kvs4._containskey("9")) { 
 //BA.debugLineNum = 526;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 527;BA.debugLine="Activity.Color=c10";
mostCurrent._activity.setColor(_c10);
 //BA.debugLineNum = 528;BA.debugLine="apm.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._apm.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 529;BA.debugLine="Label4.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._label4.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 530;BA.debugLine="Label5.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._label5.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 531;BA.debugLine="Label3.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._label3.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 532;BA.debugLine="apm.UnfinishedStrokeColor=Colors.ARGB(190,255,25";
mostCurrent._apm.setUnfinishedStrokeColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (190),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 533;BA.debugLine="apm.FinishedStrokeColor=mcl.md_light_blue_A400";
mostCurrent._apm.setFinishedStrokeColor(mostCurrent._mcl.getmd_light_blue_A400());
 };
 //BA.debugLineNum = 536;BA.debugLine="If kvs4.ContainsKey(\"10\")Then";
if (mostCurrent._kvs4._containskey("10")) { 
 //BA.debugLineNum = 537;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 538;BA.debugLine="Activity.Color=c11";
mostCurrent._activity.setColor(_c11);
 //BA.debugLineNum = 539;BA.debugLine="apm.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._apm.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 540;BA.debugLine="apm.FinishedStrokeColor=Colors.ARGB(200,255,255,";
mostCurrent._apm.setFinishedStrokeColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 541;BA.debugLine="apm.UnfinishedStrokeColor=Colors.ARGB(100,255,25";
mostCurrent._apm.setUnfinishedStrokeColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (100),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 542;BA.debugLine="Label4.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._label4.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 543;BA.debugLine="Label5.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._label5.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 544;BA.debugLine="Label3.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._label3.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 545;BA.debugLine="apm.FinishedStrokeColor=mcl.md_light_green_A400";
mostCurrent._apm.setFinishedStrokeColor(mostCurrent._mcl.getmd_light_green_A400());
 };
 //BA.debugLineNum = 548;BA.debugLine="If kvs4.ContainsKey(\"11\")Then";
if (mostCurrent._kvs4._containskey("11")) { 
 //BA.debugLineNum = 549;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 550;BA.debugLine="Activity.Color=c12";
mostCurrent._activity.setColor(_c12);
 //BA.debugLineNum = 551;BA.debugLine="apm.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._apm.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 552;BA.debugLine="Label4.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._label4.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 553;BA.debugLine="Label5.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._label5.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 554;BA.debugLine="Label3.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._label3.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 555;BA.debugLine="Label1.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._label1.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 556;BA.debugLine="Label2.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._label2.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 557;BA.debugLine="apm.UnfinishedStrokeColor=Colors.ARGB(190,255,25";
mostCurrent._apm.setUnfinishedStrokeColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (190),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 558;BA.debugLine="apm.FinishedStrokeColor=mcl.md_light_green_A400";
mostCurrent._apm.setFinishedStrokeColor(mostCurrent._mcl.getmd_light_green_A400());
 //BA.debugLineNum = 561;BA.debugLine="panel3.Color=Colors.ARGB(100,255,255,255)";
mostCurrent._panel3.setColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (100),(int) (255),(int) (255),(int) (255)));
 };
 //BA.debugLineNum = 564;BA.debugLine="If kvs4.ContainsKey(\"12\")Then";
if (mostCurrent._kvs4._containskey("12")) { 
 //BA.debugLineNum = 565;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 566;BA.debugLine="Activity.Color=c13";
mostCurrent._activity.setColor(_c13);
 //BA.debugLineNum = 567;BA.debugLine="apm.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._apm.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 568;BA.debugLine="Label4.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._label4.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 569;BA.debugLine="Label5.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._label5.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 570;BA.debugLine="Label3.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._label3.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 571;BA.debugLine="apm.UnfinishedStrokeColor=Colors.ARGB(190,255,25";
mostCurrent._apm.setUnfinishedStrokeColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (190),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 572;BA.debugLine="apm.FinishedStrokeColor=mcl.md_amber_100";
mostCurrent._apm.setFinishedStrokeColor(mostCurrent._mcl.getmd_amber_100());
 //BA.debugLineNum = 573;BA.debugLine="panel3.Color=Colors.ARGB(150,0,0,0)";
mostCurrent._panel3.setColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (150),(int) (0),(int) (0),(int) (0)));
 };
 //BA.debugLineNum = 576;BA.debugLine="If kvs4.ContainsKey(\"13\")Then";
if (mostCurrent._kvs4._containskey("13")) { 
 //BA.debugLineNum = 577;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 578;BA.debugLine="Activity.Color=c14";
mostCurrent._activity.setColor(_c14);
 //BA.debugLineNum = 579;BA.debugLine="apm.TextColor=Colors.Black";
mostCurrent._apm.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 580;BA.debugLine="Label4.TextColor=Colors.Black";
mostCurrent._label4.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 581;BA.debugLine="Label5.TextColor=Colors.Black";
mostCurrent._label5.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 582;BA.debugLine="Label3.TextColor=Colors.Black";
mostCurrent._label3.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 583;BA.debugLine="apm.UnfinishedStrokeColor=Colors.ARGB(190,255,25";
mostCurrent._apm.setUnfinishedStrokeColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (190),(int) (255),(int) (255),(int) (255)));
 };
...
mostCurrent._label3.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 593;BA.debugLine="apm.UnfinishedStrokeColor=Colors.ARGB(190,255,25";
mostCurrent._apm.setUnfinishedStrokeColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (190),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 594;BA.debugLine="apm.FinishedStrokeColor=mcl.md_light_green_A400";
mostCurrent._apm.setFinishedStrokeColor(mostCurrent._mcl.getmd_light_green_A400());
 };
...
public static String  _sy_click() throws Exception{
 //BA.debugLineNum = 662;BA.debugLine="Sub sy_click";
 //BA.debugLineNum = 663;BA.debugLine="StartActivity(sys)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._sys.getObject()));
 //BA.debugLineNum = 664;BA.debugLine="SetAnimation.setanimati(\"extra_in\", \"extra_out\")";
mostCurrent._setanimation._setanimati(mostCurrent.activityBA,"extra_in","extra_out");
...
String _d = "";
 //BA.debugLineNum = 377;BA.debugLine="Sub value_check";
 //BA.debugLineNum = 378;BA.debugLine="lv3.Clear";
mostCurrent._lv3.Clear();
 //BA.debugLineNum = 379;BA.debugLine="lil1=lv3.TwoLinesAndBitmap.Label";
mostCurrent._lil1 = mostCurrent._lv3.getTwoLinesAndBitmap().Label;
 //BA.debugLineNum = 380;BA.debugLine="lil2=lv3.TwoLinesAndBitmap.SecondLabel";
mostCurrent._lil2 = mostCurrent._lv3.getTwoLinesAndBitmap().SecondLabel;
 //BA.debugLineNum = 382;BA.debugLine="lil1.TextColor=mcl.md_black_1000";
mostCurrent._lil1.setTextColor(mostCurrent._mcl.getmd_black_1000());
 //BA.debugLineNum = 383;BA.debugLine="lil1.TextSize=16";
mostCurrent._lil1.setTextSize((float) (16));
 //BA.debugLineNum = 384;BA.debugLine="lil2.TextColor=mcl.md_white_1000";
mostCurrent._lil2.setTextColor(mostCurrent._mcl.getmd_white_1000());
 //BA.debugLineNum = 385;BA.debugLine="lil2.TextSize=14";
mostCurrent._lil2.setTextSize((float) (14));
 //BA.debugLineNum = 386;BA.debugLine="For Each d As String In kvstime.ListKeys";
...
_d = BA.ObjectToString(group8.Get(index8));
 //BA.debugLineNum = 387;BA.debugLine="Log(d)";
anywheresoftware.b4a.keywords.Common.Log(_d);
 //BA.debugLineNum = 388;BA.debugLine="lv3.AddTwoLinesAndBitmap2(\"Info:\",d,LoadBitmap(F";
