...
public static boolean  _activity_keypress(int _keycode) throws Exception{
 //BA.debugLineNum = 845;BA.debugLine="Sub Activity_KeyPress (KeyCode As Int) As Boolean";
 //BA.debugLineNum = 846;BA.debugLine="If KeyCode=KeyCodes.KEYCODE_BACK Then";
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK) { 
 //BA.debugLineNum = 847;BA.debugLine="Activity.Finish";
mostCurrent._activity.Finish();
 //BA.debugLineNum = 848;BA.debugLine="ToastMessageShow(\"BCT - Backround Service\",False";
...
int _i = 0;
int _form = 0;
 //BA.debugLineNum = 967;BA.debugLine="Sub app_info";
 //BA.debugLineNum = 968;BA.debugLine="lv2.Clear";
mostCurrent._lv2.Clear();
 //BA.debugLineNum = 969;BA.debugLine="list3.Clear";
mostCurrent._list3.Clear();
 //BA.debugLineNum = 970;BA.debugLine="datalist.Clear";
mostCurrent._datalist.Clear();
 //BA.debugLineNum = 972;BA.debugLine="list1=pak.GetInstalledPackages";
mostCurrent._list1 = _pak.GetInstalledPackages();
 //BA.debugLineNum = 974;BA.debugLine="Obj1.Target = Obj1.GetContext";
mostCurrent._obj1.Target = (Object)(mostCurrent._obj1.GetContext(processBA));
 //BA.debugLineNum = 975;BA.debugLine="Obj1.Target = Obj1.RunMethod(\"getPackageManager\")";
mostCurrent._obj1.Target = mostCurrent._obj1.RunMethod("getPackageManager");
 //BA.debugLineNum = 976;BA.debugLine="Obj2.Target = Obj1.RunMethod2(\"getInstalledPackag";
mostCurrent._obj2.Target = mostCurrent._obj1.RunMethod2("getInstalledPackages",BA.NumberToString(0),"java.lang.int");
 //BA.debugLineNum = 977;BA.debugLine="size = Obj2.RunMethod(\"size\")";
_size = (int)(BA.ObjectToNumber(mostCurrent._obj2.RunMethod("size")));
 //BA.debugLineNum = 982;BA.debugLine="For i = 0 To size -1";
{
final int step9 = 1;
final int limit9 = (int) (_size-1);
for (_i = (int) (0) ; (step9 > 0 && _i <= limit9) || (step9 < 0 && _i >= limit9); _i = ((int)(0 + _i + step9)) ) {
 //BA.debugLineNum = 983;BA.debugLine="Obj3.Target = Obj2.RunMethod2(\"get\", i, \"java.la";
mostCurrent._obj3.Target = mostCurrent._obj2.RunMethod2("get",BA.NumberToString(_i),"java.lang.int");
 //BA.debugLineNum = 984;BA.debugLine="size = Obj2.RunMethod(\"size\")";
_size = (int)(BA.ObjectToNumber(mostCurrent._obj2.RunMethod("size")));
 //BA.debugLineNum = 986;BA.debugLine="Obj3.Target = Obj3.GetField(\"applicationInfo\") '";
mostCurrent._obj3.Target = mostCurrent._obj3.GetField("applicationInfo");
 //BA.debugLineNum = 987;BA.debugLine="flags = Obj3.GetField(\"flags\")";
_flags = (int)(BA.ObjectToNumber(mostCurrent._obj3.GetField("flags")));
 //BA.debugLineNum = 988;BA.debugLine="packName = Obj3.GetField(\"packageName\")";
mostCurrent._packname = BA.ObjectToString(mostCurrent._obj3.GetField("packageName"));
 //BA.debugLineNum = 990;BA.debugLine="If Bit.And(flags, 1)  = 0 Then";
if (anywheresoftware.b4a.keywords.Common.Bit.And(_flags,(int) (1))==0) { 
 //BA.debugLineNum = 993;BA.debugLine="args(0) = Obj3.Target";
mostCurrent._args[(int) (0)] = mostCurrent._obj3.Target;
 //BA.debugLineNum = 994;BA.debugLine="Types(0) = \"android.content.pm.ApplicationInfo\"";
mostCurrent._types[(int) (0)] = "android.content.pm.ApplicationInfo";
 //BA.debugLineNum = 995;BA.debugLine="name = Obj1.RunMethod4(\"getApplicationLabel\", a";
mostCurrent._name = BA.ObjectToString(mostCurrent._obj1.RunMethod4("getApplicationLabel",mostCurrent._args,mostCurrent._types));
 //BA.debugLineNum = 996;BA.debugLine="icon = Obj1.RunMethod4(\"getApplicationIcon\", ar";
mostCurrent._icon.setObject((android.graphics.drawable.BitmapDrawable)(mostCurrent._obj1.RunMethod4("getApplicationIcon",mostCurrent._args,mostCurrent._types)));
 //BA.debugLineNum = 998;BA.debugLine="list3.Add(packName)";
mostCurrent._list3.Add((Object)(mostCurrent._packname));
 //BA.debugLineNum = 1001;BA.debugLine="phlis.Add(icon.Bitmap)";
mostCurrent._phlis.Add((Object)(mostCurrent._icon.getBitmap()));
 //BA.debugLineNum = 1004;BA.debugLine="Dim form As Int";
_form = 0;
 //BA.debugLineNum = 1005;BA.debugLine="form=File.Size(GetParentPath(GetSourceDir(GetAc";
_form = (int) (anywheresoftware.b4a.keywords.Common.File.Size(_getparentpath(_getsourcedir(_getactivitiesinfo(mostCurrent._packname))),_getfilename(_getsourcedir(_getactivitiesinfo(mostCurrent._packname)))));
 //BA.debugLineNum = 1006;BA.debugLine="datalist.Add(form)";
mostCurrent._datalist.Add((Object)(_form));
 //BA.debugLineNum = 1007;BA.debugLine="lv2.AddTwoLinesAndBitmap2(name,packName&\" - \"&F";
...
public static String  _button1_click() throws Exception{
 //BA.debugLineNum = 827;BA.debugLine="Sub Button1_Click";
 //BA.debugLineNum = 828;BA.debugLine="StartActivity(klo)";
...
public static String  _button2_click() throws Exception{
 //BA.debugLineNum = 629;BA.debugLine="Sub button2_click";
 //BA.debugLineNum = 631;BA.debugLine="End Sub";
return "";
}
public static String  _button3_click() throws Exception{
 //BA.debugLineNum = 854;BA.debugLine="Sub Button3_Click";
 //BA.debugLineNum = 855;BA.debugLine="StartActivity(sys)";
...
public static String  _button4_click() throws Exception{
 //BA.debugLineNum = 671;BA.debugLine="Sub Button4_Click";
 //BA.debugLineNum = 672;BA.debugLine="StartActivity(cool)";
...
anywheresoftware.b4a.objects.streams.File.OutputStreamWrapper _out = null;
 //BA.debugLineNum = 1017;BA.debugLine="Sub BytesToFile (Dir As String, FileName As String";
 //BA.debugLineNum = 1018;BA.debugLine="Dim out As OutputStream = File.OpenOutput(Dir, Fi";
...
_out = anywheresoftware.b4a.keywords.Common.File.OpenOutput(_dir,_filename,anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 1019;BA.debugLine="out.WriteBytes(Data, 0, Data.Length)";
_out.WriteBytes(_data,(int) (0),_data.length);
 //BA.debugLineNum = 1020;BA.debugLine="out.Close";
_out.Close();
...
long _size1 = 0L;
String _f = "";
 //BA.debugLineNum = 785;BA.debugLine="Sub CalcSize(Folder As String, recursive As Boolea";
 //BA.debugLineNum = 786;BA.debugLine="Dim size1 As Long";
_size1 = 0L;
 //BA.debugLineNum = 787;BA.debugLine="For Each f As String In File.ListFiles(Folder)";
...
_f = BA.ObjectToString(group2.Get(index2));
 //BA.debugLineNum = 788;BA.debugLine="If recursive Then";
if (_recursive) { 
 //BA.debugLineNum = 789;BA.debugLine="If File.IsDirectory(Folder, f) Then";
if (anywheresoftware.b4a.keywords.Common.File.IsDirectory(_folder,_f)) { 
 //BA.debugLineNum = 790;BA.debugLine="size1 = size1 + CalcSize(File.Combine(Folder,";
_size1 = (long) (_size1+_calcsize(anywheresoftware.b4a.keywords.Common.File.Combine(_folder,_f),_recursive));
 };
 };
 //BA.debugLineNum = 793;BA.debugLine="size1 = size1 + File.Size(Folder, f)";
_size1 = (long) (_size1+anywheresoftware.b4a.keywords.Common.File.Size(_folder,_f));
 }
;
 //BA.debugLineNum = 795;BA.debugLine="Return size1";
...
int _res = 0;
 //BA.debugLineNum = 831;BA.debugLine="Sub cl_click As Boolean";
 //BA.debugLineNum = 832;BA.debugLine="Dim res As Int";
_res = 0;
 //BA.debugLineNum = 833;BA.debugLine="res=Msgbox2(cs.Initialize.Alignment(\"ALIGN_CENTER";
_res = anywheresoftware.b4a.keywords.Common.Msgbox2(BA.ObjectToCharSequence(_cs.Initialize().Alignment(BA.getEnumFromString(android.text.Layout.Alignment.class,"ALIGN_CENTER")).Append(BA.ObjectToCharSequence(("App wird geschlossen Service Notification läuft im Hintergrund Prozess, zum deaktivieren bitte 'Settings->Start/stop Notify Service'.!\",\"Bat-CaT beenden:"))).PopAll().getObject()),BA.ObjectToCharSequence(_cs.Initialize().Typeface(anywheresoftware.b4a.keywords.Common.Typeface.DEFAULT).Color((int) (0xff01ff20)).Size((int) (40)).PopAll().getObject()),"ja","Abbruch","",(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Power.png").getObject()),mostCurrent.activityBA);
 //BA.debugLineNum = 835;BA.debugLine="If res=DialogResponse.POSITIVE Then";
if (_res==anywheresoftware.b4a.keywords.Common.DialogResponse.POSITIVE) { 
 //BA.debugLineNum = 836;BA.debugLine="Activity.Finish";
mostCurrent._activity.Finish();
 }else {
 //BA.debugLineNum = 838;BA.debugLine="If res=DialogResponse.CANCEL Then";
if (_res==anywheresoftware.b4a.keywords.Common.DialogResponse.CANCEL) { 
 //BA.debugLineNum = 839;BA.debugLine="ToastMessageShow(\"zurück..\",False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("zurück.."),anywheresoftware.b4a.keywords.Common.False);
 ...
 //BA.debugLineNum = 842;BA.debugLine="Return(True)";
if (true) return (anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 843;BA.debugLine="End Sub";
return false;
}
public static String  _cli_click() throws Exception{
 //BA.debugLineNum = 1035;BA.debugLine="Sub cli_click";
 //BA.debugLineNum = 1037;BA.debugLine="StartActivity(cool)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._cool.getObject()));
...
int _volta = 0;
int _vs = 0;
 //BA.debugLineNum = 859;BA.debugLine="Sub device_BatteryChanged (level As Int, Scale As";
 //BA.debugLineNum = 861;BA.debugLine="Dim val,hours,minutes,rst,ts,volta,vs As Int";
_val = 0;
_hours = 0;
_minutes = 0;
_rst = 0;
...
_volta = 0;
_vs = 0;
 //BA.debugLineNum = 862;BA.debugLine="Label1.Visible=True";
mostCurrent._label1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 863;BA.debugLine="File.WriteString(File.DirDefaultExternal&\"/mnt/ca";
anywheresoftware.b4a.keywords.Common.File.WriteString(anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal()+"/mnt/cache","lvl.txt",BA.NumberToString(_level));
 //BA.debugLineNum = 864;BA.debugLine="File.WriteString(File.DirDefaultExternal&\"/mnt/ca";
anywheresoftware.b4a.keywords.Common.File.WriteString(anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal()+"/mnt/cache","volt.txt",mostCurrent._volt);
 //BA.debugLineNum = 865;BA.debugLine="volta=Intent.GetExtra(\"voltage\")/1000";
_volta = (int) ((double)(BA.ObjectToNumber(_intent.GetExtra("voltage")))/(double)1000);
 //BA.debugLineNum = 866;BA.debugLine="apm.Progress=level";
mostCurrent._apm.setProgress(_level);
 //BA.debugLineNum = 867;BA.debugLine="apm.BottomText=Intent.GetExtra(\"technology\")";
mostCurrent._apm.setBottomText(BA.ObjectToString(_intent.GetExtra("technology")));
 //BA.debugLineNum = 868;BA.debugLine="apm.Max=Scale";
mostCurrent._apm.setMax(_scale);
 //BA.debugLineNum = 869;BA.debugLine="rst=Scale-level";
_rst = (int) (_scale-_level);
 //BA.debugLineNum = 870;BA.debugLine="If Plugged=True Then";
if (_plugged==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 871;BA.debugLine="apm.BottomText=\"Aufladen via USB: \"&volta&\" V\"";
mostCurrent._apm.setBottomText("Aufladen via USB: "+BA.NumberToString(_volta)+" V");
 //BA.debugLineNum = 872;BA.debugLine="Log(\"VOLT: \"&Intent.GetExtra(\"voltage\"))";
anywheresoftware.b4a.keywords.Common.Log("VOLT: "+BA.ObjectToString(_intent.GetExtra("voltage")));
 //BA.debugLineNum = 873;BA.debugLine="val =rst*Intent.GetExtra(\"voltage\") /1000";
_val = (int) (_rst*(double)(BA.ObjectToNumber(_intent.GetExtra("voltage")))/(double)1000);
 //BA.debugLineNum = 874;BA.debugLine="hours = Floor(val / 60)";
_hours = (int) (anywheresoftware.b4a.keywords.Common.Floor(_val/(double)60));
 //BA.debugLineNum = 875;BA.debugLine="minutes = val Mod 60";
_minutes = (int) (_val%60);
 //BA.debugLineNum = 876;BA.debugLine="If level=100 Then";
if (_level==100) { 
 //BA.debugLineNum = 877;BA.debugLine="apm.BottomText=\"Angeschlossen via USB:\"&volta&";
mostCurrent._apm.setBottomText("Angeschlossen via USB:"+BA.NumberToString(_volta)+" V");
 //BA.debugLineNum = 878;BA.debugLine="Label4.Text=\"Batterie voll geladen\"";
mostCurrent._label4.setText(BA.ObjectToCharSequence("Batterie voll geladen"));
 }else {
 //BA.debugLineNum = 881;BA.debugLine="Label4.Text=\"voll in: \"&hours&\"h - \"&minutes&\"mi";
mostCurrent._label4.setText(BA.ObjectToCharSequence("voll in: "+BA.NumberToString(_hours)+"h - "+BA.NumberToString(_minutes)+"min"));
 };
 //BA.debugLineNum = 883;BA.debugLine="If level <= 60 Then";
if (_level<=60) { 
 };
 //BA.debugLineNum = 886;BA.debugLine="If level<=20 Then";
if (_level<=20) { 
 };
 }else {
 //BA.debugLineNum = 890;BA.debugLine="If level<=5 Then";
if (_level<=5) { 
 //BA.debugLineNum = 891;BA.debugLine="Label1.TextColor=Colors.Red";
mostCurrent._label1.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Red);
 //BA.debugLineNum = 892;BA.debugLine="Label1.TextSize=15";
mostCurrent._label1.setTextSize((float) (15));
 //BA.debugLineNum = 893;BA.debugLine="Label1.Text=\"Akku laden!\"";
mostCurrent._label1.setText(BA.ObjectToCharSequence("Akku laden!"));
 //BA.debugLineNum = 894;BA.debugLine="low_power";
_low_power();
 };
 //BA.debugLineNum = 897;BA.debugLine="vs=Intent.GetExtra(\"icon-small\")/1000";
_vs = (int) ((double)(BA.ObjectToNumber(_intent.GetExtra("icon-small")))/(double)1000);
 //BA.debugLineNum = 898;BA.debugLine="ts= vs-level/Intent.GetExtra(\"voltage\")/1000";
_ts = (int) (_vs-_level/(double)(double)(BA.ObjectToNumber(_intent.GetExtra("voltage")))/(double)1000);
 //BA.debugLineNum = 899;BA.debugLine="val =ts/10";
_val = (int) (_ts/(double)10);
 //BA.debugLineNum = 900;BA.debugLine="Log(\"ident: \"&val)";
anywheresoftware.b4a.keywords.Common.Log("ident: "+BA.NumberToString(_val));
 //BA.debugLineNum = 901;BA.debugLine="hours = Floor(val / 60)";
_hours = (int) (anywheresoftware.b4a.keywords.Common.Floor(_val/(double)60));
 //BA.debugLineNum = 902;BA.debugLine="minutes = val Mod 60";
_minutes = (int) (_val%60);
 //BA.debugLineNum = 903;BA.debugLine="Label4.Text= \"noch: \"&hours&\"h - \"&minutes&\"min\"";
mostCurrent._label4.setText(BA.ObjectToCharSequence("noch: "+BA.NumberToString(_hours)+"h - "+BA.NumberToString(_minutes)+"min"));
 //BA.debugLineNum = 905;BA.debugLine="If level <= 100 Then";
if (_level<=100) { 
 };
 //BA.debugLineNum = 910;BA.debugLine="If level <= 80 Then";
if (_level<=80) { 
 };
 //BA.debugLineNum = 914;BA.debugLine="If level <= 60 Then";
if (_level<=60) { 
 };
 //BA.debugLineNum = 918;BA.debugLine="If level <= 40 Then";
if (_level<=40) { 
 };
 //BA.debugLineNum = 922;BA.debugLine="If level<=20 Then";
if (_level<=20) { 
 };
 //BA.debugLineNum = 925;BA.debugLine="If level = 5 Then";
if (_level==5) { 
 };
 //BA.debugLineNum = 928;BA.debugLine="If level < 4 Then";
if (_level<4) { 
 };
 //BA.debugLineNum = 931;BA.debugLine="If temp >=41 Then";
...
public static String  _fc_copydone(String _key,boolean _error) throws Exception{
 //BA.debugLineNum = 1027;BA.debugLine="Sub fc_CopyDone(Key As String, Error As Boolean)";
 //BA.debugLineNum = 1029;BA.debugLine="End Sub";
return "";
}
public static byte[]  _filetobytes(String _dir,String _filename) throws Exception{
 //BA.debugLineNum = 1023;BA.debugLine="Sub FileToBytes (Dir As String, FileName As String";
 //BA.debugLineNum = 1024;BA.debugLine="Return Bit.InputStreamToBytes(File.OpenInput(Dir,";
...
double _si = 0;
int _i = 0;
 //BA.debugLineNum = 798;BA.debugLine="Sub FormatFileSize(Bytes As Float) As String";
 //BA.debugLineNum = 800;BA.debugLine="Private Unit() As String = Array As String(\" Byte";
_unit = new String[]{" Byte"," KB"," MB"," GB"," TB"," PB"," EB"," ZB"," YB"};
 //BA.debugLineNum = 802;BA.debugLine="If Bytes = 0 Then";
if (_bytes==0) { 
 //BA.debugLineNum = 804;BA.debugLine="Return \"0 Bytes\"";
if (true) return "0 Bytes";
 }else {
 //BA.debugLineNum = 808;BA.debugLine="Private Po, Si As Double";
_po = 0;
_si = 0;
 //BA.debugLineNum = 809;BA.debugLine="Private I As Int";
_i = 0;
 //BA.debugLineNum = 811;BA.debugLine="Bytes = Abs(Bytes)";
_bytes = (float) (anywheresoftware.b4a.keywords.Common.Abs(_bytes));
 //BA.debugLineNum = 813;BA.debugLine="I = Floor(Logarithm(Bytes, 1024))";
_i = (int) (anywheresoftware.b4a.keywords.Common.Floor(anywheresoftware.b4a.keywords.Common.Logarithm(_bytes,1024)));
 //BA.debugLineNum = 814;BA.debugLine="Po = Power(1024, I)";
_po = anywheresoftware.b4a.keywords.Common.Power(1024,_i);
 //BA.debugLineNum = 815;BA.debugLine="Si = Bytes / Po";
_si = _bytes/(double)_po;
 //BA.debugLineNum = 817;BA.debugLine="Return NumberFormat(Si, 1, 2) & Unit(I)";
...
anywheresoftware.b4a.agraham.reflection.Reflection _r = null;
 //BA.debugLineNum = 1062;BA.debugLine="Sub GetActivitiesInfo(package As String) As Object";
 //BA.debugLineNum = 1063;BA.debugLine="Dim r As Reflector";
_r = new anywheresoftware.b4a.agraham.reflection.Reflection();
 //BA.debugLineNum = 1064;BA.debugLine="r.Target = r.GetContext";
_r.Target = (Object)(_r.GetContext(processBA));
 //BA.debugLineNum = 1065;BA.debugLine="r.Target = r.RunMethod(\"getPackageManager\")";
_r.Target = _r.RunMethod("getPackageManager");
 //BA.debugLineNum = 1066;BA.debugLine="r.Target = r.RunMethod3(\"getPackageInfo\", package";
_r.Target = _r.RunMethod3("getPackageInfo",_package,"java.lang.String",BA.NumberToString(0x00000001),"java.lang.int");
 //BA.debugLineNum = 1067;BA.debugLine="Return r.GetField(\"applicationInfo\")";
...
public static String  _getfilename(String _fullpath) throws Exception{
 //BA.debugLineNum = 1031;BA.debugLine="Sub GetFileName(FullPath As String) As String";
 //BA.debugLineNum = 1032;BA.debugLine="Return FullPath.SubString(FullPath.LastIndexOf(\"/";
...
String _path1 = "";
 //BA.debugLineNum = 1043;BA.debugLine="Sub GetParentPath(Path As String) As String";
 //BA.debugLineNum = 1044;BA.debugLine="Dim Path1 As String";
_path1 = "";
 //BA.debugLineNum = 1045;BA.debugLine="If Path = \"/\" Then";
if ((_path).equals("/")) { 
 //BA.debugLineNum = 1046;BA.debugLine="Return \"/\"";
if (true) return "/";
 };
 //BA.debugLineNum = 1048;BA.debugLine="L = Path.LastIndexOf(\"/\")";
mostCurrent._l = BA.NumberToString(_path.lastIndexOf("/"));
 //BA.debugLineNum = 1049;BA.debugLine="If L = Path.Length - 1 Then";
if ((mostCurrent._l).equals(BA.NumberToString(_path.length()-1))) { 
 //BA.debugLineNum = 1051;BA.debugLine="Path1 = Path.SubString2(0,L)";
_path1 = _path.substring((int) (0),(int)(Double.parseDouble(mostCurrent._l)));
 }else {
 //BA.debugLineNum = 1053;BA.debugLine="Path1 = Path";
_path1 = _path;
 };
 //BA.debugLineNum = 1055;BA.debugLine="L = Path.LastIndexOf(\"/\")";
mostCurrent._l = BA.NumberToString(_path.lastIndexOf("/"));
 //BA.debugLineNum = 1056;BA.debugLine="If L = 0 Then";
if ((mostCurrent._l).equals(BA.NumberToString(0))) { 
 //BA.debugLineNum = 1057;BA.debugLine="L = 1";
mostCurrent._l = BA.NumberToString(1);
 };
 //BA.debugLineNum = 1059;BA.debugLine="Return Path1.SubString2(0,L)";
...
anywheresoftware.b4a.agraham.reflection.Reflection _r = null;
 //BA.debugLineNum = 1070;BA.debugLine="Sub GetSourceDir(AppInfo As Object) As String";
 //BA.debugLineNum = 1071;BA.debugLine="Try";
try { //BA.debugLineNum = 1072;BA.debugLine="Dim r As Reflector";
_r = new anywheresoftware.b4a.agraham.reflection.Reflection();
 //BA.debugLineNum = 1073;BA.debugLine="r.Target = AppInfo";
_r.Target = _appinfo;
 //BA.debugLineNum = 1074;BA.debugLine="Return r.GetField(\"sourceDir\")";
if (true) return BA.ObjectToString(_r.GetField("sourceDir"));
 } 
       catch (Exception e6) {
			processBA.setLastException(e6); //BA.debugLineNum = 1076;BA.debugLine="Return \"\"";
if (true) return "";
 };
...
public static String  _inputlist_checkedchange(boolean _checked) throws Exception{
 //BA.debugLineNum = 1039;BA.debugLine="Sub InputList_CheckedChange(Checked As Boolean)";
...
anywheresoftware.b4a.objects.LabelWrapper _la3 = null;
 //BA.debugLineNum = 634;BA.debugLine="Sub lab_set2";
 //BA.debugLineNum = 635;BA.debugLine="Dim la3 As Label";
_la3 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 636;BA.debugLine="ListView1.Invalidate";
mostCurrent._listview1.Invalidate();
 //BA.debugLineNum = 637;BA.debugLine="la=ListView1.TwoLinesAndBitmap.Label";
mostCurrent._la = mostCurrent._listview1.getTwoLinesAndBitmap().Label;
 //BA.debugLineNum = 638;BA.debugLine="la2=ListView1.TwoLinesAndBitmap.SecondLabel";
mostCurrent._la2 = mostCurrent._listview1.getTwoLinesAndBitmap().SecondLabel;
 //BA.debugLineNum = 639;BA.debugLine="la1=ListView1.TwoLinesLayout.Label";
mostCurrent._la1 = mostCurrent._listview1.getTwoLinesLayout().Label;
 //BA.debugLineNum = 640;BA.debugLine="la3=ListView1.TwoLinesLayout.SecondLabel";
_la3 = mostCurrent._listview1.getTwoLinesLayout().SecondLabel;
 //BA.debugLineNum = 641;BA.debugLine="la.TextSize=13";
mostCurrent._la.setTextSize((float) (13));
 //BA.debugLineNum = 642;BA.debugLine="la.TextColor=Colors.Black";
mostCurrent._la.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 643;BA.debugLine="la1.TextSize=13";
mostCurrent._la1.setTextSize((float) (13));
 //BA.debugLineNum = 644;BA.debugLine="la1.TextColor=Colors.Black";
mostCurrent._la1.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 645;BA.debugLine="la2.TextSize=11";
mostCurrent._la2.setTextSize((float) (11));
 //BA.debugLineNum = 646;BA.debugLine="la2.TextColor=Colors.ARGB(150,255,255,255)";
mostCurrent._la2.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (150),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 647;BA.debugLine="la3.TextColor=Colors.ARGB(100,255,255,255)";
_la3.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (100),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 648;BA.debugLine="la3.TextSize=10";
_la3.setTextSize((float) (10));
 //BA.debugLineNum = 649;BA.debugLine="la1.TextSize=12";
mostCurrent._la1.setTextSize((float) (12));
 //BA.debugLineNum = 650;BA.debugLine="la1.TextColor=Colors.ARGB(180,255,255,255)";
mostCurrent._la1.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (180),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 651;BA.debugLine="ListView1.TwoLinesAndBitmap.ImageView.Height=48di";
mostCurrent._listview1.getTwoLinesAndBitmap().ImageView.setHeight(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (48)));
 //BA.debugLineNum = 652;BA.debugLine="ListView1.TwoLinesAndBitmap.ImageView.Width=48dip";
mostCurrent._listview1.getTwoLinesAndBitmap().ImageView.setWidth(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (48)));
 //BA.debugLineNum = 653;BA.debugLine="ListView1.TwoLinesAndBitmap.ItemHeight=60dip";
mostCurrent._listview1.getTwoLinesAndBitmap().setItemHeight(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (60)));
 //BA.debugLineNum = 654;BA.debugLine="ListView1.SingleLineLayout.ItemHeight=60dip";
mostCurrent._listview1.getSingleLineLayout().setItemHeight(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (60)));
 //BA.debugLineNum = 655;BA.debugLine="ListView1.TwoLinesLayout.ItemHeight=50dip";
...
public static String  _label_text() throws Exception{
 //BA.debugLineNum = 689;BA.debugLine="Sub label_text";
 //BA.debugLineNum = 690;BA.debugLine="lk.TextSize=13";
mostCurrent._lk.setTextSize((float) (13));
 //BA.debugLineNum = 691;BA.debugLine="lk.TextColor=Colors.Black";
mostCurrent._lk.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 692;BA.debugLine="lk.Text=\"Version: \"&pak.GetVersionName(\"com.batca";
...
public static String  _label1_click() throws Exception{
 //BA.debugLineNum = 823;BA.debugLine="Sub Label1_Click";
 //BA.debugLineNum = 824;BA.debugLine="StartActivity(sys)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._sys.getObject()));
 //BA.debugLineNum = 825;BA.debugLine="End Sub";
return "";
}
public static String  _label4_click() throws Exception{
 //BA.debugLineNum = 948;BA.debugLine="Sub Label4_Click";
 //BA.debugLineNum = 949;BA.debugLine="StartActivity(sys)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._sys.getObject()));
...
int _ti = 0;
int _h = 0;
 //BA.debugLineNum = 744;BA.debugLine="Sub li2 As Boolean";
 //BA.debugLineNum = 745;BA.debugLine="list2.Clear";
mostCurrent._list2.Clear();
 //BA.debugLineNum = 746;BA.debugLine="list4.Clear";
mostCurrent._list4.Clear();
 //BA.debugLineNum = 747;BA.debugLine="list5.Clear";
mostCurrent._list5.Clear();
 //BA.debugLineNum = 748;BA.debugLine="list6.Clear";
mostCurrent._list6.Clear();
 //BA.debugLineNum = 749;BA.debugLine="proc.Clear";
mostCurrent._proc.Clear();
 //BA.debugLineNum = 750;BA.debugLine="ramlist.Clear";
mostCurrent._ramlist.Clear();
 //BA.debugLineNum = 751;BA.debugLine="li3";
_li3();
 //BA.debugLineNum = 752;BA.debugLine="Dim si,st As Int";
_si = 0;
_st = 0;
 //BA.debugLineNum = 753;BA.debugLine="si=ra.AvailableExternalMemorySize+ra.AvailableInt";
_si = (int) (mostCurrent._ra.getAvailableExternalMemorySize()+mostCurrent._ra.getAvailableInternalMemorySize());
 //BA.debugLineNum = 756;BA.debugLine="proc=ra.getRecentTasks(99,0)";
mostCurrent._proc.setObject((java.util.List)(mostCurrent._ra.getRecentTasks((int) (99),(int) (0))));
 //BA.debugLineNum = 757;BA.debugLine="list2=ra.RunningServiceInfo(999,list4,list5,list6";
mostCurrent._list2.setObject((java.util.List)(mostCurrent._ra.RunningServiceInfo((int) (999),(java.util.List)(mostCurrent._list4.getObject()),(java.util.List)(mostCurrent._list5.getObject()),(java.util.List)(mostCurrent._list6.getObject()))));
 //BA.debugLineNum = 760;BA.debugLine="Dim math1 As Int";
_math1 = 0;
 //BA.debugLineNum = 762;BA.debugLine="Dim ti As Int=proc.Size+list4.Size";
_ti = (int) (mostCurrent._proc.getSize()+mostCurrent._list4.getSize());
 //BA.debugLineNum = 764;BA.debugLine="For h = 0 To  list4.size-1";
{
final int step14 = 1;
final int limit14 = (int) (mostCurrent._list4.getSize()-1);
for (_h = (int) (0) ; (step14 > 0 && _h <= limit14) || (step14 < 0 && _h >= limit14); _h = ((int)(0 + _h + step14)) ) {
 //BA.debugLineNum = 766;BA.debugLine="math1=si";
_math1 = _si;
 //BA.debugLineNum = 767;BA.debugLine="ProgressBar1.Progress=h";
mostCurrent._progressbar1.setProgress(_h);
 //BA.debugLineNum = 768;BA.debugLine="Label5.Text=ti&\"% \"&FormatFileSize(math1)";
mostCurrent._label5.setText(BA.ObjectToCharSequence(BA.NumberToString(_ti)+"% "+_formatfilesize((float) (_math1))));
 }
};
 //BA.debugLineNum = 770;BA.debugLine="Return(True)";
if (true) return (anywheresoftware.b4a.keywords.Common.True);
...
int _az = 0;
int _g = 0;
 //BA.debugLineNum = 703;BA.debugLine="Sub li3";
 //BA.debugLineNum = 704;BA.debugLine="app_info";
_app_info();
 //BA.debugLineNum = 705;BA.debugLine="volt=bat.BatteryInformation(7)/1000";
mostCurrent._volt = BA.NumberToString(mostCurrent._bat._getbatteryinformation()[(int) (7)]/(double)1000);
 //BA.debugLineNum = 706;BA.debugLine="temp=bat.BatteryInformation(6)/10";
mostCurrent._temp = BA.NumberToString(mostCurrent._bat._getbatteryinformation()[(int) (6)]/(double)10);
 //BA.debugLineNum = 707;BA.debugLine="Dim piclist As List";
_piclist = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 708;BA.debugLine="piclist.Initialize";
_piclist.Initialize();
 //BA.debugLineNum = 709;BA.debugLine="sd=LoadBitmap(File.DirAssets,\"ic_sim_card_black_2";
mostCurrent._sd = anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_sim_card_black_24dp.png");
 //BA.debugLineNum = 710;BA.debugLine="sdi=LoadBitmap(File.DirAssets,\"ic_sim_card_white_";
mostCurrent._sdi = anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_sim_card_white_24dp.png");
 //BA.debugLineNum = 711;BA.debugLine="Dim si,st As Int";
_si = 0;
_st = 0;
 //BA.debugLineNum = 712;BA.debugLine="st=ra.TotalExternalMemorySize+ra.TotalInternalMem";
_st = (int) (mostCurrent._ra.getTotalExternalMemorySize()+mostCurrent._ra.getTotalInternalMemorySize());
 //BA.debugLineNum = 714;BA.debugLine="si=ra.AvailableExternalMemorySize+ra.AvailableInt";
_si = (int) (mostCurrent._ra.getAvailableExternalMemorySize()+mostCurrent._ra.getAvailableInternalMemorySize());
 //BA.debugLineNum = 716;BA.debugLine="ListView1.Clear";
mostCurrent._listview1.Clear();
 //BA.debugLineNum = 717;BA.debugLine="If ra.externalMemoryAvailable Then";
if (mostCurrent._ra.externalMemoryAvailable()) { 
 //BA.debugLineNum = 719;BA.debugLine="Dim lz,az As Int";
_lz = 0;
_az = 0;
 //BA.debugLineNum = 721;BA.debugLine="For Each g As Int  In datalist";
...
_g = (int)(BA.ObjectToNumber(group14.Get(index14)));
 //BA.debugLineNum = 723;BA.debugLine="lz=g";
_lz = _g;
 //BA.debugLineNum = 724;BA.debugLine="az=lz*1024*1024*10";
_az = (int) (_lz*1024*1024*10);
 }
;
 //BA.debugLineNum = 726;BA.debugLine="Log(\"SUB-> \"&FormatFileSize(az))";
anywheresoftware.b4a.keywords.Common.Log("SUB-> "+_formatfilesize((float) (_az)));
 //BA.debugLineNum = 727;BA.debugLine="ListView1.AddTwoLinesAndbitmap2(\"SD Memory(Total";
mostCurrent._listview1.AddTwoLinesAndBitmap2(BA.ObjectToCharSequence("SD Memory(Total): "+_formatfilesize((float) (mostCurrent._ra.getTotalInternalMemorySize()))),BA.ObjectToCharSequence(BA.NumberToString(mostCurrent._list3.getSize())+" apps installiert("+_formatfilesize((float) (_az))+") auf: "+_getparentpath(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/Android")),(android.graphics.Bitmap)(mostCurrent._sd.getObject()),(Object)(2));
 //BA.debugLineNum = 729;BA.debugLine="ListView1.AddTwoLinesAndBitmap2(\"SD Used: \"&Form";
mostCurrent._listview1.AddTwoLinesAndBitmap2(BA.ObjectToCharSequence("SD Used: "+_formatfilesize((float) (_si-_st))),BA.ObjectToCharSequence(_getparentpath(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/Android")),(android.graphics.Bitmap)(mostCurrent._sd.getObject()),(Object)(3));
 //BA.debugLineNum = 731;BA.debugLine="ListView1.AddTwoLinesAndBitmap2(\"SD Free: \"&Form";
mostCurrent._listview1.AddTwoLinesAndBitmap2(BA.ObjectToCharSequence("SD Free: "+_formatfilesize((float) (mostCurrent._ra.getAvailableExternalMemorySize()+mostCurrent._ra.getAvailableInternalMemorySize()))),BA.ObjectToCharSequence(_getparentpath(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/Android")),(android.graphics.Bitmap)(mostCurrent._sd.getObject()),(Object)(4));
 //BA.debugLineNum = 732;BA.debugLine="ListView1.AddTwoLinesAndbitmap2(\"SD (Intern): \"&";
mostCurrent._listview1.AddTwoLinesAndBitmap2(BA.ObjectToCharSequence("SD (Intern): "+_formatfilesize((float) (mostCurrent._ra.getTotalInternalMemorySize()))),BA.ObjectToCharSequence(_getparentpath(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/Android")),(android.graphics.Bitmap)(mostCurrent._sdi.getObject()),(Object)(5));
 ...
 //BA.debugLineNum = 734;BA.debugLine="ListView1.AddTwoLinesAndbitmap2(\"SD Memory(Total";
mostCurrent._listview1.AddTwoLinesAndBitmap2(BA.ObjectToCharSequence("SD Memory(Total):"),BA.ObjectToCharSequence(_formatfilesize((float) (mostCurrent._ra.getTotalInternalMemorySize()+mostCurrent._ra.getTotalExternalMemorySize()))),(android.graphics.Bitmap)(mostCurrent._sd.getObject()),(Object)(2));
 //BA.debugLineNum = 735;BA.debugLine="ListView1.AddTwoLinesAndbitmap2(\"SD(Inten):\",For";
mostCurrent._listview1.AddTwoLinesAndBitmap2(BA.ObjectToCharSequence("SD(Inten):"),BA.ObjectToCharSequence(_formatfilesize((float) (mostCurrent._ra.getTotalInternalMemorySize()))),(android.graphics.Bitmap)(mostCurrent._sdi.getObject()),(Object)(5));
 //BA.debugLineNum = 736;BA.debugLine="ListView1.AddTwoLinesAndBitmap2(\"SD total Free:\"";
mostCurrent._listview1.AddTwoLinesAndBitmap2(BA.ObjectToCharSequence("SD total Free:"),BA.ObjectToCharSequence(_formatfilesize((float) (mostCurrent._ra.getAvailableExternalMemorySize()+mostCurrent._ra.getAvailableInternalMemorySize()))),(android.graphics.Bitmap)(mostCurrent._sd.getObject()),(Object)(4));
 //BA.debugLineNum = 737;BA.debugLine="ListView1.AddTwoLinesAndBitmap2(\"SD total Used:\"";
...
public static String  _listview1_itemclick(int _position,Object _value) throws Exception{
 //BA.debugLineNum = 952;BA.debugLine="Sub listview1_ItemClick (Position As Int, value As";
 //BA.debugLineNum = 953;BA.debugLine="If Position=0 Then";
if (_position==0) { 
 //BA.debugLineNum = 954;BA.debugLine="rl_lo";
_rl_lo();
 };
...
public static String  _loading_norm() throws Exception{
 //BA.debugLineNum = 958;BA.debugLine="Sub loading_norm";
 //BA.debugLineNum = 960;BA.debugLine="End Sub";
return "";
}
public static String  _low_power() throws Exception{
 //BA.debugLineNum = 963;BA.debugLine="Sub low_power";
...
anywheresoftware.b4a.objects.IntentWrapper _i = null;
 //BA.debugLineNum = 599;BA.debugLine="Sub lvMenu_ItemClick (Position As Int, Value As Ob";
 //BA.debugLineNum = 600;BA.debugLine="If Value = 0 Then";
if ((_value).equals((Object)(0))) { 
 //BA.debugLineNum = 601;BA.debugLine="opt_click";
_opt_click();
 //BA.debugLineNum = 602;BA.debugLine="slm.CloseSidebar";
mostCurrent._slm._closesidebar();
 };
 //BA.debugLineNum = 604;BA.debugLine="If Value=1 Then";
if ((_value).equals((Object)(1))) { 
 //BA.debugLineNum = 605;BA.debugLine="cl_click";
_cl_click();
 //BA.debugLineNum = 606;BA.debugLine="slm.CloseSidebar";
mostCurrent._slm._closesidebar();
 };
 //BA.debugLineNum = 608;BA.debugLine="If Value=2 Then";
if ((_value).equals((Object)(2))) { 
 //BA.debugLineNum = 609;BA.debugLine="Dim i As Intent";
_i = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 610;BA.debugLine="i.Initialize( \"android.intent.action.POWER_USAGE";
_i.Initialize("android.intent.action.POWER_USAGE_SUMMARY","");
 //BA.debugLineNum = 611;BA.debugLine="slm.CloseSidebar";
mostCurrent._slm._closesidebar();
 //BA.debugLineNum = 612;BA.debugLine="StartActivity(i)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_i.getObject()));
 };
 //BA.debugLineNum = 614;BA.debugLine="If Value=3 Then";
...
mostCurrent._slm._closesidebar();
 ...
 //BA.debugLineNum = 618;BA.debugLine="If Value=4 Then";
if ((_value).equals((Object)(4))) { 
 //BA.debugLineNum = 619;BA.debugLine="StartActivity(sys)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._sys.getObject()));
...
mostCurrent._slm._closesidebar();
 ...
 //BA.debugLineNum = 623;BA.debugLine="If Value=5 Then";
if ((_value).equals((Object)(5))) { 
 //BA.debugLineNum = 624;BA.debugLine="pci_click";
_pci_click();
...
mostCurrent._label1.SetLayout(anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (40),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (40),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (40),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (90)));
 //BA.debugLineNum = 362;BA.debugLine="Button4.TextSize=10";
mostCurrent._button4.setTextSize((float) (10));
 //BA.debugLineNum = 365;BA.debugLine="Label2.SetVisibleAnimated(100,False)";
mostCurrent._label2.SetVisibleAnimated((int) (100),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 366;BA.debugLine="Label4.SetVisibleAnimated(100,False)";
...
public static String  _menu_onmove(boolean _isopening) throws Exception{
 //BA.debugLineNum = 388;BA.debugLine="Sub Menu_onMove (IsOpening As Boolean)";
 //BA.debugLineNum = 389;BA.debugLine="If IsOpening=True Then";
if (_isopening==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 390;BA.debugLine="Button4.SetTextSizeAnimated(50,10)";
mostCurrent._button4.SetTextSizeAnimated((int) (50),(float) (10));
 //BA.debugLineNum = 391;BA.debugLine="Button4.SetLayoutAnimated(200,1%x,50%y,40%x,105)";
mostCurrent._button4.SetLayoutAnimated((int) (200),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (1),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (50),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (40),mostCurrent.activityBA),(int) (105));
 };
...
int _hours = 0;
int _minutes = 0;
 //BA.debugLineNum = 940;BA.debugLine="Sub minutes_hours ( ms As Int ) As String";
 //BA.debugLineNum = 941;BA.debugLine="Dim val,hours,minutes As Int";
_val = 0;
_hours = 0;
_minutes = 0;
 //BA.debugLineNum = 942;BA.debugLine="val = ms";
_val = _ms;
 //BA.debugLineNum = 943;BA.debugLine="hours = Floor(val / 60)";
_hours = (int) (anywheresoftware.b4a.keywords.Common.Floor(_val/(double)60));
 //BA.debugLineNum = 944;BA.debugLine="minutes = val Mod 60";
_minutes = (int) (_val%60);
 //BA.debugLineNum = 945;BA.debugLine="Return NumberFormat(hours, 1, 0) & \":\" & NumberFo";
...
public static String  _opt_click() throws Exception{
 //BA.debugLineNum = 677;BA.debugLine="Sub opt_click";
 //BA.debugLineNum = 678;BA.debugLine="StartActivity(settings)";
...
public static String  _pci_click() throws Exception{
 //BA.debugLineNum = 695;BA.debugLine="Sub pci_click";
 //BA.debugLineNum = 696;BA.debugLine="cd.AddView(panel3,-1,350)";
mostCurrent._cd.AddView((android.view.View)(mostCurrent._panel3.getObject()),(int) (-1),(int) (350));
 //BA.debugLineNum = 697;BA.debugLine="cd.Show(\"About Batt-Cat: \",\"\",\"Got It\",\"\",LoadBit";
mostCurrent._cd.Show("About Batt-Cat: ","","Got It","",mostCurrent.activityBA,(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Rss.png").getObject()));
 //BA.debugLineNum = 698;BA.debugLine="If Not (cd2.Response=DialogResponse.CANCEL) Then";
if (anywheresoftware.b4a.keywords.Common.Not(mostCurrent._cd2.getResponse()==anywheresoftware.b4a.keywords.Common.DialogResponse.CANCEL)) { 
 //BA.debugLineNum = 699;BA.debugLine="ct.ShowBitmap(\"©2017 SuloMedia™\",30,Gravity.BOTT";
...
public static String  _prog_init() throws Exception{
 //BA.debugLineNum = 395;BA.debugLine="Sub prog_init";
 //BA.debugLineNum = 397;BA.debugLine="End Sub";
return "";
}
public static String  _re_bound() throws Exception{
 //BA.debugLineNum = 595;BA.debugLine="Sub re_bound";
 //BA.debugLineNum = 596;BA.debugLine="StartActivity(klo)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._klo.getObject()));
 //BA.debugLineNum = 597;BA.debugLine="End Sub";
return "";
}
public static String  _rl_lo() throws Exception{
 //BA.debugLineNum = 681;BA.debugLine="Sub rl_lo";
 //BA.debugLineNum = 682;BA.debugLine="cd2.Show(\"User App´s\",\"Check\",\"\",\"\",LoadBitmap(Fi";
mostCurrent._cd2.Show("User App´s","Check","","",mostCurrent.activityBA,(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Android.png").getObject()));
 //BA.debugLineNum = 683;BA.debugLine="If cd2.Response=DialogResponse.POSITIVE Then";
if (mostCurrent._cd2.getResponse()==anywheresoftware.b4a.keywords.Common.DialogResponse.POSITIVE) { 
 //BA.debugLineNum = 684;BA.debugLine="ToastMessageShow(\"closed...\",False)";
...
public static String  _slem_click() throws Exception{
 //BA.debugLineNum = 585;BA.debugLine="Sub slem_click";
 //BA.debugLineNum = 586;BA.debugLine="If slm.IsSidebarVisible Then";
if (mostCurrent._slm._issidebarvisible()) { 
 //BA.debugLineNum = 587;BA.debugLine="slm.CloseSidebar";
mostCurrent._slm._closesidebar();
 }else {
 //BA.debugLineNum = 590;BA.debugLine="slm.OpenSidebar";
mostCurrent._slm._opensidebar();
 };
...
public static String  _slem1_click() throws Exception{
 //BA.debugLineNum = 581;BA.debugLine="Sub slem1_click";
 //BA.debugLineNum = 582;BA.debugLine="slem_click";
_slem_click();
...
public static String  _store_check() throws Exception{
 //BA.debugLineNum = 399;BA.debugLine="Sub store_check";
 //BA.debugLineNum = 400;BA.debugLine="c1=mcl.md_light_blue_A700";
_c1 = mostCurrent._mcl.getmd_light_blue_A700();
 //BA.debugLineNum = 401;BA.debugLine="c2=mcl.md_amber_A700";
_c2 = mostCurrent._mcl.getmd_amber_A700();
 //BA.debugLineNum = 402;BA.debugLine="c3=mcl.md_white_1000";
_c3 = mostCurrent._mcl.getmd_white_1000();
 //BA.debugLineNum = 403;BA.debugLine="c4=mcl.md_teal_A700";
_c4 = mostCurrent._mcl.getmd_teal_A700();
 //BA.debugLineNum = 404;BA.debugLine="c5=mcl.md_deep_purple_A700";
_c5 = mostCurrent._mcl.getmd_deep_purple_A700();
 //BA.debugLineNum = 405;BA.debugLine="c6=mcl.md_red_A700";
_c6 = mostCurrent._mcl.getmd_red_A700();
 //BA.debugLineNum = 406;BA.debugLine="c7=mcl.md_indigo_A700";
_c7 = mostCurrent._mcl.getmd_indigo_A700();
 //BA.debugLineNum = 407;BA.debugLine="c8=mcl.md_blue_A700";
_c8 = mostCurrent._mcl.getmd_blue_A700();
 //BA.debugLineNum = 408;BA.debugLine="c9=mcl.md_orange_A700";
_c9 = mostCurrent._mcl.getmd_orange_A700();
 //BA.debugLineNum = 409;BA.debugLine="c10=mcl.md_grey_700";
_c10 = mostCurrent._mcl.getmd_grey_700();
 //BA.debugLineNum = 410;BA.debugLine="c11=mcl.md_green_A700";
_c11 = mostCurrent._mcl.getmd_green_A700();
 //BA.debugLineNum = 411;BA.debugLine="c12=mcl.md_black_1000";
_c12 = mostCurrent._mcl.getmd_black_1000();
 //BA.debugLineNum = 412;BA.debugLine="c13=mcl.md_yellow_A700";
_c13 = mostCurrent._mcl.getmd_yellow_A700();
 //BA.debugLineNum = 413;BA.debugLine="c14=mcl.md_cyan_A700";
_c14 = mostCurrent._mcl.getmd_cyan_A700();
 //BA.debugLineNum = 414;BA.debugLine="c15=mcl.md_blue_grey_700";
_c15 = mostCurrent._mcl.getmd_blue_grey_700();
 //BA.debugLineNum = 415;BA.debugLine="c16=mcl.md_light_blue_A700";
_c16 = mostCurrent._mcl.getmd_light_blue_A700();
 //BA.debugLineNum = 416;BA.debugLine="If kvs4sub.ContainsKey(\"off\") Then";
if (mostCurrent._kvs4sub._containskey("off")) { 
 //BA.debugLineNum = 417;BA.debugLine="StopService(Starter)";
anywheresoftware.b4a.keywords.Common.StopService(mostCurrent.activityBA,(Object)(mostCurrent._starter.getObject()));
 }else {
 };
 //BA.debugLineNum = 428;BA.debugLine="If kvs4.ContainsKey(\"0\")Then";
if (mostCurrent._kvs4._containskey("0")) { 
 //BA.debugLineNum = 429;BA.debugLine="Log(\"AC_true->1\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->1");
 //BA.debugLineNum = 430;BA.debugLine="Activity.Color=c1";
mostCurrent._activity.setColor(_c1);
 //BA.debugLineNum = 431;BA.debugLine="apm.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._apm.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 432;BA.debugLine="Label4.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._label4.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 433;BA.debugLine="Label5.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._label5.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 434;BA.debugLine="Label3.TextColor=Colors.ARGB(200,255,255,255)";
...
mostCurrent._activity.setColor(_c3);
 //BA.debugLineNum = 449;BA.debugLine="apm.TextColor=Colors.Black";
mostCurrent._apm.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 450;BA.debugLine="Label4.TextColor=Colors.Black";
mostCurrent._label4.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 451;BA.debugLine="Label5.TextColor=Colors.Black";
mostCurrent._label5.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 452;BA.debugLine="Label3.TextColor=Colors.Black";
mostCurrent._label3.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 }else {
 };
 //BA.debugLineNum = 456;BA.debugLine="If kvs4.ContainsKey(\"3\")Then";
if (mostCurrent._kvs4._containskey("3")) { 
 //BA.debugLineNum = 457;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 458;BA.debugLine="Activity.Color=c4";
mostCurrent._activity.setColor(_c4);
 //BA.debugLineNum = 459;BA.debugLine="apm.TextColor=Colors.Black";
mostCurrent._apm.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 460;BA.debugLine="Label4.TextColor=Colors.Black";
mostCurrent._label4.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 461;BA.debugLine="Label5.TextColor=Colors.Black";
mostCurrent._label5.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 462;BA.debugLine="Label3.TextColor=Colors.Black";
mostCurrent._label3.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 }else {
 };
 //BA.debugLineNum = 466;BA.debugLine="If kvs4.ContainsKey(\"4\")Then";
if (mostCurrent._kvs4._containskey("4")) { 
 //BA.debugLineNum = 467;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 468;BA.debugLine="Activity.Color=c5";
...
mostCurrent._label3.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 ...
 //BA.debugLineNum = 476;BA.debugLine="If kvs4.ContainsKey(\"5\")Then";
if (mostCurrent._kvs4._containskey("5")) { 
 //BA.debugLineNum = 477;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 478;BA.debugLine="Activity.Color=c6";
...
mostCurrent._label3.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 ...
 //BA.debugLineNum = 486;BA.debugLine="If kvs4.ContainsKey(\"6\")Then";
if (mostCurrent._kvs4._containskey("6")) { 
 //BA.debugLineNum = 487;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 488;BA.debugLine="Activity.Color=c7";
...
mostCurrent._label3.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 ...
 //BA.debugLineNum = 496;BA.debugLine="If kvs4.ContainsKey(\"7\")Then";
if (mostCurrent._kvs4._containskey("7")) { 
 //BA.debugLineNum = 497;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 498;BA.debugLine="Activity.Color=c8";
...
mostCurrent._label3.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 ...
 //BA.debugLineNum = 506;BA.debugLine="If kvs4.ContainsKey(\"8\")Then";
if (mostCurrent._kvs4._containskey("8")) { 
 //BA.debugLineNum = 507;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 508;BA.debugLine="Activity.Color=c9";
mostCurrent._activity.setColor(_c9);
 //BA.debugLineNum = 509;BA.debugLine="apm.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._apm.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 510;BA.debugLine="Label4.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._label4.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 511;BA.debugLine="Label5.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._label5.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 512;BA.debugLine="Label3.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._label3.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 }else {
 };
 //BA.debugLineNum = 516;BA.debugLine="If kvs4.ContainsKey(\"9\")Then";
if (mostCurrent._kvs4._containskey("9")) { 
 //BA.debugLineNum = 517;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 518;BA.debugLine="Activity.Color=c10";
mostCurrent._activity.setColor(_c10);
 //BA.debugLineNum = 519;BA.debugLine="apm.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._apm.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 520;BA.debugLine="Label4.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._label4.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 521;BA.debugLine="Label5.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._label5.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 522;BA.debugLine="Label3.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._label3.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 }else {
 };
 //BA.debugLineNum = 526;BA.debugLine="If kvs4.ContainsKey(\"10\")Then";
if (mostCurrent._kvs4._containskey("10")) { 
 //BA.debugLineNum = 527;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 528;BA.debugLine="Activity.Color=c11";
mostCurrent._activity.setColor(_c11);
 //BA.debugLineNum = 529;BA.debugLine="apm.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._apm.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 530;BA.debugLine="apm.FinishedStrokeColor=Colors.ARGB(200,255,255,";
mostCurrent._apm.setFinishedStrokeColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 531;BA.debugLine="apm.UnfinishedStrokeColor=Colors.ARGB(100,255,25";
mostCurrent._apm.setUnfinishedStrokeColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (100),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 532;BA.debugLine="Label4.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._label4.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 533;BA.debugLine="Label5.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._label5.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 534;BA.debugLine="Label3.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._label3.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 }else {
 };
 //BA.debugLineNum = 538;BA.debugLine="If kvs4.ContainsKey(\"11\")Then";
if (mostCurrent._kvs4._containskey("11")) { 
 //BA.debugLineNum = 539;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 540;BA.debugLine="Activity.Color=c12";
mostCurrent._activity.setColor(_c12);
 //BA.debugLineNum = 541;BA.debugLine="apm.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._apm.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
...
mostCurrent._label3.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 ...
 //BA.debugLineNum = 548;BA.debugLine="If kvs4.ContainsKey(\"12\")Then";
if (mostCurrent._kvs4._containskey("12")) { 
 //BA.debugLineNum = 549;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 550;BA.debugLine="Activity.Color=c13";
...
mostCurrent._label3.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 ...
 //BA.debugLineNum = 558;BA.debugLine="If kvs4.ContainsKey(\"13\")Then";
if (mostCurrent._kvs4._containskey("13")) { 
 //BA.debugLineNum = 559;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 560;BA.debugLine="Activity.Color=c14";
mostCurrent._activity.setColor(_c14);
 //BA.debugLineNum = 561;BA.debugLine="apm.TextColor=Colors.Black";
mostCurrent._apm.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 562;BA.debugLine="Label4.TextColor=Colors.Black";
mostCurrent._label4.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 563;BA.debugLine="Label5.TextColor=Colors.Black";
mostCurrent._label5.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 564;BA.debugLine="Label3.TextColor=Colors.Black";
mostCurrent._label3.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 }else {
 };
 //BA.debugLineNum = 568;BA.debugLine="If kvs4.ContainsKey(\"14\")Then";
if (mostCurrent._kvs4._containskey("14")) { 
 //BA.debugLineNum = 569;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 570;BA.debugLine="Activity.Color=c15";
mostCurrent._activity.setColor(_c15);
 //BA.debugLineNum = 571;BA.debugLine="apm.TextColor=Colors.Black";
mostCurrent._apm.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 572;BA.debugLine="Label4.TextColor=Colors.Black";
mostCurrent._label4.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 573;BA.debugLine="Label5.TextColor=Colors.Black";
mostCurrent._label5.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 574;BA.debugLine="Label3.TextColor=Colors.Black";
mostCurrent._label3.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 }else {
 };
 //BA.debugLineNum = 578;BA.debugLine="Activity.Invalidate";
...
int _counter = 0;
 //BA.debugLineNum = 772;BA.debugLine="Sub t1_Tick";
 //BA.debugLineNum = 773;BA.debugLine="Dim counter As Int";
_counter = 0;
 //BA.debugLineNum = 774;BA.debugLine="counter=counter+1";
_counter = (int) (_counter+1);
 //BA.debugLineNum = 775;BA.debugLine="If counter > 1 Then Log(\"1\")";
if (_counter>1) { 
anywheresoftware.b4a.keywords.Common.Log("1");};
 //BA.debugLineNum = 776;BA.debugLine="If counter >2 Then Log(\"2\")";
if (_counter>2) { 
anywheresoftware.b4a.keywords.Common.Log("2");};
 //BA.debugLineNum = 777;BA.debugLine="If counter=3 Then";
if (_counter==3) { 
 //BA.debugLineNum = 778;BA.debugLine="li2";
_li2();
 //BA.debugLineNum = 779;BA.debugLine="t1.Enabled=False";
_t1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 780;BA.debugLine="timer_start";
_timer_start();
 };
