...
anywheresoftware.b4a.objects.LabelWrapper _lvm2 = null;
 ...
 //BA.debugLineNum = 84;BA.debugLine="Activity.LoadLayout(\"1\")";
mostCurrent._activity.LoadLayout("1",mostCurrent.activityBA);
 //BA.debugLineNum = 87;BA.debugLine="Activity.Title=pak.GetApplicationLabel(\"com.batca";
...
mostCurrent._toolbarhelper.Initialize(mostCurrent.activityBA);
 //BA.debugLineNum = 94;BA.debugLine="ToolbarHelper.Hide";
mostCurrent._toolbarhelper.Hide();
 //BA.debugLineNum = 97;BA.debugLine="ra.Initialize(\"ra\")";
mostCurrent._ra.Initialize(processBA,"ra");
 //BA.debugLineNum = 98;BA.debugLine="bat.Initialize";
mostCurrent._bat._initialize(processBA);
 //BA.debugLineNum = 99;BA.debugLine="ct.Initialize";
mostCurrent._ct.Initialize(processBA);
 //BA.debugLineNum = 100;BA.debugLine="list.Initialize";
mostCurrent._list.Initialize();
 //BA.debugLineNum = 101;BA.debugLine="list1.Initialize";
mostCurrent._list1.Initialize();
 //BA.debugLineNum = 102;BA.debugLine="list2.Initialize";
mostCurrent._list2.Initialize();
 //BA.debugLineNum = 103;BA.debugLine="list3.Initialize";
mostCurrent._list3.Initialize();
 //BA.debugLineNum = 104;BA.debugLine="list4.Initialize";
mostCurrent._list4.Initialize();
 //BA.debugLineNum = 105;BA.debugLine="list5.Initialize";
mostCurrent._list5.Initialize();
 //BA.debugLineNum = 106;BA.debugLine="list6.Initialize";
mostCurrent._list6.Initialize();
 //BA.debugLineNum = 107;BA.debugLine="phlis.Initialize";
mostCurrent._phlis.Initialize();
 //BA.debugLineNum = 108;BA.debugLine="datalist.Initialize";
mostCurrent._datalist.Initialize();
 //BA.debugLineNum = 109;BA.debugLine="setlist.Initialize";
mostCurrent._setlist.Initialize();
 //BA.debugLineNum = 110;BA.debugLine="lv2.Initialize(\"lv2\")";
mostCurrent._lv2.Initialize(mostCurrent.activityBA,"lv2");
 //BA.debugLineNum = 111;BA.debugLine="panel3.Initialize(\"panel3\")";
mostCurrent._panel3.Initialize(mostCurrent.activityBA,"panel3");
 //BA.debugLineNum = 112;BA.debugLine="smlp.Initialize(\"smlp\")";
mostCurrent._smlp.Initialize(mostCurrent.activityBA,"smlp");
 //BA.debugLineNum = 113;BA.debugLine="lip.Initialize(\"lip\")";
mostCurrent._lip.Initialize(mostCurrent.activityBA,"lip");
 //BA.debugLineNum = 115;BA.debugLine="lis.Initialize";
mostCurrent._lis.Initialize();
 //BA.debugLineNum = 116;BA.debugLine="proc.Initialize";
mostCurrent._proc.Initialize();
 //BA.debugLineNum = 117;BA.debugLine="lk.Initialize(\"lk\")";
mostCurrent._lk.Initialize(mostCurrent.activityBA,"lk");
 //BA.debugLineNum = 118;BA.debugLine="optmap.Initialize";
mostCurrent._optmap.Initialize();
 //BA.debugLineNum = 119;BA.debugLine="la.Initialize(\"la\")";
mostCurrent._la.Initialize(mostCurrent.activityBA,"la");
 //BA.debugLineNum = 120;BA.debugLine="la1.Initialize(\"la1\")";
mostCurrent._la1.Initialize(mostCurrent.activityBA,"la1");
 //BA.debugLineNum = 121;BA.debugLine="la2.Initialize(\"la2\")";
mostCurrent._la2.Initialize(mostCurrent.activityBA,"la2");
 //BA.debugLineNum = 122;BA.debugLine="ramlist.Initialize";
mostCurrent._ramlist.Initialize();
 //BA.debugLineNum = 123;BA.debugLine="panel3.AddView(lk,10,5,80%x,50%y)";
...
mostCurrent._lip.AddView((android.view.View)(mostCurrent._lv2.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (1)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (1)),(int) (-1),(int) (-1));
 //BA.debugLineNum = 130;BA.debugLine="cd2.AddView(lip,-1,-1)";
mostCurrent._cd2.AddView((android.view.View)(mostCurrent._lip.getObject()),(int) (-1),(int) (-1));
 //BA.debugLineNum = 131;BA.debugLine="smlp.Enabled=True";
mostCurrent._smlp.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 132;BA.debugLine="showtip.Initialize(\"showtip\")";
mostCurrent._showtip.Initialize(mostCurrent.activityBA,"showtip");
 //BA.debugLineNum = 133;BA.debugLine="ima.Initialize(\"ima\")";
mostCurrent._ima.Initialize(mostCurrent.activityBA,"ima");
 //BA.debugLineNum = 134;BA.debugLine="ima.Bitmap=LoadBitmap(File.DirAssets,\"icon_batcat";
mostCurrent._ima.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"icon_batcat.png").getObject()));
 //BA.debugLineNum = 135;BA.debugLine="panel3.AddView(ima,50,150,450,250)";
mostCurrent._panel3.AddView((android.view.View)(mostCurrent._ima.getObject()),(int) (50),(int) (150),(int) (450),(int) (250));
 //BA.debugLineNum = 140;BA.debugLine="date=DateTime.Date(DateTime.Now)";
mostCurrent._date = anywheresoftware.b4a.keywords.Common.DateTime.Date(anywheresoftware.b4a.keywords.Common.DateTime.getNow());
 //BA.debugLineNum = 141;BA.debugLine="time=DateTime.Time(DateTime.Now)";
mostCurrent._time = anywheresoftware.b4a.keywords.Common.DateTime.Time(anywheresoftware.b4a.keywords.Common.DateTime.getNow());
 //BA.debugLineNum = 143;BA.debugLine="volt=bat.BatteryInformation(7)/1000";
mostCurrent._volt = BA.NumberToString(mostCurrent._bat._getbatteryinformation()[(int) (7)]/(double)1000);
 //BA.debugLineNum = 144;BA.debugLine="temp=bat.BatteryInformation(6)/10";
mostCurrent._temp = BA.NumberToString(mostCurrent._bat._getbatteryinformation()[(int) (6)]/(double)10);
 //BA.debugLineNum = 145;BA.debugLine="level1=bat.BatteryInformation(0)";
mostCurrent._level1 = BA.NumberToString(mostCurrent._bat._getbatteryinformation()[(int) (0)]);
 //BA.debugLineNum = 150;BA.debugLine="Label3.Text=\"Ver. \"&pak.GetVersionName(\"com.batc";
...
mostCurrent._lvmenu.BringToFront();
 //BA.debugLineNum = 191;BA.debugLine="lv2.Enabled=True";
mostCurrent._lv2.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 195;BA.debugLine="If FirstTime=True Then";
if (_firsttime==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 196;BA.debugLine="slm.OpenSidebar";
mostCurrent._slm._opensidebar();
 //BA.debugLineNum = 197;BA.debugLine="Button4.Visible=False";
mostCurrent._button4.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 198;BA.debugLine="Button4.ButtonColor=mcl.md_light_green_A400";
mostCurrent._button4.setButtonColor(mostCurrent._mcl.getmd_light_green_A400());
 //BA.debugLineNum = 199;BA.debugLine="show_tip";
_show_tip();
 //BA.debugLineNum = 200;BA.debugLine="If File.Exists(File.DirDefaultExternal&\"/mnt/cac";
...
mostCurrent._listview1.Clear();
 ...
 //BA.debugLineNum = 205;BA.debugLine="File.MakeDir(File.DirDefaultExternal, \"mnt/cach";
anywheresoftware.b4a.keywords.Common.File.MakeDir(anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal(),"mnt/cache");
 //BA.debugLineNum = 206;BA.debugLine="File.MakeDir(File.DirRootExternal, \"mnt/data\")";
anywheresoftware.b4a.keywords.Common.File.MakeDir(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"mnt/data");
 //BA.debugLineNum = 207;BA.debugLine="File.WriteList(File.DirDefaultExternal&\"/mnt/ca";
anywheresoftware.b4a.keywords.Common.File.WriteList(anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal()+"/mnt/cache","sv.txt",mostCurrent._list4);
 //BA.debugLineNum = 208;BA.debugLine="File.WriteList(File.DirDefaultExternal&\"/mnt/ca";
anywheresoftware.b4a.keywords.Common.File.WriteList(anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal()+"/mnt/cache","fn.txt",mostCurrent._list1);
 //BA.debugLineNum = 209;BA.debugLine="File.WriteList(File.DirDefaultExternal&\"/mnt/ca";
anywheresoftware.b4a.keywords.Common.File.WriteList(anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal()+"/mnt/cache","APnames.txt",mostCurrent._list3);
 //BA.debugLineNum = 210;BA.debugLine="File.WriteString(File.DirDefaultExternal&\"/mnt/";
anywheresoftware.b4a.keywords.Common.File.WriteString(anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal()+"/mnt/cache","lvl.txt",mostCurrent._level1);
 //BA.debugLineNum = 211;BA.debugLine="File.WriteString(File.DirDefaultExternal&\"/mnt/";
...
anywheresoftware.b4a.keywords.Common.File.WriteList(anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal()+"/mnt/cache","settings.txt",mostCurrent._setlist);
 //BA.debugLineNum = 214;BA.debugLine="File.WriteList(File.DirDefaultExternal&\"/mnt/ca";
...
anywheresoftware.b4a.keywords.Common.File.WriteString(anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal()+"/mnt/cache","lvl2.txt","0");
 //BA.debugLineNum = 216;BA.debugLine="File.WriteMap(File.DirDefaultExternal&\"/mnt/cac";
anywheresoftware.b4a.keywords.Common.File.WriteMap(anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal()+"/mnt/cache","smap1.txt",mostCurrent._optmap);
 //BA.debugLineNum = 217;BA.debugLine="ToastMessageShow(\"BC Log loaded! \"&date&\", \"&ti";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("BC Log loaded! "+mostCurrent._date+", "+mostCurrent._time),anywheresoftware.b4a.keywords.Common.False);
 ...
 //BA.debugLineNum = 220;BA.debugLine="ToastMessageShow(\"Willkommen\",False)";
...
mostCurrent._kvs4sub._initialize(processBA,anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal(),"datastore_sub_4");
 //BA.debugLineNum = 239;BA.debugLine="device.Initialize(\"device\")";
...
mostCurrent._label4.setText(BA.ObjectToCharSequence(BA.NumberToString(anywheresoftware.b4a.keywords.Common.Round2((double)(Double.parseDouble(mostCurrent._volt)),(int) (1)))+" V"));
 //BA.debugLineNum = 247;BA.debugLine="Mclist.Initialize";
mostCurrent._mclist.Initialize();
 //BA.debugLineNum = 249;BA.debugLine="Mclist.Clear";
mostCurrent._mclist.Clear();
 //BA.debugLineNum = 250;BA.debugLine="Mclist.Add(c1)";
mostCurrent._mclist.Add((Object)(_c1));
 //BA.debugLineNum = 251;BA.debugLine="Mclist.Add(c2)";
mostCurrent._mclist.Add((Object)(_c2));
 //BA.debugLineNum = 252;BA.debugLine="Mclist.Add(c3)";
mostCurrent._mclist.Add((Object)(_c3));
 //BA.debugLineNum = 253;BA.debugLine="Mclist.Add(c4)";
...
_c2 = mostCurrent._mcl.getmd_amber_A700();
 //BA.debugLineNum = 256;BA.debugLine="c3=mcl.md_lime_A700";
...
_c11 = mostCurrent._mcl.getmd_green_A700();
 //BA.debugLineNum = 265;BA.debugLine="c12=mcl.md_light_green_A700";
...
mostCurrent._batlow.Initialize(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Battery Icons - Colorful 128px (10).png");
 //BA.debugLineNum = 288;BA.debugLine="ulow.Initialize(File.DirAssets,\"Battery Icons - C";
mostCurrent._ulow.Initialize(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Battery Icons - Colorful 128px (14).png");
 //BA.debugLineNum = 291;BA.debugLine="app_info";
_app_info();
 //BA.debugLineNum = 292;BA.debugLine="lab_set2";
_lab_set2();
 //BA.debugLineNum = 293;BA.debugLine="label_text";
_label_text();
 //BA.debugLineNum = 295;BA.debugLine="store_check";
_store_check();
 //BA.debugLineNum = 296;BA.debugLine="li2";
_li2();
 //BA.debugLineNum = 298;BA.debugLine="If prog.IsInitialized=True Then";
if (mostCurrent._prog.IsInitialized()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 299;BA.debugLine="prog.BringToFront";
...
public static boolean  _activity_keypress(int _keycode) throws Exception{
 //BA.debugLineNum = 783;BA.debugLine="Sub Activity_KeyPress (KeyCode As Int) As Boolean";
 //BA.debugLineNum = 784;BA.debugLine="If KeyCode=KeyCodes.KEYCODE_BACK Then";
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK) { 
 //BA.debugLineNum = 785;BA.debugLine="Activity.Finish";
mostCurrent._activity.Finish();
 //BA.debugLineNum = 786;BA.debugLine="ToastMessageShow(\"BCT - Backround Service\",False";
...
public static String  _activity_resume() throws Exception{
 //BA.debugLineNum = 304;BA.debugLine="Sub Activity_Resume";
 //BA.debugLineNum = 305;BA.debugLine="If prog.IsInitialized=True Then";
if (mostCurrent._prog.IsInitialized()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 306;BA.debugLine="prog.BringToFront";
mostCurrent._prog._bringtofront();
 };
 //BA.debugLineNum = 308;BA.debugLine="app_info";
_app_info();
 //BA.debugLineNum = 309;BA.debugLine="lab_set2";
_lab_set2();
 //BA.debugLineNum = 310;BA.debugLine="label_text";
_label_text();
 //BA.debugLineNum = 312;BA.debugLine="store_check";
_store_check();
 //BA.debugLineNum = 313;BA.debugLine="li2";
_li2();
...
int _i = 0;
int _form = 0;
 //BA.debugLineNum = 914;BA.debugLine="Sub app_info";
 //BA.debugLineNum = 915;BA.debugLine="lv2.Clear";
mostCurrent._lv2.Clear();
 //BA.debugLineNum = 916;BA.debugLine="list3.Clear";
mostCurrent._list3.Clear();
 //BA.debugLineNum = 917;BA.debugLine="datalist.Clear";
mostCurrent._datalist.Clear();
 //BA.debugLineNum = 919;BA.debugLine="list1=pak.GetInstalledPackages";
mostCurrent._list1 = _pak.GetInstalledPackages();
 //BA.debugLineNum = 921;BA.debugLine="Obj1.Target = Obj1.GetContext";
mostCurrent._obj1.Target = (Object)(mostCurrent._obj1.GetContext(processBA));
 //BA.debugLineNum = 922;BA.debugLine="Obj1.Target = Obj1.RunMethod(\"getPackageManager\")";
mostCurrent._obj1.Target = mostCurrent._obj1.RunMethod("getPackageManager");
 //BA.debugLineNum = 923;BA.debugLine="Obj2.Target = Obj1.RunMethod2(\"getInstalledPackag";
mostCurrent._obj2.Target = mostCurrent._obj1.RunMethod2("getInstalledPackages",BA.NumberToString(0),"java.lang.int");
 //BA.debugLineNum = 924;BA.debugLine="size = Obj2.RunMethod(\"size\")";
_size = (int)(BA.ObjectToNumber(mostCurrent._obj2.RunMethod("size")));
 //BA.debugLineNum = 929;BA.debugLine="For i = 0 To size -1";
{
final int step9 = 1;
final int limit9 = (int) (_size-1);
for (_i = (int) (0) ; (step9 > 0 && _i <= limit9) || (step9 < 0 && _i >= limit9); _i = ((int)(0 + _i + step9)) ) {
 //BA.debugLineNum = 930;BA.debugLine="Obj3.Target = Obj2.RunMethod2(\"get\", i, \"java.la";
mostCurrent._obj3.Target = mostCurrent._obj2.RunMethod2("get",BA.NumberToString(_i),"java.lang.int");
 //BA.debugLineNum = 931;BA.debugLine="size = Obj2.RunMethod(\"size\")";
_size = (int)(BA.ObjectToNumber(mostCurrent._obj2.RunMethod("size")));
 //BA.debugLineNum = 933;BA.debugLine="Obj3.Target = Obj3.GetField(\"applicationInfo\") '";
mostCurrent._obj3.Target = mostCurrent._obj3.GetField("applicationInfo");
 //BA.debugLineNum = 934;BA.debugLine="flags = Obj3.GetField(\"flags\")";
_flags = (int)(BA.ObjectToNumber(mostCurrent._obj3.GetField("flags")));
 //BA.debugLineNum = 935;BA.debugLine="packName = Obj3.GetField(\"packageName\")";
mostCurrent._packname = BA.ObjectToString(mostCurrent._obj3.GetField("packageName"));
 //BA.debugLineNum = 937;BA.debugLine="If Bit.And(flags, 1)  = 0 Then";
if (anywheresoftware.b4a.keywords.Common.Bit.And(_flags,(int) (1))==0) { 
 //BA.debugLineNum = 940;BA.debugLine="args(0) = Obj3.Target";
mostCurrent._args[(int) (0)] = mostCurrent._obj3.Target;
 //BA.debugLineNum = 941;BA.debugLine="Types(0) = \"android.content.pm.ApplicationInfo\"";
mostCurrent._types[(int) (0)] = "android.content.pm.ApplicationInfo";
 //BA.debugLineNum = 942;BA.debugLine="name = Obj1.RunMethod4(\"getApplicationLabel\", a";
mostCurrent._name = BA.ObjectToString(mostCurrent._obj1.RunMethod4("getApplicationLabel",mostCurrent._args,mostCurrent._types));
 //BA.debugLineNum = 943;BA.debugLine="icon = Obj1.RunMethod4(\"getApplicationIcon\", ar";
mostCurrent._icon.setObject((android.graphics.drawable.BitmapDrawable)(mostCurrent._obj1.RunMethod4("getApplicationIcon",mostCurrent._args,mostCurrent._types)));
 //BA.debugLineNum = 945;BA.debugLine="list3.Add(packName)";
mostCurrent._list3.Add((Object)(mostCurrent._packname));
 //BA.debugLineNum = 948;BA.debugLine="phlis.Add(icon.Bitmap)";
mostCurrent._phlis.Add((Object)(mostCurrent._icon.getBitmap()));
 //BA.debugLineNum = 951;BA.debugLine="Dim form As Int";
_form = 0;
 //BA.debugLineNum = 952;BA.debugLine="form=File.Size(GetParentPath(GetSourceDir(GetAc";
_form = (int) (anywheresoftware.b4a.keywords.Common.File.Size(_getparentpath(_getsourcedir(_getactivitiesinfo(mostCurrent._packname))),_getfilename(_getsourcedir(_getactivitiesinfo(mostCurrent._packname)))));
 //BA.debugLineNum = 953;BA.debugLine="datalist.Add(form)";
mostCurrent._datalist.Add((Object)(_form));
 //BA.debugLineNum = 954;BA.debugLine="lv2.AddTwoLinesAndBitmap2(name,packName&\" - \"&F";
...
public static String  _button1_click() throws Exception{
 //BA.debugLineNum = 755;BA.debugLine="Sub Button1_Click";
 //BA.debugLineNum = 756;BA.debugLine="StartActivity(klo)";
...
public static String  _button2_click() throws Exception{
 //BA.debugLineNum = 575;BA.debugLine="Sub button2_click";
 //BA.debugLineNum = 577;BA.debugLine="End Sub";
return "";
}
public static String  _button3_click() throws Exception{
 //BA.debugLineNum = 792;BA.debugLine="Sub Button3_Click";
 //BA.debugLineNum = 793;BA.debugLine="StartActivity(sys)";
...
public static String  _button4_click() throws Exception{
 //BA.debugLineNum = 618;BA.debugLine="Sub Button4_Click";
 //BA.debugLineNum = 619;BA.debugLine="CallSubDelayed(cool,\"c_start\")";
...
anywheresoftware.b4a.objects.streams.File.OutputStreamWrapper _out = null;
 //BA.debugLineNum = 964;BA.debugLine="Sub BytesToFile (Dir As String, FileName As String";
 //BA.debugLineNum = 965;BA.debugLine="Dim out As OutputStream = File.OpenOutput(Dir, Fi";
...
_out = anywheresoftware.b4a.keywords.Common.File.OpenOutput(_dir,_filename,anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 966;BA.debugLine="out.WriteBytes(Data, 0, Data.Length)";
_out.WriteBytes(_data,(int) (0),_data.length);
 //BA.debugLineNum = 967;BA.debugLine="out.Close";
_out.Close();
...
long _size1 = 0L;
String _f = "";
 //BA.debugLineNum = 713;BA.debugLine="Sub CalcSize(Folder As String, recursive As Boolea";
 //BA.debugLineNum = 714;BA.debugLine="Dim size1 As Long";
_size1 = 0L;
 //BA.debugLineNum = 715;BA.debugLine="For Each f As String In File.ListFiles(Folder)";
...
_f = BA.ObjectToString(group2.Get(index2));
 //BA.debugLineNum = 716;BA.debugLine="If recursive Then";
if (_recursive) { 
 //BA.debugLineNum = 717;BA.debugLine="If File.IsDirectory(Folder, f) Then";
if (anywheresoftware.b4a.keywords.Common.File.IsDirectory(_folder,_f)) { 
 //BA.debugLineNum = 718;BA.debugLine="size1 = size1 + CalcSize(File.Combine(Folder,";
_size1 = (long) (_size1+_calcsize(anywheresoftware.b4a.keywords.Common.File.Combine(_folder,_f),_recursive));
 };
 };
 //BA.debugLineNum = 721;BA.debugLine="size1 = size1 + File.Size(Folder, f)";
_size1 = (long) (_size1+anywheresoftware.b4a.keywords.Common.File.Size(_folder,_f));
 }
;
 //BA.debugLineNum = 723;BA.debugLine="Return size1";
...
int _res = 0;
 //BA.debugLineNum = 759;BA.debugLine="Sub cl_click As Boolean";
 //BA.debugLineNum = 770;BA.debugLine="Dim res As Int";
_res = 0;
 //BA.debugLineNum = 771;BA.debugLine="res=Msgbox2(cs.Initialize.Alignment(\"ALIGN_CENTER";
_res = anywheresoftware.b4a.keywords.Common.Msgbox2(BA.ObjectToCharSequence(_cs.Initialize().Alignment(BA.getEnumFromString(android.text.Layout.Alignment.class,"ALIGN_CENTER")).Append(BA.ObjectToCharSequence(("pp wird geschlossen Service Notification läuft im Hintergrund Prozess, zum deaktivieren bitte 'Settings->Start/stop Notify Service'.!\",\"Bat-CaT beenden:"))).PopAll().getObject()),BA.ObjectToCharSequence(_cs.Initialize().Typeface(anywheresoftware.b4a.keywords.Common.Typeface.getFONTAWESOME()).Color((int) (0xff01ff20)).Size((int) (40)).PopAll().getObject()),"ja","Abbruch","",(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Power.png").getObject()),mostCurrent.activityBA);
 //BA.debugLineNum = 773;BA.debugLine="If res=DialogResponse.POSITIVE Then";
if (_res==anywheresoftware.b4a.keywords.Common.DialogResponse.POSITIVE) { 
 //BA.debugLineNum = 774;BA.debugLine="Activity.Finish";
mostCurrent._activity.Finish();
 }else {
 //BA.debugLineNum = 776;BA.debugLine="If res=DialogResponse.CANCEL Then";
if (_res==anywheresoftware.b4a.keywords.Common.DialogResponse.CANCEL) { 
 //BA.debugLineNum = 777;BA.debugLine="ToastMessageShow(\"zurück..\",False)";
...
public static String  _cli_click() throws Exception{
 //BA.debugLineNum = 982;BA.debugLine="Sub cli_click";
 //BA.debugLineNum = 984;BA.debugLine="StartActivity(cool)";
...
int _rst = 0;
int _status = 0;
 //BA.debugLineNum = 797;BA.debugLine="Sub device_BatteryChanged (level As Int, Scale As";
 //BA.debugLineNum = 798;BA.debugLine="li2";
_li2();
 //BA.debugLineNum = 800;BA.debugLine="ImageView2.Visible=True";
mostCurrent._imageview2.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 801;BA.debugLine="Dim val,hours,minutes,rst As Int";
_val = 0;
_hours = 0;
_minutes = 0;
_rst = 0;
 //BA.debugLineNum = 803;BA.debugLine="Dim status As Int = Intent.GetExtra(\"voltage\")";
_status = (int)(BA.ObjectToNumber(_intent.GetExtra("voltage")));
 //BA.debugLineNum = 804;BA.debugLine="Label1.Visible=True";
mostCurrent._label1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 805;BA.debugLine="File.WriteString(File.DirDefaultExternal&\"/mnt/ca";
anywheresoftware.b4a.keywords.Common.File.WriteString(anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal()+"/mnt/cache","lvl.txt",BA.NumberToString(_level));
 //BA.debugLineNum = 806;BA.debugLine="File.WriteString(File.DirDefaultExternal&\"/mnt/ca";
anywheresoftware.b4a.keywords.Common.File.WriteString(anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal()+"/mnt/cache","volt.txt",mostCurrent._volt);
 //BA.debugLineNum = 808;BA.debugLine="Label6.Text=level&\"%\"";
mostCurrent._label6.setText(BA.ObjectToCharSequence(BA.NumberToString(_level)+"%"));
 //BA.debugLineNum = 809;BA.debugLine="If prog.IsInitialized=True Then";
if (mostCurrent._prog.IsInitialized()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 811;BA.debugLine="prog.SetProgress(360/Scale*level)";
mostCurrent._prog._setprogress((int) (360/(double)_scale*_level));
 }else {
 };
 //BA.debugLineNum = 819;BA.debugLine="If Plugged=True Then";
if (_plugged==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 820;BA.debugLine="ImageView2.Bitmap=usb1";
mostCurrent._imageview2.setBitmap((android.graphics.Bitmap)(mostCurrent._usb1.getObject()));
 //BA.debugLineNum = 822;BA.debugLine="If level=100 Then";
if (_level==100) { 
 //BA.debugLineNum = 823;BA.debugLine="ImageView2.Bitmap=usb1";
mostCurrent._imageview2.setBitmap((android.graphics.Bitmap)(mostCurrent._usb1.getObject()));
 };
 //BA.debugLineNum = 826;BA.debugLine="rst=level*status/1000";
_rst = (int) (_level*_status/(double)1000);
 //BA.debugLineNum = 827;BA.debugLine="Log(rst)'status/Scale*level/60";
anywheresoftware.b4a.keywords.Common.Log(BA.NumberToString(_rst));
 //BA.debugLineNum = 828;BA.debugLine="val =rst'/60";
_val = _rst;
 //BA.debugLineNum = 829;BA.debugLine="hours = Floor(val / 60)";
_hours = (int) (anywheresoftware.b4a.keywords.Common.Floor(_val/(double)60));
 //BA.debugLineNum = 830;BA.debugLine="minutes = val Mod 60";
_minutes = (int) (_val%60);
 //BA.debugLineNum = 831;BA.debugLine="Label4.Text=\"voll in: \"&hours&\"h,\"&minutes&\"min\"";
mostCurrent._label4.setText(BA.ObjectToCharSequence("voll in: "+BA.NumberToString(_hours)+"h,"+BA.NumberToString(_minutes)+"min"));
 //BA.debugLineNum = 832;BA.debugLine="If level <= 60 Then";
if (_level<=60) { 
 //BA.debugLineNum = 833;BA.debugLine="ImageView2.Bitmap=usb2";
mostCurrent._imageview2.setBitmap((android.graphics.Bitmap)(mostCurrent._usb2.getObject()));
 };
 //BA.debugLineNum = 835;BA.debugLine="If level<=20 Then";
if (_level<=20) { 
 //BA.debugLineNum = 836;BA.debugLine="ImageView2.Bitmap=usb3";
mostCurrent._imageview2.setBitmap((android.graphics.Bitmap)(mostCurrent._usb3.getObject()));
 };
 }else {
 //BA.debugLineNum = 839;BA.debugLine="If level<=5 Then";
if (_level<=5) { 
 //BA.debugLineNum = 840;BA.debugLine="Label1.TextColor=Colors.Red";
mostCurrent._label1.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Red);
 //BA.debugLineNum = 841;BA.debugLine="Label1.TextSize=15";
mostCurrent._label1.setTextSize((float) (15));
 //BA.debugLineNum = 842;BA.debugLine="Label1.Text=\"Akku laden!\"";
mostCurrent._label1.setText(BA.ObjectToCharSequence("Akku laden!"));
 //BA.debugLineNum = 843;BA.debugLine="low_power";
_low_power();
 };
 //BA.debugLineNum = 847;BA.debugLine="val =level*1000 / 60";
...
_minutes = (int) (_val%60);
 //BA.debugLineNum = 850;BA.debugLine="Label4.Text= \"noch: \"&hours&\"h,\"&minutes&\"min\"";
mostCurrent._label4.setText(BA.ObjectToCharSequence("noch: "+BA.NumberToString(_hours)+"h,"+BA.NumberToString(_minutes)+"min"));
 //BA.debugLineNum = 852;BA.debugLine="If level <= 100 Then";
if (_level<=100) { 
 //BA.debugLineNum = 855;BA.debugLine="ImageView2.Bitmap=bat100";
mostCurrent._imageview2.setBitmap((android.graphics.Bitmap)(mostCurrent._bat100.getObject()));
 };
 //BA.debugLineNum = 857;BA.debugLine="If level <= 80 Then";
if (_level<=80) { 
 //BA.debugLineNum = 858;BA.debugLine="ImageView2.Bitmap=bat80";
mostCurrent._imageview2.setBitmap((android.graphics.Bitmap)(mostCurrent._bat80.getObject()));
 };
 //BA.debugLineNum = 861;BA.debugLine="If level <= 60 Then";
if (_level<=60) { 
 //BA.debugLineNum = 863;BA.debugLine="ImageView2.Bitmap=bat60";
mostCurrent._imageview2.setBitmap((android.graphics.Bitmap)(mostCurrent._bat60.getObject()));
 };
 //BA.debugLineNum = 865;BA.debugLine="If level <= 40 Then";
if (_level<=40) { 
 //BA.debugLineNum = 866;BA.debugLine="ImageView2.Bitmap=bat40";
mostCurrent._imageview2.setBitmap((android.graphics.Bitmap)(mostCurrent._bat40.getObject()));
 };
 //BA.debugLineNum = 869;BA.debugLine="If level<=20 Then";
if (_level<=20) { 
 //BA.debugLineNum = 870;BA.debugLine="ImageView2.Bitmap=bat20";
mostCurrent._imageview2.setBitmap((android.graphics.Bitmap)(mostCurrent._bat20.getObject()));
 };
 //BA.debugLineNum = 872;BA.debugLine="If level = 5 Then";
if (_level==5) { 
 //BA.debugLineNum = 873;BA.debugLine="ImageView2.Bitmap=batlow";
mostCurrent._imageview2.setBitmap((android.graphics.Bitmap)(mostCurrent._batlow.getObject()));
 };
 //BA.debugLineNum = 875;BA.debugLine="If level < 4 Then";
if (_level<4) { 
 //BA.debugLineNum = 876;BA.debugLine="ImageView2.Bitmap=ulow";
mostCurrent._imageview2.setBitmap((android.graphics.Bitmap)(mostCurrent._ulow.getObject()));
 };
 //BA.debugLineNum = 878;BA.debugLine="If temp >=41 Then";
...
public static String  _device_devicestorageok(anywheresoftware.b4a.objects.IntentWrapper _intent) throws Exception{
 //BA.debugLineNum = 323;BA.debugLine="Sub  device_DeviceStorageOk (Intent As Intent)";
 //BA.debugLineNum = 324;BA.debugLine="Log(Intent)";
...
public static String  _fc_copydone(String _key,boolean _error) throws Exception{
 //BA.debugLineNum = 974;BA.debugLine="Sub fc_CopyDone(Key As String, Error As Boolean)";
 //BA.debugLineNum = 976;BA.debugLine="End Sub";
return "";
}
public static byte[]  _filetobytes(String _dir,String _filename) throws Exception{
 //BA.debugLineNum = 970;BA.debugLine="Sub FileToBytes (Dir As String, FileName As String";
 //BA.debugLineNum = 971;BA.debugLine="Return Bit.InputStreamToBytes(File.OpenInput(Dir,";
...
public static String  _floatingactionbutton1_click() throws Exception{
 //BA.debugLineNum = 320;BA.debugLine="Sub FloatingActionButton1_Click";
 //BA.debugLineNum = 321;BA.debugLine="CallSubDelayed(cool,Null)";
...
double _si = 0;
int _i = 0;
 //BA.debugLineNum = 726;BA.debugLine="Sub FormatFileSize(Bytes As Float) As String";
 //BA.debugLineNum = 728;BA.debugLine="Private Unit() As String = Array As String(\" Byte";
_unit = new String[]{" Byte"," KB"," MB"," GB"," TB"," PB"," EB"," ZB"," YB"};
 //BA.debugLineNum = 730;BA.debugLine="If Bytes = 0 Then";
if (_bytes==0) { 
 //BA.debugLineNum = 732;BA.debugLine="Return \"0 Bytes\"";
if (true) return "0 Bytes";
 }else {
 //BA.debugLineNum = 736;BA.debugLine="Private Po, Si As Double";
_po = 0;
_si = 0;
 //BA.debugLineNum = 737;BA.debugLine="Private I As Int";
_i = 0;
 //BA.debugLineNum = 739;BA.debugLine="Bytes = Abs(Bytes)";
_bytes = (float) (anywheresoftware.b4a.keywords.Common.Abs(_bytes));
 //BA.debugLineNum = 741;BA.debugLine="I = Floor(Logarithm(Bytes, 1024))";
_i = (int) (anywheresoftware.b4a.keywords.Common.Floor(anywheresoftware.b4a.keywords.Common.Logarithm(_bytes,1024)));
 //BA.debugLineNum = 742;BA.debugLine="Po = Power(1024, I)";
_po = anywheresoftware.b4a.keywords.Common.Power(1024,_i);
 //BA.debugLineNum = 743;BA.debugLine="Si = Bytes / Po";
_si = _bytes/(double)_po;
 //BA.debugLineNum = 745;BA.debugLine="Return NumberFormat(Si, 1, 2) & Unit(I)";
...
anywheresoftware.b4a.agraham.reflection.Reflection _r = null;
 //BA.debugLineNum = 1009;BA.debugLine="Sub GetActivitiesInfo(package As String) As Object";
 //BA.debugLineNum = 1010;BA.debugLine="Dim r As Reflector";
_r = new anywheresoftware.b4a.agraham.reflection.Reflection();
 //BA.debugLineNum = 1011;BA.debugLine="r.Target = r.GetContext";
_r.Target = (Object)(_r.GetContext(processBA));
 //BA.debugLineNum = 1012;BA.debugLine="r.Target = r.RunMethod(\"getPackageManager\")";
_r.Target = _r.RunMethod("getPackageManager");
 //BA.debugLineNum = 1013;BA.debugLine="r.Target = r.RunMethod3(\"getPackageInfo\", package";
_r.Target = _r.RunMethod3("getPackageInfo",_package,"java.lang.String",BA.NumberToString(0x00000001),"java.lang.int");
 //BA.debugLineNum = 1014;BA.debugLine="Return r.GetField(\"applicationInfo\")";
...
public static String  _getfilename(String _fullpath) throws Exception{
 //BA.debugLineNum = 978;BA.debugLine="Sub GetFileName(FullPath As String) As String";
 //BA.debugLineNum = 979;BA.debugLine="Return FullPath.SubString(FullPath.LastIndexOf(\"/";
...
String _path1 = "";
 //BA.debugLineNum = 990;BA.debugLine="Sub GetParentPath(Path As String) As String";
 //BA.debugLineNum = 991;BA.debugLine="Dim Path1 As String";
_path1 = "";
 //BA.debugLineNum = 992;BA.debugLine="If Path = \"/\" Then";
if ((_path).equals("/")) { 
 //BA.debugLineNum = 993;BA.debugLine="Return \"/\"";
if (true) return "/";
 };
 //BA.debugLineNum = 995;BA.debugLine="L = Path.LastIndexOf(\"/\")";
mostCurrent._l = BA.NumberToString(_path.lastIndexOf("/"));
 //BA.debugLineNum = 996;BA.debugLine="If L = Path.Length - 1 Then";
if ((mostCurrent._l).equals(BA.NumberToString(_path.length()-1))) { 
 //BA.debugLineNum = 998;BA.debugLine="Path1 = Path.SubString2(0,L)";
_path1 = _path.substring((int) (0),(int)(Double.parseDouble(mostCurrent._l)));
 }else {
 //BA.debugLineNum = 1000;BA.debugLine="Path1 = Path";
_path1 = _path;
 };
 //BA.debugLineNum = 1002;BA.debugLine="L = Path.LastIndexOf(\"/\")";
mostCurrent._l = BA.NumberToString(_path.lastIndexOf("/"));
 //BA.debugLineNum = 1003;BA.debugLine="If L = 0 Then";
if ((mostCurrent._l).equals(BA.NumberToString(0))) { 
 //BA.debugLineNum = 1004;BA.debugLine="L = 1";
mostCurrent._l = BA.NumberToString(1);
 };
 //BA.debugLineNum = 1006;BA.debugLine="Return Path1.SubString2(0,L)";
...
anywheresoftware.b4a.agraham.reflection.Reflection _r = null;
 //BA.debugLineNum = 1017;BA.debugLine="Sub GetSourceDir(AppInfo As Object) As String";
 //BA.debugLineNum = 1018;BA.debugLine="Try";
try { //BA.debugLineNum = 1019;BA.debugLine="Dim r As Reflector";
_r = new anywheresoftware.b4a.agraham.reflection.Reflection();
 //BA.debugLineNum = 1020;BA.debugLine="r.Target = AppInfo";
_r.Target = _appinfo;
 //BA.debugLineNum = 1021;BA.debugLine="Return r.GetField(\"sourceDir\")";
if (true) return BA.ObjectToString(_r.GetField("sourceDir"));
 } 
       catch (Exception e6) {
			processBA.setLastException(e6); //BA.debugLineNum = 1023;BA.debugLine="Return \"\"";
if (true) return "";
 };
...
public static String  _globals() throws Exception{
 ...
 //BA.debugLineNum = 26;BA.debugLine="Private ProgressBar1 As ProgressBar";
mostCurrent._progressbar1 = new anywheresoftware.b4a.objects.ProgressBarWrapper();
 //BA.debugLineNum = 27;BA.debugLine="Private ra As OperatingSystem";
mostCurrent._ra = new com.rootsoft.oslibrary.OSLibrary();
 //BA.debugLineNum = 28;BA.debugLine="Dim device As PhoneEvents";
...
mostCurrent._temp = "";
mostCurrent._level1 = "";
 //BA.debugLineNum = 43;BA.debugLine="Private Panel2,panel3,lip,smlp As Panel";
...
mostCurrent._ramlist = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 71;BA.debugLine="Dim cat As Cache";
mostCurrent._cat = new flm.b4a.cache.Cache();
 //BA.debugLineNum = 72;BA.debugLine="Private prog As progress";
mostCurrent._prog = new com.batcat.progress();
 //BA.debugLineNum = 74;BA.debugLine="Dim fbc As ColorDrawable";
mostCurrent._fbc = new anywheresoftware.b4a.objects.drawable.ColorDrawable();
 //BA.debugLineNum = 75;BA.debugLine="Dim xml As XmlLayoutBuilder";
mostCurrent._xml = new anywheresoftware.b4a.object.XmlLayoutBuilder();
 //BA.debugLineNum = 76;BA.debugLine="Private ImageView1 As ImageView";
mostCurrent._imageview1 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 77;BA.debugLine="Private pgWheel1 As pgWheel";
mostCurrent._pgwheel1 = new de.donmanfred.pgWheel();
 //BA.debugLineNum = 78;BA.debugLine="Private ImageView2 As ImageView";
mostCurrent._imageview2 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 79;BA.debugLine="Dim bat20,bat40,bat60,bat80,bat100,batlow,usb1,us";
...
public static String  _inputlist_checkedchange(boolean _checked) throws Exception{
 //BA.debugLineNum = 986;BA.debugLine="Sub InputList_CheckedChange(Checked As Boolean)";
...
anywheresoftware.b4a.objects.LabelWrapper _la3 = null;
 //BA.debugLineNum = 580;BA.debugLine="Sub lab_set2";
 //BA.debugLineNum = 581;BA.debugLine="Dim la3 As Label";
_la3 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 582;BA.debugLine="ListView1.Invalidate";
mostCurrent._listview1.Invalidate();
 //BA.debugLineNum = 583;BA.debugLine="la=ListView1.TwoLinesAndBitmap.Label";
mostCurrent._la = mostCurrent._listview1.getTwoLinesAndBitmap().Label;
 //BA.debugLineNum = 584;BA.debugLine="la2=ListView1.TwoLinesAndBitmap.SecondLabel";
mostCurrent._la2 = mostCurrent._listview1.getTwoLinesAndBitmap().SecondLabel;
 //BA.debugLineNum = 585;BA.debugLine="la1=ListView1.TwoLinesLayout.Label";
mostCurrent._la1 = mostCurrent._listview1.getTwoLinesLayout().Label;
 //BA.debugLineNum = 586;BA.debugLine="la3=ListView1.TwoLinesLayout.SecondLabel";
_la3 = mostCurrent._listview1.getTwoLinesLayout().SecondLabel;
 //BA.debugLineNum = 587;BA.debugLine="la.TextSize=13";
mostCurrent._la.setTextSize((float) (13));
 //BA.debugLineNum = 588;BA.debugLine="la.TextColor=Colors.Black";
mostCurrent._la.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 589;BA.debugLine="la1.TextSize=13";
mostCurrent._la1.setTextSize((float) (13));
 //BA.debugLineNum = 590;BA.debugLine="la1.TextColor=Colors.Black";
mostCurrent._la1.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 591;BA.debugLine="la2.TextSize=11";
mostCurrent._la2.setTextSize((float) (11));
 //BA.debugLineNum = 592;BA.debugLine="la2.TextColor=Colors.ARGB(150,255,255,255)";
mostCurrent._la2.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (150),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 593;BA.debugLine="la3.TextColor=Colors.ARGB(100,255,255,255)";
_la3.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (100),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 594;BA.debugLine="la3.TextSize=10";
_la3.setTextSize((float) (10));
 //BA.debugLineNum = 595;BA.debugLine="la1.TextSize=12";
mostCurrent._la1.setTextSize((float) (12));
 //BA.debugLineNum = 596;BA.debugLine="la1.TextColor=Colors.ARGB(180,255,255,255)";
mostCurrent._la1.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (180),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 597;BA.debugLine="ListView1.TwoLinesAndBitmap.ImageView.Height=48di";
mostCurrent._listview1.getTwoLinesAndBitmap().ImageView.setHeight(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (48)));
 //BA.debugLineNum = 598;BA.debugLine="ListView1.TwoLinesAndBitmap.ImageView.Width=48dip";
mostCurrent._listview1.getTwoLinesAndBitmap().ImageView.setWidth(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (48)));
 //BA.debugLineNum = 599;BA.debugLine="ListView1.TwoLinesAndBitmap.ItemHeight=60dip";
mostCurrent._listview1.getTwoLinesAndBitmap().setItemHeight(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (60)));
 //BA.debugLineNum = 600;BA.debugLine="ListView1.SingleLineLayout.ItemHeight=60dip";
mostCurrent._listview1.getSingleLineLayout().setItemHeight(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (60)));
 //BA.debugLineNum = 601;BA.debugLine="ListView1.TwoLinesLayout.ItemHeight=50dip";
...
public static String  _label_text() throws Exception{
 //BA.debugLineNum = 634;BA.debugLine="Sub label_text";
 //BA.debugLineNum = 635;BA.debugLine="lk.TextSize=13";
mostCurrent._lk.setTextSize((float) (13));
 //BA.debugLineNum = 636;BA.debugLine="lk.TextColor=Colors.Black";
mostCurrent._lk.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 637;BA.debugLine="lk.Text=\"Version: \"&pak.GetVersionName(\"com.batca";
...
public static String  _label1_click() throws Exception{
 //BA.debugLineNum = 751;BA.debugLine="Sub Label1_Click";
 //BA.debugLineNum = 752;BA.debugLine="StartActivity(sys)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._sys.getObject()));
 //BA.debugLineNum = 753;BA.debugLine="End Sub";
return "";
}
public static String  _label4_click() throws Exception{
 //BA.debugLineNum = 895;BA.debugLine="Sub Label4_Click";
 //BA.debugLineNum = 896;BA.debugLine="StartActivity(sys)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._sys.getObject()));
...
int _ti = 0;
int _h = 0;
 //BA.debugLineNum = 689;BA.debugLine="Sub li2 As Boolean";
 //BA.debugLineNum = 690;BA.debugLine="list2.Clear";
mostCurrent._list2.Clear();
 //BA.debugLineNum = 691;BA.debugLine="list4.Clear";
mostCurrent._list4.Clear();
 //BA.debugLineNum = 692;BA.debugLine="list5.Clear";
mostCurrent._list5.Clear();
 //BA.debugLineNum = 693;BA.debugLine="list6.Clear";
mostCurrent._list6.Clear();
 //BA.debugLineNum = 694;BA.debugLine="proc.Clear";
mostCurrent._proc.Clear();
 //BA.debugLineNum = 695;BA.debugLine="ramlist.Clear";
mostCurrent._ramlist.Clear();
 //BA.debugLineNum = 696;BA.debugLine="li3";
_li3();
 //BA.debugLineNum = 697;BA.debugLine="proc=ra.getRecentTasks(99,0)";
mostCurrent._proc.setObject((java.util.List)(mostCurrent._ra.getRecentTasks((int) (99),(int) (0))));
 //BA.debugLineNum = 698;BA.debugLine="list2=ra.RunningServiceInfo(999,list4,list5,list6";
mostCurrent._list2.setObject((java.util.List)(mostCurrent._ra.RunningServiceInfo((int) (999),(java.util.List)(mostCurrent._list4.getObject()),(java.util.List)(mostCurrent._list5.getObject()),(java.util.List)(mostCurrent._list6.getObject()))));
 //BA.debugLineNum = 701;BA.debugLine="Dim math1 As Int";
_math1 = 0;
 //BA.debugLineNum = 702;BA.debugLine="math1=proc.Size+list4.Size*1000*1024*10";
_math1 = (int) (mostCurrent._proc.getSize()+mostCurrent._list4.getSize()*1000*1024*10);
 //BA.debugLineNum = 703;BA.debugLine="Dim ti As Int=proc.Size+list4.Size";
_ti = (int) (mostCurrent._proc.getSize()+mostCurrent._list4.getSize());
 //BA.debugLineNum = 705;BA.debugLine="For h = 0 To  list4.size-1";
{
final int step13 = 1;
...
for (_h = (int) (0) ; (step13 > 0 && _h <= limit13) || (step13 < 0 && _h >= limit13); _h = ((int)(0 + _h + step13)) ) {
 //BA.debugLineNum = 707;BA.debugLine="ProgressBar1.Progress=h";
mostCurrent._progressbar1.setProgress(_h);
 //BA.debugLineNum = 708;BA.debugLine="Label5.Text=ti&\"% \"&FormatFileSize(math1)";
mostCurrent._label5.setText(BA.ObjectToCharSequence(BA.NumberToString(_ti)+"% "+_formatfilesize((float) (_math1))));
 }
};
 //BA.debugLineNum = 710;BA.debugLine="Return(True)";
if (true) return (anywheresoftware.b4a.keywords.Common.True);
...
int _az = 0;
int _g = 0;
 //BA.debugLineNum = 648;BA.debugLine="Sub li3";
 //BA.debugLineNum = 649;BA.debugLine="app_info";
_app_info();
 //BA.debugLineNum = 650;BA.debugLine="volt=bat.BatteryInformation(7)/1000";
mostCurrent._volt = BA.NumberToString(mostCurrent._bat._getbatteryinformation()[(int) (7)]/(double)1000);
 //BA.debugLineNum = 651;BA.debugLine="temp=bat.BatteryInformation(6)/10";
mostCurrent._temp = BA.NumberToString(mostCurrent._bat._getbatteryinformation()[(int) (6)]/(double)10);
 //BA.debugLineNum = 652;BA.debugLine="Dim piclist As List";
_piclist = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 653;BA.debugLine="piclist.Initialize";
_piclist.Initialize();
 //BA.debugLineNum = 654;BA.debugLine="sd=LoadBitmap(File.DirAssets,\"ic_sim_card_black_2";
mostCurrent._sd = anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_sim_card_black_24dp.png");
 //BA.debugLineNum = 655;BA.debugLine="sdi=LoadBitmap(File.DirAssets,\"ic_sim_card_white_";
mostCurrent._sdi = anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_sim_card_white_24dp.png");
 //BA.debugLineNum = 656;BA.debugLine="Dim si,st As Int";
_si = 0;
_st = 0;
 //BA.debugLineNum = 657;BA.debugLine="st=ra.TotalExternalMemorySize+ra.TotalInternalMem";
_st = (int) (mostCurrent._ra.getTotalExternalMemorySize()+mostCurrent._ra.getTotalInternalMemorySize());
 //BA.debugLineNum = 659;BA.debugLine="si=ra.AvailableExternalMemorySize+ra.AvailableInt";
_si = (int) (mostCurrent._ra.getAvailableExternalMemorySize()+mostCurrent._ra.getAvailableInternalMemorySize());
 //BA.debugLineNum = 661;BA.debugLine="ListView1.Clear";
mostCurrent._listview1.Clear();
 //BA.debugLineNum = 662;BA.debugLine="If ra.externalMemoryAvailable Then";
if (mostCurrent._ra.externalMemoryAvailable()) { 
 //BA.debugLineNum = 664;BA.debugLine="Dim lz,az As Int";
_lz = 0;
_az = 0;
 //BA.debugLineNum = 666;BA.debugLine="For Each g As Int  In datalist";
...
_g = (int)(BA.ObjectToNumber(group14.Get(index14)));
 //BA.debugLineNum = 668;BA.debugLine="lz=g";
_lz = _g;
 //BA.debugLineNum = 669;BA.debugLine="az=lz*1024*1024*10";
_az = (int) (_lz*1024*1024*10);
 }
;
 //BA.debugLineNum = 671;BA.debugLine="Log(\"SUB-> \"&FormatFileSize(az))";
anywheresoftware.b4a.keywords.Common.Log("SUB-> "+_formatfilesize((float) (_az)));
 //BA.debugLineNum = 672;BA.debugLine="ListView1.AddTwoLinesAndbitmap2(\"SD Memory(Total";
mostCurrent._listview1.AddTwoLinesAndBitmap2(BA.ObjectToCharSequence("SD Memory(Total): "+_formatfilesize((float) (mostCurrent._ra.getTotalInternalMemorySize()))),BA.ObjectToCharSequence(BA.NumberToString(mostCurrent._list3.getSize())+" apps installiert("+_formatfilesize((float) (_az))+") auf: "+_getparentpath(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/Android")),(android.graphics.Bitmap)(mostCurrent._sd.getObject()),(Object)(2));
 //BA.debugLineNum = 674;BA.debugLine="ListView1.AddTwoLinesAndBitmap2(\"SD Used: \"&Form";
mostCurrent._listview1.AddTwoLinesAndBitmap2(BA.ObjectToCharSequence("SD Used: "+_formatfilesize((float) (_si-_st))),BA.ObjectToCharSequence(_getparentpath(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/Android")),(android.graphics.Bitmap)(mostCurrent._sd.getObject()),(Object)(3));
 //BA.debugLineNum = 676;BA.debugLine="ListView1.AddTwoLinesAndBitmap2(\"SD Free: \"&Form";
mostCurrent._listview1.AddTwoLinesAndBitmap2(BA.ObjectToCharSequence("SD Free: "+_formatfilesize((float) (mostCurrent._ra.getAvailableExternalMemorySize()+mostCurrent._ra.getAvailableInternalMemorySize()))),BA.ObjectToCharSequence(_getparentpath(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/Android")),(android.graphics.Bitmap)(mostCurrent._sd.getObject()),(Object)(4));
 //BA.debugLineNum = 677;BA.debugLine="ListView1.AddTwoLinesAndbitmap2(\"SD (Intern): \"&";
mostCurrent._listview1.AddTwoLinesAndBitmap2(BA.ObjectToCharSequence("SD (Intern): "+_formatfilesize((float) (mostCurrent._ra.getTotalInternalMemorySize()))),BA.ObjectToCharSequence(_getparentpath(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/Android")),(android.graphics.Bitmap)(mostCurrent._sdi.getObject()),(Object)(5));
 ...
 //BA.debugLineNum = 679;BA.debugLine="ListView1.AddTwoLinesAndbitmap2(\"SD Memory(Total";
mostCurrent._listview1.AddTwoLinesAndBitmap2(BA.ObjectToCharSequence("SD Memory(Total):"),BA.ObjectToCharSequence(_formatfilesize((float) (mostCurrent._ra.getTotalInternalMemorySize()+mostCurrent._ra.getTotalExternalMemorySize()))),(android.graphics.Bitmap)(mostCurrent._sd.getObject()),(Object)(2));
 //BA.debugLineNum = 680;BA.debugLine="ListView1.AddTwoLinesAndbitmap2(\"SD(Inten):\",For";
mostCurrent._listview1.AddTwoLinesAndBitmap2(BA.ObjectToCharSequence("SD(Inten):"),BA.ObjectToCharSequence(_formatfilesize((float) (mostCurrent._ra.getTotalInternalMemorySize()))),(android.graphics.Bitmap)(mostCurrent._sdi.getObject()),(Object)(5));
 //BA.debugLineNum = 681;BA.debugLine="ListView1.AddTwoLinesAndBitmap2(\"SD total Free:\"";
mostCurrent._listview1.AddTwoLinesAndBitmap2(BA.ObjectToCharSequence("SD total Free:"),BA.ObjectToCharSequence(_formatfilesize((float) (mostCurrent._ra.getAvailableExternalMemorySize()+mostCurrent._ra.getAvailableInternalMemorySize()))),(android.graphics.Bitmap)(mostCurrent._sd.getObject()),(Object)(4));
 //BA.debugLineNum = 682;BA.debugLine="ListView1.AddTwoLinesAndBitmap2(\"SD total Used:\"";
...
public static String  _listview1_itemclick(int _position,Object _value) throws Exception{
 //BA.debugLineNum = 899;BA.debugLine="Sub listview1_ItemClick (Position As Int, value As";
 //BA.debugLineNum = 900;BA.debugLine="If Position=0 Then";
if (_position==0) { 
 //BA.debugLineNum = 901;BA.debugLine="rl_lo";
_rl_lo();
 };
...
public static String  _loading_norm() throws Exception{
 //BA.debugLineNum = 905;BA.debugLine="Sub loading_norm";
 //BA.debugLineNum = 907;BA.debugLine="End Sub";
return "";
}
public static String  _low_power() throws Exception{
 //BA.debugLineNum = 910;BA.debugLine="Sub low_power";
...
anywheresoftware.b4a.objects.IntentWrapper _i = null;
 //BA.debugLineNum = 545;BA.debugLine="Sub lvMenu_ItemClick (Position As Int, Value As Ob";
 //BA.debugLineNum = 546;BA.debugLine="If Value = 0 Then";
if ((_value).equals((Object)(0))) { 
 //BA.debugLineNum = 547;BA.debugLine="opt_click";
_opt_click();
 //BA.debugLineNum = 548;BA.debugLine="slm.CloseSidebar";
mostCurrent._slm._closesidebar();
 };
 //BA.debugLineNum = 550;BA.debugLine="If Value=1 Then";
if ((_value).equals((Object)(1))) { 
 //BA.debugLineNum = 551;BA.debugLine="cl_click";
_cl_click();
 //BA.debugLineNum = 552;BA.debugLine="slm.CloseSidebar";
mostCurrent._slm._closesidebar();
 };
 //BA.debugLineNum = 554;BA.debugLine="If Value=2 Then";
if ((_value).equals((Object)(2))) { 
 //BA.debugLineNum = 555;BA.debugLine="Dim i As Intent";
_i = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 556;BA.debugLine="i.Initialize( \"android.intent.action.POWER_USAGE";
_i.Initialize("android.intent.action.POWER_USAGE_SUMMARY","");
 //BA.debugLineNum = 557;BA.debugLine="slm.CloseSidebar";
mostCurrent._slm._closesidebar();
 //BA.debugLineNum = 558;BA.debugLine="StartActivity(i)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_i.getObject()));
 };
 //BA.debugLineNum = 560;BA.debugLine="If Value=3 Then";
if ((_value).equals((Object)(3))) { 
 //BA.debugLineNum = 561;BA.debugLine="StartActivity(klo)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._klo.getObject()));
 //BA.debugLineNum = 562;BA.debugLine="slm.CloseSidebar";
mostCurrent._slm._closesidebar();
 };
 //BA.debugLineNum = 564;BA.debugLine="If Value=4 Then";
if ((_value).equals((Object)(4))) { 
 //BA.debugLineNum = 565;BA.debugLine="StartActivity(sys)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._sys.getObject()));
 //BA.debugLineNum = 566;BA.debugLine="cl_click";
_cl_click();
 //BA.debugLineNum = 567;BA.debugLine="slm.CloseSidebar";
mostCurrent._slm._closesidebar();
 };
 //BA.debugLineNum = 569;BA.debugLine="If Value=5 Then";
if ((_value).equals((Object)(5))) { 
 //BA.debugLineNum = 570;BA.debugLine="pci_click";
_pci_click();
 //BA.debugLineNum = 571;BA.debugLine="slm.CloseSidebar";
mostCurrent._slm._closesidebar();
 };
...
public static String  _menu_onfullyclosed() throws Exception{
 ...
 //BA.debugLineNum = 375;BA.debugLine="Button4.Visible=True";
...
mostCurrent._button4.BringToFront();
 //BA.debugLineNum = 378;BA.debugLine="Button4.SetLayoutAnimated(100,20%x,50%y,60%x,105";
mostCurrent._button4.SetLayoutAnimated((int) (100),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (20),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (50),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (60),mostCurrent.activityBA),(int) (105));
 //BA.debugLineNum = 379;BA.debugLine="ImageView2.SetLayoutAnimated(100,40%x,5%y,20%x,40";
mostCurrent._imageview2.SetLayoutAnimated((int) (100),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (40),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (5),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (20),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (40),mostCurrent.activityBA));
 //BA.debugLineNum = 380;BA.debugLine="Label1.SetLayout(40%x,40%y,40%x,90dip)";
mostCurrent._label1.SetLayout(anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (40),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (40),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (40),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (90)));
 //BA.debugLineNum = 381;BA.debugLine="Button4.TextSize=18";
mostCurrent._button4.setTextSize((float) (18));
 //BA.debugLineNum = 382;BA.debugLine="ImageView2.SetVisibleAnimated(100,True)";
mostCurrent._imageview2.SetVisibleAnimated((int) (100),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 383;BA.debugLine="Label2.SetVisibleAnimated(100,True)";
mostCurrent._label2.SetVisibleAnimated((int) (100),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 384;BA.debugLine="Label4.SetVisibleAnimated(100,True)";
mostCurrent._label4.SetVisibleAnimated((int) (100),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 386;BA.debugLine="If prog.IsInitialized=True Then";
if (mostCurrent._prog.IsInitialized()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 387;BA.debugLine="prog.BringToFront";
mostCurrent._prog._bringtofront();
 }else {
 //BA.debugLineNum = 389;BA.debugLine="prog_init";
_prog_init();
 };
...
public static String  _menu_onfullyopen() throws Exception{
 //BA.debugLineNum = 347;BA.debugLine="Sub Menu_onFullyOpen";
 //BA.debugLineNum = 348;BA.debugLine="If prog.IsInitialized=True Then";
if (mostCurrent._prog.IsInitialized()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 349;BA.debugLine="prog.SendToBack";
mostCurrent._prog._sendtoback();
 }else {
 };
 //BA.debugLineNum = 353;BA.debugLine="lvMenu.BringToFront";
mostCurrent._lvmenu.BringToFront();
 //BA.debugLineNum = 354;BA.debugLine="smlp.BringToFront";
mostCurrent._smlp.BringToFront();
 //BA.debugLineNum = 355;BA.debugLine="slm.Sidebar.BringToFront";
mostCurrent._slm._sidebar().BringToFront();
 //BA.debugLineNum = 356;BA.debugLine="lvMenu.BringToFront";
mostCurrent._lvmenu.BringToFront();
 //BA.debugLineNum = 357;BA.debugLine="ImageView2.Visible=False";
mostCurrent._imageview2.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 358;BA.debugLine="Button4.SendToBack";
mostCurrent._button4.SendToBack();
 //BA.debugLineNum = 359;BA.debugLine="ProgressBar1.SendToBack";
mostCurrent._progressbar1.SendToBack();
 //BA.debugLineNum = 360;BA.debugLine="Button4.SetLayoutAnimated(100,0%x,50%y,20%x,105)";
mostCurrent._button4.SetLayoutAnimated((int) (100),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (0),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (50),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (20),mostCurrent.activityBA),(int) (105));
 //BA.debugLineNum = 362;BA.debugLine="Button4.Visible=False";
mostCurrent._button4.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 363;BA.debugLine="Label1.SetLayout(40%x,40%y,40%x,90dip)";
mostCurrent._label1.SetLayout(anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (40),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (40),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (40),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (90)));
 //BA.debugLineNum = 364;BA.debugLine="Button4.TextSize=10";
mostCurrent._button4.setTextSize((float) (10));
 //BA.debugLineNum = 365;BA.debugLine="ImageView2.SetVisibleAnimated(100,False)";
mostCurrent._imageview2.SetVisibleAnimated((int) (100),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 366;BA.debugLine="Label6.SetVisibleAnimated(100,False)";
mostCurrent._label6.SetVisibleAnimated((int) (100),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 367;BA.debugLine="Label2.SetVisibleAnimated(100,False)";
mostCurrent._label2.SetVisibleAnimated((int) (100),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 368;BA.debugLine="Label4.SetVisibleAnimated(100,False)";
...
public static String  _menu_onmove(boolean _isopening) throws Exception{
 //BA.debugLineNum = 393;BA.debugLine="Sub Menu_onMove (IsOpening As Boolean)";
 //BA.debugLineNum = 394;BA.debugLine="If IsOpening=True Then";
if (_isopening==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 395;BA.debugLine="Button4.SetTextSizeAnimated(50,10)";
mostCurrent._button4.SetTextSizeAnimated((int) (50),(float) (10));
 //BA.debugLineNum = 396;BA.debugLine="ImageView2.SetLayoutAnimated(100,0%x,5%y,40%x,40";
mostCurrent._imageview2.SetLayoutAnimated((int) (100),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (0),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (5),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (40),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (40),mostCurrent.activityBA));
 //BA.debugLineNum = 397;BA.debugLine="Label6.SetVisibleAnimated(100,True)";
mostCurrent._label6.SetVisibleAnimated((int) (100),anywheresoftware.b4a.keywords.Common.True);
 };
...
int _hours = 0;
int _minutes = 0;
 //BA.debugLineNum = 887;BA.debugLine="Sub minutes_hours ( ms As Int ) As String";
 //BA.debugLineNum = 888;BA.debugLine="Dim val,hours,minutes As Int";
_val = 0;
_hours = 0;
_minutes = 0;
 //BA.debugLineNum = 889;BA.debugLine="val = ms";
_val = _ms;
 //BA.debugLineNum = 890;BA.debugLine="hours = Floor(val / 60)";
_hours = (int) (anywheresoftware.b4a.keywords.Common.Floor(_val/(double)60));
 //BA.debugLineNum = 891;BA.debugLine="minutes = val Mod 60";
_minutes = (int) (_val%60);
 //BA.debugLineNum = 892;BA.debugLine="Return NumberFormat(hours, 1, 0) & \":\" & NumberFo";
...
public static String  _opt_click() throws Exception{
 //BA.debugLineNum = 622;BA.debugLine="Sub opt_click";
 //BA.debugLineNum = 623;BA.debugLine="StartActivity(settings)";
...
public static String  _pci_click() throws Exception{
 //BA.debugLineNum = 640;BA.debugLine="Sub pci_click";
 //BA.debugLineNum = 641;BA.debugLine="cd.AddView(panel3,-1,350)";
mostCurrent._cd.AddView((android.view.View)(mostCurrent._panel3.getObject()),(int) (-1),(int) (350));
 //BA.debugLineNum = 642;BA.debugLine="cd.Show(\"About Batt-Cat: \",\"\",\"Got It\",\"\",LoadBit";
mostCurrent._cd.Show("About Batt-Cat: ","","Got It","",mostCurrent.activityBA,(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Rss.png").getObject()));
 //BA.debugLineNum = 643;BA.debugLine="If Not (cd2.Response=DialogResponse.CANCEL) Then";
if (anywheresoftware.b4a.keywords.Common.Not(mostCurrent._cd2.getResponse()==anywheresoftware.b4a.keywords.Common.DialogResponse.CANCEL)) { 
 //BA.debugLineNum = 644;BA.debugLine="ct.ShowBitmap(\"©2017 SuloMedia™\",30,Gravity.BOTT";
...
public static String  _prog_init() throws Exception{
 //BA.debugLineNum = 401;BA.debugLine="Sub prog_init";
 //BA.debugLineNum = 402;BA.debugLine="If prog.IsInitialized=False Then";
if (mostCurrent._prog.IsInitialized()==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 403;BA.debugLine="prog.Initialize(Activity,12%x,5%y,360,15,mcl.md_l";
mostCurrent._prog._initialize(mostCurrent.activityBA,mostCurrent._activity,anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (12),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (5),mostCurrent.activityBA),(int) (360),(int) (15),mostCurrent._mcl.getmd_light_green_A400(),anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (190),(int) (255),(int) (255),(int) (255)),(anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper(), (android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.Null)));
 //BA.debugLineNum = 404;BA.debugLine="prog.BringToFront";
mostCurrent._prog._bringtofront();
 };
...
public static String  _re_bound() throws Exception{
 //BA.debugLineNum = 541;BA.debugLine="Sub re_bound";
 //BA.debugLineNum = 542;BA.debugLine="StartActivity(klo)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._klo.getObject()));
 //BA.debugLineNum = 543;BA.debugLine="End Sub";
return "";
}
public static String  _rl_lo() throws Exception{
 //BA.debugLineNum = 626;BA.debugLine="Sub rl_lo";
 //BA.debugLineNum = 627;BA.debugLine="cd2.Show(\"User App´s\",\"Check\",\"\",\"\",LoadBitmap(Fi";
mostCurrent._cd2.Show("User App´s","Check","","",mostCurrent.activityBA,(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Android.png").getObject()));
 //BA.debugLineNum = 628;BA.debugLine="If cd2.Response=DialogResponse.POSITIVE Then";
if (mostCurrent._cd2.getResponse()==anywheresoftware.b4a.keywords.Common.DialogResponse.POSITIVE) { 
 //BA.debugLineNum = 629;BA.debugLine="ToastMessageShow(\"closed...\",False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("closed..."),anywheresoftware.b4a.keywords.Common.False);
 ...
 //BA.debugLineNum = 631;BA.debugLine="Return";
if (true) return "";
 //BA.debugLineNum = 632;BA.debugLine="End Sub";
return "";
}
public static String  _show_2() throws Exception{
 //BA.debugLineNum = 338;BA.debugLine="Sub show_2";
 //BA.debugLineNum = 339;BA.debugLine="slm.OpenSidebar";
mostCurrent._slm._opensidebar();
 //BA.debugLineNum = 340;BA.debugLine="showtip.setDelay(400)";
mostCurrent._showtip.setDelay((int) (400));
 //BA.debugLineNum = 341;BA.debugLine="showtip.setCircleColor(Colors.ARGB(195,255,255,25";
mostCurrent._showtip.setCircleColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (195),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 342;BA.debugLine="showtip.setTitle(pak.GetApplicationLabel(\"com.bat";
mostCurrent._showtip.setTitle(_pak.GetApplicationLabel("com.batcat")).build();
 //BA.debugLineNum = 343;BA.debugLine="showtip.build.setDescription(\"Tippe hier um dein";
mostCurrent._showtip.build().setDescription("Tippe hier um dein Akku zu Boosten...");
 //BA.debugLineNum = 344;BA.debugLine="showtip.setTarget(Button4)";
mostCurrent._showtip.setTarget((android.view.View)(mostCurrent._button4.getObject()));
 //BA.debugLineNum = 345;BA.debugLine="showtip.show";
mostCurrent._showtip.show();
 //BA.debugLineNum = 346;BA.debugLine="End Sub";
return "";
}
public static String  _show_start() throws Exception{
 //BA.debugLineNum = 326;BA.debugLine="Sub show_start";
 //BA.debugLineNum = 329;BA.debugLine="End Sub";
return "";
}
public static String  _show_tip() throws Exception{
 //BA.debugLineNum = 330;BA.debugLine="Sub show_tip";
 //BA.debugLineNum = 331;BA.debugLine="showtip.setDelay(400)";
mostCurrent._showtip.setDelay((int) (400));
 //BA.debugLineNum = 332;BA.debugLine="showtip.setCircleColor(Colors.ARGB(195,255,255,2";
mostCurrent._showtip.setCircleColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (195),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 333;BA.debugLine="showtip.setTitle(pak.GetApplicationLabel(\"com.ba";
mostCurrent._showtip.setTitle(_pak.GetApplicationLabel("com.batcat")).build();
 //BA.debugLineNum = 334;BA.debugLine="showtip.build.setDescription(\"Swipe nach links z";
mostCurrent._showtip.build().setDescription("Swipe nach links zum öffnen und nach rechts zum schließen des Menü´s");
 //BA.debugLineNum = 335;BA.debugLine="showtip.setTarget(smlp).build";
mostCurrent._showtip.setTarget((android.view.View)(mostCurrent._smlp.getObject())).build();
 //BA.debugLineNum = 336;BA.debugLine="showtip.show";
mostCurrent._showtip.show();
 //BA.debugLineNum = 337;BA.debugLine="End Sub";
return "";
}
public static String  _slem_click() throws Exception{
 //BA.debugLineNum = 531;BA.debugLine="Sub slem_click";
 //BA.debugLineNum = 532;BA.debugLine="If slm.IsSidebarVisible Then";
if (mostCurrent._slm._issidebarvisible()) { 
 //BA.debugLineNum = 533;BA.debugLine="slm.CloseSidebar";
mostCurrent._slm._closesidebar();
 }else {
 //BA.debugLineNum = 536;BA.debugLine="slm.OpenSidebar";
mostCurrent._slm._opensidebar();
 };
...
public static String  _slem1_click() throws Exception{
 //BA.debugLineNum = 527;BA.debugLine="Sub slem1_click";
 //BA.debugLineNum = 528;BA.debugLine="slem_click";
_slem_click();
 //BA.debugLineNum = 529;BA.debugLine="End Sub";
return "";
}
public static String  _st_click() throws Exception{
 //BA.debugLineNum = 613;BA.debugLine="Sub st_click";
 //BA.debugLineNum = 614;BA.debugLine="StartActivity(klo)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._klo.getObject()));
 //BA.debugLineNum = 615;BA.debugLine="End Sub";
return "";
}
public static String  _stat_me() throws Exception{
 //BA.debugLineNum = 604;BA.debugLine="Sub stat_me";
 //BA.debugLineNum = 605;BA.debugLine="StartActivity(klo)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._klo.getObject()));
 //BA.debugLineNum = 606;BA.debugLine="End Sub";
return "";
}
public static String  _store_check() throws Exception{
 //BA.debugLineNum = 408;BA.debugLine="Sub store_check";
 //BA.debugLineNum = 409;BA.debugLine="c1=mcl.md_light_blue_A700";
_c1 = mostCurrent._mcl.getmd_light_blue_A700();
 //BA.debugLineNum = 410;BA.debugLine="c2=mcl.md_amber_A700";
_c2 = mostCurrent._mcl.getmd_amber_A700();
 //BA.debugLineNum = 411;BA.debugLine="c3=mcl.md_lime_A700";
_c3 = mostCurrent._mcl.getmd_lime_A700();
 //BA.debugLineNum = 412;BA.debugLine="c4=mcl.md_teal_A700";
_c4 = mostCurrent._mcl.getmd_teal_A700();
 //BA.debugLineNum = 413;BA.debugLine="c5=mcl.md_deep_purple_A700";
_c5 = mostCurrent._mcl.getmd_deep_purple_A700();
 //BA.debugLineNum = 414;BA.debugLine="c6=mcl.md_red_A700";
_c6 = mostCurrent._mcl.getmd_red_A700();
 //BA.debugLineNum = 415;BA.debugLine="c7=mcl.md_indigo_A700";
_c7 = mostCurrent._mcl.getmd_indigo_A700();
 //BA.debugLineNum = 416;BA.debugLine="c8=mcl.md_blue_A700";
_c8 = mostCurrent._mcl.getmd_blue_A700();
 //BA.debugLineNum = 417;BA.debugLine="c9=mcl.md_orange_A700";
_c9 = mostCurrent._mcl.getmd_orange_A700();
 //BA.debugLineNum = 418;BA.debugLine="c10=mcl.md_grey_700";
_c10 = mostCurrent._mcl.getmd_grey_700();
 //BA.debugLineNum = 419;BA.debugLine="c11=mcl.md_green_A700";
_c11 = mostCurrent._mcl.getmd_green_A700();
 //BA.debugLineNum = 420;BA.debugLine="c12=mcl.md_light_green_A700";
_c12 = mostCurrent._mcl.getmd_light_green_A700();
 //BA.debugLineNum = 421;BA.debugLine="c13=mcl.md_yellow_A700";
_c13 = mostCurrent._mcl.getmd_yellow_A700();
 //BA.debugLineNum = 422;BA.debugLine="c14=mcl.md_cyan_A700";
_c14 = mostCurrent._mcl.getmd_cyan_A700();
 //BA.debugLineNum = 423;BA.debugLine="c15=mcl.md_blue_grey_700";
_c15 = mostCurrent._mcl.getmd_blue_grey_700();
 //BA.debugLineNum = 424;BA.debugLine="If kvs4sub.ContainsKey(\"off\") Then";
if (mostCurrent._kvs4sub._containskey("off")) { 
 //BA.debugLineNum = 425;BA.debugLine="StopService(Starter)";
...
mostCurrent._activity.setColor(_c1);
 ...
 //BA.debugLineNum = 436;BA.debugLine="If kvs4.ContainsKey(\"0\")Then";
if (mostCurrent._kvs4._containskey("0")) { 
 //BA.debugLineNum = 437;BA.debugLine="Log(\"AC_true->1\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->1");
 //BA.debugLineNum = 438;BA.debugLine="Activity.Color=c1";
mostCurrent._activity.setColor(_c1);
 };
...
mostCurrent._activity.setColor(_c2);
 ...
 //BA.debugLineNum = 446;BA.debugLine="If kvs4.ContainsKey(\"2\")Then";
if (mostCurrent._kvs4._containskey("2")) { 
 //BA.debugLineNum = 447;BA.debugLine="Log(\"AC_true->3\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->3");
 //BA.debugLineNum = 448;BA.debugLine="Activity.Color=c3";
mostCurrent._activity.setColor(_c3);
 }else {
 };
 //BA.debugLineNum = 452;BA.debugLine="If kvs4.ContainsKey(\"3\")Then";
if (mostCurrent._kvs4._containskey("3")) { 
 //BA.debugLineNum = 453;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 454;BA.debugLine="Activity.Color=c4";
mostCurrent._activity.setColor(_c4);
 }else {
 };
 //BA.debugLineNum = 458;BA.debugLine="If kvs4.ContainsKey(\"4\")Then";
if (mostCurrent._kvs4._containskey("4")) { 
 //BA.debugLineNum = 459;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 460;BA.debugLine="Activity.Color=c5";
mostCurrent._activity.setColor(_c5);
 }else {
 };
 //BA.debugLineNum = 464;BA.debugLine="If kvs4.ContainsKey(\"5\")Then";
if (mostCurrent._kvs4._containskey("5")) { 
 //BA.debugLineNum = 465;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 466;BA.debugLine="Activity.Color=c6";
mostCurrent._activity.setColor(_c6);
 }else {
 };
 //BA.debugLineNum = 470;BA.debugLine="If kvs4.ContainsKey(\"6\")Then";
if (mostCurrent._kvs4._containskey("6")) { 
 //BA.debugLineNum = 471;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 472;BA.debugLine="Activity.Color=c7";
mostCurrent._activity.setColor(_c7);
 }else {
 };
 //BA.debugLineNum = 476;BA.debugLine="If kvs4.ContainsKey(\"7\")Then";
if (mostCurrent._kvs4._containskey("7")) { 
 //BA.debugLineNum = 477;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 478;BA.debugLine="Activity.Color=c8";
mostCurrent._activity.setColor(_c8);
 }else {
 };
 //BA.debugLineNum = 482;BA.debugLine="If kvs4.ContainsKey(\"8\")Then";
if (mostCurrent._kvs4._containskey("8")) { 
 //BA.debugLineNum = 483;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 484;BA.debugLine="Activity.Color=c9";
mostCurrent._activity.setColor(_c9);
 }else {
 };
 //BA.debugLineNum = 488;BA.debugLine="If kvs4.ContainsKey(\"9\")Then";
if (mostCurrent._kvs4._containskey("9")) { 
 //BA.debugLineNum = 489;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 490;BA.debugLine="Activity.Color=c10";
mostCurrent._activity.setColor(_c10);
 }else {
 };
 //BA.debugLineNum = 494;BA.debugLine="If kvs4.ContainsKey(\"10\")Then";
if (mostCurrent._kvs4._containskey("10")) { 
 //BA.debugLineNum = 495;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 496;BA.debugLine="Activity.Color=c11";
mostCurrent._activity.setColor(_c11);
 }else {
 };
 //BA.debugLineNum = 500;BA.debugLine="If kvs4.ContainsKey(\"11\")Then";
if (mostCurrent._kvs4._containskey("11")) { 
 //BA.debugLineNum = 501;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 502;BA.debugLine="Activity.Color=c12";
mostCurrent._activity.setColor(_c12);
 }else {
 };
 //BA.debugLineNum = 506;BA.debugLine="If kvs4.ContainsKey(\"12\")Then";
if (mostCurrent._kvs4._containskey("12")) { 
 //BA.debugLineNum = 507;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 508;BA.debugLine="Activity.Color=c13";
mostCurrent._activity.setColor(_c13);
 }else {
 };
 //BA.debugLineNum = 512;BA.debugLine="If kvs4.ContainsKey(\"13\")Then";
if (mostCurrent._kvs4._containskey("13")) { 
 //BA.debugLineNum = 513;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 514;BA.debugLine="Activity.Color=c14";
mostCurrent._activity.setColor(_c14);
 }else {
 };
 //BA.debugLineNum = 518;BA.debugLine="If kvs4.ContainsKey(\"14\")Then";
if (mostCurrent._kvs4._containskey("14")) { 
 //BA.debugLineNum = 519;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 520;BA.debugLine="Activity.Color=c15";
...
public static String  _sy_click() throws Exception{
 //BA.debugLineNum = 608;BA.debugLine="Sub sy_click";
 //BA.debugLineNum = 609;BA.debugLine="StartActivity(sys)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(mostCurrent._sys.getObject()));
