...
mostCurrent._lw3.Initialize(mostCurrent.activityBA,"lw3");
 //BA.debugLineNum = 95;BA.debugLine="catdel.initialize(\"catdel\")";
_catdel.initialize("catdel",processBA);
...
mostCurrent._ffolders.Initialize();
 //BA.debugLineNum = 101;BA.debugLine="xOSStats.Initialize(400, 50, Me, \"myStats\")";
mostCurrent._xosstats._initialize(mostCurrent.activityBA,(int) (400),(int) (50),cool.getObject(),"myStats");
 //BA.debugLineNum = 102;BA.debugLine="kvs4sub.Initialize(File.DirDefaultExternal, \"data";
mostCurrent._kvs4sub._initialize(processBA,anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal(),"datastore_sub_4");
 //BA.debugLineNum = 103;BA.debugLine="kvs4.Initialize(File.DirDefaultExternal, \"datasto";
...
if (_firsttime) { 
 //BA.debugLineNum = 105;BA.debugLine="Activity.Color=c10";
mostCurrent._activity.setColor(_c10);
 //BA.debugLineNum = 106;BA.debugLine="If File.Exists(File.DirDefaultExternal&\"/mnt/cac";
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal()+"/mnt/cache","cdata.txt")) { 
 //BA.debugLineNum = 108;BA.debugLine="File.WriteList(File.DirDefaultExternal&\"/mnt/ca";
anywheresoftware.b4a.keywords.Common.File.WriteList(anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal()+"/mnt/cache","sv.txt",mostCurrent._list4);
 //BA.debugLineNum = 109;BA.debugLine="File.WriteList(File.DirDefaultExternal&\"/mnt/ca";
anywheresoftware.b4a.keywords.Common.File.WriteList(anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal()+"/mnt/cache","fn.txt",mostCurrent._list1);
 ...
 //BA.debugLineNum = 112;BA.debugLine="File.MakeDir(File.DirDefaultExternal, \"mnt/cache\"";
anywheresoftware.b4a.keywords.Common.File.MakeDir(anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal(),"mnt/cache");
 //BA.debugLineNum = 113;BA.debugLine="File.MakeDir(File.DirDefaultExternal, \"mnt/cache/";
...
anywheresoftware.b4a.keywords.Common.File.WriteList(anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal()+"/mnt/cache","fn.txt",mostCurrent._list1);
 //BA.debugLineNum = 116;BA.debugLine="File.WriteList(File.DirDefaultExternal&\"/mnt/cac";
anywheresoftware.b4a.keywords.Common.File.WriteList(anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal()+"/mnt/cache","cdata.txt",mostCurrent._catlist);
 //BA.debugLineNum = 117;BA.debugLine="File.WriteString(File.DirDefaultExternal&\"/mnt/";
anywheresoftware.b4a.keywords.Common.File.WriteString(anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal()+"/mnt/cache","cclist.txt","");
 //BA.debugLineNum = 118;BA.debugLine="ToastMessageShow(\"Files ready! \"&date&\", \"&time,F";
...
_t1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 127;BA.debugLine="ffolders.Initialize";
mostCurrent._ffolders.Initialize();
 //BA.debugLineNum = 128;BA.debugLine="dial.TextSize=15";
mostCurrent._dial.setTextSize((float) (15));
 //BA.debugLineNum = 129;BA.debugLine="dial.TextColor=Colors.White";
mostCurrent._dial.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 130;BA.debugLine="dialog.AddView(diapan,350,350)";
mostCurrent._dialog.AddView((android.view.View)(mostCurrent._diapan.getObject()),(int) (350),(int) (350));
 //BA.debugLineNum = 131;BA.debugLine="diapan.AddView(lw2,3,3,-1,-1)";
mostCurrent._diapan.AddView((android.view.View)(mostCurrent._lw2.getObject()),(int) (3),(int) (3),(int) (-1),(int) (-1));
 //BA.debugLineNum = 134;BA.debugLine="paths = storage.Initialize";
mostCurrent._paths = mostCurrent._storage.Initialize();
 //BA.debugLineNum = 135;BA.debugLine="nativeMe.InitializeContext";
...
_c16 = mostCurrent._mcl.getmd_light_blue_A400();
 //BA.debugLineNum = 155;BA.debugLine="ani.InitializeTranslate(\"ani\",0,1,5,9)";
mostCurrent._ani.InitializeTranslate(mostCurrent.activityBA,"ani",(float) (0),(float) (1),(float) (5),(float) (9));
 //BA.debugLineNum = 158;BA.debugLine="Panel2.Visible=False";
mostCurrent._panel2.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 161;BA.debugLine="ffil.Initialize";
mostCurrent._ffil.Initialize();
 //BA.debugLineNum = 162;BA.debugLine="ffold.Initialize";
mostCurrent._ffold.Initialize();
 //BA.debugLineNum = 163;BA.debugLine="Activity.Color=mcl.md_white_1000";
mostCurrent._activity.setColor(mostCurrent._mcl.getmd_white_1000());
 //BA.debugLineNum = 164;BA.debugLine="ImageView1.BringToFront";
mostCurrent._imageview1.BringToFront();
 //BA.debugLineNum = 165;BA.debugLine="Dim secl As Label = ListView1.TwoLinesAndBitmap.S";
_secl = new anywheresoftware.b4a.objects.LabelWrapper();
_secl = mostCurrent._listview1.getTwoLinesAndBitmap().SecondLabel;
 //BA.debugLineNum = 166;BA.debugLine="l1=ListView1.TwoLinesAndBitmap.Label";
mostCurrent._l1 = mostCurrent._listview1.getTwoLinesAndBitmap().Label;
 //BA.debugLineNum = 167;BA.debugLine="l1.TextSize=15";
mostCurrent._l1.setTextSize((float) (15));
 //BA.debugLineNum = 168;BA.debugLine="secl.TextSize=12";
_secl.setTextSize((float) (12));
 //BA.debugLineNum = 169;BA.debugLine="l1.TextColor=mcl.md_blue_400";
mostCurrent._l1.setTextColor(mostCurrent._mcl.getmd_blue_400());
 //BA.debugLineNum = 170;BA.debugLine="secl.TextColor=mcl.md_black_1000";
_secl.setTextColor(mostCurrent._mcl.getmd_black_1000());
 //BA.debugLineNum = 171;BA.debugLine="GetDeviceId";
_getdeviceid();
 //BA.debugLineNum = 172;BA.debugLine="store_check";
_store_check();
 //BA.debugLineNum = 173;BA.debugLine="t1.Enabled=False";
_t1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 175;BA.debugLine="cat_start";
_cat_start();
...
mostCurrent._activity.Finish();
 //BA.debugLineNum = 199;BA.debugLine="SetAnimation.setanimati(\"extra_in\", \"extra_out\")";
...
public static String  _activity_pause(boolean _userclosed) throws Exception{
 ...
 //BA.debugLineNum = 191;BA.debugLine="xOSStats.EndStats";
mostCurrent._xosstats._endstats();
 //BA.debugLineNum = 192;BA.debugLine="anima.Stop(ImageView1)";
...
public static String  _activity_resume() throws Exception{
 ...
 //BA.debugLineNum = 180;BA.debugLine="anima.InitializeRotateCenter(\"anima\",1,3,ImageVie";
mostCurrent._anima.InitializeRotateCenter(mostCurrent.activityBA,"anima",(float) (1),(float) (3),(android.view.View)(mostCurrent._imageview1.getObject()));
 //BA.debugLineNum = 181;BA.debugLine="anima.RepeatMode=anima.REPEAT_INFINITE";
mostCurrent._anima.setRepeatMode(mostCurrent._anima.REPEAT_INFINITE);
 //BA.debugLineNum = 182;BA.debugLine="anima.SetInterpolator(anima.INTERPOLATOR_BOUNCE)";
mostCurrent._anima.SetInterpolator(mostCurrent._anima.INTERPOLATOR_BOUNCE);
 //BA.debugLineNum = 183;BA.debugLine="store_check";
_store_check();
 //BA.debugLineNum = 184;BA.debugLine="xOSStats.StartStats";
mostCurrent._xosstats._startstats();
 //BA.debugLineNum = 185;BA.debugLine="cat_start";
_cat_start();
...
int _i = 0;
 //BA.debugLineNum = 596;BA.debugLine="Sub app_info";
 //BA.debugLineNum = 598;BA.debugLine="list1=pak.GetInstalledPackages";
mostCurrent._list1 = mostCurrent._pak.GetInstalledPackages();
 //BA.debugLineNum = 600;BA.debugLine="Obj1.Target = Obj1.GetContext";
mostCurrent._obj1.Target = (Object)(mostCurrent._obj1.GetContext(processBA));
 //BA.debugLineNum = 601;BA.debugLine="Obj1.Target = Obj1.RunMethod(\"getPackageManager\")";
mostCurrent._obj1.Target = mostCurrent._obj1.RunMethod("getPackageManager");
 //BA.debugLineNum = 602;BA.debugLine="Obj2.Target = Obj1.RunMethod2(\"getInstalledPackag";
...
_size = (int)(BA.ObjectToNumber(mostCurrent._obj2.RunMethod("size")));
 //BA.debugLineNum = 605;BA.debugLine="For i = 0 To size -1";
{
final int step6 = 1;
final int limit6 = (int) (_size-1);
for (_i = (int) (0) ; (step6 > 0 && _i <= limit6) || (step6 < 0 && _i >= limit6); _i = ((int)(0 + _i + step6)) ) {
 //BA.debugLineNum = 606;BA.debugLine="Obj3.Target = Obj2.RunMethod2(\"get\", i, \"java.la";
mostCurrent._obj3.Target = mostCurrent._obj2.RunMethod2("get",BA.NumberToString(_i),"java.lang.int");
 //BA.debugLineNum = 607;BA.debugLine="size = Obj2.RunMethod(\"size\")";
_size = (int)(BA.ObjectToNumber(mostCurrent._obj2.RunMethod("size")));
 //BA.debugLineNum = 609;BA.debugLine="Obj3.Target = Obj3.GetField(\"applicationInfo\") '";
mostCurrent._obj3.Target = mostCurrent._obj3.GetField("applicationInfo");
 //BA.debugLineNum = 610;BA.debugLine="flags = Obj3.GetField(\"flags\")";
_flags = (int)(BA.ObjectToNumber(mostCurrent._obj3.GetField("flags")));
 //BA.debugLineNum = 611;BA.debugLine="packName = Obj3.GetField(\"packageName\")";
mostCurrent._packname = BA.ObjectToString(mostCurrent._obj3.GetField("packageName"));
 //BA.debugLineNum = 613;BA.debugLine="If Bit.And(flags, 1)  = 0 Then";
if (anywheresoftware.b4a.keywords.Common.Bit.And(_flags,(int) (1))==0) { 
 //BA.debugLineNum = 616;BA.debugLine="args(0) = Obj3.Target";
mostCurrent._args[(int) (0)] = mostCurrent._obj3.Target;
 //BA.debugLineNum = 617;BA.debugLine="Types(0) = \"android.content.pm.ApplicationInfo\"";
mostCurrent._types[(int) (0)] = "android.content.pm.ApplicationInfo";
 //BA.debugLineNum = 618;BA.debugLine="name = Obj1.RunMethod4(\"getApplicationLabel\", a";
mostCurrent._name = BA.ObjectToString(mostCurrent._obj1.RunMethod4("getApplicationLabel",mostCurrent._args,mostCurrent._types));
 //BA.debugLineNum = 619;BA.debugLine="icon = Obj1.RunMethod4(\"getApplicationIcon\", ar";
...
anywheresoftware.b4a.randomaccessfile.B4XSerializator _ser = null;
 //BA.debugLineNum = 681;BA.debugLine="Sub byte_to_object(data() As Byte)As Object";
 //BA.debugLineNum = 682;BA.debugLine="Dim ser As B4XSerializator";
_ser = new anywheresoftware.b4a.randomaccessfile.B4XSerializator();
 //BA.debugLineNum = 683;BA.debugLine="Return ser.ConvertBytesToObject(data)";
...
public static String  _c_start() throws Exception{
 //BA.debugLineNum = 329;BA.debugLine="Sub c_start";
 //BA.debugLineNum = 330;BA.debugLine="app_info";
_app_info();
 //BA.debugLineNum = 331;BA.debugLine="catlist.Clear";
mostCurrent._catlist.Clear();
 //BA.debugLineNum = 332;BA.debugLine="dill.Clear";
mostCurrent._dill.Clear();
 //BA.debugLineNum = 333;BA.debugLine="list2.Clear";
mostCurrent._list2.Clear();
 //BA.debugLineNum = 334;BA.debugLine="list4.Clear";
mostCurrent._list4.Clear();
 //BA.debugLineNum = 335;BA.debugLine="list7.Clear";
mostCurrent._list7.Clear();
 //BA.debugLineNum = 336;BA.debugLine="apklist.Clear";
mostCurrent._apklist.Clear();
 //BA.debugLineNum = 338;BA.debugLine="list2=op.RunningTaskInfo(99,list8,list9,list10)";
...
long _size1 = 0L;
String _f = "";
 //BA.debugLineNum = 686;BA.debugLine="Sub CalcSize(Folder As String, recursive As Boolea";
 //BA.debugLineNum = 687;BA.debugLine="Dim size1 As Long";
_size1 = 0L;
 //BA.debugLineNum = 688;BA.debugLine="For Each f As String In File.ListFiles(Folder)";
...
_f = BA.ObjectToString(group2.Get(index2));
 //BA.debugLineNum = 689;BA.debugLine="If recursive Then";
if (_recursive) { 
 //BA.debugLineNum = 690;BA.debugLine="If File.IsDirectory(Folder, f) Then";
if (anywheresoftware.b4a.keywords.Common.File.IsDirectory(_folder,_f)) { 
 //BA.debugLineNum = 691;BA.debugLine="size1 = size1 + CalcSize(File.Combine(Folder,";
_size1 = (long) (_size1+_calcsize(anywheresoftware.b4a.keywords.Common.File.Combine(_folder,_f),_recursive));
 };
 };
 //BA.debugLineNum = 694;BA.debugLine="size1 = size1 + File.Size(Folder, f)";
_size1 = (long) (_size1+anywheresoftware.b4a.keywords.Common.File.Size(_folder,_f));
 }
;
 //BA.debugLineNum = 696;BA.debugLine="Return size1";
if (true) return _size1;
 //BA.debugLineNum = 697;BA.debugLine="End Sub";
return 0L;
}
public static String  _cat_start() throws Exception{
 //BA.debugLineNum = 203;BA.debugLine="Sub cat_start";
 //BA.debugLineNum = 204;BA.debugLine="dpm1.TextColor=Colors.White";
mostCurrent._dpm1.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 205;BA.debugLine="dpm1.Color=Colors.Transparent";
mostCurrent._dpm1.setColor(anywheresoftware.b4a.keywords.Common.Colors.Transparent);
 //BA.debugLineNum = 206;BA.debugLine="dpm1.FinishedStrokeColor= mcl.md_light_blue_700";
mostCurrent._dpm1.setFinishedStrokeColor(mostCurrent._mcl.getmd_light_blue_700());
 //BA.debugLineNum = 207;BA.debugLine="dpm1.FinishedStrokeWidth=25";
mostCurrent._dpm1.setFinishedStrokeWidth((float) (25));
 //BA.debugLineNum = 208;BA.debugLine="dpm1.UnfinishedStrokeColor=Colors.Transparent";
mostCurrent._dpm1.setUnfinishedStrokeColor(anywheresoftware.b4a.keywords.Common.Colors.Transparent);
 //BA.debugLineNum = 209;BA.debugLine="dpm1.UnfinishedStrokeWidth=30";
mostCurrent._dpm1.setUnfinishedStrokeWidth((float) (30));
 //BA.debugLineNum = 210;BA.debugLine="dpm1.SuffixText=\"%\"";
mostCurrent._dpm1.setSuffixText("%");
 //BA.debugLineNum = 211;BA.debugLine="dpm1.InnerBackgroundColor=mcl.md_light_blue_A200";
mostCurrent._dpm1.setInnerBackgroundColor(mostCurrent._mcl.getmd_light_blue_A200());
 //BA.debugLineNum = 213;BA.debugLine="dpm1.InnerBottomTextSize=18";
mostCurrent._dpm1.setInnerBottomTextSize((float) (18));
 //BA.debugLineNum = 214;BA.debugLine="dpm1.InnerBottomTextColor=Colors.Black";
mostCurrent._dpm1.setInnerBottomTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 215;BA.debugLine="dpm1.PrefixText=\"Cleaning: \"";
mostCurrent._dpm1.setPrefixText("Cleaning: ");
 //BA.debugLineNum = 217;BA.debugLine="ReadDir(dir1,False)";
_readdir(mostCurrent._dir1,anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 221;BA.debugLine="ImageView1.Visible=False";
...
public static String  _catdel_oncleancompleted(long _cachesize) throws Exception{
 //BA.debugLineNum = 393;BA.debugLine="Sub catdel_onCleanCompleted (CacheSize As Long)";
 //BA.debugLineNum = 396;BA.debugLine="dpm1.InnerBottomText=xMSOS.formateFileSize(CacheS";
mostCurrent._dpm1.setInnerBottomText(mostCurrent._xmsos.formateFileSize(mostCurrent.activityBA,_cachesize)+" clean!");
 //BA.debugLineNum = 397;BA.debugLine="ListView1.AddSingleLine(xMSOS.formateFileSize(Cac";
mostCurrent._listview1.AddSingleLine(BA.ObjectToCharSequence(mostCurrent._xmsos.formateFileSize(mostCurrent.activityBA,_cachesize)+" gesäubert"));
 //BA.debugLineNum = 398;BA.debugLine="t_start";
_t_start();
 //BA.debugLineNum = 399;BA.debugLine="End Sub";
return "";
}
public static String  _catdel_oncleanstarted() throws Exception{
 //BA.debugLineNum = 389;BA.debugLine="Sub catdel_onCleanStarted";
 //BA.debugLineNum = 390;BA.debugLine="ListView1.AddSingleLine(\"lösche...\" )";
...
int _n = 0;
Object[] _app = null;
 //BA.debugLineNum = 401;BA.debugLine="Sub catdel_onScanCompleted (AppsList As Object)";
 //BA.debugLineNum = 402;BA.debugLine="time=DateTime.Time(DateTime.Now)";
mostCurrent._time = anywheresoftware.b4a.keywords.Common.DateTime.Time(anywheresoftware.b4a.keywords.Common.DateTime.getNow());
 //BA.debugLineNum = 403;BA.debugLine="lvg.stopAnim";
mostCurrent._lvg.stopAnim();
 //BA.debugLineNum = 404;BA.debugLine="Dim totalsize As Long = 0";
_totalsize = (long) (0);
 //BA.debugLineNum = 405;BA.debugLine="Dim pm As PackageManager";
_pm = new anywheresoftware.b4a.phone.PackageManagerWrapper();
 //BA.debugLineNum = 406;BA.debugLine="ListView1.Clear";
mostCurrent._listview1.Clear();
 //BA.debugLineNum = 407;BA.debugLine="lw2.Clear";
mostCurrent._lw2.Clear();
 //BA.debugLineNum = 408;BA.debugLine="Try";
try { //BA.debugLineNum = 409;BA.debugLine="Dim lu As List = AppsList";
_lu = new anywheresoftware.b4a.objects.collections.List();
_lu.setObject((java.util.List)(_appslist));
 //BA.debugLineNum = 410;BA.debugLine="If lu.Size=0 Then";
if (_lu.getSize()==0) { 
 //BA.debugLineNum = 412;BA.debugLine="ListView1.AddSingleLine(\"No App cache found. Al";
mostCurrent._listview1.AddSingleLine(BA.ObjectToCharSequence("No App cache found. All clear"));
 //BA.debugLineNum = 413;BA.debugLine="catlist.Clear";
mostCurrent._catlist.Clear();
 //BA.debugLineNum = 414;BA.debugLine="catlist.Add(time&\" - No App cache found\")";
mostCurrent._catlist.Add((Object)(mostCurrent._time+" - No App cache found"));
 //BA.debugLineNum = 415;BA.debugLine="t_start";
_t_start();
 //BA.debugLineNum = 416;BA.debugLine="Return";
if (true) return "";
 };
 //BA.debugLineNum = 418;BA.debugLine="For n = 0 To lu.Size-1";
{
final int step16 = 1;
final int limit16 = (int) (_lu.getSize()-1);
for (_n = (int) (0) ; (step16 > 0 && _n <= limit16) || (step16 < 0 && _n >= limit16); _n = ((int)(0 + _n + step16)) ) {
 //BA.debugLineNum = 419;BA.debugLine="Dim app() As Object = lu.Get(n)";
_app = (Object[])(_lu.Get(_n));
 //BA.debugLineNum = 420;BA.debugLine="If app(1) = \"com.android.systemui\" Then Continu";
if ((_app[(int) (1)]).equals((Object)("com.android.systemui"))) { 
if (true) continue;};
 //BA.debugLineNum = 421;BA.debugLine="Dim icon As BitmapDrawable = pm.GetApplicationI";
...
mostCurrent._icon.setObject((android.graphics.drawable.BitmapDrawable)(_pm.GetApplicationIcon(BA.ObjectToString(_app[(int) (1)]))));
 //BA.debugLineNum = 422;BA.debugLine="ListView1.SetSelection(n)";
mostCurrent._listview1.SetSelection(_n);
 //BA.debugLineNum = 423;BA.debugLine="ListView1.AddTwoLinesAndBitmap(app(0),NumberFor";
mostCurrent._listview1.AddTwoLinesAndBitmap(BA.ObjectToCharSequence(_app[(int) (0)]),BA.ObjectToCharSequence(anywheresoftware.b4a.keywords.Common.NumberFormat2((double)(BA.ObjectToNumber(_app[(int) (2)]))/(double)1024/(double)1024,(int) (1),(int) (2),(int) (2),anywheresoftware.b4a.keywords.Common.True)+"MB"),mostCurrent._icon.getBitmap());
 //BA.debugLineNum = 424;BA.debugLine="lw3.AddTwoLinesAndBitmap(app(0),NumberFormat2(a";
mostCurrent._lw3.AddTwoLinesAndBitmap(BA.ObjectToCharSequence(_app[(int) (0)]),BA.ObjectToCharSequence(anywheresoftware.b4a.keywords.Common.NumberFormat2((double)(BA.ObjectToNumber(_app[(int) (2)]))/(double)1024/(double)1024,(int) (1),(int) (2),(int) (2),anywheresoftware.b4a.keywords.Common.True)+"MB"),mostCurrent._icon.getBitmap());
 //BA.debugLineNum = 425;BA.debugLine="totalsize = totalsize+app(2)";
_totalsize = (long) (_totalsize+(double)(BA.ObjectToNumber(_app[(int) (2)])));
 //BA.debugLineNum = 426;BA.debugLine="catlist.Clear";
mostCurrent._catlist.Clear();
 //BA.debugLineNum = 427;BA.debugLine="catlist.Add(app(0)&\" - \"&NumberFormat2(app(2)/1";
mostCurrent._catlist.Add((Object)(BA.ObjectToString(_app[(int) (0)])+" - "+anywheresoftware.b4a.keywords.Common.NumberFormat2((double)(BA.ObjectToNumber(_app[(int) (2)]))/(double)1024/(double)1024,(int) (1),(int) (2),(int) (2),anywheresoftware.b4a.keywords.Common.True)+"MB cache"+" | "+mostCurrent._op.formatSize(_totalsize)));
 //BA.debugLineNum = 428;BA.debugLine="File.WriteList(File.DirDefaultExternal&\"/mnt/ca";
anywheresoftware.b4a.keywords.Common.File.WriteList(anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal()+"/mnt/cache","cdata.txt",mostCurrent._catlist);
 }
};
 } 
       catch (Exception e29) {
			processBA.setLastException(e29); //BA.debugLineNum = 433;BA.debugLine="Log(LastException.Message)";
anywheresoftware.b4a.keywords.Common.Log(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage());
 //BA.debugLineNum = 434;BA.debugLine="catlist.Add(LastException.Message)";
mostCurrent._catlist.Add((Object)(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA).getMessage()));
 };
 //BA.debugLineNum = 436;BA.debugLine="If lu.Size>0 Then";
if (_lu.getSize()>0) { 
 //BA.debugLineNum = 437;BA.debugLine="cl_msg";
_cl_msg();
 }else {
 //BA.debugLineNum = 439;BA.debugLine="close";
_close();
 };
...
public static String  _catdel_onscanprogress(int _current,int _total) throws Exception{
 //BA.debugLineNum = 382;BA.debugLine="Sub catdel_onScanProgress (Current As Int , Total";
 //BA.debugLineNum = 383;BA.debugLine="dpm1.Max=Total";
mostCurrent._dpm1.setMax(_total);
 //BA.debugLineNum = 384;BA.debugLine="dpm1.Progress=Current";
mostCurrent._dpm1.setProgress(_current);
 //BA.debugLineNum = 385;BA.debugLine="Label1.Text=\"durchsuche -> \"&Current&\" Apps nach";
...
public static String  _catdel_onscanstarted() throws Exception{
 //BA.debugLineNum = 346;BA.debugLine="Sub catdel_OnScanStarted";
 //BA.debugLineNum = 347;BA.debugLine="Log(\"Started\")";
...
int _res = 0;
 //BA.debugLineNum = 443;BA.debugLine="Sub cl_msg";
 //BA.debugLineNum = 444;BA.debugLine="Dim diap As BetterDialogs";
_diap = new flm.b4a.betterdialogs.BetterDialogs();
 //BA.debugLineNum = 445;BA.debugLine="Dim res As Int";
_res = 0;
 //BA.debugLineNum = 446;BA.debugLine="res=diap.CustomDialog(\"Cache found:\",130dip,80dip";
_res = _diap.CustomDialog((Object)("Cache found:"),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (130)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (80)),(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(mostCurrent._lw3.getObject())),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (300)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (350)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)),(Object)(anywheresoftware.b4a.keywords.Common.Colors.White),(Object)("Ja löschen"),(Object)(""),(Object)("Nein Ende"),anywheresoftware.b4a.keywords.Common.False,"diap",mostCurrent.activityBA);
 //BA.debugLineNum = 447;BA.debugLine="If res=DialogResponse.POSITIVE Then";
if (_res==anywheresoftware.b4a.keywords.Common.DialogResponse.POSITIVE) { 
 //BA.debugLineNum = 448;BA.debugLine="catdel.CleanCache";
_catdel.CleanCache();
 //BA.debugLineNum = 449;BA.debugLine="t_start";
_t_start();
 }else {
 //BA.debugLineNum = 451;BA.debugLine="ImageView1.Visible=True";
mostCurrent._imageview1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 452;BA.debugLine="dpm1.Visible=False";
mostCurrent._dpm1.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 454;BA.debugLine="anima.Start(ImageView1)";
mostCurrent._anima.Start((android.view.View)(mostCurrent._imageview1.getObject()));
 //BA.debugLineNum = 455;BA.debugLine="full_close";
_full_close();
 };
...
anywheresoftware.b4a.keywords.Common.Log("--------------- NO CDATA--------------");
 ...
 //BA.debugLineNum = 480;BA.debugLine="delayed_t2";
_delayed_t2();
...
public static String  _del_quest() throws Exception{
 //BA.debugLineNum = 484;BA.debugLine="Sub del_quest";
 //BA.debugLineNum = 485;BA.debugLine="ImageView1.Visible=True";
mostCurrent._imageview1.setVisible(anywheresoftware.b4a.keywords.Common.True);
...
public static String  _delayed_t2() throws Exception{
 //BA.debugLineNum = 559;BA.debugLine="Sub delayed_t2";
 //BA.debugLineNum = 560;BA.debugLine="dpm1.InnerBottomText=Label1.text";
...
mostCurrent._dpm1.setProgress((int) (100));
 //BA.debugLineNum = 562;BA.debugLine="lvg.SetVisibleAnimated(100,False)";
mostCurrent._lvg.SetVisibleAnimated((int) (100),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 563;BA.debugLine="lvg.stopAnim";
mostCurrent._lvg.stopAnim();
 //BA.debugLineNum = 565;BA.debugLine="If count > 7 Then";
if (_count>7) { 
 //BA.debugLineNum = 566;BA.debugLine="Label1.text=op.formatSize(cat.FreeMemory)&\" free";
mostCurrent._label1.setText(BA.ObjectToCharSequence(mostCurrent._op.formatSize(mostCurrent._cat.getFreeMemory())+" free.."));
 //BA.debugLineNum = 567;BA.debugLine="ListView1.Clear";
mostCurrent._listview1.Clear();
 };
 //BA.debugLineNum = 569;BA.debugLine="If count> 8 Then";
if (_count>8) { 
 //BA.debugLineNum = 570;BA.debugLine="Label1.text=op.formatSize(cat.FreeMemory)";
mostCurrent._label1.setText(BA.ObjectToCharSequence(mostCurrent._op.formatSize(mostCurrent._cat.getFreeMemory())));
 //BA.debugLineNum = 572;BA.debugLine="ListView1.AddSingleLine(xMSOS.formateFileSize(ca";
mostCurrent._listview1.AddSingleLine(BA.ObjectToCharSequence(mostCurrent._xmsos.formateFileSize(mostCurrent.activityBA,mostCurrent._cat.getFreeMemory())));
 ...
 //BA.debugLineNum = 574;BA.debugLine="If count> 9 Then";
if (_count>9) { 
 //BA.debugLineNum = 576;BA.debugLine="anima.Start(ImageView1)";
mostCurrent._anima.Start((android.view.View)(mostCurrent._imageview1.getObject()));
 //BA.debugLineNum = 577;BA.debugLine="dpm1.Visible=False";
mostCurrent._dpm1.setVisible(anywheresoftware.b4a.keywords.Common.False);
 };
 //BA.debugLineNum = 580;BA.debugLine="If count> 10 Then";
if (_count>10) { 
 };
 //BA.debugLineNum = 583;BA.debugLine="If count = 11 Then";
if (_count==11) { 
 //BA.debugLineNum = 585;BA.debugLine="t1.Enabled=False";
_t1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
...
public static String  _file_copydone() throws Exception{
 //BA.debugLineNum = 699;BA.debugLine="Sub file_CopyDone";
 //BA.debugLineNum = 700;BA.debugLine="Log(\"copy done!\")";
...
public static String  _full_close() throws Exception{
 //BA.debugLineNum = 591;BA.debugLine="Sub full_close";
 //BA.debugLineNum = 592;BA.debugLine="Activity.Finish";
mostCurrent._activity.Finish();
...
int _id = 0;
 //BA.debugLineNum = 652;BA.debugLine="Sub GetDeviceId As String";
 //BA.debugLineNum = 653;BA.debugLine="Dim api As Int";
_api = 0;
 //BA.debugLineNum = 654;BA.debugLine="Dim r As Reflector";
_r = new anywheresoftware.b4a.agraham.reflection.Reflection();
 //BA.debugLineNum = 655;BA.debugLine="api = r.GetStaticField(\"android.os.Build$VERSION\"";
_api = (int)(BA.ObjectToNumber(_r.GetStaticField("android.os.Build$VERSION","SDK_INT")));
 //BA.debugLineNum = 656;BA.debugLine="If api < 18 Then";
if (_api<18) { 
 //BA.debugLineNum = 658;BA.debugLine="If File.Exists(File.DirInternal, \"__id\") Then";
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"__id")) { 
 //BA.debugLineNum = 659;BA.debugLine="Return File.ReadString(File.DirInternal, \"__id\"";
if (true) return anywheresoftware.b4a.keywords.Common.File.ReadString(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"__id");
 //BA.debugLineNum = 660;BA.debugLine="c_start";
_c_start();
 }else {
 //BA.debugLineNum = 662;BA.debugLine="c_start";
_c_start();
 //BA.debugLineNum = 663;BA.debugLine="Dim id As Int";
_id = 0;
 //BA.debugLineNum = 664;BA.debugLine="id = Rnd(0x10000000, 0x7FFFFFFF)";
_id = anywheresoftware.b4a.keywords.Common.Rnd((int) (0x10000000),(int) (0x7fffffff));
 //BA.debugLineNum = 665;BA.debugLine="File.WriteString(File.DirInternal, \"__id\", id)";
anywheresoftware.b4a.keywords.Common.File.WriteString(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"__id",BA.NumberToString(_id));
 //BA.debugLineNum = 666;BA.debugLine="Return id";
if (true) return BA.NumberToString(_id);
 };
 //BA.debugLineNum = 668;BA.debugLine="Log(api)";
anywheresoftware.b4a.keywords.Common.Log(BA.NumberToString(_api));
 }else {
 //BA.debugLineNum = 671;BA.debugLine="Return r.GetStaticField(\"android.os.Build\", \"SER";
if (true) return BA.ObjectToString(_r.GetStaticField("android.os.Build","SERIAL"));
 //BA.debugLineNum = 672;BA.debugLine="storage_check";
_storage_check();
 };
...
public static String  _mystats_update(float[] _cpuefficiency,float _ramusage) throws Exception{
 //BA.debugLineNum = 342;BA.debugLine="Sub myStats_Update(CPUEfficiency() As Float, RAMUs";
 //BA.debugLineNum = 344;BA.debugLine="End Sub";
return "";
}
public static byte[]  _object_to_byte(Object _obj) throws Exception{
anywheresoftware.b4a.randomaccessfile.B4XSerializator _ser = null;
 //BA.debugLineNum = 676;BA.debugLine="Sub object_to_byte(obj As Object)As Byte()";
 //BA.debugLineNum = 677;BA.debugLine="Dim ser As B4XSerializator";
_ser = new anywheresoftware.b4a.randomaccessfile.B4XSerializator();
 //BA.debugLineNum = 678;BA.debugLine="Return ser.ConvertObjectToBytes(obj)";
...
int _i = 0;
String _v = "";
 //BA.debugLineNum = 628;BA.debugLine="Sub ReadDir(folder As String, recursive As Boolean";
 //BA.debugLineNum = 629;BA.debugLine="ffolders.Clear";
mostCurrent._ffolders.Clear();
 //BA.debugLineNum = 630;BA.debugLine="ffiles.Clear";
mostCurrent._ffiles.Clear();
 //BA.debugLineNum = 632;BA.debugLine="Dim lst As List = File.ListFiles(folder)";
_lst = new anywheresoftware.b4a.objects.collections.List();
_lst = anywheresoftware.b4a.keywords.Common.File.ListFiles(_folder);
 //BA.debugLineNum = 633;BA.debugLine="For i = 0 To lst.Size - 1";
{
final int step4 = 1;
final int limit4 = (int) (_lst.getSize()-1);
for (_i = (int) (0) ; (step4 > 0 && _i <= limit4) || (step4 < 0 && _i >= limit4); _i = ((int)(0 + _i + step4)) ) {
 //BA.debugLineNum = 634;BA.debugLine="If File.IsDirectory(folder,lst.Get(i)) Then";
if (anywheresoftware.b4a.keywords.Common.File.IsDirectory(_folder,BA.ObjectToString(_lst.Get(_i)))) { 
 //BA.debugLineNum = 635;BA.debugLine="Dim v As String";
_v = "";
 //BA.debugLineNum = 636;BA.debugLine="v = folder&\"/\"&lst.Get(i)";
_v = _folder+"/"+BA.ObjectToString(_lst.Get(_i));
 //BA.debugLineNum = 638;BA.debugLine="ffolders.Add(v.SubString(root1.Length+1))";
mostCurrent._ffolders.Add((Object)(_v.substring((int) (mostCurrent._root1.length()+1))));
 //BA.debugLineNum = 640;BA.debugLine="If recursive Then";
if (_recursive) { 
 //BA.debugLineNum = 641;BA.debugLine="ReadDir(v,recursive)";
_readdir(_v,_recursive);
 };
 }else {
 //BA.debugLineNum = 645;BA.debugLine="ffiles.Add(folder&\"/\"&lst.Get(i))";
mostCurrent._ffiles.Add((Object)(_folder+"/"+BA.ObjectToString(_lst.Get(_i))));
 };
 }
};
 //BA.debugLineNum = 649;BA.debugLine="Log(ffolders.Size&\" Ordner / \"&ffiles.Size&\" Date";
...
int _j = 0;
 //BA.debugLineNum = 494;BA.debugLine="Sub real_delete";
 //BA.debugLineNum = 495;BA.debugLine="RunningTaskInfos=ActivityManager1.GetRunningTasks";
mostCurrent._runningtaskinfos = mostCurrent._activitymanager1.GetRunningTasks(processBA);
 //BA.debugLineNum = 496;BA.debugLine="Log(\"RunningTaskInfos.Length=\"&RunningTaskInfos.L";
anywheresoftware.b4a.keywords.Common.Log("RunningTaskInfos.Length="+BA.NumberToString(mostCurrent._runningtaskinfos.length));
 //BA.debugLineNum = 498;BA.debugLine="For j = 0 To list7.Size-1";
{
final int step3 = 1;
final int limit3 = (int) (mostCurrent._list7.getSize()-1);
for (_j = (int) (0) ; (step3 > 0 && _j <= limit3) || (step3 < 0 && _j >= limit3); _j = ((int)(0 + _j + step3)) ) {
 //BA.debugLineNum = 499;BA.debugLine="Log(\"Recent Tasks: \"&list7.get(j))";
anywheresoftware.b4a.keywords.Common.Log("Recent Tasks: "+BA.ObjectToString(mostCurrent._list7.Get(_j)));
 //BA.debugLineNum = 500;BA.debugLine="ActivityManager1.killBackgroundProcesses(\"com.ba";
mostCurrent._activitymanager1.KillBackgroundProcesses(processBA,"com.batcat");
 //BA.debugLineNum = 501;BA.debugLine="op.killProcess(list7.Get(j))";
mostCurrent._op.killProcess((int)(BA.ObjectToNumber(mostCurrent._list7.Get(_j))));
 }
};
 //BA.debugLineNum = 503;BA.debugLine="close";
_close();
...
public static String  _s_scan() throws Exception{
 //BA.debugLineNum = 321;BA.debugLine="Sub s_scan";
 //BA.debugLineNum = 324;BA.debugLine="lvg.startAnim";
mostCurrent._lvg.startAnim();
 //BA.debugLineNum = 325;BA.debugLine="catdel.ScanCache";
_catdel.ScanCache();
 //BA.debugLineNum = 327;BA.debugLine="c_start";
_c_start();
...
String _f = "";
 //BA.debugLineNum = 351;BA.debugLine="Sub storage_check";
 //BA.debugLineNum = 352;BA.debugLine="For i = 0 To paths.Size-1";
{
final int step1 = 1;
final int limit1 = (int) (mostCurrent._paths.getSize()-1);
for (_i = (int) (0) ; (step1 > 0 && _i <= limit1) || (step1 < 0 && _i >= limit1); _i = ((int)(0 + _i + step1)) ) {
 //BA.debugLineNum = 353;BA.debugLine="Log(paths.GetKeyAt(i)&\"=\"&paths.GetValueAt(i))";
anywheresoftware.b4a.keywords.Common.Log(BA.ObjectToString(mostCurrent._paths.GetKeyAt(_i))+"="+BA.ObjectToString(mostCurrent._paths.GetValueAt(_i)));
 ...
 //BA.debugLineNum = 356;BA.debugLine="Log (\"DirRootExternal = \"&de)";
anywheresoftware.b4a.keywords.Common.Log("DirRootExternal = "+mostCurrent._de);
 //BA.debugLineNum = 358;BA.debugLine="If mtc.Find = True Then";
if (mostCurrent._mtc.Find()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 359;BA.debugLine="Dim mnt As String = mtc.Group(0)";
_mnt = mostCurrent._mtc.Group((int) (0));
 //BA.debugLineNum = 361;BA.debugLine="Log (\"mount point = \"& mnt)";
anywheresoftware.b4a.keywords.Common.Log("mount point = "+_mnt);
 //BA.debugLineNum = 362;BA.debugLine="Dim dirs As List = File.ListFiles(mnt)";
_dirs = new anywheresoftware.b4a.objects.collections.List();
_dirs = anywheresoftware.b4a.keywords.Common.File.ListFiles(_mnt);
 //BA.debugLineNum = 363;BA.debugLine="For Each f As String In dirs";
...
_f = BA.ObjectToString(group9.Get(index9));
 //BA.debugLineNum = 364;BA.debugLine="If storage.isExternalStorageRemovable(mnt&f) Th";
if (mostCurrent._storage.isExternalStorageRemovable(_mnt+_f)) { 
 //BA.debugLineNum = 365;BA.debugLine="Log (\"Device = \"& f&\":\"&mnt&f&\" is removable\")";
anywheresoftware.b4a.keywords.Common.Log("Device = "+_f+":"+_mnt+_f+" is removable");
 //BA.debugLineNum = 366;BA.debugLine="If File.ListFiles(mnt&f).IsInitialized Then";
if (anywheresoftware.b4a.keywords.Common.File.ListFiles(_mnt+_f).IsInitialized()) { 
 //BA.debugLineNum = 367;BA.debugLine="Log(\"probably ExtSDCard: \"&mnt&f)";
anywheresoftware.b4a.keywords.Common.Log("probably ExtSDCard: "+_mnt+_f);
 //BA.debugLineNum = 368;BA.debugLine="extsdcard = mnt&f";
mostCurrent._extsdcard = _mnt+_f;
 }else {
 };
 }else {
 //BA.debugLineNum = 373;BA.debugLine="Log (\"Device = \"& f&\":\"&mnt&f&\" is NOT removab";
anywheresoftware.b4a.keywords.Common.Log("Device = "+_f+":"+_mnt+_f+" is NOT removable");
 };
 }
;
 };
 //BA.debugLineNum = 378;BA.debugLine="s_scan";
_s_scan();
 //BA.debugLineNum = 379;BA.debugLine="End Sub";
return "";
}
public static String  _store_check() throws Exception{
 //BA.debugLineNum = 224;BA.debugLine="Sub store_check";
 //BA.debugLineNum = 225;BA.debugLine="c1=mcl.md_light_blue_A400";
_c1 = mostCurrent._mcl.getmd_light_blue_A400();
 //BA.debugLineNum = 226;BA.debugLine="c2=mcl.md_amber_A400";
_c2 = mostCurrent._mcl.getmd_amber_A400();
 //BA.debugLineNum = 227;BA.debugLine="c3=mcl.md_white_1000";
_c3 = mostCurrent._mcl.getmd_white_1000();
 //BA.debugLineNum = 228;BA.debugLine="c4=mcl.md_teal_A400";
_c4 = mostCurrent._mcl.getmd_teal_A400();
 //BA.debugLineNum = 229;BA.debugLine="c5=mcl.md_deep_purple_A400";
_c5 = mostCurrent._mcl.getmd_deep_purple_A400();
 //BA.debugLineNum = 230;BA.debugLine="c6=mcl.md_red_A700";
_c6 = mostCurrent._mcl.getmd_red_A700();
 //BA.debugLineNum = 231;BA.debugLine="c7=mcl.md_indigo_A400";
_c7 = mostCurrent._mcl.getmd_indigo_A400();
 //BA.debugLineNum = 232;BA.debugLine="c8=mcl.md_blue_A400";
_c8 = mostCurrent._mcl.getmd_blue_A400();
 //BA.debugLineNum = 233;BA.debugLine="c9=mcl.md_orange_A700";
_c9 = mostCurrent._mcl.getmd_orange_A700();
 //BA.debugLineNum = 234;BA.debugLine="c10=mcl.md_grey_600";
_c10 = mostCurrent._mcl.getmd_grey_600();
 //BA.debugLineNum = 235;BA.debugLine="c11=mcl.md_green_A400";
_c11 = mostCurrent._mcl.getmd_green_A400();
 //BA.debugLineNum = 236;BA.debugLine="c12=mcl.md_black_1000";
_c12 = mostCurrent._mcl.getmd_black_1000();
 //BA.debugLineNum = 237;BA.debugLine="c13=mcl.md_light_green_A400";
_c13 = mostCurrent._mcl.getmd_light_green_A400();
 //BA.debugLineNum = 238;BA.debugLine="c14=mcl.md_cyan_A400";
_c14 = mostCurrent._mcl.getmd_cyan_A400();
 //BA.debugLineNum = 239;BA.debugLine="c15=mcl.md_blue_grey_400";
_c15 = mostCurrent._mcl.getmd_blue_grey_400();
 //BA.debugLineNum = 240;BA.debugLine="c16=mcl.md_light_blue_A400";
_c16 = mostCurrent._mcl.getmd_light_blue_A400();
 //BA.debugLineNum = 241;BA.debugLine="If kvs4sub.ContainsKey(\"off\") Then";
if (mostCurrent._kvs4sub._containskey("off")) { 
 //BA.debugLineNum = 242;BA.debugLine="StopService(Starter)";
anywheresoftware.b4a.keywords.Common.StopService(mostCurrent.activityBA,(Object)(mostCurrent._starter.getObject()));
 };
 //BA.debugLineNum = 244;BA.debugLine="If kvs4.ContainsKey(\"0\")Then";
if (mostCurrent._kvs4._containskey("0")) { 
 //BA.debugLineNum = 245;BA.debugLine="Log(\"AC_true->1\")";
...
mostCurrent._activity.setColor(_c1);
 ...
 //BA.debugLineNum = 249;BA.debugLine="If kvs4.ContainsKey(\"1\")Then";
if (mostCurrent._kvs4._containskey("1")) { 
 //BA.debugLineNum = 250;BA.debugLine="Log(\"AC_true->2\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->2");
 //BA.debugLineNum = 251;BA.debugLine="Activity.Color=c2";
mostCurrent._activity.setColor(_c2);
 };
 //BA.debugLineNum = 254;BA.debugLine="If kvs4.ContainsKey(\"2\")Then";
if (mostCurrent._kvs4._containskey("2")) { 
 //BA.debugLineNum = 255;BA.debugLine="Log(\"AC_true->3\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->3");
 //BA.debugLineNum = 256;BA.debugLine="Activity.Color=c3";
mostCurrent._activity.setColor(_c3);
 //BA.debugLineNum = 257;BA.debugLine="Label1.TextColor=Colors.Black";
mostCurrent._label1.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 };
 //BA.debugLineNum = 259;BA.debugLine="If kvs4.ContainsKey(\"3\")Then";
...
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 261;BA.debugLine="Activity.Color=c4";
mostCurrent._activity.setColor(_c4);
 };
 //BA.debugLineNum = 264;BA.debugLine="If kvs4.ContainsKey(\"4\")Then";
if (mostCurrent._kvs4._containskey("4")) { 
 //BA.debugLineNum = 265;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 266;BA.debugLine="Activity.Color=c5";
mostCurrent._activity.setColor(_c5);
 };
 //BA.debugLineNum = 269;BA.debugLine="If kvs4.ContainsKey(\"5\")Then";
if (mostCurrent._kvs4._containskey("5")) { 
 //BA.debugLineNum = 270;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 271;BA.debugLine="Activity.Color=c6";
mostCurrent._activity.setColor(_c6);
 };
 //BA.debugLineNum = 274;BA.debugLine="If kvs4.ContainsKey(\"6\")Then";
if (mostCurrent._kvs4._containskey("6")) { 
 //BA.debugLineNum = 275;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 276;BA.debugLine="Activity.Color=c7";
...
mostCurrent._activity.setColor(_c8);
 ...
 //BA.debugLineNum = 284;BA.debugLine="If kvs4.ContainsKey(\"8\")Then";
if (mostCurrent._kvs4._containskey("8")) { 
 //BA.debugLineNum = 285;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 286;BA.debugLine="Activity.Color=c9";
mostCurrent._activity.setColor(_c9);
 };
 //BA.debugLineNum = 289;BA.debugLine="If kvs4.ContainsKey(\"9\")Then";
if (mostCurrent._kvs4._containskey("9")) { 
 //BA.debugLineNum = 290;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 291;BA.debugLine="Activity.Color=c10";
mostCurrent._activity.setColor(_c10);
 };
 //BA.debugLineNum = 294;BA.debugLine="If kvs4.ContainsKey(\"10\")Then";
if (mostCurrent._kvs4._containskey("10")) { 
 //BA.debugLineNum = 295;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 296;BA.debugLine="Activity.Color=c11";
mostCurrent._activity.setColor(_c11);
 };
 //BA.debugLineNum = 299;BA.debugLine="If kvs4.ContainsKey(\"11\")Then";
if (mostCurrent._kvs4._containskey("11")) { 
 //BA.debugLineNum = 300;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 301;BA.debugLine="Activity.Color=c12";
mostCurrent._activity.setColor(_c12);
 //BA.debugLineNum = 302;BA.debugLine="Label1.TextColor=Colors.ARGB(200,255,255,255)";
mostCurrent._label1.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 };
 //BA.debugLineNum = 304;BA.debugLine="If kvs4.ContainsKey(\"12\")Then";
if (mostCurrent._kvs4._containskey("12")) { 
 //BA.debugLineNum = 305;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 306;BA.debugLine="Activity.Color=c13";
mostCurrent._activity.setColor(_c13);
 };
 //BA.debugLineNum = 309;BA.debugLine="If kvs4.ContainsKey(\"13\")Then";
if (mostCurrent._kvs4._containskey("13")) { 
 //BA.debugLineNum = 310;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 311;BA.debugLine="Activity.Color=c14";
mostCurrent._activity.setColor(_c14);
 };
 //BA.debugLineNum = 314;BA.debugLine="If kvs4.ContainsKey(\"14\")Then";
if (mostCurrent._kvs4._containskey("14")) { 
 //BA.debugLineNum = 315;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 316;BA.debugLine="Activity.Color=c15";
...
public static String  _t_start() throws Exception{
 //BA.debugLineNum = 459;BA.debugLine="Sub t_start";
 //BA.debugLineNum = 460;BA.debugLine="lvg.startAnim";
mostCurrent._lvg.startAnim();
 //BA.debugLineNum = 461;BA.debugLine="dpm1.max=100";
mostCurrent._dpm1.setMax((int) (100));
 //BA.debugLineNum = 462;BA.debugLine="t1.Enabled=True";
_t1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 463;BA.debugLine="t1_Tick";
_t1_tick();
 //BA.debugLineNum = 464;BA.debugLine="End Sub";
return "";
}
public static String  _t1_tick() throws Exception{
 //BA.debugLineNum = 507;BA.debugLine="Sub t1_Tick";
 //BA.debugLineNum = 508;BA.debugLine="count=count+1";
_count = (int) (_count+1);
 //BA.debugLineNum = 509;BA.debugLine="ListView1.SetSelection(-1)";
mostCurrent._listview1.SetSelection((int) (-1));
 //BA.debugLineNum = 510;BA.debugLine="dpm1.Max=100";
mostCurrent._dpm1.setMax((int) (100));
 //BA.debugLineNum = 511;BA.debugLine="dpm1.UnfinishedStrokeWidth=20";
mostCurrent._dpm1.setUnfinishedStrokeWidth((float) (20));
 //BA.debugLineNum = 512;BA.debugLine="dpm1.UnfinishedStrokeColor=Colors.ARGB(180,255,25";
mostCurrent._dpm1.setUnfinishedStrokeColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (180),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 513;BA.debugLine="If count>0 Then";
if (_count>0) { 
 //BA.debugLineNum = 514;BA.debugLine="Label1.text=\"search Battery..\"";
mostCurrent._label1.setText(BA.ObjectToCharSequence("search Battery.."));
 };
 //BA.debugLineNum = 516;BA.debugLine="If count > 1 Then";
if (_count>1) { 
 //BA.debugLineNum = 518;BA.debugLine="Label1.text=\"check Battery..\"";
mostCurrent._label1.setText(BA.ObjectToCharSequence("check Battery.."));
 //BA.debugLineNum = 519;BA.debugLine="dpm1.Progress=20";
mostCurrent._dpm1.setProgress((int) (20));
 };
 //BA.debugLineNum = 521;BA.debugLine="If count > 2 Then";
if (_count>2) { 
 //BA.debugLineNum = 522;BA.debugLine="Label1.text=\"optimize Battery..\"";
mostCurrent._label1.setText(BA.ObjectToCharSequence("optimize Battery.."));
 //BA.debugLineNum = 523;BA.debugLine="dpm1.Progress=36";
mostCurrent._dpm1.setProgress((int) (36));
 };
 //BA.debugLineNum = 525;BA.debugLine="If count > 3 Then";
if (_count>3) { 
 //BA.debugLineNum = 527;BA.debugLine="Label1.text=\"search Application cache\"";
mostCurrent._label1.setText(BA.ObjectToCharSequence("search Application cache"));
 //BA.debugLineNum = 529;BA.debugLine="dpm1.Progress=42";
mostCurrent._dpm1.setProgress((int) (42));
 };
 //BA.debugLineNum = 532;BA.debugLine="If count > 4 Then";
if (_count>4) { 
 //BA.debugLineNum = 534;BA.debugLine="dpm1.Progress=52";
mostCurrent._dpm1.setProgress((int) (52));
 //BA.debugLineNum = 537;BA.debugLine="Label1.text=\"cleaning Cache System..\"";
mostCurrent._label1.setText(BA.ObjectToCharSequence("cleaning Cache System.."));
 //BA.debugLineNum = 539;BA.debugLine="dpm1.Progress=67";
mostCurrent._dpm1.setProgress((int) (67));
 };
 //BA.debugLineNum = 541;BA.debugLine="If count > 5 Then";
if (_count>5) { 
 //BA.debugLineNum = 542;BA.debugLine="dpm1.Progress=89";
mostCurrent._dpm1.setProgress((int) (89));
 //BA.debugLineNum = 543;BA.debugLine="Label1.text=\"deleting Garbage Cache..\"";
mostCurrent._label1.setText(BA.ObjectToCharSequence("deleting Garbage Cache.."));
 //BA.debugLineNum = 546;BA.debugLine="Label1.text=\"check: \"&op.formatSize(op.Availab";
mostCurrent._label1.setText(BA.ObjectToCharSequence("check: "+mostCurrent._op.formatSize(mostCurrent._op.getAvailableMemory())));
 //BA.debugLineNum = 548;BA.debugLine="dpm1.Progress=100";
mostCurrent._dpm1.setProgress((int) (100));
 };
 //BA.debugLineNum = 550;BA.debugLine="If count > 6 Then";
if (_count>6) { 
 //BA.debugLineNum = 553;BA.debugLine="Label1.text=op.formatSize(cat.FreeMemory)";
mostCurrent._label1.setText(BA.ObjectToCharSequence(mostCurrent._op.formatSize(mostCurrent._cat.getFreeMemory())));
 //BA.debugLineNum = 555;BA.debugLine="CallSub(Me,\"del_quest\")";
