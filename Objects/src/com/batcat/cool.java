...
public anywheresoftware.b4a.objects.drawable.ColorDrawable _mbmp = null;
...
int _h = 0;
 ...
 //BA.debugLineNum = 66;BA.debugLine="Activity.LoadLayout(\"5\")";
mostCurrent._activity.LoadLayout("5",mostCurrent.activityBA);
 //BA.debugLineNum = 67;BA.debugLine="Activity.Title=pak.GetApplicationLabel(\"com.batca";
mostCurrent._activity.setTitle(BA.ObjectToCharSequence(mostCurrent._pak.GetApplicationLabel("com.batcat")+" - "+mostCurrent._pak.GetVersionName("com.batcat")));
 //BA.debugLineNum = 68;BA.debugLine="op.Initialize(\"op\")";
mostCurrent._op.Initialize(processBA,"op");
 //BA.debugLineNum = 69;BA.debugLine="list1.Initialize";
mostCurrent._list1.Initialize();
 //BA.debugLineNum = 70;BA.debugLine="list2.Initialize";
mostCurrent._list2.Initialize();
 //BA.debugLineNum = 71;BA.debugLine="list3.Initialize";
mostCurrent._list3.Initialize();
 //BA.debugLineNum = 72;BA.debugLine="list4.Initialize";
mostCurrent._list4.Initialize();
 //BA.debugLineNum = 73;BA.debugLine="list5.Initialize";
mostCurrent._list5.Initialize();
 //BA.debugLineNum = 74;BA.debugLine="list6.Initialize";
mostCurrent._list6.Initialize();
 //BA.debugLineNum = 75;BA.debugLine="list7.Initialize";
mostCurrent._list7.Initialize();
 //BA.debugLineNum = 76;BA.debugLine="list8.Initialize";
mostCurrent._list8.Initialize();
 //BA.debugLineNum = 77;BA.debugLine="list9.Initialize";
mostCurrent._list9.Initialize();
 //BA.debugLineNum = 78;BA.debugLine="reslist.Initialize";
mostCurrent._reslist.Initialize();
 //BA.debugLineNum = 79;BA.debugLine="apklist.Initialize";
mostCurrent._apklist.Initialize();
 //BA.debugLineNum = 80;BA.debugLine="clist.Initialize";
mostCurrent._clist.Initialize();
 //BA.debugLineNum = 81;BA.debugLine="aclist.Initialize";
mostCurrent._aclist.Initialize();
 //BA.debugLineNum = 82;BA.debugLine="filelist.Initialize";
mostCurrent._filelist.Initialize();
 //BA.debugLineNum = 83;BA.debugLine="apclist.Initialize";
mostCurrent._apclist.Initialize();
 //BA.debugLineNum = 84;BA.debugLine="ph.Initialize(\"ph\")";
mostCurrent._ph.Initialize(processBA,"ph");
 //BA.debugLineNum = 85;BA.debugLine="piclist.Initialize";
mostCurrent._piclist.Initialize();
 //BA.debugLineNum = 86;BA.debugLine="lis.Initialize";
mostCurrent._lis.Initialize();
 //BA.debugLineNum = 89;BA.debugLine="l1.Initialize(\"l1\")";
mostCurrent._l1.Initialize(mostCurrent.activityBA,"l1");
 //BA.debugLineNum = 90;BA.debugLine="l2.Initialize(\"l2\")";
mostCurrent._l2.Initialize(mostCurrent.activityBA,"l2");
 //BA.debugLineNum = 92;BA.debugLine="phlis.Initialize";
mostCurrent._phlis.Initialize();
 //BA.debugLineNum = 93;BA.debugLine="diapan.Initialize(\"diapan\")";
mostCurrent._diapan.Initialize(mostCurrent.activityBA,"diapan");
 //BA.debugLineNum = 94;BA.debugLine="dial.Initialize(\"dial\")";
mostCurrent._dial.Initialize(mostCurrent.activityBA,"dial");
 //BA.debugLineNum = 95;BA.debugLine="dill.Initialize";
mostCurrent._dill.Initialize();
 //BA.debugLineNum = 96;BA.debugLine="lw2.Initialize(\"lw2\")";
...
mostCurrent._ffiles.Initialize();
 //BA.debugLineNum = 98;BA.debugLine="ph.Initialize(\"ph\")";
mostCurrent._ph.Initialize(processBA,"ph");
 //BA.debugLineNum = 99;BA.debugLine="ffiles.Initialize";
mostCurrent._ffiles.Initialize();
 //BA.debugLineNum = 100;BA.debugLine="ffolders.Initialize";
...
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal()+"/mnt/cache","ressize.txt")) { 
 //BA.debugLineNum = 105;BA.debugLine="ToastMessageShow(\"core ready...!\",False)";
...
anywheresoftware.b4a.keywords.Common.File.WriteList(anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal()+"/mnt/cache","fn.txt",mostCurrent._list1);
 //BA.debugLineNum = 114;BA.debugLine="File.WriteList(File.DirDefaultExternal&\"/mnt/cach";
anywheresoftware.b4a.keywords.Common.File.WriteList(anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal()+"/mnt/cache","apk1.txt",mostCurrent._list7);
 //BA.debugLineNum = 115;BA.debugLine="File.WriteList(File.DirDefaultExternal&\"/mnt/cach";
anywheresoftware.b4a.keywords.Common.File.WriteList(anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal()+"/mnt/cache","apk2.txt",mostCurrent._list8);
 //BA.debugLineNum = 116;BA.debugLine="File.WriteList(File.DirDefaultExternal&\"/mnt/cach";
anywheresoftware.b4a.keywords.Common.File.WriteList(anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal()+"/mnt/cache","apk3.txt",mostCurrent._list9);
 //BA.debugLineNum = 117;BA.debugLine="File.WriteList(File.DirDefaultExternal&\"/mnt/cach";
anywheresoftware.b4a.keywords.Common.File.WriteList(anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal()+"/mnt/cache","pn1.txt",mostCurrent._lis);
 //BA.debugLineNum = 118;BA.debugLine="File.WriteList(File.DirDefaultExternal&\"/mnt/cach";
anywheresoftware.b4a.keywords.Common.File.WriteList(anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal()+"/mnt/cache","apsize.txt",mostCurrent._clist);
 //BA.debugLineNum = 119;BA.debugLine="File.WriteList(File.DirDefaultExternal&\"/mnt/cach";
anywheresoftware.b4a.keywords.Common.File.WriteList(anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal()+"/mnt/cache","ressize.txt",mostCurrent._reslist);
 //BA.debugLineNum = 120;BA.debugLine="File.WriteString(File.DirDefaultExternal&\"/mnt/";
anywheresoftware.b4a.keywords.Common.File.WriteString(anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal()+"/mnt/cache","cclist.txt","");
 //BA.debugLineNum = 121;BA.debugLine="ToastMessageShow(\"Files ready! \"&date&\", \"&time,F";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("Files ready! "+mostCurrent._date+", "+mostCurrent._time),anywheresoftware.b4a.keywords.Common.False);
 ...
 //BA.debugLineNum = 125;BA.debugLine="t1.Initialize(\"t1\",1000)";
_t1.Initialize(processBA,"t1",(long) (1000));
 //BA.debugLineNum = 126;BA.debugLine="t1.Enabled=False";
...
mostCurrent._diapan.AddView((android.view.View)(mostCurrent._lw2.getObject()),(int) (3),(int) (3),(int) (-1),(int) (-1));
 //BA.debugLineNum = 141;BA.debugLine="paths = storage.Initialize";
...
mostCurrent._nativeme.InitializeContext(processBA);
 //BA.debugLineNum = 149;BA.debugLine="Panel2.Visible=False";
mostCurrent._panel2.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 151;BA.debugLine="ffil.Initialize";
mostCurrent._ffil.Initialize();
 //BA.debugLineNum = 152;BA.debugLine="ffold.Initialize";
mostCurrent._ffold.Initialize();
 //BA.debugLineNum = 153;BA.debugLine="Activity.Color=mcl.md_white_1000";
mostCurrent._activity.setColor(mostCurrent._mcl.getmd_white_1000());
 //BA.debugLineNum = 157;BA.debugLine="For h = 0 To clist.Size-1";
{
final int step66 = 1;
final int limit66 = (int) (mostCurrent._clist.getSize()-1);
for (_h = (int) (0) ; (step66 > 0 && _h <= limit66) || (step66 < 0 && _h >= limit66); _h = ((int)(0 + _h + step66)) ) {
 //BA.debugLineNum = 158;BA.debugLine="Log(clist.Get(h))";
anywheresoftware.b4a.keywords.Common.Log(BA.ObjectToString(mostCurrent._clist.Get(_h)));
 }
};
 //BA.debugLineNum = 160;BA.debugLine="andro.Initialize(File.DirAssets,\"ic_autorenew_bla";
mostCurrent._andro.Initialize(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_autorenew_black_48dp.png");
 //BA.debugLineNum = 161;BA.debugLine="bat.Initialize(File.DirAssets,\"ic_data_usage_blac";
mostCurrent._bat.Initialize(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_data_usage_black_48dp.png");
 //BA.debugLineNum = 162;BA.debugLine="desk.Initialize(File.DirAssets, \"ic_battery_alert";
mostCurrent._desk.Initialize(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_battery_alert_black_48dp.png");
 //BA.debugLineNum = 163;BA.debugLine="work.Initialize(File.DirAssets, \"ic_delete_black_";
mostCurrent._work.Initialize(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_delete_black_48dp.png");
 //BA.debugLineNum = 165;BA.debugLine="anima.InitializeAlpha(\"anima\",0,1)";
mostCurrent._anima.InitializeAlpha(mostCurrent.activityBA,"anima",(float) (0),(float) (1));
 //BA.debugLineNum = 170;BA.debugLine="GetDeviceId";
_getdeviceid();
 //BA.debugLineNum = 171;BA.debugLine="c_start";
_c_start();
 //BA.debugLineNum = 173;BA.debugLine="clean_start";
_clean_start();
...
public static String  _activity_resume() throws Exception{
 ...
 //BA.debugLineNum = 177;BA.debugLine="t1.Enabled=True";
...
int _i = 0;
 //BA.debugLineNum = 557;BA.debugLine="Sub app_info";
 //BA.debugLineNum = 559;BA.debugLine="list1=pak.GetInstalledPackages";
mostCurrent._list1 = mostCurrent._pak.GetInstalledPackages();
 //BA.debugLineNum = 561;BA.debugLine="Obj1.Target = Obj1.GetContext";
mostCurrent._obj1.Target = (Object)(mostCurrent._obj1.GetContext(processBA));
 //BA.debugLineNum = 562;BA.debugLine="Obj1.Target = Obj1.RunMethod(\"getPackageManager\")";
mostCurrent._obj1.Target = mostCurrent._obj1.RunMethod("getPackageManager");
 //BA.debugLineNum = 563;BA.debugLine="Obj2.Target = Obj1.RunMethod2(\"getInstalledPackag";
mostCurrent._obj2.Target = mostCurrent._obj1.RunMethod2("getInstalledPackages",BA.NumberToString(0),"java.lang.int");
 //BA.debugLineNum = 564;BA.debugLine="size = Obj2.RunMethod(\"size\")";
_size = (int)(BA.ObjectToNumber(mostCurrent._obj2.RunMethod("size")));
 //BA.debugLineNum = 569;BA.debugLine="For i = 0 To size -1";
{
final int step6 = 1;
final int limit6 = (int) (_size-1);
for (_i = (int) (0) ; (step6 > 0 && _i <= limit6) || (step6 < 0 && _i >= limit6); _i = ((int)(0 + _i + step6)) ) {
 //BA.debugLineNum = 570;BA.debugLine="Obj3.Target = Obj2.RunMethod2(\"get\", i, \"java.la";
mostCurrent._obj3.Target = mostCurrent._obj2.RunMethod2("get",BA.NumberToString(_i),"java.lang.int");
 //BA.debugLineNum = 571;BA.debugLine="size = Obj2.RunMethod(\"size\")";
_size = (int)(BA.ObjectToNumber(mostCurrent._obj2.RunMethod("size")));
 //BA.debugLineNum = 573;BA.debugLine="Obj3.Target = Obj3.GetField(\"applicationInfo\") '";
mostCurrent._obj3.Target = mostCurrent._obj3.GetField("applicationInfo");
 //BA.debugLineNum = 574;BA.debugLine="flags = Obj3.GetField(\"flags\")";
_flags = (int)(BA.ObjectToNumber(mostCurrent._obj3.GetField("flags")));
 //BA.debugLineNum = 575;BA.debugLine="packName = Obj3.GetField(\"packageName\")";
mostCurrent._packname = BA.ObjectToString(mostCurrent._obj3.GetField("packageName"));
 //BA.debugLineNum = 577;BA.debugLine="If Bit.And(flags, 1)  = 0 Then";
...
mostCurrent._icon.setObject((android.graphics.drawable.BitmapDrawable)(mostCurrent._obj1.RunMethod4("getApplicationIcon",mostCurrent._args,mostCurrent._types)));
 //BA.debugLineNum = 585;BA.debugLine="phlis.Add(icon.Bitmap)";
mostCurrent._phlis.Add((Object)(mostCurrent._icon.getBitmap()));
 //BA.debugLineNum = 586;BA.debugLine="list3.Add(packName)";
mostCurrent._list3.Add((Object)(mostCurrent._packname));
 //BA.debugLineNum = 591;BA.debugLine="Log(ffolders.Size&\" folder / \"&ffiles.Size&\" fi";
...
anywheresoftware.b4a.randomaccessfile.B4XSerializator _ser = null;
 //BA.debugLineNum = 604;BA.debugLine="Sub byte_to_object(data() As Byte)As Object";
 //BA.debugLineNum = 605;BA.debugLine="Dim ser As B4XSerializator";
_ser = new anywheresoftware.b4a.randomaccessfile.B4XSerializator();
 //BA.debugLineNum = 606;BA.debugLine="Return ser.ConvertBytesToObject(data)";
...
public static String  _c_start() throws Exception{
 //BA.debugLineNum = 194;BA.debugLine="Sub c_start";
 //BA.debugLineNum = 195;BA.debugLine="app_info";
_app_info();
 //BA.debugLineNum = 197;BA.debugLine="dill.Clear";
mostCurrent._dill.Clear();
 //BA.debugLineNum = 198;BA.debugLine="reslist.Clear";
mostCurrent._reslist.Clear();
 //BA.debugLineNum = 199;BA.debugLine="piclist.Clear";
mostCurrent._piclist.Clear();
 //BA.debugLineNum = 200;BA.debugLine="filelist.Clear";
mostCurrent._filelist.Clear();
 //BA.debugLineNum = 201;BA.debugLine="apclist.Clear";
mostCurrent._apclist.Clear();
 //BA.debugLineNum = 202;BA.debugLine="list2.Clear";
mostCurrent._list2.Clear();
 //BA.debugLineNum = 203;BA.debugLine="list4.Clear";
mostCurrent._list4.Clear();
 //BA.debugLineNum = 204;BA.debugLine="phlis.Clear";
mostCurrent._phlis.Clear();
 //BA.debugLineNum = 205;BA.debugLine="piclist.Add(andro)";
mostCurrent._piclist.Add((Object)(mostCurrent._andro.getObject()));
 //BA.debugLineNum = 206;BA.debugLine="piclist.Add(bat)";
mostCurrent._piclist.Add((Object)(mostCurrent._bat.getObject()));
 //BA.debugLineNum = 207;BA.debugLine="piclist.Add(desk)";
mostCurrent._piclist.Add((Object)(mostCurrent._desk.getObject()));
 //BA.debugLineNum = 208;BA.debugLine="li4";
_li4();
 //BA.debugLineNum = 209;BA.debugLine="cat_start";
_cat_start();
...
long _size1 = 0L;
String _f = "";
 //BA.debugLineNum = 660;BA.debugLine="Sub CalcSize(Folder As String, recursive As Boolea";
 //BA.debugLineNum = 661;BA.debugLine="Dim size1 As Long";
_size1 = 0L;
 //BA.debugLineNum = 662;BA.debugLine="For Each f As String In File.ListFiles(Folder)";
...
_f = BA.ObjectToString(group2.Get(index2));
 //BA.debugLineNum = 663;BA.debugLine="If recursive Then";
if (_recursive) { 
 //BA.debugLineNum = 664;BA.debugLine="If File.IsDirectory(Folder, f) Then";
if (anywheresoftware.b4a.keywords.Common.File.IsDirectory(_folder,_f)) { 
 //BA.debugLineNum = 665;BA.debugLine="size1 = size1 + CalcSize(File.Combine(Folder,";
_size1 = (long) (_size1+_calcsize(anywheresoftware.b4a.keywords.Common.File.Combine(_folder,_f),_recursive));
 };
 };
 //BA.debugLineNum = 668;BA.debugLine="size1 = size1 + File.Size(Folder, f)";
_size1 = (long) (_size1+anywheresoftware.b4a.keywords.Common.File.Size(_folder,_f));
 }
;
 //BA.debugLineNum = 670;BA.debugLine="Return size1";
if (true) return _size1;
 //BA.debugLineNum = 671;BA.debugLine="End Sub";
return 0L;
}
public static String  _cat_start() throws Exception{
 //BA.debugLineNum = 269;BA.debugLine="Sub cat_start";
 //BA.debugLineNum = 280;BA.debugLine="dpm1.Color=Colors.Transparent";
mostCurrent._dpm1.setColor(anywheresoftware.b4a.keywords.Common.Colors.Transparent);
 //BA.debugLineNum = 281;BA.debugLine="dpm1.FinishedStrokeColor=mcl.md_light_blue_A700";
mostCurrent._dpm1.setFinishedStrokeColor(mostCurrent._mcl.getmd_light_blue_A700());
 //BA.debugLineNum = 282;BA.debugLine="dpm1.FinishedStrokeWidth=25";
mostCurrent._dpm1.setFinishedStrokeWidth((float) (25));
 //BA.debugLineNum = 283;BA.debugLine="dpm1.UnfinishedStrokeColor=mcl.md_grey_700";
mostCurrent._dpm1.setUnfinishedStrokeColor(mostCurrent._mcl.getmd_grey_700());
 //BA.debugLineNum = 284;BA.debugLine="dpm1.UnfinishedStrokeWidth=30";
mostCurrent._dpm1.setUnfinishedStrokeWidth((float) (30));
 //BA.debugLineNum = 285;BA.debugLine="dpm1.SuffixText=\"% -> fertig..\"";
mostCurrent._dpm1.setSuffixText("% -> fertig..");
 //BA.debugLineNum = 286;BA.debugLine="dpm1.InnerBackgroundColor=mcl.md_cyan_A100";
mostCurrent._dpm1.setInnerBackgroundColor(mostCurrent._mcl.getmd_cyan_A100());
 //BA.debugLineNum = 287;BA.debugLine="dpm1.InnerBottomText=\"working...\"";
mostCurrent._dpm1.setInnerBottomText("working...");
 //BA.debugLineNum = 288;BA.debugLine="dpm1.InnerBottomTextSize=18";
mostCurrent._dpm1.setInnerBottomTextSize((float) (18));
 //BA.debugLineNum = 289;BA.debugLine="dpm1.InnerBottomTextColor=Colors.Black";
mostCurrent._dpm1.setInnerBottomTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 290;BA.debugLine="dpm1.PrefixText=\"Boost: \"";
mostCurrent._dpm1.setPrefixText("Boost: ");
 //BA.debugLineNum = 292;BA.debugLine="clean_start";
_clean_start();
 //BA.debugLineNum = 293;BA.debugLine="t1.Enabled=True";
_t1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 294;BA.debugLine="t1_Tick";
_t1_tick();
 //BA.debugLineNum = 295;BA.debugLine="End Sub";
return "";
}
public static String  _clean_start() throws Exception{
 //BA.debugLineNum = 523;BA.debugLine="Sub clean_start";
 //BA.debugLineNum = 536;BA.debugLine="End Sub";
return "";
}
public static String  _close() throws Exception{
String _df = "";
 //BA.debugLineNum = 350;BA.debugLine="Sub close";
 //BA.debugLineNum = 351;BA.debugLine="If Not(apklist.size=0) Then";
if (anywheresoftware.b4a.keywords.Common.Not(mostCurrent._apklist.getSize()==0)) { 
 //BA.debugLineNum = 352;BA.debugLine="Dim df As String";
_df = "";
 //BA.debugLineNum = 353;BA.debugLine="df=apklist.size";
_df = BA.NumberToString(mostCurrent._apklist.getSize());
 //BA.debugLineNum = 354;BA.debugLine="Label1.Text=op.formatSize(cat.FreeMemory)&\" RAM";
mostCurrent._label1.setText(BA.ObjectToCharSequence(mostCurrent._op.formatSize(mostCurrent._cat.getFreeMemory())+" RAM free! "+BA.NumberToString(mostCurrent._list4.getSize())+" -Backround Processes closed."+_df+" Files and Trash Data cleared"));
 ...
 //BA.debugLineNum = 356;BA.debugLine="Label1.Text=op.formatSize(cat.FreeMemory)&\" RAM";
mostCurrent._label1.setText(BA.ObjectToCharSequence(mostCurrent._op.formatSize(mostCurrent._cat.getFreeMemory())+" RAM free! "+BA.NumberToString(mostCurrent._list4.getSize())+" Backround Processes killed...!"));
 ...
 //BA.debugLineNum = 361;BA.debugLine="delayed_t2";
_delayed_t2();
...
String _f = "";
 //BA.debugLineNum = 306;BA.debugLine="Private Sub CopyFolder(Source As String, targetFol";
 //BA.debugLineNum = 307;BA.debugLine="If File.Exists(targetFolder, \"\") = False Then Fil";
...
anywheresoftware.b4a.keywords.Common.File.MakeDir(_targetfolder,"");};
 //BA.debugLineNum = 308;BA.debugLine="For Each f As String In File.ListFiles(Source)";
final anywheresoftware.b4a.BA.IterableList group2 = anywheresoftware.b4a.keywords.Common.File.ListFiles(_source);
final int groupLen2 = group2.getSize();
for (int index2 = 0;index2 < groupLen2 ;index2++){
_f = BA.ObjectToString(group2.Get(index2));
 //BA.debugLineNum = 309;BA.debugLine="If File.IsDirectory(Source, f) Then";
if (anywheresoftware.b4a.keywords.Common.File.IsDirectory(_source,_f)) { 
 //BA.debugLineNum = 310;BA.debugLine="CopyFolder(File.Combine(Source, f), File.Combin";
_copyfolder(anywheresoftware.b4a.keywords.Common.File.Combine(_source,_f),anywheresoftware.b4a.keywords.Common.File.Combine(_targetfolder,_f));
 //BA.debugLineNum = 311;BA.debugLine="Continue";
if (true) continue;
 };
 //BA.debugLineNum = 313;BA.debugLine="File.Copy(Source, f, targetFolder, f)";
...
public static String  _del_quest() throws Exception{
 //BA.debugLineNum = 364;BA.debugLine="Sub del_quest";
 //BA.debugLineNum = 366;BA.debugLine="ImageView1.Bitmap=LoadBitmap(File.DirAssets,\"Acce";
mostCurrent._imageview1.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Accept128.png").getObject()));
 //BA.debugLineNum = 367;BA.debugLine="Label1.Text= \"clear RAM and close..\"";
mostCurrent._label1.setText(BA.ObjectToCharSequence("clear RAM and close.."));
 //BA.debugLineNum = 369;BA.debugLine="real_delete";
_real_delete();
 //BA.debugLineNum = 372;BA.debugLine="End Sub";
return "";
}
public static String  _delayed_t2() throws Exception{
 //BA.debugLineNum = 480;BA.debugLine="Sub delayed_t2";
 //BA.debugLineNum = 481;BA.debugLine="dpm1.SetLayoutAnimated(0dip,0dip,0,0,0)";
mostCurrent._dpm1.SetLayoutAnimated(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (0)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (0)),(int) (0),(int) (0),(int) (0));
 //BA.debugLineNum = 482;BA.debugLine="anima.Stop(ImageView1)";
mostCurrent._anima.Stop((android.view.View)(mostCurrent._imageview1.getObject()));
 //BA.debugLineNum = 488;BA.debugLine="If count > 7 Then";
if (_count>7) { 
 //BA.debugLineNum = 489;BA.debugLine="catdel.clearCache";
mostCurrent._catdel.clearCache();
 //BA.debugLineNum = 491;BA.debugLine="Label1.Text=op.formatSize(cat.FreeMemory)&\" free";
mostCurrent._label1.setText(BA.ObjectToCharSequence(mostCurrent._op.formatSize(mostCurrent._cat.getFreeMemory())+" free.."));
 //BA.debugLineNum = 492;BA.debugLine="ToastMessageShow(\"closing in 2 sec...\",False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("closing in 2 sec..."),anywheresoftware.b4a.keywords.Common.False);
 };
 //BA.debugLineNum = 495;BA.debugLine="If count> 8 Then";
if (_count>8) { 
 //BA.debugLineNum = 496;BA.debugLine="ToastMessageShow(\"closing in 1 sec...\",False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("closing in 1 sec..."),anywheresoftware.b4a.keywords.Common.False);
 };
 //BA.debugLineNum = 498;BA.debugLine="If count = 9 Then";
if (_count==9) { 
 //BA.debugLineNum = 499;BA.debugLine="t1.Enabled=False";
_t1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 500;BA.debugLine="ToastMessageShow(\"ready!\",False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("ready!"),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 501;BA.debugLine="ToastMessageShow(op.formatSize(cat.FreeMemory)&\"";
...
mostCurrent._activity.Finish();
 //BA.debugLineNum = 503;BA.debugLine="SetAnimation.setanimati (\"extra_in\", \"extra_out\"";
mostCurrent._setanimation._setanimati(mostCurrent.activityBA,"extra_in","extra_out");
 };
...
int _i = 0;
int _d = 0;
 //BA.debugLineNum = 374;BA.debugLine="Sub deleting_files";
 //BA.debugLineNum = 375;BA.debugLine="dill.Clear";
mostCurrent._dill.Clear();
 //BA.debugLineNum = 377;BA.debugLine="Dim dd As String";
_dd = "";
 //BA.debugLineNum = 378;BA.debugLine="Dim ens As String";
_ens = "";
 //BA.debugLineNum = 379;BA.debugLine="For i = 0 To  list3.Size-1";
{
final int step4 = 1;
final int limit4 = (int) (mostCurrent._list3.getSize()-1);
for (_i = (int) (0) ; (step4 > 0 && _i <= limit4) || (step4 < 0 && _i >= limit4); _i = ((int)(0 + _i + step4)) ) {
 //BA.debugLineNum = 380;BA.debugLine="dd=list3.Get(i)";
_dd = BA.ObjectToString(mostCurrent._list3.Get(_i));
 //BA.debugLineNum = 381;BA.debugLine="ens=GetParentPath(GetSourceDir(GetActivitiesInfo";
_ens = _getparentpath(_getsourcedir(_getactivitiesinfo(_dd)));
 //BA.debugLineNum = 382;BA.debugLine="ReadDir(ens,True)";
_readdir(_ens,anywheresoftware.b4a.keywords.Common.True);
 }
};
 //BA.debugLineNum = 385;BA.debugLine="For d = 0 To ffold.Size-1";
{
final int step9 = 1;
...
public static String  _fc_copydone(String _key,boolean _error) throws Exception{
 //BA.debugLineNum = 610;BA.debugLine="Sub fc_CopyDone(Key As String, Error As Boolean)";
 //BA.debugLineNum = 612;BA.debugLine="End Sub";
return "";
}
public static String  _fc_putdone(String _key,boolean _error) throws Exception{
 //BA.debugLineNum = 614;BA.debugLine="Sub fc_PutDone(key As String,Error As Boolean)";
 //BA.debugLineNum = 616;BA.debugLine="End Sub";
return "";
}
public static String  _fc2_putdone(String _key,boolean _error) throws Exception{
 //BA.debugLineNum = 618;BA.debugLine="Sub fc2_PutDone(key As String,Error As Boolean)";
 //BA.debugLineNum = 620;BA.debugLine="End Sub";
return "";
}
public static String  _file_copydone() throws Exception{
 //BA.debugLineNum = 673;BA.debugLine="Sub file_CopyDone";
 //BA.debugLineNum = 674;BA.debugLine="Log(\"copy done!\")";
...
anywheresoftware.b4a.agraham.reflection.Reflection _r = null;
 //BA.debugLineNum = 642;BA.debugLine="Sub GetActivitiesInfo(package As String) As Object";
 //BA.debugLineNum = 643;BA.debugLine="Dim r As Reflector";
_r = new anywheresoftware.b4a.agraham.reflection.Reflection();
 //BA.debugLineNum = 644;BA.debugLine="r.Target = r.GetContext";
_r.Target = (Object)(_r.GetContext(processBA));
 //BA.debugLineNum = 645;BA.debugLine="r.Target = r.RunMethod(\"getPackageManager\")";
_r.Target = _r.RunMethod("getPackageManager");
 //BA.debugLineNum = 646;BA.debugLine="r.Target = r.RunMethod3(\"getPackageInfo\", package";
_r.Target = _r.RunMethod3("getPackageInfo",_package,"java.lang.String",BA.NumberToString(0x00000001),"java.lang.int");
 //BA.debugLineNum = 647;BA.debugLine="Return r.GetField(\"applicationInfo\")";
...
anywheresoftware.b4a.agraham.reflection.Reflection _r = null;
int _id = 0;
 //BA.debugLineNum = 212;BA.debugLine="Sub GetDeviceId As String";
 //BA.debugLineNum = 213;BA.debugLine="Dim api As Int";
_api = 0;
 //BA.debugLineNum = 214;BA.debugLine="Dim r As Reflector";
_r = new anywheresoftware.b4a.agraham.reflection.Reflection();
 //BA.debugLineNum = 215;BA.debugLine="api = r.GetStaticField(\"android.os.Build$VERSION\"";
_api = (int)(BA.ObjectToNumber(_r.GetStaticField("android.os.Build$VERSION","SDK_INT")));
 //BA.debugLineNum = 216;BA.debugLine="If api < 18 Then";
if (_api<18) { 
 //BA.debugLineNum = 218;BA.debugLine="If File.Exists(File.DirInternal, \"__id\") Then";
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"__id")) { 
 //BA.debugLineNum = 219;BA.debugLine="Return File.ReadString(File.DirInternal, \"__id\"";
if (true) return anywheresoftware.b4a.keywords.Common.File.ReadString(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"__id");
 //BA.debugLineNum = 220;BA.debugLine="c_start";
_c_start();
 }else {
 //BA.debugLineNum = 222;BA.debugLine="c_start";
_c_start();
 //BA.debugLineNum = 223;BA.debugLine="Dim id As Int";
_id = 0;
 //BA.debugLineNum = 224;BA.debugLine="id = Rnd(0x10000000, 0x7FFFFFFF)";
_id = anywheresoftware.b4a.keywords.Common.Rnd((int) (0x10000000),(int) (0x7fffffff));
 //BA.debugLineNum = 225;BA.debugLine="File.WriteString(File.DirInternal, \"__id\", id)";
anywheresoftware.b4a.keywords.Common.File.WriteString(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"__id",BA.NumberToString(_id));
 //BA.debugLineNum = 226;BA.debugLine="Return id";
if (true) return BA.NumberToString(_id);
 };
 //BA.debugLineNum = 228;BA.debugLine="Log(api)";
anywheresoftware.b4a.keywords.Common.Log(BA.NumberToString(_api));
 }else {
 //BA.debugLineNum = 231;BA.debugLine="Return r.GetStaticField(\"android.os.Build\", \"SER";
if (true) return BA.ObjectToString(_r.GetStaticField("android.os.Build","SERIAL"));
 //BA.debugLineNum = 235;BA.debugLine="storage_check";
_storage_check();
 };
...
String _l = "";
String _path1 = "";
 //BA.debugLineNum = 622;BA.debugLine="Sub GetParentPath(Path As String) As String";
 //BA.debugLineNum = 623;BA.debugLine="Dim L As String";
_l = "";
 //BA.debugLineNum = 624;BA.debugLine="Dim Path1 As String";
_path1 = "";
 //BA.debugLineNum = 625;BA.debugLine="If Path = \"/\" Then";
if ((_path).equals("/")) { 
 //BA.debugLineNum = 626;BA.debugLine="Return \"/\"";
if (true) return "/";
 };
 //BA.debugLineNum = 628;BA.debugLine="L = Path.LastIndexOf(\"/\")";
_l = BA.NumberToString(_path.lastIndexOf("/"));
 //BA.debugLineNum = 629;BA.debugLine="If L = Path.Length - 1 Then";
if ((_l).equals(BA.NumberToString(_path.length()-1))) { 
 //BA.debugLineNum = 631;BA.debugLine="Path1 = Path.SubString2(0,L)";
_path1 = _path.substring((int) (0),(int)(Double.parseDouble(_l)));
 }else {
 //BA.debugLineNum = 633;BA.debugLine="Path1 = Path";
_path1 = _path;
 };
 //BA.debugLineNum = 635;BA.debugLine="L = Path.LastIndexOf(\"/\")";
_l = BA.NumberToString(_path.lastIndexOf("/"));
 //BA.debugLineNum = 636;BA.debugLine="If L = 0 Then";
if ((_l).equals(BA.NumberToString(0))) { 
 //BA.debugLineNum = 637;BA.debugLine="L = 1";
_l = BA.NumberToString(1);
 };
 //BA.debugLineNum = 639;BA.debugLine="Return Path1.SubString2(0,L)";
...
anywheresoftware.b4a.agraham.reflection.Reflection _r = null;
 //BA.debugLineNum = 650;BA.debugLine="Sub GetSourceDir(AppInfo As Object) As String";
 //BA.debugLineNum = 651;BA.debugLine="Try";
try { //BA.debugLineNum = 652;BA.debugLine="Dim r As Reflector";
_r = new anywheresoftware.b4a.agraham.reflection.Reflection();
 //BA.debugLineNum = 653;BA.debugLine="r.Target = AppInfo";
_r.Target = _appinfo;
 //BA.debugLineNum = 654;BA.debugLine="Return r.GetField(\"sourceDir\")";
if (true) return BA.ObjectToString(_r.GetField("sourceDir"));
 } 
       catch (Exception e6) {
			processBA.setLastException(e6); //BA.debugLineNum = 656;BA.debugLine="Return \"\"";
if (true) return "";
 };
...
public static String  _globals() throws Exception{
 ...
 //BA.debugLineNum = 11;BA.debugLine="Dim op As OperatingSystem";
mostCurrent._op = new com.rootsoft.oslibrary.OSLibrary();
 //BA.debugLineNum = 12;BA.debugLine="Private Label1 As Label";
mostCurrent._label1 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 13;BA.debugLine="Dim count As Int=0";
_count = (int) (0);
 //BA.debugLineNum = 14;BA.debugLine="Dim args(1) As Object";
...
;
 //BA.debugLineNum = 15;BA.debugLine="Dim Obj1, Obj2, Obj3 As Reflector";
...
mostCurrent._obj3 = new anywheresoftware.b4a.agraham.reflection.Reflection();
 //BA.debugLineNum = 16;BA.debugLine="Dim Types(1), name,packName,date,time As String";
...
mostCurrent._date = "";
mostCurrent._time = "";
 //BA.debugLineNum = 18;BA.debugLine="Dim icon As BitmapDrawable";
mostCurrent._icon = new anywheresoftware.b4a.objects.drawable.BitmapDrawable();
 //BA.debugLineNum = 19;BA.debugLine="Dim pak As PackageManager";
mostCurrent._pak = new anywheresoftware.b4a.phone.PackageManagerWrapper();
 //BA.debugLineNum = 20;BA.debugLine="Dim list1,list2,list3,clist,piclist,phlis,list4,l";
...
mostCurrent._filelist = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 21;BA.debugLine="Dim catdel As CacheCleaner";
mostCurrent._catdel = new anywheresoftware.b4a.cachecleaner.CacheCleaner();
 //BA.debugLineNum = 22;BA.debugLine="Dim cat As Cache";
mostCurrent._cat = new flm.b4a.cache.Cache();
 //BA.debugLineNum = 24;BA.debugLine="Private lw2 As ListView";
mostCurrent._lw2 = new anywheresoftware.b4a.objects.ListViewWrapper();
 //BA.debugLineNum = 25;BA.debugLine="Dim l1,l2,l3 As Label";
...
mostCurrent._l3 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 26;BA.debugLine="Dim ph As PhoneEvents";
mostCurrent._ph = new anywheresoftware.b4a.phone.PhoneEvents();
 //BA.debugLineNum = 27;BA.debugLine="Dim size,flags,count As Int";
_size = 0;
_flags = 0;
_count = 0;
 //BA.debugLineNum = 28;BA.debugLine="Dim ffiles,ffolders As List";
...
mostCurrent._panel2 = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 48;BA.debugLine="Private ImageView1 As ImageView";
mostCurrent._imageview1 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 50;BA.debugLine="Dim ffil,ffold As List";
...
mostCurrent._ffold = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 52;BA.debugLine="Dim rot As String";
mostCurrent._rot = "";
 //BA.debugLineNum = 54;BA.debugLine="Dim andro,bat,desk,work As Bitmap";
...
mostCurrent._work = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper();
 //BA.debugLineNum = 56;BA.debugLine="Private mcl As MaterialColors";
mostCurrent._mcl = new com.tchart.materialcolors.MaterialColors();
 //BA.debugLineNum = 58;BA.debugLine="Private mBmp As ColorDrawable";
mostCurrent._mbmp = new anywheresoftware.b4a.objects.drawable.ColorDrawable();
 //BA.debugLineNum = 59;BA.debugLine="Dim ffiles,ffolders As List";
mostCurrent._ffiles = new anywheresoftware.b4a.objects.collections.List();
mostCurrent._ffolders = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 60;BA.debugLine="Private dpm1 As DonutProgressMaster";
mostCurrent._dpm1 = new circleprogressmasterwrapper.donutProgressMasterWrapper();
 //BA.debugLineNum = 61;BA.debugLine="Dim root1 As String";
mostCurrent._root1 = "";
 //BA.debugLineNum = 62;BA.debugLine="Dim anima As AnimationPlus";
...
int _u = 0;
 //BA.debugLineNum = 339;BA.debugLine="Sub li4";
 //BA.debugLineNum = 341;BA.debugLine="list2=op.RunningServiceInfo(999,list4,list5,list6";
...
String _data = "";
 //BA.debugLineNum = 299;BA.debugLine="Sub logcat_LogCatData(Buffer() As Byte, Length As";
 //BA.debugLineNum = 300;BA.debugLine="Dim data As String";
_data = "";
 //BA.debugLineNum = 301;BA.debugLine="data = BytesToString(Buffer,0,Length,\"UTF-8\")";
_data = anywheresoftware.b4a.keywords.Common.BytesToString(_buffer,(int) (0),_length,"UTF-8");
 //BA.debugLineNum = 303;BA.debugLine="Log(data)";
...
anywheresoftware.b4a.randomaccessfile.B4XSerializator _ser = null;
 //BA.debugLineNum = 599;BA.debugLine="Sub object_to_byte(obj As Object)As Byte()";
 //BA.debugLineNum = 600;BA.debugLine="Dim ser As B4XSerializator";
_ser = new anywheresoftware.b4a.randomaccessfile.B4XSerializator();
 //BA.debugLineNum = 601;BA.debugLine="Return ser.ConvertObjectToBytes(obj)";
...
String _tr = "";
 //BA.debugLineNum = 507;BA.debugLine="Sub pg_onProgressChange(current As Int, maxvalue A";
 //BA.debugLineNum = 508;BA.debugLine="andro.Initialize(File.DirAssets,\"Android.png\")";
mostCurrent._andro.Initialize(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Android.png");
 //BA.debugLineNum = 509;BA.debugLine="bat.Initialize(File.DirAssets,\"Battery.png\")";
mostCurrent._bat.Initialize(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Battery.png");
 //BA.debugLineNum = 510;BA.debugLine="desk.Initialize(File.DirAssets, \"Chart.png\")";
mostCurrent._desk.Initialize(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Chart.png");
 //BA.debugLineNum = 511;BA.debugLine="maxvalue=100";
_maxvalue = (int) (100);
 //BA.debugLineNum = 512;BA.debugLine="If current=count+1 Then";
if (_current==_count+1) { 
 //BA.debugLineNum = 513;BA.debugLine="For Each tr As String In reslist";
...
_tr = BA.ObjectToString(group6.Get(index6));
 //BA.debugLineNum = 514;BA.debugLine="Log(tr)";
anywheresoftware.b4a.keywords.Common.Log(_tr);
 //BA.debugLineNum = 515;BA.debugLine="ImageView1.Bitmap=andro";
mostCurrent._imageview1.setBitmap((android.graphics.Bitmap)(mostCurrent._andro.getObject()));
 //BA.debugLineNum = 516;BA.debugLine="Label1.Text=tr";
mostCurrent._label1.setText(BA.ObjectToCharSequence(_tr));
 }
;
 };
 //BA.debugLineNum = 519;BA.debugLine="If current=95 Then";
if (_current==95) { 
 //BA.debugLineNum = 520;BA.debugLine="ImageView1.Bitmap=LoadBitmap(File.DirAssets,\"Acc";
mostCurrent._imageview1.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Accept128.png").getObject()));
 };
...
public static String  _ph_devicestorageok(anywheresoftware.b4a.objects.IntentWrapper _intent) throws Exception{
 //BA.debugLineNum = 409;BA.debugLine="Sub ph_DeviceStorageOk (Intent As Intent)";
 //BA.debugLineNum = 410;BA.debugLine="Log(Intent.ExtrasToString)";
...
int _i = 0;
String _v = "";
 //BA.debugLineNum = 317;BA.debugLine="Sub ReadDir(folder As String, recursive As Boolean";
 //BA.debugLineNum = 318;BA.debugLine="ffolders.Clear";
mostCurrent._ffolders.Clear();
 //BA.debugLineNum = 319;BA.debugLine="ffiles.Clear";
mostCurrent._ffiles.Clear();
 //BA.debugLineNum = 321;BA.debugLine="Dim lst As List = File.ListFiles(folder)";
_lst = new anywheresoftware.b4a.objects.collections.List();
_lst = anywheresoftware.b4a.keywords.Common.File.ListFiles(_folder);
 //BA.debugLineNum = 322;BA.debugLine="For i = 0 To lst.Size - 1";
{
final int step4 = 1;
final int limit4 = (int) (_lst.getSize()-1);
for (_i = (int) (0) ; (step4 > 0 && _i <= limit4) || (step4 < 0 && _i >= limit4); _i = ((int)(0 + _i + step4)) ) {
 //BA.debugLineNum = 323;BA.debugLine="If File.IsDirectory(folder,lst.Get(i)) Then";
if (anywheresoftware.b4a.keywords.Common.File.IsDirectory(_folder,BA.ObjectToString(_lst.Get(_i)))) { 
 //BA.debugLineNum = 324;BA.debugLine="Dim v As String";
_v = "";
 //BA.debugLineNum = 325;BA.debugLine="v = folder&\"/\"&lst.Get(i)";
_v = _folder+"/"+BA.ObjectToString(_lst.Get(_i));
 //BA.debugLineNum = 327;BA.debugLine="ffolders.Add(v.SubString(root1.Length+1))";
mostCurrent._ffolders.Add((Object)(_v.substring((int) (mostCurrent._root1.length()+1))));
 //BA.debugLineNum = 328;BA.debugLine="If recursive Then";
if (_recursive) { 
 //BA.debugLineNum = 329;BA.debugLine="ReadDir(v,recursive)";
_readdir(_v,_recursive);
 };
 }else {
 //BA.debugLineNum = 332;BA.debugLine="ffiles.Add(folder&\"/\"&lst.Get(i))";
...
uk.co.martinpearman.b4a.activitymanager.RunningTaskInfo _runningtaskinfo1 = null;
 //BA.debugLineNum = 392;BA.debugLine="Sub real_delete";
 //BA.debugLineNum = 394;BA.debugLine="RunningTaskInfos=ActivityManager1.GetRunningTasks";
mostCurrent._runningtaskinfos = mostCurrent._activitymanager1.GetRunningTasks(processBA);
 //BA.debugLineNum = 395;BA.debugLine="Log(\"RunningTaskInfos.Length=\"&RunningTaskInfos.L";
anywheresoftware.b4a.keywords.Common.Log("RunningTaskInfos.Length="+BA.NumberToString(mostCurrent._runningtaskinfos.length));
 //BA.debugLineNum = 397;BA.debugLine="For Each RunningTaskInfo1 As RunningTaskInfo In R";
final uk.co.martinpearman.b4a.activitymanager.RunningTaskInfo[] group3 = mostCurrent._runningtaskinfos;
final int groupLen3 = group3.length;
for (int index3 = 0;index3 < groupLen3 ;index3++){
_runningtaskinfo1 = group3[index3];
 //BA.debugLineNum = 400;BA.debugLine="Label1.Text=RunningTaskInfo1.GetApplicationName&";
...
;
 //BA.debugLineNum = 406;BA.debugLine="close";
_close();
...
String _f = "";
 //BA.debugLineNum = 239;BA.debugLine="Sub storage_check";
 //BA.debugLineNum = 240;BA.debugLine="For i = 0 To paths.Size-1";
{
final int step1 = 1;
final int limit1 = (int) (mostCurrent._paths.getSize()-1);
for (_i = (int) (0) ; (step1 > 0 && _i <= limit1) || (step1 < 0 && _i >= limit1); _i = ((int)(0 + _i + step1)) ) {
 //BA.debugLineNum = 241;BA.debugLine="Log(paths.GetKeyAt(i)&\"=\"&paths.GetValueAt(i))";
anywheresoftware.b4a.keywords.Common.Log(BA.ObjectToString(mostCurrent._paths.GetKeyAt(_i))+"="+BA.ObjectToString(mostCurrent._paths.GetValueAt(_i)));
 ...
 //BA.debugLineNum = 244;BA.debugLine="Log (\"DirRootExternal = \"&de)";
anywheresoftware.b4a.keywords.Common.Log("DirRootExternal = "+mostCurrent._de);
 //BA.debugLineNum = 246;BA.debugLine="If mtc.Find = True Then";
if (mostCurrent._mtc.Find()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 247;BA.debugLine="Dim mnt As String = mtc.Group(0)";
_mnt = mostCurrent._mtc.Group((int) (0));
 //BA.debugLineNum = 249;BA.debugLine="Log (\"mount point = \"& mnt)";
anywheresoftware.b4a.keywords.Common.Log("mount point = "+_mnt);
 //BA.debugLineNum = 250;BA.debugLine="Dim dirs As List = File.ListFiles(mnt)";
_dirs = new anywheresoftware.b4a.objects.collections.List();
_dirs = anywheresoftware.b4a.keywords.Common.File.ListFiles(_mnt);
 //BA.debugLineNum = 251;BA.debugLine="For Each f As String In dirs";
...
_f = BA.ObjectToString(group9.Get(index9));
 //BA.debugLineNum = 252;BA.debugLine="If storage.isExternalStorageRemovable(mnt&f) Th";
if (mostCurrent._storage.isExternalStorageRemovable(_mnt+_f)) { 
 //BA.debugLineNum = 253;BA.debugLine="Log (\"Device = \"& f&\":\"&mnt&f&\" is removable\")";
anywheresoftware.b4a.keywords.Common.Log("Device = "+_f+":"+_mnt+_f+" is removable");
 //BA.debugLineNum = 254;BA.debugLine="If File.ListFiles(mnt&f).IsInitialized Then";
if (anywheresoftware.b4a.keywords.Common.File.ListFiles(_mnt+_f).IsInitialized()) { 
 //BA.debugLineNum = 255;BA.debugLine="Log(\"probably ExtSDCard: \"&mnt&f)";
anywheresoftware.b4a.keywords.Common.Log("probably ExtSDCard: "+_mnt+_f);
 //BA.debugLineNum = 256;BA.debugLine="extsdcard = mnt&f";
mostCurrent._extsdcard = _mnt+_f;
 }else {
 };
 }else {
 //BA.debugLineNum = 261;BA.debugLine="Log (\"Device = \"& f&\":\"&mnt&f&\" is NOT removab";
anywheresoftware.b4a.keywords.Common.Log("Device = "+_f+":"+_mnt+_f+" is NOT removable");
 };
 }
;
 };
 //BA.debugLineNum = 266;BA.debugLine="c_start";
_c_start();
 //BA.debugLineNum = 267;BA.debugLine="End Sub";
return "";
}
public static String  _t1_tick() throws Exception{
 //BA.debugLineNum = 413;BA.debugLine="Sub t1_Tick";
 //BA.debugLineNum = 414;BA.debugLine="count=count+1";
_count = (int) (_count+1);
 //BA.debugLineNum = 415;BA.debugLine="anima.InitializeScale(\"anima\",0dip,100dip,125dip,";
mostCurrent._anima.InitializeScale(mostCurrent.activityBA,"anima",(float) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (0))),(float) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (100))),(float) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (125))),(float) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (500))));
 //BA.debugLineNum = 416;BA.debugLine="anima.RepeatMode=anima.REPEAT_REVERSE";
mostCurrent._anima.setRepeatMode(mostCurrent._anima.REPEAT_REVERSE);
 //BA.debugLineNum = 417;BA.debugLine="anima.Duration=5000";
mostCurrent._anima.setDuration((long) (5000));
 //BA.debugLineNum = 419;BA.debugLine="anima.SetInterpolator(anima.INTERPOLATOR_ACCELERA";
mostCurrent._anima.SetInterpolator(mostCurrent._anima.INTERPOLATOR_ACCELERATE);
 //BA.debugLineNum = 420;BA.debugLine="anima.Start(ImageView1)";
mostCurrent._anima.Start((android.view.View)(mostCurrent._imageview1.getObject()));
 //BA.debugLineNum = 421;BA.debugLine="dpm1.Max=100";
mostCurrent._dpm1.setMax((int) (100));
 //BA.debugLineNum = 422;BA.debugLine="ImageView1.Visible=True";
mostCurrent._imageview1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 424;BA.debugLine="ImageView1.Bitmap=andro";
mostCurrent._imageview1.setBitmap((android.graphics.Bitmap)(mostCurrent._andro.getObject()));
 //BA.debugLineNum = 427;BA.debugLine="dpm1.Progress=5";
mostCurrent._dpm1.setProgress((int) (5));
 //BA.debugLineNum = 428;BA.debugLine="dpm1.UnfinishedStrokeWidth=20";
mostCurrent._dpm1.setUnfinishedStrokeWidth((float) (20));
 //BA.debugLineNum = 429;BA.debugLine="dpm1.UnfinishedStrokeColor=Colors.ARGB(180,255,25";
...
if (_count>0) { 
 //BA.debugLineNum = 434;BA.debugLine="Label1.Text=\"check Battery..\"";
mostCurrent._label1.setText(BA.ObjectToCharSequence("check Battery.."));
 };
 //BA.debugLineNum = 436;BA.debugLine="If count > 1 Then";
if (_count>1) { 
 //BA.debugLineNum = 437;BA.debugLine="Label1.Text=\"check Battery..\"";
mostCurrent._label1.setText(BA.ObjectToCharSequence("check Battery.."));
 //BA.debugLineNum = 438;BA.debugLine="dpm1.Progress=20";
mostCurrent._dpm1.setProgress((int) (20));
 };
 //BA.debugLineNum = 440;BA.debugLine="If count > 2 Then";
if (_count>2) { 
 //BA.debugLineNum = 441;BA.debugLine="Label1.Text=\"check Battery..\"";
mostCurrent._label1.setText(BA.ObjectToCharSequence("check Battery.."));
 };
 //BA.debugLineNum = 443;BA.debugLine="If count > 3 Then";
if (_count>3) { 
 //BA.debugLineNum = 446;BA.debugLine="Label1.Text=\"check System..\"";
mostCurrent._label1.setText(BA.ObjectToCharSequence("check System.."));
 //BA.debugLineNum = 447;BA.debugLine="dpm1.Progress=42";
mostCurrent._dpm1.setProgress((int) (42));
 };
 //BA.debugLineNum = 450;BA.debugLine="If count > 4 Then";
if (_count>4) { 
 //BA.debugLineNum = 451;BA.debugLine="ImageView1.Bitmap=bat";
mostCurrent._imageview1.setBitmap((android.graphics.Bitmap)(mostCurrent._bat.getObject()));
 //BA.debugLineNum = 453;BA.debugLine="Label1.Text=\"clear Cache System..\"";
mostCurrent._label1.setText(BA.ObjectToCharSequence("clear Cache System.."));
 //BA.debugLineNum = 454;BA.debugLine="dpm1.Progress=67";
mostCurrent._dpm1.setProgress((int) (67));
 };
 //BA.debugLineNum = 456;BA.debugLine="If count > 5 Then";
if (_count>5) { 
 //BA.debugLineNum = 457;BA.debugLine="Label1.Text=\"clear Cache System..\"";
mostCurrent._label1.setText(BA.ObjectToCharSequence("clear Cache System.."));
 //BA.debugLineNum = 458;BA.debugLine="ImageView1.Bitmap=desk";
mostCurrent._imageview1.setBitmap((android.graphics.Bitmap)(mostCurrent._desk.getObject()));
 //BA.debugLineNum = 460;BA.debugLine="Label1.Text=\"check \"&op.formatSize(op.Availabl";
mostCurrent._label1.setText(BA.ObjectToCharSequence("check "+mostCurrent._op.formatSize(mostCurrent._op.getAvailableMemory())));
 //BA.debugLineNum = 461;BA.debugLine="dpm1.Progress=89";
mostCurrent._dpm1.setProgress((int) (89));
 };
 //BA.debugLineNum = 463;BA.debugLine="If count > 6 Then";
if (_count>6) { 
 //BA.debugLineNum = 464;BA.debugLine="dpm1.Progress=100";
mostCurrent._dpm1.setProgress((int) (100));
 //BA.debugLineNum = 465;BA.debugLine="dpm1.Visible=False";
mostCurrent._dpm1.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 466;BA.debugLine="Label1.Text=op.formatSize(cat.FreeMemory)";
mostCurrent._label1.setText(BA.ObjectToCharSequence(mostCurrent._op.formatSize(mostCurrent._cat.getFreeMemory())));
 //BA.debugLineNum = 467;BA.debugLine="If Not (filelist.Size=1) Then";
if (anywheresoftware.b4a.keywords.Common.Not(mostCurrent._filelist.getSize()==1)) { 
 //BA.debugLineNum = 468;BA.debugLine="ImageView1.Bitmap=andro";
mostCurrent._imageview1.setBitmap((android.graphics.Bitmap)(mostCurrent._andro.getObject()));
 //BA.debugLineNum = 469;BA.debugLine="Label1.Text=nativeMe.RunMethod(\"getOSCodename\"";
mostCurrent._label1.setText(BA.ObjectToCharSequence(mostCurrent._nativeme.RunMethod("getOSCodename",(Object[])(anywheresoftware.b4a.keywords.Common.Null))));
 //BA.debugLineNum = 470;BA.debugLine="ImageView1.Bitmap=bat";
mostCurrent._imageview1.setBitmap((android.graphics.Bitmap)(mostCurrent._bat.getObject()));
 }else {
 //BA.debugLineNum = 472;BA.debugLine="ImageView1.Bitmap=andro";
mostCurrent._imageview1.setBitmap((android.graphics.Bitmap)(mostCurrent._andro.getObject()));
 //BA.debugLineNum = 474;BA.debugLine="ImageView1.Bitmap=desk";
mostCurrent._imageview1.setBitmap((android.graphics.Bitmap)(mostCurrent._desk.getObject()));
 };
 //BA.debugLineNum = 476;BA.debugLine="CallSub(Me,\"del_quest\")";
