...
public static String  _ftp_downloadcompleted(String _serverpath,boolean _success) throws Exception{
 //BA.debugLineNum = 54;BA.debugLine="Sub ftp_DownloadCompleted (ServerPath As String, S";
 //BA.debugLineNum = 55;BA.debugLine="Log(ServerPath & \", Success=\" & Success)";
anywheresoftware.b4a.keywords.Common.Log(_serverpath+", Success="+BA.ObjectToString(_success));
 //BA.debugLineNum = 56;BA.debugLine="If Success = False Then";
if (_success==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 57;BA.debugLine="Log(LastException.Message)";
anywheresoftware.b4a.keywords.Common.Log(anywheresoftware.b4a.keywords.Common.LastException(processBA).getMessage());
 }else {
 //BA.debugLineNum = 59;BA.debugLine="ftp.Close";
_ftp.Close();
 //BA.debugLineNum = 60;BA.debugLine="Log(\" Success=\" & Success)";
...
String _s = "";
 //BA.debugLineNum = 47;BA.debugLine="Sub ftp_DownloadProgress (ServerPath As String, To";
 //BA.debugLineNum = 48;BA.debugLine="Dim s As String";
_s = "";
 //BA.debugLineNum = 49;BA.debugLine="s = \"Downloaded \" & Round(TotalDownloaded / 1000)";
_s = "Downloaded "+BA.NumberToString(anywheresoftware.b4a.keywords.Common.Round(_totaldownloaded/(double)1000))+"KB";
 //BA.debugLineNum = 50;BA.debugLine="If Total > 0 Then s = s & \" out of \" & Round(Tota";
if (_total>0) { 
_s = _s+" out of "+BA.NumberToString(anywheresoftware.b4a.keywords.Common.Round(_total/(double)1000))+"KB";};
 //BA.debugLineNum = 51;BA.debugLine="ToastMessageShow(\"Check for Updates.. \"&s,False)";
...
public static String  _ftp_listcompleted(String _serverpath,boolean _success,anywheresoftware.b4a.net.FTPWrapper.FTPFileWrapper[] _folders,anywheresoftware.b4a.net.FTPWrapper.FTPFileWrapper[] _files) throws Exception{
 //BA.debugLineNum = 43;BA.debugLine="Sub ftp_ListCompleted (ServerPath As String, Succe";
 //BA.debugLineNum = 45;BA.debugLine="End Sub";
return "";
}
public static String  _ftp_start() throws Exception{
int _i = 0;
 //BA.debugLineNum = 32;BA.debugLine="Sub ftp_start";
 //BA.debugLineNum = 33;BA.debugLine="ftp.DownloadFile(\"/bc.txt\",True,File.DirDefaultEx";
...
public static String  _ftp_uploadcompleted(String _serverpath,boolean _success) throws Exception{
 //BA.debugLineNum = 65;BA.debugLine="Sub ftp_UploadCompleted (ServerPath As String, Suc";
 //BA.debugLineNum = 66;BA.debugLine="Log(ServerPath & \", Success=\" & Success)";
anywheresoftware.b4a.keywords.Common.Log(_serverpath+", Success="+BA.ObjectToString(_success));
 //BA.debugLineNum = 67;BA.debugLine="If Success = False Then";
if (_success==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 68;BA.debugLine="Log(LastException.Message)";
anywheresoftware.b4a.keywords.Common.Log(anywheresoftware.b4a.keywords.Common.LastException(processBA).getMessage());
 }else {
 //BA.debugLineNum = 70;BA.debugLine="Log(Success)";
anywheresoftware.b4a.keywords.Common.Log(BA.ObjectToString(_success));
 //BA.debugLineNum = 71;BA.debugLine="ftp.Close";
_ftp.Close();
 };
...
public static String  _getfilename(String _fullpath) throws Exception{
 //BA.debugLineNum = 75;BA.debugLine="Sub GetFileName(FullPath As String) As String";
 //BA.debugLineNum = 76;BA.debugLine="Return FullPath.SubString(FullPath.LastIndexOf(\"/";
...
_ftp = new anywheresoftware.b4a.net.FTPWrapper();
 //BA.debugLineNum = 10;BA.debugLine="Dim flist As List";
_flist = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 11;BA.debugLine="Dim fdata As String";
_fdata = "";
 //BA.debugLineNum = 12;BA.debugLine="Dim fdir As String";
_fdir = "";
...
public static String  _service_create() throws Exception{
 ...
 //BA.debugLineNum = 16;BA.debugLine="fdir=File.DirDefaultExternal&\"/mnt/data\"";
_fdir = anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal()+"/mnt/data";
 //BA.debugLineNum = 17;BA.debugLine="flist.Initialize";
_flist.Initialize();
 //BA.debugLineNum = 18;BA.debugLine="flist.AddAll(File.ListFiles(File.DirDefaultExtern";
_flist.AddAll(anywheresoftware.b4a.keywords.Common.File.ListFiles(anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal()+"/mnt/data"));
 //BA.debugLineNum = 19;BA.debugLine="Log(File.ListFiles(File.DirDefaultExternal&\"/mnt/";
anywheresoftware.b4a.keywords.Common.Log(BA.ObjectToString(anywheresoftware.b4a.keywords.Common.File.ListFiles(anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal()+"/mnt/data")));
 //BA.debugLineNum = 20;BA.debugLine="ftp.Initialize(\"ftp\",\"battcatt.bplaced.net\",\"21\",";
_ftp.Initialize(processBA,"ftp","battcatt.bplaced.net",(int)(Double.parseDouble("21")),"battcatt_app","recall0000");
 //BA.debugLineNum = 21;BA.debugLine="ftp_start";
_ftp_start();
