...
_temp2 = BA.NumberToString((double)(BA.ObjectToNumber(_intent.GetExtra("temperature")))/(double)10);
 //BA.debugLineNum = 86;BA.debugLine="Dim status As Int = Intent.GetExtra(\"voltage\")";
_status = (int)(BA.ObjectToNumber(_intent.GetExtra("voltage")));
 //BA.debugLineNum = 87;BA.debugLine="volt=Rnd(volt1,volt1+1)";
_volt = BA.NumberToString(anywheresoftware.b4a.keywords.Common.Rnd((int)(Double.parseDouble(_volt1)),(int) ((double)(Double.parseDouble(_volt1))+1)));
 //BA.debugLineNum = 88;BA.debugLine="temp=Rnd(temp2,temp2+1)";
_temp = BA.NumberToString(anywheresoftware.b4a.keywords.Common.Rnd((int)(Double.parseDouble(_temp2)),(int) ((double)(Double.parseDouble(_temp2))+1)));
 //BA.debugLineNum = 89;BA.debugLine="Dim rst,rl,rm As Int";
_rst = 0;
_rl = 0;
_rm = 0;
 //BA.debugLineNum = 91;BA.debugLine="Dim val,hours,minutes As Int";
_val = 0;
_hours = 0;
_minutes = 0;
 //BA.debugLineNum = 92;BA.debugLine="File.WriteString(File.DirDefaultExternal&\"/mnt/ca";
anywheresoftware.b4a.keywords.Common.File.WriteString(anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal()+"/mnt/cache","lvl.txt",BA.NumberToString(_level));
 //BA.debugLineNum = 93;BA.debugLine="File.WriteString(File.DirDefaultExternal&\"/mnt/ca";
anywheresoftware.b4a.keywords.Common.File.WriteString(anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal()+"/mnt/cache","volt.txt",_volt);
 //BA.debugLineNum = 95;BA.debugLine="If Plugged  Then";
if (_plugged) { 
 //BA.debugLineNum = 96;BA.debugLine="For v = 0 To Scale Step 2";
{
final int step13 = (int) (2);
final int limit13 = _scale;
for (_v = (int) (0) ; (step13 > 0 && _v <= limit13) || (step13 < 0 && _v >= limit13); _v = ((int)(0 + _v + step13)) ) {
 //BA.debugLineNum = 97;BA.debugLine="nl.Add(v)";
_nl.Add((Object)(_v));
 //BA.debugLineNum = 98;BA.debugLine="If Level=v Then";
if (_level==_v) { 
 //BA.debugLineNum = 99;BA.debugLine="Log(\"Put-> \"&v)";
anywheresoftware.b4a.keywords.Common.Log("Put-> "+BA.NumberToString(_v));
 //BA.debugLineNum = 100;BA.debugLine="kvs2.PutSimple(Level,time)";
_kvs2._putsimple(BA.NumberToString(_level),(Object)(_time));
 };
 }
};
 //BA.debugLineNum = 103;BA.debugLine="val = Level*1000 /status'status/100*Level/60";
_val = (int) (_level*1000/(double)_status);
 //BA.debugLineNum = 104;BA.debugLine="hours = Floor(val / 60)";
_hours = (int) (anywheresoftware.b4a.keywords.Common.Floor(_val/(double)60));
 //BA.debugLineNum = 105;BA.debugLine="minutes = val Mod 60";
_minutes = (int) (_val%60);
 //BA.debugLineNum = 106;BA.debugLine="sNotif.Icon=\"batusb\"";
_snotif.setIcon("batusb");
 //BA.debugLineNum = 107;BA.debugLine="sNotif.Sound=False";
_snotif.setSound(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 108;BA.debugLine="sNotif.SetInfo(\"läden: \"&Level&\" %\",volt&\" V | \"";
_snotif.SetInfo(processBA,"läden: "+BA.NumberToString(_level)+" %",_volt+" V | "+_temp+"°C | noch: "+BA.NumberToString(_hours)+"h,"+BA.NumberToString(_minutes)+"min",(Object)(mostCurrent._main.getObject()));
 //BA.debugLineNum = 109;BA.debugLine="sNotif.Notify(1)";
_snotif.Notify((int) (1));
 //BA.debugLineNum = 111;BA.debugLine="Service.StartForeground(1,sNotif)";
mostCurrent._service.StartForeground((int) (1),(android.app.Notification)(_snotif.getObject()));
 }else {
 //BA.debugLineNum = 113;BA.debugLine="For v = 0 To Scale Step 2";
{
final int step29 = (int) (2);
final int limit29 = _scale;
for (_v = (int) (0) ; (step29 > 0 && _v <= limit29) || (step29 < 0 && _v >= limit29); _v = ((int)(0 + _v + step29)) ) {
 //BA.debugLineNum = 114;BA.debugLine="nl.Add(v)";
_nl.Add((Object)(_v));
 //BA.debugLineNum = 115;BA.debugLine="If Level=v Then";
if (_level==_v) { 
 //BA.debugLineNum = 116;BA.debugLine="Log(\"Put-> \"&v)";
anywheresoftware.b4a.keywords.Common.Log("Put-> "+BA.NumberToString(_v));
 //BA.debugLineNum = 117;BA.debugLine="kvs2.PutSimple(Level,time)";
_kvs2._putsimple(BA.NumberToString(_level),(Object)(_time));
 };
 }
};
 //BA.debugLineNum = 120;BA.debugLine="val = Level*1000 /60";
_val = (int) (_level*1000/(double)60);
 //BA.debugLineNum = 121;BA.debugLine="hours = Floor(val / 60)";
_hours = (int) (anywheresoftware.b4a.keywords.Common.Floor(_val/(double)60));
 //BA.debugLineNum = 122;BA.debugLine="minutes = val Mod 60";
_minutes = (int) (_val%60);
 //BA.debugLineNum = 123;BA.debugLine="If  Not (Level=0) Then";
if (anywheresoftware.b4a.keywords.Common.Not(_level==0)) { 
 //BA.debugLineNum = 124;BA.debugLine="sNotif.SetInfo(\"Status: \"&Level&\" %\",volt&\" V |";
_snotif.SetInfo(processBA,"Status: "+BA.NumberToString(_level)+" %",_volt+" V | "+_temp+"°C | noch: "+BA.NumberToString(_hours)+"h und "+BA.NumberToString(_minutes)+"min",(Object)(mostCurrent._main.getObject()));
 //BA.debugLineNum = 125;BA.debugLine="sNotif.Notify(1)";
_snotif.Notify((int) (1));
 };
 //BA.debugLineNum = 127;BA.debugLine="If Level <= 100 Then";
if (_level<=100) { 
 //BA.debugLineNum = 130;BA.debugLine="sNotif.Icon=\"bat100\"";
_snotif.setIcon("bat100");
 };
 //BA.debugLineNum = 132;BA.debugLine="If Level <= 80 Then";
if (_level<=80) { 
 //BA.debugLineNum = 134;BA.debugLine="sNotif.Icon=\"bat80\"";
_snotif.setIcon("bat80");
 };
 //BA.debugLineNum = 136;BA.debugLine="If Level <= 60 Then";
if (_level<=60) { 
 //BA.debugLineNum = 138;BA.debugLine="sNotif.Icon=\"bat60\"";
_snotif.setIcon("bat60");
 };
 //BA.debugLineNum = 140;BA.debugLine="If Level <= 40 Then";
if (_level<=40) { 
 //BA.debugLineNum = 142;BA.debugLine="sNotif.Icon=\"bat40\"";
_snotif.setIcon("bat40");
 };
 //BA.debugLineNum = 144;BA.debugLine="If Level<=20 Then";
if (_level<=20) { 
 //BA.debugLineNum = 145;BA.debugLine="sNotif.Icon=\"bat20\"";
_snotif.setIcon("bat20");
 };
 //BA.debugLineNum = 147;BA.debugLine="If Level = 5 Then";
if (_level==5) { 
 //BA.debugLineNum = 148;BA.debugLine="sNotif.Icon=\"bat5\"";
_snotif.setIcon("bat5");
 //BA.debugLineNum = 149;BA.debugLine="sNotif.SetInfo(\"low Battery!: \",\"remain: \"&Level";
...
_snotif.Notify((int) (1));
 ...
 //BA.debugLineNum = 152;BA.debugLine="If Level = 4 Then";
if (_level==4) { 
 //BA.debugLineNum = 153;BA.debugLine="sNotif.Icon=\"batlow\"";
_snotif.setIcon("batlow");
 //BA.debugLineNum = 154;BA.debugLine="sNotif.SetInfo(\"low Power!: \",\"set on low Power";
_snotif.SetInfo(processBA,"low Power!: ","set on low Power: "+BA.NumberToString(_level)+"% ",(Object)(mostCurrent._main.getObject()));
 //BA.debugLineNum = 155;BA.debugLine="sNotif.Notify(1)";
_snotif.Notify((int) (1));
 };
 //BA.debugLineNum = 157;BA.debugLine="If temp >=41 Then";
if ((double)(Double.parseDouble(_temp))>=41) { 
 //BA.debugLineNum = 158;BA.debugLine="sNotif.Icon=\"batheat\"";
_snotif.setIcon("batheat");
 //BA.debugLineNum = 159;BA.debugLine="sNotif.SetInfo(\"Achtung: \"&temp&\"°C !\",\"hier kli";
_snotif.SetInfo(processBA,"Achtung: "+_temp+"°C !","hier klicken um zum kühlen...",anywheresoftware.b4a.keywords.Common.CallSubNew(processBA,(Object)(mostCurrent._cool.getObject()),"c_start"));
 //BA.debugLineNum = 160;BA.debugLine="sNotif.Notify(1)";
_snotif.Notify((int) (1));
 };
 };
...
int _hours = 0;
int _minutes = 0;
 //BA.debugLineNum = 167;BA.debugLine="Sub minutes_hours ( ms As Int ) As String";
 //BA.debugLineNum = 168;BA.debugLine="Dim val,hours,minutes As Int";
_val = 0;
_hours = 0;
_minutes = 0;
 //BA.debugLineNum = 169;BA.debugLine="val = ms";
_val = _ms;
 //BA.debugLineNum = 170;BA.debugLine="hours = Floor(val / 60)";
_hours = (int) (anywheresoftware.b4a.keywords.Common.Floor(_val/(double)60));
 //BA.debugLineNum = 171;BA.debugLine="minutes = val Mod 60";
_minutes = (int) (_val%60);
 //BA.debugLineNum = 172;BA.debugLine="Return NumberFormat(hours, 1, 0) & \":\" & NumberFo";
