...
public static String  _acactionmenu1_menuitemclick(de.amberhome.objects.appcompat.ACMenuItemWrapper _item) throws Exception{
 //BA.debugLineNum = 419;BA.debugLine="Sub ACActionMenu1_MenuItemClick (Item As ACMenuIte";
 //BA.debugLineNum = 421;BA.debugLine="End Sub";
return "";
}
public static String  _acbutton1_click() throws Exception{
 //BA.debugLineNum = 155;BA.debugLine="Sub ACButton1_Click";
 //BA.debugLineNum = 156;BA.debugLine="If Not(Panel2.Visible=True) Then";
if (anywheresoftware.b4a.keywords.Common.Not(mostCurrent._panel2.getVisible()==anywheresoftware.b4a.keywords.Common.True)) { 
 //BA.debugLineNum = 157;BA.debugLine="popa.Show";
mostCurrent._popa.Show();
 }else {
 //BA.debugLineNum = 159;BA.debugLine="popa.Close";
...
public static String  _acspinner1_itemclick(int _position,Object _value) throws Exception{
 //BA.debugLineNum = 306;BA.debugLine="Sub ACSpinner1_ItemClick (Position As Int, Value A";
 //BA.debugLineNum = 307;BA.debugLine="Value=ACSpinner1.SelectedIndex";
_value = (Object)(mostCurrent._acspinner1.getSelectedIndex());
 //BA.debugLineNum = 308;BA.debugLine="ACSpinner1.SelectedIndex=Position";
mostCurrent._acspinner1.setSelectedIndex(_position);
 //BA.debugLineNum = 309;BA.debugLine="If Position=0 Then";
if (_position==0) { 
 //BA.debugLineNum = 310;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 311;BA.debugLine="kvs4.PutSimple(\"0\",Value)";
mostCurrent._kvs4._putsimple("0",_value);
 //BA.debugLineNum = 312;BA.debugLine="ToastMessageShow(\"light blue\",False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("light blue"),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 313;BA.debugLine="Panel2.Color=c16";
mostCurrent._panel2.setColor(_c16);
 //BA.debugLineNum = 314;BA.debugLine="Log(\"Is in Store\")";
anywheresoftware.b4a.keywords.Common.Log("Is in Store");
 };
 //BA.debugLineNum = 316;BA.debugLine="If Position=1 Then";
if (_position==1) { 
 //BA.debugLineNum = 317;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 318;BA.debugLine="kvs4.PutSimple(\"1\",Value)";
mostCurrent._kvs4._putsimple("1",_value);
 //BA.debugLineNum = 319;BA.debugLine="ToastMessageShow(\"Amber \",False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("Amber "),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 320;BA.debugLine="Log(\"New Store\")";
anywheresoftware.b4a.keywords.Common.Log("New Store");
 //BA.debugLineNum = 321;BA.debugLine="Panel2.Color=c2";
mostCurrent._panel2.setColor(_c2);
 };
 //BA.debugLineNum = 323;BA.debugLine="If Position=2 Then";
if (_position==2) { 
 //BA.debugLineNum = 324;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 325;BA.debugLine="kvs4.PutSimple(\"2\",Value)";
mostCurrent._kvs4._putsimple("2",_value);
 //BA.debugLineNum = 326;BA.debugLine="ToastMessageShow(\"Lime \",False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("Lime "),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 327;BA.debugLine="Log(\"Now Stored\")";
anywheresoftware.b4a.keywords.Common.Log("Now Stored");
 //BA.debugLineNum = 328;BA.debugLine="Panel2.Color=c3";
mostCurrent._panel2.setColor(_c3);
 //BA.debugLineNum = 329;BA.debugLine="Activity.Invalidate";
mostCurrent._activity.Invalidate();
 };
 //BA.debugLineNum = 331;BA.debugLine="If Position=3 Then";
if (_position==3) { 
 //BA.debugLineNum = 332;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 333;BA.debugLine="kvs4.PutSimple(\"3\",Value)";
mostCurrent._kvs4._putsimple("3",_value);
 //BA.debugLineNum = 334;BA.debugLine="ToastMessageShow(\"Teal \",False)";
...
anywheresoftware.b4a.keywords.Common.Log("Stored ---");
 //BA.debugLineNum = 336;BA.debugLine="Panel2.Color=c4";
mostCurrent._panel2.setColor(_c4);
 //BA.debugLineNum = 337;BA.debugLine="Activity.Invalidate";
mostCurrent._activity.Invalidate();
 };
 //BA.debugLineNum = 339;BA.debugLine="If Position=4 Then";
if (_position==4) { 
 //BA.debugLineNum = 340;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 341;BA.debugLine="kvs4.PutSimple(\"4\",Value)";
mostCurrent._kvs4._putsimple("4",_value);
 //BA.debugLineNum = 342;BA.debugLine="ToastMessageShow(\"purple(dark) \",False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("purple(dark) "),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 343;BA.debugLine="Log(\"Stored ---\")";
anywheresoftware.b4a.keywords.Common.Log("Stored ---");
 //BA.debugLineNum = 344;BA.debugLine="Panel2.Color=c5";
mostCurrent._panel2.setColor(_c5);
 };
 //BA.debugLineNum = 346;BA.debugLine="If Position=5 Then";
if (_position==5) { 
 //BA.debugLineNum = 347;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 348;BA.debugLine="kvs4.PutSimple(\"5\",Value)";
mostCurrent._kvs4._putsimple("5",_value);
 //BA.debugLineNum = 349;BA.debugLine="ToastMessageShow(\"red \",False)";
...
anywheresoftware.b4a.keywords.Common.Log("Stored ---");
 //BA.debugLineNum = 351;BA.debugLine="Panel2.Color=c6";
mostCurrent._panel2.setColor(_c6);
 };
 //BA.debugLineNum = 353;BA.debugLine="If Position=6 Then";
if (_position==6) { 
 //BA.debugLineNum = 354;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 355;BA.debugLine="kvs4.PutSimple(\"6\",Value)";
mostCurrent._kvs4._putsimple("6",_value);
 //BA.debugLineNum = 356;BA.debugLine="ToastMessageShow(\"indigo \",False)";
...
anywheresoftware.b4a.keywords.Common.Log("Stored ---");
 //BA.debugLineNum = 358;BA.debugLine="Panel2.Color=c7";
mostCurrent._panel2.setColor(_c7);
 };
 //BA.debugLineNum = 360;BA.debugLine="If Position=7 Then";
if (_position==7) { 
 //BA.debugLineNum = 361;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 362;BA.debugLine="kvs4.PutSimple(\"7\",Value)";
mostCurrent._kvs4._putsimple("7",_value);
 //BA.debugLineNum = 363;BA.debugLine="ToastMessageShow(\"blue \",False)";
...
anywheresoftware.b4a.keywords.Common.Log("Stored ---");
 //BA.debugLineNum = 365;BA.debugLine="Panel2.Color=c8";
mostCurrent._panel2.setColor(_c8);
 };
 //BA.debugLineNum = 367;BA.debugLine="If Position=8 Then";
if (_position==8) { 
 //BA.debugLineNum = 368;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 369;BA.debugLine="kvs4.PutSimple(\"8\",Value)";
mostCurrent._kvs4._putsimple("8",_value);
 //BA.debugLineNum = 370;BA.debugLine="ToastMessageShow(\"orange\",False)";
...
anywheresoftware.b4a.keywords.Common.Log("Stored ---");
 //BA.debugLineNum = 372;BA.debugLine="Panel2.Color=c9";
mostCurrent._panel2.setColor(_c9);
 };
 //BA.debugLineNum = 374;BA.debugLine="If Position=9 Then";
if (_position==9) { 
 //BA.debugLineNum = 375;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 376;BA.debugLine="kvs4.PutSimple(\"9\",Value)";
mostCurrent._kvs4._putsimple("9",_value);
 //BA.debugLineNum = 377;BA.debugLine="ToastMessageShow(\"grey \",False)";
...
anywheresoftware.b4a.keywords.Common.Log("Stored ---");
 //BA.debugLineNum = 379;BA.debugLine="Panel2.Color=c10";
mostCurrent._panel2.setColor(_c10);
 };
 //BA.debugLineNum = 381;BA.debugLine="If Position=10 Then";
if (_position==10) { 
 //BA.debugLineNum = 382;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 383;BA.debugLine="kvs4.PutSimple(\"10\",Value)";
mostCurrent._kvs4._putsimple("10",_value);
 //BA.debugLineNum = 384;BA.debugLine="ToastMessageShow(\"green \",False)";
...
anywheresoftware.b4a.keywords.Common.Log("Stored ---");
 //BA.debugLineNum = 386;BA.debugLine="Panel2.Color=c11";
mostCurrent._panel2.setColor(_c11);
 //BA.debugLineNum = 387;BA.debugLine="Activity.Invalidate";
mostCurrent._activity.Invalidate();
 };
 //BA.debugLineNum = 389;BA.debugLine="If Position=11 Then";
if (_position==11) { 
 //BA.debugLineNum = 390;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 391;BA.debugLine="kvs4.PutSimple(\"11\",Value)";
mostCurrent._kvs4._putsimple("11",_value);
 //BA.debugLineNum = 392;BA.debugLine="ToastMessageShow(\"light green \",False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("light green "),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 393;BA.debugLine="Log(\"Stored ---\")";
anywheresoftware.b4a.keywords.Common.Log("Stored ---");
 //BA.debugLineNum = 394;BA.debugLine="Panel2.Color=c12";
mostCurrent._panel2.setColor(_c12);
 };
 //BA.debugLineNum = 396;BA.debugLine="If Position=12 Then";
if (_position==12) { 
 //BA.debugLineNum = 397;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 398;BA.debugLine="kvs4.PutSimple(\"12\",Value)";
mostCurrent._kvs4._putsimple("12",_value);
 //BA.debugLineNum = 399;BA.debugLine="ToastMessageShow(\"yellow \",False)";
...
anywheresoftware.b4a.keywords.Common.Log("Stored ---");
 //BA.debugLineNum = 401;BA.debugLine="Panel2.Color=c13";
mostCurrent._panel2.setColor(_c13);
 };
 //BA.debugLineNum = 403;BA.debugLine="If Position=13 Then";
if (_position==13) { 
 //BA.debugLineNum = 404;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 405;BA.debugLine="kvs4.PutSimple(\"13\",Value)";
mostCurrent._kvs4._putsimple("13",_value);
 //BA.debugLineNum = 406;BA.debugLine="ToastMessageShow(\"cyan \",False)";
...
anywheresoftware.b4a.keywords.Common.Log("Stored ---");
 //BA.debugLineNum = 408;BA.debugLine="Panel2.Color=c14";
mostCurrent._panel2.setColor(_c14);
 };
 //BA.debugLineNum = 410;BA.debugLine="If Position=14 Then";
if (_position==14) { 
 //BA.debugLineNum = 411;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 412;BA.debugLine="kvs4.PutSimple(\"14\",Value)";
...
anywheresoftware.b4a.keywords.Common.Log("Stored ---");
 //BA.debugLineNum = 415;BA.debugLine="Panel2.Color=c15";
...
anywheresoftware.b4a.objects.drawable.BitmapDrawable _bd = null;
 ...
 //BA.debugLineNum = 47;BA.debugLine="Activity.LoadLayout(\"6\")";
mostCurrent._activity.LoadLayout("6",mostCurrent.activityBA);
 //BA.debugLineNum = 48;BA.debugLine="Activity.Color=Colors.ARGB(200,255,255,255)";
mostCurrent._activity.setColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (200),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 50;BA.debugLine="kvs4.Initialize(File.DirDefaultExternal, \"datasto";
mostCurrent._kvs4._initialize(processBA,anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal(),"datastore_4");
 //BA.debugLineNum = 51;BA.debugLine="kvs4sub.Initialize(File.DirDefaultExternal, \"data";
...
_bd.Initialize((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_clear_black_48dp.png").getObject()));
 //BA.debugLineNum = 60;BA.debugLine="popa.Initialize(\"popa\",Panel2)";
mostCurrent._popa.Initialize(mostCurrent.activityBA,"popa",(android.view.View)(mostCurrent._panel2.getObject()));
 //BA.debugLineNum = 61;BA.debugLine="colist.Initialize";
...
_c2 = mostCurrent._mcl.getmd_amber_A700();
 //BA.debugLineNum = 78;BA.debugLine="c3=mcl.md_white_1000";
...
_c11 = mostCurrent._mcl.getmd_green_A700();
 //BA.debugLineNum = 87;BA.debugLine="c12=mcl.md_black_1000";
...
mostCurrent._acspinner1.Add2(BA.ObjectToCharSequence("Amber"),(android.graphics.drawable.Drawable)(mostCurrent._cc2.getObject()));
 //BA.debugLineNum = 114;BA.debugLine="ACSpinner1.Add2(\"White(Arctic)\",cc3)'-<<<<<<chang";
...
mostCurrent._acspinner1.Add2(BA.ObjectToCharSequence("green"),(android.graphics.drawable.Drawable)(mostCurrent._cc11.getObject()));
 //BA.debugLineNum = 123;BA.debugLine="ACSpinner1.Add2(\"Black(Ultra)\",cc12)'-<<<<<<chang";
...
public static String  _cb1_checkedchange(boolean _checked) throws Exception{
 //BA.debugLineNum = 429;BA.debugLine="Sub cb1_CheckedChange(Checked As Boolean)";
 //BA.debugLineNum = 430;BA.debugLine="If Not(Checked=True) Then";
if (anywheresoftware.b4a.keywords.Common.Not(_checked==anywheresoftware.b4a.keywords.Common.True)) { 
 //BA.debugLineNum = 431;BA.debugLine="dev.StopListening";
mostCurrent._dev.StopListening();
 //BA.debugLineNum = 432;BA.debugLine="StopService(Starter)";
anywheresoftware.b4a.keywords.Common.StopService(mostCurrent.activityBA,(Object)(mostCurrent._starter.getObject()));
 //BA.debugLineNum = 434;BA.debugLine="kvs4sub.DeleteAll";
mostCurrent._kvs4sub._deleteall();
 //BA.debugLineNum = 435;BA.debugLine="kvs4sub.PutSimple(\"off\",Checked)";
mostCurrent._kvs4sub._putsimple("off",(Object)(_checked));
 //BA.debugLineNum = 436;BA.debugLine="ToastMessageShow(\"Status Service Stop\",False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("Status Service Stop"),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 437;BA.debugLine="Log(\"end\")";
anywheresoftware.b4a.keywords.Common.Log("end");
 }else {
 //BA.debugLineNum = 439;BA.debugLine="If kvs4sub.ContainsKey(\"off\") Then";
if (mostCurrent._kvs4sub._containskey("off")) { 
 //BA.debugLineNum = 440;BA.debugLine="kvs4sub.DeleteAll";
mostCurrent._kvs4sub._deleteall();
 //BA.debugLineNum = 441;BA.debugLine="StartService(Starter)";
anywheresoftware.b4a.keywords.Common.StartService(mostCurrent.activityBA,(Object)(mostCurrent._starter.getObject()));
 //BA.debugLineNum = 442;BA.debugLine="StartService(hw)";
anywheresoftware.b4a.keywords.Common.StartService(mostCurrent.activityBA,(Object)(mostCurrent._hw.getObject()));
 //BA.debugLineNum = 443;BA.debugLine="ToastMessageShow(\"Status Service Start\",False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("Status Service Start"),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 444;BA.debugLine="Log(\"start\")";
...
public static String  _panel2_touch(int _action,float _x,float _y) throws Exception{
 //BA.debugLineNum = 423;BA.debugLine="Sub Panel2_Touch (Action As Int, X As Float, Y As";
 //BA.debugLineNum = 425;BA.debugLine="End Sub";
return "";
}
public static String  _popa_itemclicked(de.amberhome.objects.appcompat.ACMenuItemWrapper _item) throws Exception{
 //BA.debugLineNum = 163;BA.debugLine="Sub popa_ItemClicked (Item As ACMenuItem)";
 //BA.debugLineNum = 164;BA.debugLine="If Item = popa.GetItem(0) Then";
...
public static String  _store_check() throws Exception{
 //BA.debugLineNum = 169;BA.debugLine="Sub store_check";
 //BA.debugLineNum = 170;BA.debugLine="If kvs4sub.ContainsKey(\"off\") Then";
if (mostCurrent._kvs4sub._containskey("off")) { 
 //BA.debugLineNum = 171;BA.debugLine="cb1_CheckedChange(True)";
_cb1_checkedchange(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 172;BA.debugLine="cb1.Checked=True";
mostCurrent._cb1.setChecked(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 173;BA.debugLine="Log(\"AC_true->\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->");
 }else {
 //BA.debugLineNum = 175;BA.debugLine="kvs4sub.DeleteAll";
mostCurrent._kvs4sub._deleteall();
 //BA.debugLineNum = 176;BA.debugLine="Log(\"AC_Off->\")";
anywheresoftware.b4a.keywords.Common.Log("AC_Off->");
 //BA.debugLineNum = 177;BA.debugLine="cb1.Checked=False";
mostCurrent._cb1.setChecked(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 178;BA.debugLine="cb1_CheckedChange(False)";
_cb1_checkedchange(anywheresoftware.b4a.keywords.Common.False);
 };
 //BA.debugLineNum = 181;BA.debugLine="If kvs4.ContainsKey(\"0\")Then";
if (mostCurrent._kvs4._containskey("0")) { 
 //BA.debugLineNum = 182;BA.debugLine="Log(\"AC_true->1\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->1");
 //BA.debugLineNum = 184;BA.debugLine="ACSpinner1.SelectedIndex=0";
mostCurrent._acspinner1.setSelectedIndex((int) (0));
 //BA.debugLineNum = 185;BA.debugLine="Panel2.Color=c1";
mostCurrent._panel2.setColor(_c1);
 };
 //BA.debugLineNum = 187;BA.debugLine="If kvs4.ContainsKey(\"1\")Then";
if (mostCurrent._kvs4._containskey("1")) { 
 //BA.debugLineNum = 188;BA.debugLine="Log(\"AC_true->2\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->2");
 //BA.debugLineNum = 189;BA.debugLine="ACSpinner1.SelectedIndex=1";
mostCurrent._acspinner1.setSelectedIndex((int) (1));
 //BA.debugLineNum = 190;BA.debugLine="Panel2.Color=c2";
mostCurrent._panel2.setColor(_c2);
 }else {
 };
 //BA.debugLineNum = 194;BA.debugLine="If kvs4.ContainsKey(\"2\")Then";
if (mostCurrent._kvs4._containskey("2")) { 
 //BA.debugLineNum = 195;BA.debugLine="Log(\"AC_true->3\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->3");
 //BA.debugLineNum = 196;BA.debugLine="Panel2.Color=c3";
mostCurrent._panel2.setColor(_c3);
 //BA.debugLineNum = 197;BA.debugLine="ACSpinner1.SelectedIndex=2";
mostCurrent._acspinner1.setSelectedIndex((int) (2));
 }else {
 };
 //BA.debugLineNum = 202;BA.debugLine="If kvs4.ContainsKey(\"3\")Then";
...
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 204;BA.debugLine="Panel2.Color=c4";
mostCurrent._panel2.setColor(_c4);
 //BA.debugLineNum = 205;BA.debugLine="ACSpinner1.SelectedIndex=3";
mostCurrent._acspinner1.setSelectedIndex((int) (3));
 }else {
 };
 //BA.debugLineNum = 210;BA.debugLine="If kvs4.ContainsKey(\"4\")Then";
if (mostCurrent._kvs4._containskey("4")) { 
 //BA.debugLineNum = 211;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 213;BA.debugLine="ACSpinner1.SelectedIndex=4";
mostCurrent._acspinner1.setSelectedIndex((int) (4));
 //BA.debugLineNum = 214;BA.debugLine="Panel2.Color=c5";
mostCurrent._panel2.setColor(_c5);
 }else {
 };
 //BA.debugLineNum = 218;BA.debugLine="If kvs4.ContainsKey(\"5\")Then";
if (mostCurrent._kvs4._containskey("5")) { 
 //BA.debugLineNum = 219;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 221;BA.debugLine="Panel2.Color=c6";
mostCurrent._panel2.setColor(_c6);
 //BA.debugLineNum = 222;BA.debugLine="ACSpinner1.SelectedIndex=5";
mostCurrent._acspinner1.setSelectedIndex((int) (5));
 }else {
 };
 //BA.debugLineNum = 226;BA.debugLine="If kvs4.ContainsKey(\"6\")Then";
if (mostCurrent._kvs4._containskey("6")) { 
 //BA.debugLineNum = 227;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 229;BA.debugLine="ACSpinner1.SelectedIndex=6";
mostCurrent._acspinner1.setSelectedIndex((int) (6));
 //BA.debugLineNum = 230;BA.debugLine="Panel2.Color=c7";
mostCurrent._panel2.setColor(_c7);
 }else {
 };
 //BA.debugLineNum = 234;BA.debugLine="If kvs4.ContainsKey(\"7\")Then";
if (mostCurrent._kvs4._containskey("7")) { 
 //BA.debugLineNum = 235;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 236;BA.debugLine="Panel2.Color=c8";
mostCurrent._panel2.setColor(_c8);
 //BA.debugLineNum = 238;BA.debugLine="ACSpinner1.SelectedIndex=7";
mostCurrent._acspinner1.setSelectedIndex((int) (7));
 }else {
 };
 //BA.debugLineNum = 242;BA.debugLine="If kvs4.ContainsKey(\"8\")Then";
if (mostCurrent._kvs4._containskey("8")) { 
 //BA.debugLineNum = 243;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 246;BA.debugLine="Panel2.Color=c9";
mostCurrent._panel2.setColor(_c9);
 //BA.debugLineNum = 247;BA.debugLine="ACSpinner1.SelectedIndex=8";
mostCurrent._acspinner1.setSelectedIndex((int) (8));
 }else {
 };
 //BA.debugLineNum = 251;BA.debugLine="If kvs4.ContainsKey(\"9\")Then";
if (mostCurrent._kvs4._containskey("9")) { 
 //BA.debugLineNum = 252;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 254;BA.debugLine="Panel2.Color=c10";
mostCurrent._panel2.setColor(_c10);
 //BA.debugLineNum = 255;BA.debugLine="ACSpinner1.SelectedIndex=9";
mostCurrent._acspinner1.setSelectedIndex((int) (9));
 }else {
 };
 //BA.debugLineNum = 260;BA.debugLine="If kvs4.ContainsKey(\"10\")Then";
if (mostCurrent._kvs4._containskey("10")) { 
 //BA.debugLineNum = 261;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 262;BA.debugLine="Panel2.Color=c11";
mostCurrent._panel2.setColor(_c11);
 //BA.debugLineNum = 263;BA.debugLine="ACSpinner1.SelectedIndex=10";
mostCurrent._acspinner1.setSelectedIndex((int) (10));
 }else {
 };
 //BA.debugLineNum = 268;BA.debugLine="If kvs4.ContainsKey(\"11\")Then";
if (mostCurrent._kvs4._containskey("11")) { 
 //BA.debugLineNum = 269;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 271;BA.debugLine="Panel2.Color=c12";
mostCurrent._panel2.setColor(_c12);
 //BA.debugLineNum = 272;BA.debugLine="ACSpinner1.SelectedIndex=11";
mostCurrent._acspinner1.setSelectedIndex((int) (11));
 }else {
 };
 //BA.debugLineNum = 277;BA.debugLine="If kvs4.ContainsKey(\"12\")Then";
if (mostCurrent._kvs4._containskey("12")) { 
 //BA.debugLineNum = 278;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 280;BA.debugLine="Panel2.Color=c13";
mostCurrent._panel2.setColor(_c13);
 //BA.debugLineNum = 281;BA.debugLine="ACSpinner1.SelectedIndex=12";
mostCurrent._acspinner1.setSelectedIndex((int) (12));
 }else {
 };
 //BA.debugLineNum = 286;BA.debugLine="If kvs4.ContainsKey(\"13\")Then";
if (mostCurrent._kvs4._containskey("13")) { 
 //BA.debugLineNum = 287;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 288;BA.debugLine="ACSpinner1.SelectedIndex=13";
mostCurrent._acspinner1.setSelectedIndex((int) (13));
 //BA.debugLineNum = 289;BA.debugLine="Panel2.Color=c14";
mostCurrent._panel2.setColor(_c14);
 }else {
 };
 //BA.debugLineNum = 295;BA.debugLine="If kvs4.ContainsKey(\"14\")Then";
if (mostCurrent._kvs4._containskey("14")) { 
 //BA.debugLineNum = 296;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 298;BA.debugLine="Panel2.Color=c15";
mostCurrent._panel2.setColor(_c15);
 //BA.debugLineNum = 299;BA.debugLine="ACSpinner1.SelectedIndex=14";
