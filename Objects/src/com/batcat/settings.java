...
public static String  _acspinner1_itemclick(int _position,Object _value) throws Exception{
 //BA.debugLineNum = 355;BA.debugLine="Sub ACSpinner1_ItemClick (Position As Int, Value A";
 //BA.debugLineNum = 356;BA.debugLine="Value=ACSpinner1.SelectedIndex";
_value = (Object)(mostCurrent._acspinner1.getSelectedIndex());
 //BA.debugLineNum = 357;BA.debugLine="ACSpinner1.SelectedIndex=Position";
mostCurrent._acspinner1.setSelectedIndex(_position);
 //BA.debugLineNum = 358;BA.debugLine="ACSpinner1.Prompt=\"Select Color:\"";
mostCurrent._acspinner1.setPrompt(BA.ObjectToCharSequence("Select Color:"));
 //BA.debugLineNum = 359;BA.debugLine="ACSpinner1.DropdownBackgroundColor= ACSpinner1.T";
mostCurrent._acspinner1.setDropdownBackgroundColor(mostCurrent._acspinner1.THEME_LIGHT);
 //BA.debugLineNum = 360;BA.debugLine="If Position=0 Then";
if (_position==0) { 
 //BA.debugLineNum = 361;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 362;BA.debugLine="kvs4.PutSimple(\"0\",Value)";
...
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(_value),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 364;BA.debugLine="Panel2.Color=c16";
mostCurrent._panel2.setColor(_c16);
 //BA.debugLineNum = 365;BA.debugLine="Log(\"Is in Store\")";
anywheresoftware.b4a.keywords.Common.Log("Is in Store");
 };
 //BA.debugLineNum = 367;BA.debugLine="If Position=1 Then";
if (_position==1) { 
 //BA.debugLineNum = 368;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 369;BA.debugLine="kvs4.PutSimple(\"1\",Value)";
mostCurrent._kvs4._putsimple("1",_value);
 //BA.debugLineNum = 370;BA.debugLine="ToastMessageShow(Value,False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(_value),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 371;BA.debugLine="Log(\"New Store\")";
anywheresoftware.b4a.keywords.Common.Log("New Store");
 //BA.debugLineNum = 372;BA.debugLine="Panel2.Color=c2";
mostCurrent._panel2.setColor(_c2);
 };
 //BA.debugLineNum = 374;BA.debugLine="If Position=2 Then";
if (_position==2) { 
 //BA.debugLineNum = 375;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 376;BA.debugLine="kvs4.PutSimple(\"2\",Value)";
mostCurrent._kvs4._putsimple("2",_value);
 //BA.debugLineNum = 377;BA.debugLine="ToastMessageShow(Value,False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(_value),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 378;BA.debugLine="Log(\"Now Stored\")";
anywheresoftware.b4a.keywords.Common.Log("Now Stored");
 //BA.debugLineNum = 379;BA.debugLine="Panel2.Color=c3";
mostCurrent._panel2.setColor(_c3);
 //BA.debugLineNum = 380;BA.debugLine="Activity.Invalidate";
mostCurrent._activity.Invalidate();
 };
 //BA.debugLineNum = 382;BA.debugLine="If Position=3 Then";
if (_position==3) { 
 //BA.debugLineNum = 383;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 384;BA.debugLine="kvs4.PutSimple(\"3\",Value)";
...
anywheresoftware.b4a.keywords.Common.Log("Stored ---");
 //BA.debugLineNum = 387;BA.debugLine="Panel2.Color=c4";
mostCurrent._panel2.setColor(_c4);
 //BA.debugLineNum = 388;BA.debugLine="Activity.Invalidate";
mostCurrent._activity.Invalidate();
 };
 //BA.debugLineNum = 390;BA.debugLine="If Position=4 Then";
if (_position==4) { 
 //BA.debugLineNum = 391;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 392;BA.debugLine="kvs4.PutSimple(\"4\",Value)";
...
anywheresoftware.b4a.keywords.Common.Log("Stored ---");
 //BA.debugLineNum = 395;BA.debugLine="Panel2.Color=c5";
mostCurrent._panel2.setColor(_c5);
 };
 //BA.debugLineNum = 397;BA.debugLine="If Position=5 Then";
if (_position==5) { 
 //BA.debugLineNum = 398;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 399;BA.debugLine="kvs4.PutSimple(\"5\",Value)";
mostCurrent._kvs4._putsimple("5",_value);
 //BA.debugLineNum = 400;BA.debugLine="ToastMessageShow(Value,False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(_value),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 401;BA.debugLine="Log(\"Stored ---\")";
anywheresoftware.b4a.keywords.Common.Log("Stored ---");
 //BA.debugLineNum = 402;BA.debugLine="Panel2.Color=c6";
mostCurrent._panel2.setColor(_c6);
 };
 //BA.debugLineNum = 404;BA.debugLine="If Position=6 Then";
if (_position==6) { 
 //BA.debugLineNum = 405;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 406;BA.debugLine="kvs4.PutSimple(\"6\",Value)";
mostCurrent._kvs4._putsimple("6",_value);
 //BA.debugLineNum = 407;BA.debugLine="ToastMessageShow(Value,False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(_value),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 408;BA.debugLine="Log(\"Stored ---\")";
anywheresoftware.b4a.keywords.Common.Log("Stored ---");
 //BA.debugLineNum = 409;BA.debugLine="Panel2.Color=c7";
mostCurrent._panel2.setColor(_c7);
 };
 //BA.debugLineNum = 411;BA.debugLine="If Position=7 Then";
if (_position==7) { 
 //BA.debugLineNum = 412;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 413;BA.debugLine="kvs4.PutSimple(\"7\",Value)";
mostCurrent._kvs4._putsimple("7",_value);
 //BA.debugLineNum = 414;BA.debugLine="ToastMessageShow(Value,False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(_value),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 415;BA.debugLine="Log(\"Stored ---\")";
anywheresoftware.b4a.keywords.Common.Log("Stored ---");
 //BA.debugLineNum = 416;BA.debugLine="Panel2.Color=c8";
mostCurrent._panel2.setColor(_c8);
 };
 //BA.debugLineNum = 418;BA.debugLine="If Position=8 Then";
if (_position==8) { 
 //BA.debugLineNum = 419;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 420;BA.debugLine="kvs4.PutSimple(\"8\",Value)";
mostCurrent._kvs4._putsimple("8",_value);
 //BA.debugLineNum = 421;BA.debugLine="ToastMessageShow(Value,False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(_value),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 422;BA.debugLine="Log(\"Stored ---\")";
anywheresoftware.b4a.keywords.Common.Log("Stored ---");
 //BA.debugLineNum = 423;BA.debugLine="Panel2.Color=c9";
mostCurrent._panel2.setColor(_c9);
 };
 //BA.debugLineNum = 425;BA.debugLine="If Position=9 Then";
if (_position==9) { 
 //BA.debugLineNum = 426;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 427;BA.debugLine="kvs4.PutSimple(\"9\",Value)";
mostCurrent._kvs4._putsimple("9",_value);
 //BA.debugLineNum = 428;BA.debugLine="ToastMessageShow(Value,False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(_value),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 429;BA.debugLine="Log(\"Stored ---\")";
anywheresoftware.b4a.keywords.Common.Log("Stored ---");
 //BA.debugLineNum = 430;BA.debugLine="Panel2.Color=c10";
mostCurrent._panel2.setColor(_c10);
 };
 //BA.debugLineNum = 432;BA.debugLine="If Position=10 Then";
if (_position==10) { 
 //BA.debugLineNum = 433;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 434;BA.debugLine="kvs4.PutSimple(\"10\",Value)";
mostCurrent._kvs4._putsimple("10",_value);
 //BA.debugLineNum = 435;BA.debugLine="ToastMessageShow(Value,False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(_value),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 436;BA.debugLine="Log(\"Stored ---\")";
anywheresoftware.b4a.keywords.Common.Log("Stored ---");
 //BA.debugLineNum = 437;BA.debugLine="Panel2.Color=c11";
mostCurrent._panel2.setColor(_c11);
 //BA.debugLineNum = 438;BA.debugLine="Activity.Invalidate";
mostCurrent._activity.Invalidate();
 };
 //BA.debugLineNum = 440;BA.debugLine="If Position=11 Then";
if (_position==11) { 
 //BA.debugLineNum = 441;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 442;BA.debugLine="kvs4.PutSimple(\"11\",Value)";
...
anywheresoftware.b4a.keywords.Common.Log("Stored ---");
 //BA.debugLineNum = 445;BA.debugLine="Panel2.Color=c12";
mostCurrent._panel2.setColor(_c12);
 //BA.debugLineNum = 446;BA.debugLine="Label5.TextColor=Colors.White";
mostCurrent._label5.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 };
 //BA.debugLineNum = 448;BA.debugLine="If Position=12 Then";
if (_position==12) { 
 //BA.debugLineNum = 449;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 450;BA.debugLine="kvs4.PutSimple(\"12\",Value)";
...
anywheresoftware.b4a.keywords.Common.Log("Stored ---");
 //BA.debugLineNum = 453;BA.debugLine="Panel2.Color=c13";
mostCurrent._panel2.setColor(_c13);
 };
 //BA.debugLineNum = 455;BA.debugLine="If Position=13 Then";
if (_position==13) { 
 //BA.debugLineNum = 456;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 457;BA.debugLine="kvs4.PutSimple(\"13\",Value)";
mostCurrent._kvs4._putsimple("13",_value);
 //BA.debugLineNum = 458;BA.debugLine="ToastMessageShow(Value,False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(_value),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 459;BA.debugLine="Log(\"Stored ---\")";
anywheresoftware.b4a.keywords.Common.Log("Stored ---");
 //BA.debugLineNum = 460;BA.debugLine="Panel2.Color=c14";
mostCurrent._panel2.setColor(_c14);
 };
 //BA.debugLineNum = 462;BA.debugLine="If Position=14 Then";
if (_position==14) { 
 //BA.debugLineNum = 463;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 464;BA.debugLine="kvs4.PutSimple(\"14\",Value)";
mostCurrent._kvs4._putsimple("14",_value);
 //BA.debugLineNum = 465;BA.debugLine="ToastMessageShow(Value,False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(_value),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 466;BA.debugLine="Log(\"Stored ---\")";
anywheresoftware.b4a.keywords.Common.Log("Stored ---");
 //BA.debugLineNum = 467;BA.debugLine="Panel2.Color=c15";
...
public static String  _store_check() throws Exception{
 //BA.debugLineNum = 221;BA.debugLine="Sub store_check";
 //BA.debugLineNum = 222;BA.debugLine="If kvs4sub.ContainsKey(\"off\") Then";
if (mostCurrent._kvs4sub._containskey("off")) { 
 //BA.debugLineNum = 223;BA.debugLine="arb.Checked=False";
mostCurrent._arb.setChecked(anywheresoftware.b4a.keywords.Common.False);
 }else {
 //BA.debugLineNum = 226;BA.debugLine="arb.Checked=True";
mostCurrent._arb.setChecked(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 230;BA.debugLine="If kvs4.ContainsKey(\"0\")Then";
if (mostCurrent._kvs4._containskey("0")) { 
 //BA.debugLineNum = 231;BA.debugLine="Log(\"AC_true->1\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->1");
 //BA.debugLineNum = 233;BA.debugLine="ACSpinner1.SelectedIndex=0";
mostCurrent._acspinner1.setSelectedIndex((int) (0));
 //BA.debugLineNum = 234;BA.debugLine="Panel2.Color=c1";
mostCurrent._panel2.setColor(_c1);
 };
 //BA.debugLineNum = 237;BA.debugLine="If kvs4.ContainsKey(\"1\")Then";
if (mostCurrent._kvs4._containskey("1")) { 
 //BA.debugLineNum = 238;BA.debugLine="Log(\"AC_true->2\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->2");
 //BA.debugLineNum = 239;BA.debugLine="ACSpinner1.SelectedIndex=1";
mostCurrent._acspinner1.setSelectedIndex((int) (1));
 //BA.debugLineNum = 240;BA.debugLine="Panel2.Color=c2";
mostCurrent._panel2.setColor(_c2);
 //BA.debugLineNum = 241;BA.debugLine="Activity.Color=c1";
mostCurrent._activity.setColor(_c1);
 };
 //BA.debugLineNum = 243;BA.debugLine="If kvs4.ContainsKey(\"2\")Then";
if (mostCurrent._kvs4._containskey("2")) { 
 //BA.debugLineNum = 244;BA.debugLine="Log(\"AC_true->3\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->3");
 //BA.debugLineNum = 245;BA.debugLine="Panel2.Color=c3";
mostCurrent._panel2.setColor(_c3);
 //BA.debugLineNum = 248;BA.debugLine="Activity.Color=c1";
mostCurrent._activity.setColor(_c1);
 };
 //BA.debugLineNum = 250;BA.debugLine="If kvs4.ContainsKey(\"3\")Then";
if (mostCurrent._kvs4._containskey("3")) { 
 //BA.debugLineNum = 251;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 252;BA.debugLine="Panel2.Color=c4";
mostCurrent._panel2.setColor(_c4);
 //BA.debugLineNum = 253;BA.debugLine="ACSpinner1.SelectedIndex=3";
mostCurrent._acspinner1.setSelectedIndex((int) (3));
 //BA.debugLineNum = 254;BA.debugLine="Activity.Color=c4";
mostCurrent._activity.setColor(_c4);
 }else {
 //BA.debugLineNum = 256;BA.debugLine="Activity.color=c4";
mostCurrent._activity.setColor(_c4);
 };
 //BA.debugLineNum = 258;BA.debugLine="If kvs4.ContainsKey(\"4\")Then";
if (mostCurrent._kvs4._containskey("4")) { 
 //BA.debugLineNum = 259;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 261;BA.debugLine="ACSpinner1.SelectedIndex=4";
mostCurrent._acspinner1.setSelectedIndex((int) (4));
 //BA.debugLineNum = 262;BA.debugLine="Panel2.Color=c5";
mostCurrent._panel2.setColor(_c5);
 //BA.debugLineNum = 264;BA.debugLine="Activity.Color=c4";
mostCurrent._activity.setColor(_c4);
 };
 //BA.debugLineNum = 266;BA.debugLine="If kvs4.ContainsKey(\"5\")Then";
if (mostCurrent._kvs4._containskey("5")) { 
 //BA.debugLineNum = 267;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 268;BA.debugLine="Activity.color=c6";
mostCurrent._activity.setColor(_c6);
 //BA.debugLineNum = 269;BA.debugLine="Panel2.Color=c6";
mostCurrent._panel2.setColor(_c6);
 //BA.debugLineNum = 270;BA.debugLine="ACSpinner1.SelectedIndex=5";
mostCurrent._acspinner1.setSelectedIndex((int) (5));
 }else {
 //BA.debugLineNum = 272;BA.debugLine="Activity.color=c4";
mostCurrent._activity.setColor(_c4);
 };
...
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 277;BA.debugLine="ACSpinner1.SelectedIndex=6";
mostCurrent._acspinner1.setSelectedIndex((int) (6));
 //BA.debugLineNum = 278;BA.debugLine="Panel2.Color=c7";
mostCurrent._panel2.setColor(_c7);
 }else {
 //BA.debugLineNum = 280;BA.debugLine="Activity.color=c4";
mostCurrent._activity.setColor(_c4);
 };
 //BA.debugLineNum = 282;BA.debugLine="If kvs4.ContainsKey(\"7\")Then";
if (mostCurrent._kvs4._containskey("7")) { 
 //BA.debugLineNum = 283;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 284;BA.debugLine="Panel2.Color=c8";
mostCurrent._panel2.setColor(_c8);
 //BA.debugLineNum = 286;BA.debugLine="ACSpinner1.SelectedIndex=7";
mostCurrent._acspinner1.setSelectedIndex((int) (7));
 }else {
 //BA.debugLineNum = 288;BA.debugLine="Activity.color=c4";
mostCurrent._activity.setColor(_c4);
 };
 //BA.debugLineNum = 290;BA.debugLine="If kvs4.ContainsKey(\"8\")Then";
if (mostCurrent._kvs4._containskey("8")) { 
 //BA.debugLineNum = 291;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 293;BA.debugLine="Activity.color=c9";
mostCurrent._activity.setColor(_c9);
 //BA.debugLineNum = 294;BA.debugLine="Panel2.Color=c9";
mostCurrent._panel2.setColor(_c9);
 //BA.debugLineNum = 295;BA.debugLine="ACSpinner1.SelectedIndex=8";
mostCurrent._acspinner1.setSelectedIndex((int) (8));
 }else {
 //BA.debugLineNum = 297;BA.debugLine="Activity.color=c4";
mostCurrent._activity.setColor(_c4);
 };
 //BA.debugLineNum = 299;BA.debugLine="If kvs4.ContainsKey(\"9\")Then";
if (mostCurrent._kvs4._containskey("9")) { 
 //BA.debugLineNum = 300;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 301;BA.debugLine="Activity.color=c10";
mostCurrent._activity.setColor(_c10);
 //BA.debugLineNum = 302;BA.debugLine="Panel2.Color=c10";
mostCurrent._panel2.setColor(_c10);
 //BA.debugLineNum = 303;BA.debugLine="ACSpinner1.SelectedIndex=9";
mostCurrent._acspinner1.setSelectedIndex((int) (9));
 }else {
 //BA.debugLineNum = 306;BA.debugLine="Activity.color=c4";
mostCurrent._activity.setColor(_c4);
 };
 //BA.debugLineNum = 308;BA.debugLine="If kvs4.ContainsKey(\"10\")Then";
if (mostCurrent._kvs4._containskey("10")) { 
 //BA.debugLineNum = 309;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 310;BA.debugLine="Panel2.Color=c11";
mostCurrent._panel2.setColor(_c11);
 //BA.debugLineNum = 311;BA.debugLine="ACSpinner1.SelectedIndex=10";
mostCurrent._acspinner1.setSelectedIndex((int) (10));
 }else {
 //BA.debugLineNum = 314;BA.debugLine="Activity.color=c4";
mostCurrent._activity.setColor(_c4);
 };
 //BA.debugLineNum = 316;BA.debugLine="If kvs4.ContainsKey(\"11\")Then";
if (mostCurrent._kvs4._containskey("11")) { 
 //BA.debugLineNum = 317;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 319;BA.debugLine="Panel2.Color=c12";
mostCurrent._panel2.setColor(_c12);
 //BA.debugLineNum = 320;BA.debugLine="Label5.TextColor=Colors.White";
mostCurrent._label5.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 321;BA.debugLine="ACSpinner1.SelectedIndex=11";
mostCurrent._acspinner1.setSelectedIndex((int) (11));
 //BA.debugLineNum = 322;BA.debugLine="Activity.color=c12";
mostCurrent._activity.setColor(_c12);
 }else {
 //BA.debugLineNum = 324;BA.debugLine="Activity.color=c4";
mostCurrent._activity.setColor(_c4);
 };
 //BA.debugLineNum = 326;BA.debugLine="If kvs4.ContainsKey(\"12\")Then";
if (mostCurrent._kvs4._containskey("12")) { 
 //BA.debugLineNum = 327;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 329;BA.debugLine="Panel2.Color=c13";
mostCurrent._panel2.setColor(_c13);
 //BA.debugLineNum = 330;BA.debugLine="ACSpinner1.SelectedIndex=12";
mostCurrent._acspinner1.setSelectedIndex((int) (12));
 //BA.debugLineNum = 331;BA.debugLine="Activity.color=c13";
mostCurrent._activity.setColor(_c13);
 }else {
 //BA.debugLineNum = 333;BA.debugLine="Activity.color=c4";
mostCurrent._activity.setColor(_c4);
 };
 //BA.debugLineNum = 335;BA.debugLine="If kvs4.ContainsKey(\"13\")Then";
if (mostCurrent._kvs4._containskey("13")) { 
 //BA.debugLineNum = 336;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 337;BA.debugLine="ACSpinner1.SelectedIndex=13";
mostCurrent._acspinner1.setSelectedIndex((int) (13));
 //BA.debugLineNum = 338;BA.debugLine="Panel2.Color=c14";
mostCurrent._panel2.setColor(_c14);
 //BA.debugLineNum = 340;BA.debugLine="Activity.color=c14";
mostCurrent._activity.setColor(_c14);
 }else {
 //BA.debugLineNum = 342;BA.debugLine="Activity.color=c4";
mostCurrent._activity.setColor(_c4);
 };
 //BA.debugLineNum = 344;BA.debugLine="If kvs4.ContainsKey(\"14\")Then";
if (mostCurrent._kvs4._containskey("14")) { 
 //BA.debugLineNum = 345;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 347;BA.debugLine="Panel2.Color=c15";
mostCurrent._panel2.setColor(_c15);
 //BA.debugLineNum = 348;BA.debugLine="ACSpinner1.SelectedIndex=14";
mostCurrent._acspinner1.setSelectedIndex((int) (14));
 //BA.debugLineNum = 349;BA.debugLine="Activity.color=c15";
mostCurrent._activity.setColor(_c15);
 }else {
 //BA.debugLineNum = 351;BA.debugLine="Activity.color=c4";
mostCurrent._activity.setColor(_c4);
 };
