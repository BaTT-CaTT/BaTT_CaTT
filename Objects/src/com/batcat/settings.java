...
public static String  _acbutton1_click() throws Exception{
 //BA.debugLineNum = 177;BA.debugLine="Sub ACButton1_Click";
 //BA.debugLineNum = 178;BA.debugLine="StateManager.SaveSettings";
mostCurrent._statemanager._savesettings(mostCurrent.activityBA);
 //BA.debugLineNum = 179;BA.debugLine="Activity.Finish";
mostCurrent._activity.Finish();
 //BA.debugLineNum = 180;BA.debugLine="SetAnimation.setanimati(\"extra_in\", \"extra_out\")";
...
public static String  _acspinner1_itemclick(int _position,Object _value) throws Exception{
 //BA.debugLineNum = 363;BA.debugLine="Sub ACSpinner1_ItemClick (Position As Int, Value A";
 //BA.debugLineNum = 364;BA.debugLine="Value=ACSpinner1.SelectedIndex";
_value = (Object)(mostCurrent._acspinner1.getSelectedIndex());
 //BA.debugLineNum = 365;BA.debugLine="ACSpinner1.SelectedIndex=Position";
mostCurrent._acspinner1.setSelectedIndex(_position);
 //BA.debugLineNum = 366;BA.debugLine="ACSpinner1.Prompt=\"Select Color:\"";
mostCurrent._acspinner1.setPrompt(BA.ObjectToCharSequence("Select Color:"));
 //BA.debugLineNum = 367;BA.debugLine="ACSpinner1.DropdownBackgroundColor= ACSpinner1.T";
mostCurrent._acspinner1.setDropdownBackgroundColor(mostCurrent._acspinner1.THEME_LIGHT);
 //BA.debugLineNum = 368;BA.debugLine="If Position=0 Then";
if (_position==0) { 
 //BA.debugLineNum = 369;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 370;BA.debugLine="kvs4.PutSimple(\"0\",Value)";
...
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(_value),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 372;BA.debugLine="Panel2.Color=c16";
mostCurrent._panel2.setColor(_c16);
 //BA.debugLineNum = 373;BA.debugLine="Log(\"Is in Store\")";
...
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 377;BA.debugLine="kvs4.PutSimple(\"1\",Value)";
mostCurrent._kvs4._putsimple("1",_value);
 //BA.debugLineNum = 378;BA.debugLine="ToastMessageShow(Value,False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(_value),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 379;BA.debugLine="Log(\"New Store\")";
anywheresoftware.b4a.keywords.Common.Log("New Store");
 //BA.debugLineNum = 380;BA.debugLine="Panel2.Color=c2";
mostCurrent._panel2.setColor(_c2);
 };
 //BA.debugLineNum = 382;BA.debugLine="If Position=2 Then";
if (_position==2) { 
 //BA.debugLineNum = 383;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 384;BA.debugLine="kvs4.PutSimple(\"2\",Value)";
mostCurrent._kvs4._putsimple("2",_value);
 //BA.debugLineNum = 385;BA.debugLine="ToastMessageShow(Value,False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(_value),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 386;BA.debugLine="Log(\"Now Stored\")";
anywheresoftware.b4a.keywords.Common.Log("Now Stored");
 //BA.debugLineNum = 387;BA.debugLine="Panel2.Color=c3";
mostCurrent._panel2.setColor(_c3);
 //BA.debugLineNum = 388;BA.debugLine="Activity.Invalidate";
mostCurrent._activity.Invalidate();
 };
 //BA.debugLineNum = 390;BA.debugLine="If Position=3 Then";
if (_position==3) { 
 //BA.debugLineNum = 391;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 392;BA.debugLine="kvs4.PutSimple(\"3\",Value)";
mostCurrent._kvs4._putsimple("3",_value);
 //BA.debugLineNum = 393;BA.debugLine="ToastMessageShow(Value,False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(_value),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 394;BA.debugLine="Log(\"Stored ---\")";
anywheresoftware.b4a.keywords.Common.Log("Stored ---");
 //BA.debugLineNum = 395;BA.debugLine="Panel2.Color=c4";
mostCurrent._panel2.setColor(_c4);
 //BA.debugLineNum = 396;BA.debugLine="Activity.Invalidate";
mostCurrent._activity.Invalidate();
 };
 //BA.debugLineNum = 398;BA.debugLine="If Position=4 Then";
if (_position==4) { 
 //BA.debugLineNum = 399;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 400;BA.debugLine="kvs4.PutSimple(\"4\",Value)";
mostCurrent._kvs4._putsimple("4",_value);
 //BA.debugLineNum = 401;BA.debugLine="ToastMessageShow(Value,False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(_value),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 402;BA.debugLine="Log(\"Stored ---\")";
anywheresoftware.b4a.keywords.Common.Log("Stored ---");
 //BA.debugLineNum = 403;BA.debugLine="Panel2.Color=c5";
mostCurrent._panel2.setColor(_c5);
 };
 //BA.debugLineNum = 405;BA.debugLine="If Position=5 Then";
if (_position==5) { 
 //BA.debugLineNum = 406;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 407;BA.debugLine="kvs4.PutSimple(\"5\",Value)";
mostCurrent._kvs4._putsimple("5",_value);
 //BA.debugLineNum = 408;BA.debugLine="ToastMessageShow(Value,False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(_value),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 409;BA.debugLine="Log(\"Stored ---\")";
anywheresoftware.b4a.keywords.Common.Log("Stored ---");
 //BA.debugLineNum = 410;BA.debugLine="Panel2.Color=c6";
mostCurrent._panel2.setColor(_c6);
 };
 //BA.debugLineNum = 412;BA.debugLine="If Position=6 Then";
if (_position==6) { 
 //BA.debugLineNum = 413;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 414;BA.debugLine="kvs4.PutSimple(\"6\",Value)";
mostCurrent._kvs4._putsimple("6",_value);
 //BA.debugLineNum = 415;BA.debugLine="ToastMessageShow(Value,False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(_value),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 416;BA.debugLine="Log(\"Stored ---\")";
anywheresoftware.b4a.keywords.Common.Log("Stored ---");
 //BA.debugLineNum = 417;BA.debugLine="Panel2.Color=c7";
mostCurrent._panel2.setColor(_c7);
 };
 //BA.debugLineNum = 419;BA.debugLine="If Position=7 Then";
if (_position==7) { 
 //BA.debugLineNum = 420;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 421;BA.debugLine="kvs4.PutSimple(\"7\",Value)";
mostCurrent._kvs4._putsimple("7",_value);
 //BA.debugLineNum = 422;BA.debugLine="ToastMessageShow(Value,False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(_value),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 423;BA.debugLine="Log(\"Stored ---\")";
anywheresoftware.b4a.keywords.Common.Log("Stored ---");
 //BA.debugLineNum = 424;BA.debugLine="Panel2.Color=c8";
mostCurrent._panel2.setColor(_c8);
 };
 //BA.debugLineNum = 426;BA.debugLine="If Position=8 Then";
if (_position==8) { 
 //BA.debugLineNum = 427;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 428;BA.debugLine="kvs4.PutSimple(\"8\",Value)";
mostCurrent._kvs4._putsimple("8",_value);
 //BA.debugLineNum = 429;BA.debugLine="ToastMessageShow(Value,False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(_value),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 430;BA.debugLine="Log(\"Stored ---\")";
anywheresoftware.b4a.keywords.Common.Log("Stored ---");
 //BA.debugLineNum = 431;BA.debugLine="Panel2.Color=c9";
mostCurrent._panel2.setColor(_c9);
 };
 //BA.debugLineNum = 433;BA.debugLine="If Position=9 Then";
if (_position==9) { 
 //BA.debugLineNum = 434;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 435;BA.debugLine="kvs4.PutSimple(\"9\",Value)";
mostCurrent._kvs4._putsimple("9",_value);
 //BA.debugLineNum = 436;BA.debugLine="ToastMessageShow(Value,False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(_value),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 437;BA.debugLine="Log(\"Stored ---\")";
anywheresoftware.b4a.keywords.Common.Log("Stored ---");
 //BA.debugLineNum = 438;BA.debugLine="Panel2.Color=c10";
mostCurrent._panel2.setColor(_c10);
 };
 //BA.debugLineNum = 440;BA.debugLine="If Position=10 Then";
if (_position==10) { 
 //BA.debugLineNum = 441;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 442;BA.debugLine="kvs4.PutSimple(\"10\",Value)";
mostCurrent._kvs4._putsimple("10",_value);
 //BA.debugLineNum = 443;BA.debugLine="ToastMessageShow(Value,False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(_value),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 444;BA.debugLine="Log(\"Stored ---\")";
anywheresoftware.b4a.keywords.Common.Log("Stored ---");
 //BA.debugLineNum = 445;BA.debugLine="Panel2.Color=c11";
mostCurrent._panel2.setColor(_c11);
 //BA.debugLineNum = 446;BA.debugLine="Activity.Invalidate";
mostCurrent._activity.Invalidate();
 };
 //BA.debugLineNum = 448;BA.debugLine="If Position=11 Then";
if (_position==11) { 
 //BA.debugLineNum = 449;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 450;BA.debugLine="kvs4.PutSimple(\"11\",Value)";
mostCurrent._kvs4._putsimple("11",_value);
 //BA.debugLineNum = 451;BA.debugLine="ToastMessageShow(Value,False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(_value),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 452;BA.debugLine="Log(\"Stored ---\")";
anywheresoftware.b4a.keywords.Common.Log("Stored ---");
 //BA.debugLineNum = 453;BA.debugLine="Panel2.Color=c12";
mostCurrent._panel2.setColor(_c12);
 //BA.debugLineNum = 454;BA.debugLine="Label5.TextColor=Colors.White";
mostCurrent._label5.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 };
 //BA.debugLineNum = 456;BA.debugLine="If Position=12 Then";
if (_position==12) { 
 //BA.debugLineNum = 457;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 458;BA.debugLine="kvs4.PutSimple(\"12\",Value)";
...
anywheresoftware.b4a.keywords.Common.Log("Stored ---");
 //BA.debugLineNum = 461;BA.debugLine="Panel2.Color=c13";
mostCurrent._panel2.setColor(_c13);
 };
 //BA.debugLineNum = 463;BA.debugLine="If Position=13 Then";
if (_position==13) { 
 //BA.debugLineNum = 464;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 465;BA.debugLine="kvs4.PutSimple(\"13\",Value)";
...
anywheresoftware.b4a.keywords.Common.Log("Stored ---");
 //BA.debugLineNum = 468;BA.debugLine="Panel2.Color=c14";
mostCurrent._panel2.setColor(_c14);
 };
 //BA.debugLineNum = 470;BA.debugLine="If Position=14 Then";
if (_position==14) { 
 //BA.debugLineNum = 471;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 472;BA.debugLine="kvs4.PutSimple(\"14\",Value)";
mostCurrent._kvs4._putsimple("14",_value);
 //BA.debugLineNum = 473;BA.debugLine="ToastMessageShow(Value,False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(_value),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 474;BA.debugLine="Log(\"Stored ---\")";
anywheresoftware.b4a.keywords.Common.Log("Stored ---");
 //BA.debugLineNum = 475;BA.debugLine="Panel2.Color=c15";
...
anywheresoftware.b4a.objects.drawable.BitmapDrawable _bd = null;
 ...
 //BA.debugLineNum = 55;BA.debugLine="Activity.LoadLayout(\"6\")";
...
mostCurrent._kvs4._initialize(processBA,anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal(),"datastore_4");
 //BA.debugLineNum = 59;BA.debugLine="kvs4sub.Initialize(File.DirDefaultExternal, \"data";
mostCurrent._kvs4sub._initialize(processBA,anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal(),"datastore_sub_4");
 //BA.debugLineNum = 60;BA.debugLine="dev.Initialize(\"dev\")";
mostCurrent._dev.Initialize(processBA,"dev");
 //BA.debugLineNum = 61;BA.debugLine="If FirstTime Then";
if (_firsttime) { 
 //BA.debugLineNum = 62;BA.debugLine="parser.Initialize";
mostCurrent._parser.Initialize(processBA);
 };
 //BA.debugLineNum = 64;BA.debugLine="uon=LoadBitmap(File.DirAssets,\"son.png\")";
mostCurrent._uon = anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"son.png");
 //BA.debugLineNum = 65;BA.debugLine="uoff=LoadBitmap(File.DirAssets,\"soff.png\")";
...
_bd = new anywheresoftware.b4a.objects.drawable.BitmapDrawable();
 //BA.debugLineNum = 67;BA.debugLine="bd.Initialize(LoadBitmap(File.DirAssets,\"ic_data_";
_bd.Initialize((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_data_usage_black_48dp.png").getObject()));
 //BA.debugLineNum = 69;BA.debugLine="popa.Initialize(\"popa\",Panel3)";
mostCurrent._popa.Initialize(mostCurrent.activityBA,"popa",(android.view.View)(mostCurrent._panel3.getObject()));
 //BA.debugLineNum = 70;BA.debugLine="colist.Initialize";
mostCurrent._colist.Initialize();
 //BA.debugLineNum = 83;BA.debugLine="popa.AddMenuItem(0,\"Save\",bd)";
...
mostCurrent._acspinner1.Add2(BA.ObjectToCharSequence("light blue"),(android.graphics.drawable.Drawable)(mostCurrent._cc1.getObject()));
 //BA.debugLineNum = 123;BA.debugLine="ACSpinner1.Add2(\"Amber\",cc2)";
mostCurrent._acspinner1.Add2(BA.ObjectToCharSequence("Amber"),(android.graphics.drawable.Drawable)(mostCurrent._cc2.getObject()));
 //BA.debugLineNum = 124;BA.debugLine="ACSpinner1.Add2(\"White(Arctic)\",cc3)'-<<<<<<chang";
mostCurrent._acspinner1.Add2(BA.ObjectToCharSequence("White(Arctic)"),(android.graphics.drawable.Drawable)(mostCurrent._cc3.getObject()));
 //BA.debugLineNum = 125;BA.debugLine="ACSpinner1.Add2(\"teal\",cc4)";
mostCurrent._acspinner1.Add2(BA.ObjectToCharSequence("teal"),(android.graphics.drawable.Drawable)(mostCurrent._cc4.getObject()));
 //BA.debugLineNum = 126;BA.debugLine="ACSpinner1.Add2(\"purple(dark)\",cc5)";
...
mostCurrent._acspinner1.Add2(BA.ObjectToCharSequence("green"),(android.graphics.drawable.Drawable)(mostCurrent._cc11.getObject()));
 //BA.debugLineNum = 133;BA.debugLine="ACSpinner1.Add2(\"Black(Ultra)\",cc12)'-<<<<<<chang";
mostCurrent._acspinner1.Add2(BA.ObjectToCharSequence("Black(Ultra)"),(android.graphics.drawable.Drawable)(mostCurrent._cc12.getObject()));
 //BA.debugLineNum = 134;BA.debugLine="ACSpinner1.Add2(\"yellow\",cc13)";
mostCurrent._acspinner1.Add2(BA.ObjectToCharSequence("yellow"),(android.graphics.drawable.Drawable)(mostCurrent._cc13.getObject()));
 //BA.debugLineNum = 135;BA.debugLine="ACSpinner1.Add2(\"cyan\",cc14)";
mostCurrent._acspinner1.Add2(BA.ObjectToCharSequence("cyan"),(android.graphics.drawable.Drawable)(mostCurrent._cc14.getObject()));
 //BA.debugLineNum = 136;BA.debugLine="ACSpinner1.Add2(\"blue grey\",cc15)";
mostCurrent._acspinner1.Add2(BA.ObjectToCharSequence("blue grey"),(android.graphics.drawable.Drawable)(mostCurrent._cc15.getObject()));
 //BA.debugLineNum = 137;BA.debugLine="ACSpinner1.Color=Colors.Transparent";
mostCurrent._acspinner1.setColor(anywheresoftware.b4a.keywords.Common.Colors.Transparent);
 //BA.debugLineNum = 140;BA.debugLine="If StateManager.RestoreState(Activity, \"Main\", 0)";
if (mostCurrent._statemanager._restorestate(mostCurrent.activityBA,mostCurrent._activity,"Main",(int) (0))==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 142;BA.debugLine="arb.Checked=True";
mostCurrent._arb.setChecked(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 143;BA.debugLine="ACSpinner1_ItemClick(0,0)";
...
_autoupdate = BA.ObjectToBoolean(mostCurrent._statemanager._getsetting2(mostCurrent.activityBA,"AutoUpdate",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.False)));
 //BA.debugLineNum = 149;BA.debugLine="store_check";
_store_check();
...
public static boolean  _activity_keypress(int _keycode) throws Exception{
 ...
 //BA.debugLineNum = 168;BA.debugLine="If KeyCode=KeyCodes.KEYCODE_BACK Then";
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK) { 
 //BA.debugLineNum = 169;BA.debugLine="Activity.Finish";
mostCurrent._activity.Finish();
 //BA.debugLineNum = 170;BA.debugLine="SetAnimation.setanimati(\"extra_in\", \"extra_out\")";
mostCurrent._setanimation._setanimati(mostCurrent.activityBA,"extra_in","extra_out");
 //BA.debugLineNum = 171;BA.debugLine="StateManager.SaveState(Activity, \"Main\")";
...
public static String  _activity_pause(boolean _userclosed) throws Exception{
 ...
 //BA.debugLineNum = 158;BA.debugLine="If UserClosed Then";
if (_userclosed) { 
 //BA.debugLineNum = 159;BA.debugLine="StateManager.SaveState(Activity, \"Main\")";
mostCurrent._statemanager._savestate(mostCurrent.activityBA,mostCurrent._activity,"Main");
 };
...
mostCurrent._activity.Finish();
 //BA.debugLineNum = 163;BA.debugLine="SetAnimation.setanimati(\"extra_in\", \"extra_out\")";
mostCurrent._setanimation._setanimati(mostCurrent.activityBA,"extra_in","extra_out");
...
public static String  _activity_resume() throws Exception{
 ...
 //BA.debugLineNum = 154;BA.debugLine="store_check";
_store_check();
 //BA.debugLineNum = 155;BA.debugLine="End Sub";
return "";
}
public static String  _arb_checkedchange(boolean _checked) throws Exception{
 //BA.debugLineNum = 191;BA.debugLine="Sub arb_CheckedChange(Checked As Boolean)";
 //BA.debugLineNum = 192;BA.debugLine="If Checked=True Then";
if (_checked==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 193;BA.debugLine="kvs4sub.DeleteAll";
mostCurrent._kvs4sub._deleteall();
 //BA.debugLineNum = 194;BA.debugLine="StartService(Starter)";
anywheresoftware.b4a.keywords.Common.StartService(mostCurrent.activityBA,(Object)(mostCurrent._starter.getObject()));
 //BA.debugLineNum = 196;BA.debugLine="StartService(webhost)";
anywheresoftware.b4a.keywords.Common.StartService(mostCurrent.activityBA,(Object)(mostCurrent._webhost.getObject()));
 //BA.debugLineNum = 197;BA.debugLine="Log(\"start\")";
anywheresoftware.b4a.keywords.Common.Log("start");
 //BA.debugLineNum = 198;BA.debugLine="ToastMessageShow(\"Services started..\",False)";
...
mostCurrent._statemanager._savesettings(mostCurrent.activityBA);
 ...
 //BA.debugLineNum = 202;BA.debugLine="If Checked=False Then";
if (_checked==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 203;BA.debugLine="kvs4sub.DeleteAll";
mostCurrent._kvs4sub._deleteall();
 //BA.debugLineNum = 204;BA.debugLine="kvs4sub.PutSimple(\"off\",Checked)";
mostCurrent._kvs4sub._putsimple("off",(Object)(_checked));
 //BA.debugLineNum = 205;BA.debugLine="StopService(Starter)";
anywheresoftware.b4a.keywords.Common.StopService(mostCurrent.activityBA,(Object)(mostCurrent._starter.getObject()));
 //BA.debugLineNum = 206;BA.debugLine="StopService(webhost)";
anywheresoftware.b4a.keywords.Common.StopService(mostCurrent.activityBA,(Object)(mostCurrent._webhost.getObject()));
 //BA.debugLineNum = 207;BA.debugLine="Log(\"Service Stop\")";
anywheresoftware.b4a.keywords.Common.Log("Service Stop");
 //BA.debugLineNum = 208;BA.debugLine="ToastMessageShow(\"Services closed!\",False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("Services closed!"),anywheresoftware.b4a.keywords.Common.False);
 ...
 //BA.debugLineNum = 210;BA.debugLine="StateManager.SaveSettings";
mostCurrent._statemanager._savesettings(mostCurrent.activityBA);
 };
...
mostCurrent._label5 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 49;BA.debugLine="Dim AutoUpdate As Boolean";
_autoupdate = false;
 //BA.debugLineNum = 51;BA.debugLine="End Sub";
return "";
}
public static String  _popa_itemclicked(de.amberhome.objects.appcompat.ACMenuItemWrapper _item) throws Exception{
 //BA.debugLineNum = 183;BA.debugLine="Sub popa_ItemClicked (Item As ACMenuItem)";
 //BA.debugLineNum = 184;BA.debugLine="If Item = popa.GetItem(0) Then";
if ((_item).equals((android.view.MenuItem)(mostCurrent._popa.GetItem((int) (0))))) { 
 //BA.debugLineNum = 185;BA.debugLine="Activity.Finish";
mostCurrent._activity.Finish();
 //BA.debugLineNum = 186;BA.debugLine="SetAnimation.setanimati(\"extra_in\", \"extra_out\")";
mostCurrent._setanimation._setanimati(mostCurrent.activityBA,"extra_in","extra_out");
 };
...
public static String  _store_check() throws Exception{
 //BA.debugLineNum = 228;BA.debugLine="Sub store_check";
 //BA.debugLineNum = 229;BA.debugLine="If kvs4sub.ContainsKey(\"off\") Then";
if (mostCurrent._kvs4sub._containskey("off")) { 
 //BA.debugLineNum = 230;BA.debugLine="arb.Checked=False";
mostCurrent._arb.setChecked(anywheresoftware.b4a.keywords.Common.False);
 }else {
 //BA.debugLineNum = 233;BA.debugLine="arb.Checked=True";
mostCurrent._arb.setChecked(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 237;BA.debugLine="If kvs4.ContainsKey(\"0\")Then";
if (mostCurrent._kvs4._containskey("0")) { 
 //BA.debugLineNum = 238;BA.debugLine="Log(\"AC_true->1\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->1");
 //BA.debugLineNum = 240;BA.debugLine="ACSpinner1.SelectedIndex=0";
mostCurrent._acspinner1.setSelectedIndex((int) (0));
 //BA.debugLineNum = 241;BA.debugLine="Panel2.Color=c1";
mostCurrent._panel2.setColor(_c1);
 };
 //BA.debugLineNum = 243;BA.debugLine="If kvs4.ContainsKey(\"1\")Then";
if (mostCurrent._kvs4._containskey("1")) { 
 //BA.debugLineNum = 244;BA.debugLine="Log(\"AC_true->2\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->2");
 //BA.debugLineNum = 245;BA.debugLine="ACSpinner1.SelectedIndex=1";
mostCurrent._acspinner1.setSelectedIndex((int) (1));
 //BA.debugLineNum = 246;BA.debugLine="Panel2.Color=c2";
mostCurrent._panel2.setColor(_c2);
 }else {
 };
...
anywheresoftware.b4a.keywords.Common.Log("AC_true->3");
 //BA.debugLineNum = 252;BA.debugLine="Panel2.Color=c3";
mostCurrent._panel2.setColor(_c3);
 }else {
 };
 //BA.debugLineNum = 258;BA.debugLine="If kvs4.ContainsKey(\"3\")Then";
...
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 260;BA.debugLine="Panel2.Color=c4";
mostCurrent._panel2.setColor(_c4);
 //BA.debugLineNum = 261;BA.debugLine="ACSpinner1.SelectedIndex=3";
mostCurrent._acspinner1.setSelectedIndex((int) (3));
 }else {
 };
 //BA.debugLineNum = 266;BA.debugLine="If kvs4.ContainsKey(\"4\")Then";
if (mostCurrent._kvs4._containskey("4")) { 
 //BA.debugLineNum = 267;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 269;BA.debugLine="ACSpinner1.SelectedIndex=4";
mostCurrent._acspinner1.setSelectedIndex((int) (4));
 //BA.debugLineNum = 270;BA.debugLine="Panel2.Color=c5";
mostCurrent._panel2.setColor(_c5);
 }else {
 };
...
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 277;BA.debugLine="Panel2.Color=c6";
mostCurrent._panel2.setColor(_c6);
 //BA.debugLineNum = 278;BA.debugLine="ACSpinner1.SelectedIndex=5";
mostCurrent._acspinner1.setSelectedIndex((int) (5));
 }else {
 };
 //BA.debugLineNum = 282;BA.debugLine="If kvs4.ContainsKey(\"6\")Then";
if (mostCurrent._kvs4._containskey("6")) { 
 //BA.debugLineNum = 283;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 285;BA.debugLine="ACSpinner1.SelectedIndex=6";
mostCurrent._acspinner1.setSelectedIndex((int) (6));
 //BA.debugLineNum = 286;BA.debugLine="Panel2.Color=c7";
mostCurrent._panel2.setColor(_c7);
 }else {
 };
 //BA.debugLineNum = 290;BA.debugLine="If kvs4.ContainsKey(\"7\")Then";
if (mostCurrent._kvs4._containskey("7")) { 
 //BA.debugLineNum = 291;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 292;BA.debugLine="Panel2.Color=c8";
mostCurrent._panel2.setColor(_c8);
 //BA.debugLineNum = 294;BA.debugLine="ACSpinner1.SelectedIndex=7";
mostCurrent._acspinner1.setSelectedIndex((int) (7));
 }else {
 };
 //BA.debugLineNum = 298;BA.debugLine="If kvs4.ContainsKey(\"8\")Then";
if (mostCurrent._kvs4._containskey("8")) { 
 //BA.debugLineNum = 299;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 302;BA.debugLine="Panel2.Color=c9";
mostCurrent._panel2.setColor(_c9);
 //BA.debugLineNum = 303;BA.debugLine="ACSpinner1.SelectedIndex=8";
mostCurrent._acspinner1.setSelectedIndex((int) (8));
 }else {
 };
 //BA.debugLineNum = 307;BA.debugLine="If kvs4.ContainsKey(\"9\")Then";
if (mostCurrent._kvs4._containskey("9")) { 
 //BA.debugLineNum = 308;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 310;BA.debugLine="Panel2.Color=c10";
mostCurrent._panel2.setColor(_c10);
 //BA.debugLineNum = 311;BA.debugLine="ACSpinner1.SelectedIndex=9";
mostCurrent._acspinner1.setSelectedIndex((int) (9));
 }else {
 };
 //BA.debugLineNum = 316;BA.debugLine="If kvs4.ContainsKey(\"10\")Then";
if (mostCurrent._kvs4._containskey("10")) { 
 //BA.debugLineNum = 317;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 318;BA.debugLine="Panel2.Color=c11";
mostCurrent._panel2.setColor(_c11);
 //BA.debugLineNum = 319;BA.debugLine="ACSpinner1.SelectedIndex=10";
mostCurrent._acspinner1.setSelectedIndex((int) (10));
 }else {
 };
 //BA.debugLineNum = 324;BA.debugLine="If kvs4.ContainsKey(\"11\")Then";
if (mostCurrent._kvs4._containskey("11")) { 
 //BA.debugLineNum = 325;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 327;BA.debugLine="Panel2.Color=c12";
mostCurrent._panel2.setColor(_c12);
 //BA.debugLineNum = 328;BA.debugLine="Label5.TextColor=Colors.White";
mostCurrent._label5.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 329;BA.debugLine="ACSpinner1.SelectedIndex=11";
mostCurrent._acspinner1.setSelectedIndex((int) (11));
 }else {
 };
 //BA.debugLineNum = 334;BA.debugLine="If kvs4.ContainsKey(\"12\")Then";
if (mostCurrent._kvs4._containskey("12")) { 
 //BA.debugLineNum = 335;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 337;BA.debugLine="Panel2.Color=c13";
mostCurrent._panel2.setColor(_c13);
 //BA.debugLineNum = 338;BA.debugLine="ACSpinner1.SelectedIndex=12";
mostCurrent._acspinner1.setSelectedIndex((int) (12));
 }else {
 };
 //BA.debugLineNum = 343;BA.debugLine="If kvs4.ContainsKey(\"13\")Then";
if (mostCurrent._kvs4._containskey("13")) { 
 //BA.debugLineNum = 344;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 345;BA.debugLine="ACSpinner1.SelectedIndex=13";
mostCurrent._acspinner1.setSelectedIndex((int) (13));
 //BA.debugLineNum = 346;BA.debugLine="Panel2.Color=c14";
mostCurrent._panel2.setColor(_c14);
 }else {
 };
 //BA.debugLineNum = 352;BA.debugLine="If kvs4.ContainsKey(\"14\")Then";
if (mostCurrent._kvs4._containskey("14")) { 
 //BA.debugLineNum = 353;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 355;BA.debugLine="Panel2.Color=c15";
mostCurrent._panel2.setColor(_c15);
 //BA.debugLineNum = 356;BA.debugLine="ACSpinner1.SelectedIndex=14";
...
anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper _bdraw = null;
 //BA.debugLineNum = 216;BA.debugLine="Sub tab_settings";
 //BA.debugLineNum = 217;BA.debugLine="Dim liv As ListView";
_liv = new anywheresoftware.b4a.objects.ListViewWrapper();
 //BA.debugLineNum = 218;BA.debugLine="Dim draw As BitmapDrawable";
_draw = new anywheresoftware.b4a.objects.drawable.BitmapDrawable();
 //BA.debugLineNum = 219;BA.debugLine="Dim bdraw As Bitmap";
_bdraw = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper();
 //BA.debugLineNum = 220;BA.debugLine="bdraw.Initialize(File.DirAssets,\"ic_folder_specia";
_bdraw.Initialize(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_folder_special_black_48dp.png");
 //BA.debugLineNum = 221;BA.debugLine="draw.Initialize(bdraw)";
_draw.Initialize((android.graphics.Bitmap)(_bdraw.getObject()));
 //BA.debugLineNum = 222;BA.debugLine="liv.Initialize(\"liv\")";
_liv.Initialize(mostCurrent.activityBA,"liv");
 //BA.debugLineNum = 223;BA.debugLine="liv.Enabled=True";
_liv.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 224;BA.debugLine="liv.AddSingleLine(\"Text\")";
_liv.AddSingleLine(BA.ObjectToCharSequence("Text"));
 //BA.debugLineNum = 225;BA.debugLine="liv.AddTwoLines(\"Text\",\"Sub text..\")";
