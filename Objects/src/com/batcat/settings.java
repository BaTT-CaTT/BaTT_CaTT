...
public static String  _acbutton1_click() throws Exception{
 //BA.debugLineNum = 169;BA.debugLine="Sub ACButton1_Click";
...
mostCurrent._activity.Finish();
 //BA.debugLineNum = 177;BA.debugLine="SetAnimation.setanimati(\"extra_in\", \"extra_out\")";
...
public static String  _acspinner1_itemclick(int _position,Object _value) throws Exception{
 //BA.debugLineNum = 373;BA.debugLine="Sub ACSpinner1_ItemClick (Position As Int, Value A";
 //BA.debugLineNum = 375;BA.debugLine="ACSpinner1.SelectedIndex=Position";
mostCurrent._acspinner1.setSelectedIndex(_position);
 //BA.debugLineNum = 377;BA.debugLine="If Position=0 Then";
if (_position==0) { 
 //BA.debugLineNum = 378;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 379;BA.debugLine="kvs4.PutSimple(\"0\",Value)";
...
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(_value),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 381;BA.debugLine="Panel2.Color=c16";
mostCurrent._panel2.setColor(_c16);
 //BA.debugLineNum = 382;BA.debugLine="Log(\"Is in Store\")";
anywheresoftware.b4a.keywords.Common.Log("Is in Store");
 };
 //BA.debugLineNum = 384;BA.debugLine="If Position=1 Then";
if (_position==1) { 
 //BA.debugLineNum = 385;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 386;BA.debugLine="kvs4.PutSimple(\"1\",Value)";
mostCurrent._kvs4._putsimple("1",_value);
 //BA.debugLineNum = 387;BA.debugLine="ToastMessageShow(Value,False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(_value),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 388;BA.debugLine="Log(\"New Store\")";
anywheresoftware.b4a.keywords.Common.Log("New Store");
 //BA.debugLineNum = 389;BA.debugLine="Panel2.Color=c2";
mostCurrent._panel2.setColor(_c2);
 };
 //BA.debugLineNum = 391;BA.debugLine="If Position=2 Then";
if (_position==2) { 
 //BA.debugLineNum = 392;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 393;BA.debugLine="kvs4.PutSimple(\"2\",Value)";
mostCurrent._kvs4._putsimple("2",_value);
 //BA.debugLineNum = 394;BA.debugLine="ToastMessageShow(Value,False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(_value),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 395;BA.debugLine="Log(\"Now Stored\")";
anywheresoftware.b4a.keywords.Common.Log("Now Stored");
 //BA.debugLineNum = 396;BA.debugLine="Panel2.Color=c3";
mostCurrent._panel2.setColor(_c3);
 //BA.debugLineNum = 397;BA.debugLine="Activity.Invalidate";
mostCurrent._activity.Invalidate();
 };
 //BA.debugLineNum = 399;BA.debugLine="If Position=3 Then";
if (_position==3) { 
 //BA.debugLineNum = 400;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 401;BA.debugLine="kvs4.PutSimple(\"3\",Value)";
mostCurrent._kvs4._putsimple("3",_value);
 //BA.debugLineNum = 402;BA.debugLine="ToastMessageShow(Value,False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(_value),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 403;BA.debugLine="Log(\"Stored ---\")";
anywheresoftware.b4a.keywords.Common.Log("Stored ---");
 //BA.debugLineNum = 404;BA.debugLine="Panel2.Color=c4";
mostCurrent._panel2.setColor(_c4);
 //BA.debugLineNum = 405;BA.debugLine="Activity.Invalidate";
mostCurrent._activity.Invalidate();
 };
 //BA.debugLineNum = 407;BA.debugLine="If Position=4 Then";
if (_position==4) { 
 //BA.debugLineNum = 408;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 409;BA.debugLine="kvs4.PutSimple(\"4\",Value)";
...
anywheresoftware.b4a.keywords.Common.Log("Stored ---");
 //BA.debugLineNum = 412;BA.debugLine="Panel2.Color=c5";
mostCurrent._panel2.setColor(_c5);
 };
 //BA.debugLineNum = 414;BA.debugLine="If Position=5 Then";
if (_position==5) { 
 //BA.debugLineNum = 415;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 416;BA.debugLine="kvs4.PutSimple(\"5\",Value)";
...
anywheresoftware.b4a.keywords.Common.Log("Stored ---");
 //BA.debugLineNum = 419;BA.debugLine="Panel2.Color=c6";
mostCurrent._panel2.setColor(_c6);
 };
 //BA.debugLineNum = 421;BA.debugLine="If Position=6 Then";
if (_position==6) { 
 //BA.debugLineNum = 422;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 423;BA.debugLine="kvs4.PutSimple(\"6\",Value)";
...
anywheresoftware.b4a.keywords.Common.Log("Stored ---");
 //BA.debugLineNum = 426;BA.debugLine="Panel2.Color=c7";
mostCurrent._panel2.setColor(_c7);
 };
 //BA.debugLineNum = 428;BA.debugLine="If Position=7 Then";
if (_position==7) { 
 //BA.debugLineNum = 429;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 430;BA.debugLine="kvs4.PutSimple(\"7\",Value)";
...
anywheresoftware.b4a.keywords.Common.Log("Stored ---");
 //BA.debugLineNum = 433;BA.debugLine="Panel2.Color=c8";
mostCurrent._panel2.setColor(_c8);
 };
 //BA.debugLineNum = 435;BA.debugLine="If Position=8 Then";
if (_position==8) { 
 //BA.debugLineNum = 436;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 437;BA.debugLine="kvs4.PutSimple(\"8\",Value)";
...
anywheresoftware.b4a.keywords.Common.Log("Stored ---");
 //BA.debugLineNum = 440;BA.debugLine="Panel2.Color=c9";
mostCurrent._panel2.setColor(_c9);
 };
 //BA.debugLineNum = 442;BA.debugLine="If Position=9 Then";
if (_position==9) { 
 //BA.debugLineNum = 443;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 444;BA.debugLine="kvs4.PutSimple(\"9\",Value)";
...
anywheresoftware.b4a.keywords.Common.Log("Stored ---");
 //BA.debugLineNum = 447;BA.debugLine="Panel2.Color=c10";
mostCurrent._panel2.setColor(_c10);
 };
 //BA.debugLineNum = 449;BA.debugLine="If Position=10 Then";
if (_position==10) { 
 //BA.debugLineNum = 450;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 451;BA.debugLine="kvs4.PutSimple(\"10\",Value)";
...
anywheresoftware.b4a.keywords.Common.Log("Stored ---");
 //BA.debugLineNum = 454;BA.debugLine="Panel2.Color=c11";
mostCurrent._panel2.setColor(_c11);
 //BA.debugLineNum = 455;BA.debugLine="Activity.Invalidate";
mostCurrent._activity.Invalidate();
 };
 //BA.debugLineNum = 457;BA.debugLine="If Position=11 Then";
if (_position==11) { 
 //BA.debugLineNum = 458;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 459;BA.debugLine="kvs4.PutSimple(\"11\",Value)";
mostCurrent._kvs4._putsimple("11",_value);
 //BA.debugLineNum = 460;BA.debugLine="ToastMessageShow(Value,False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(_value),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 461;BA.debugLine="Log(\"Stored ---\")";
anywheresoftware.b4a.keywords.Common.Log("Stored ---");
 //BA.debugLineNum = 462;BA.debugLine="Panel2.Color=c12";
mostCurrent._panel2.setColor(_c12);
 };
 //BA.debugLineNum = 464;BA.debugLine="If Position=12 Then";
if (_position==12) { 
 //BA.debugLineNum = 465;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 466;BA.debugLine="kvs4.PutSimple(\"12\",Value)";
mostCurrent._kvs4._putsimple("12",_value);
 //BA.debugLineNum = 467;BA.debugLine="ToastMessageShow(Value,False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(_value),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 468;BA.debugLine="Log(\"Stored ---\")";
anywheresoftware.b4a.keywords.Common.Log("Stored ---");
 //BA.debugLineNum = 469;BA.debugLine="Panel2.Color=c13";
mostCurrent._panel2.setColor(_c13);
 };
 //BA.debugLineNum = 471;BA.debugLine="If Position=13 Then";
if (_position==13) { 
 //BA.debugLineNum = 472;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 473;BA.debugLine="kvs4.PutSimple(\"13\",Value)";
...
anywheresoftware.b4a.keywords.Common.Log("Stored ---");
 //BA.debugLineNum = 476;BA.debugLine="Panel2.Color=c14";
mostCurrent._panel2.setColor(_c14);
 };
 //BA.debugLineNum = 478;BA.debugLine="If Position=14 Then";
if (_position==14) { 
 //BA.debugLineNum = 479;BA.debugLine="kvs4.DeleteAll";
mostCurrent._kvs4._deleteall();
 //BA.debugLineNum = 480;BA.debugLine="kvs4.PutSimple(\"14\",Value)";
mostCurrent._kvs4._putsimple("14",_value);
 //BA.debugLineNum = 481;BA.debugLine="ToastMessageShow(Value,False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(_value),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 482;BA.debugLine="Log(\"Stored ---\")";
anywheresoftware.b4a.keywords.Common.Log("Stored ---");
 //BA.debugLineNum = 483;BA.debugLine="Panel2.Color=c15";
...
boolean _autoupdate = false;
 ...
 //BA.debugLineNum = 51;BA.debugLine="Activity.LoadLayout(\"6\")";
mostCurrent._activity.LoadLayout("6",mostCurrent.activityBA);
 //BA.debugLineNum = 54;BA.debugLine="kvs4.Initialize(File.DirDefaultExternal, \"datasto";
mostCurrent._kvs4._initialize(processBA,anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal(),"datastore_4");
 //BA.debugLineNum = 55;BA.debugLine="kvs4sub.Initialize(File.DirDefaultExternal, \"data";
...
_bd.Initialize((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_data_usage_black_48dp.png").getObject()));
 //BA.debugLineNum = 64;BA.debugLine="popa.Initialize(\"popa\",Panel3)";
mostCurrent._popa.Initialize(mostCurrent.activityBA,"popa",(android.view.View)(mostCurrent._panel3.getObject()));
 //BA.debugLineNum = 65;BA.debugLine="colist.Initialize";
mostCurrent._colist.Initialize();
 //BA.debugLineNum = 76;BA.debugLine="popa.AddMenuItem(0,\"Save\",bd)";
...
mostCurrent._acspinner1.Add2(BA.ObjectToCharSequence("light blue"),(android.graphics.drawable.Drawable)(mostCurrent._cc1.getObject()));
 //BA.debugLineNum = 116;BA.debugLine="ACSpinner1.Add2(\"Amber\",cc2)";
mostCurrent._acspinner1.Add2(BA.ObjectToCharSequence("Amber"),(android.graphics.drawable.Drawable)(mostCurrent._cc2.getObject()));
 //BA.debugLineNum = 117;BA.debugLine="ACSpinner1.Add2(\"White(Arctic)\",cc3)'-<<<<<<chang";
mostCurrent._acspinner1.Add2(BA.ObjectToCharSequence("White(Arctic)"),(android.graphics.drawable.Drawable)(mostCurrent._cc3.getObject()));
 //BA.debugLineNum = 118;BA.debugLine="ACSpinner1.Add2(\"teal\",cc4)";
mostCurrent._acspinner1.Add2(BA.ObjectToCharSequence("teal"),(android.graphics.drawable.Drawable)(mostCurrent._cc4.getObject()));
 //BA.debugLineNum = 119;BA.debugLine="ACSpinner1.Add2(\"purple(dark)\",cc5)";
...
mostCurrent._acspinner1.Add2(BA.ObjectToCharSequence("green"),(android.graphics.drawable.Drawable)(mostCurrent._cc11.getObject()));
 //BA.debugLineNum = 126;BA.debugLine="ACSpinner1.Add2(\"Black(Ultra)\",cc12)'-<<<<<<chang";
mostCurrent._acspinner1.Add2(BA.ObjectToCharSequence("Black(Ultra)"),(android.graphics.drawable.Drawable)(mostCurrent._cc12.getObject()));
 //BA.debugLineNum = 127;BA.debugLine="ACSpinner1.Add2(\"yellow\",cc13)";
mostCurrent._acspinner1.Add2(BA.ObjectToCharSequence("yellow"),(android.graphics.drawable.Drawable)(mostCurrent._cc13.getObject()));
 //BA.debugLineNum = 128;BA.debugLine="ACSpinner1.Add2(\"cyan\",cc14)";
mostCurrent._acspinner1.Add2(BA.ObjectToCharSequence("cyan"),(android.graphics.drawable.Drawable)(mostCurrent._cc14.getObject()));
 //BA.debugLineNum = 129;BA.debugLine="ACSpinner1.Add2(\"blue grey\",cc15)";
mostCurrent._acspinner1.Add2(BA.ObjectToCharSequence("blue grey"),(android.graphics.drawable.Drawable)(mostCurrent._cc15.getObject()));
 //BA.debugLineNum = 132;BA.debugLine="ACSpinner1.Color=Colors.Transparent";
mostCurrent._acspinner1.setColor(anywheresoftware.b4a.keywords.Common.Colors.Transparent);
 //BA.debugLineNum = 133;BA.debugLine="ACButton1.ButtonColor=Colors.ARGB(180,255,255,255";
mostCurrent._acbutton1.setButtonColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (180),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 134;BA.debugLine="If StateManager.RestoreState(Activity, \"Main\", 60";
if (mostCurrent._statemanager._restorestate(mostCurrent.activityBA,mostCurrent._activity,"Main",(int) (60))==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 136;BA.debugLine="arb.Checked=True";
mostCurrent._arb.setChecked(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 138;BA.debugLine="Dim AutoUpdate As Boolean";
_autoupdate = false;
 //BA.debugLineNum = 140;BA.debugLine="AutoUpdate = StateManager.GetSetting2(\"AutoUpdate";
_autoupdate = BA.ObjectToBoolean(mostCurrent._statemanager._getsetting2(mostCurrent.activityBA,"AutoUpdate",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.False)));
 //BA.debugLineNum = 142;BA.debugLine="store_check";
_store_check();
 //BA.debugLineNum = 143;BA.debugLine="End Sub";
return "";
}
public static boolean  _activity_keypress(int _keycode) throws Exception{
 //BA.debugLineNum = 159;BA.debugLine="Sub Activity_KeyPress (KeyCode As Int) As Boolean";
 //BA.debugLineNum = 160;BA.debugLine="If KeyCode=KeyCodes.KEYCODE_BACK Then";
...
mostCurrent._setanimation._setanimati(mostCurrent.activityBA,"extra_in","extra_out");
 //BA.debugLineNum = 163;BA.debugLine="StateManager.SaveState(Activity, \"Main\")";
...
public static String  _activity_pause(boolean _userclosed) throws Exception{
 ...
 //BA.debugLineNum = 150;BA.debugLine="If UserClosed Then";
if (_userclosed) { 
 //BA.debugLineNum = 151;BA.debugLine="StateManager.SaveState(Activity, \"Main\")";
mostCurrent._statemanager._savestate(mostCurrent.activityBA,mostCurrent._activity,"Main");
 };
...
mostCurrent._activity.Finish();
 //BA.debugLineNum = 155;BA.debugLine="SetAnimation.setanimati(\"extra_in\", \"extra_out\")";
mostCurrent._setanimation._setanimati(mostCurrent.activityBA,"extra_in","extra_out");
...
public static String  _activity_resume() throws Exception{
 ...
 //BA.debugLineNum = 146;BA.debugLine="store_check";
_store_check();
 //BA.debugLineNum = 147;BA.debugLine="End Sub";
return "";
}
public static String  _arb_checkedchange(boolean _checked) throws Exception{
 //BA.debugLineNum = 192;BA.debugLine="Sub arb_CheckedChange(Checked As Boolean)";
 //BA.debugLineNum = 193;BA.debugLine="If Checked=True Then";
if (_checked==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 194;BA.debugLine="kvs4sub.DeleteAll";
mostCurrent._kvs4sub._deleteall();
 //BA.debugLineNum = 195;BA.debugLine="StartService(Starter)";
anywheresoftware.b4a.keywords.Common.StartService(mostCurrent.activityBA,(Object)(mostCurrent._starter.getObject()));
 //BA.debugLineNum = 197;BA.debugLine="StartService(webhost)";
anywheresoftware.b4a.keywords.Common.StartService(mostCurrent.activityBA,(Object)(mostCurrent._webhost.getObject()));
 //BA.debugLineNum = 198;BA.debugLine="Log(\"start\")";
anywheresoftware.b4a.keywords.Common.Log("start");
 //BA.debugLineNum = 199;BA.debugLine="ToastMessageShow(\"Services started..\",False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("Services started.."),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 201;BA.debugLine="StateManager.SaveSettings";
mostCurrent._statemanager._savesettings(mostCurrent.activityBA);
 }else {
 //BA.debugLineNum = 203;BA.debugLine="If Checked=False Then";
if (_checked==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 204;BA.debugLine="kvs4sub.DeleteAll";
mostCurrent._kvs4sub._deleteall();
 //BA.debugLineNum = 205;BA.debugLine="kvs4sub.PutSimple(\"off\",Checked)";
mostCurrent._kvs4sub._putsimple("off",(Object)(_checked));
 //BA.debugLineNum = 206;BA.debugLine="StopService(Starter)";
anywheresoftware.b4a.keywords.Common.StopService(mostCurrent.activityBA,(Object)(mostCurrent._starter.getObject()));
 //BA.debugLineNum = 207;BA.debugLine="StopService(webhost)";
anywheresoftware.b4a.keywords.Common.StopService(mostCurrent.activityBA,(Object)(mostCurrent._webhost.getObject()));
 //BA.debugLineNum = 208;BA.debugLine="Log(\"Service Stop\")";
anywheresoftware.b4a.keywords.Common.Log("Service Stop");
 //BA.debugLineNum = 209;BA.debugLine="ToastMessageShow(\"Services closed!\",False)";
...
public static String  _dsf1_click() throws Exception{
 //BA.debugLineNum = 188;BA.debugLine="Sub dsf1_Click";
 //BA.debugLineNum = 190;BA.debugLine="End Sub";
return "";
}
public static String  _dstablayout1_tabselected(int _index,String _selectedtab,Object _tag) throws Exception{
 //BA.debugLineNum = 215;BA.debugLine="Sub DSTabLayout1_TabSelected(Index As Int, Selecte";
...
public static String  _popa_itemclicked(de.amberhome.objects.appcompat.ACMenuItemWrapper _item) throws Exception{
 //BA.debugLineNum = 180;BA.debugLine="Sub popa_ItemClicked (Item As ACMenuItem)";
 //BA.debugLineNum = 181;BA.debugLine="If Item = popa.GetItem(0) Then";
...
public static String  _store_check() throws Exception{
 //BA.debugLineNum = 238;BA.debugLine="Sub store_check";
 //BA.debugLineNum = 239;BA.debugLine="If kvs4sub.ContainsKey(\"off\") Then";
if (mostCurrent._kvs4sub._containskey("off")) { 
 //BA.debugLineNum = 240;BA.debugLine="arb.Checked=False";
mostCurrent._arb.setChecked(anywheresoftware.b4a.keywords.Common.False);
 }else {
 //BA.debugLineNum = 245;BA.debugLine="arb.Checked=True";
mostCurrent._arb.setChecked(anywheresoftware.b4a.keywords.Common.True);
 };
 //BA.debugLineNum = 248;BA.debugLine="If kvs4.ContainsKey(\"0\")Then";
if (mostCurrent._kvs4._containskey("0")) { 
 //BA.debugLineNum = 249;BA.debugLine="Log(\"AC_true->1\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->1");
 //BA.debugLineNum = 251;BA.debugLine="ACSpinner1.SelectedIndex=0";
mostCurrent._acspinner1.setSelectedIndex((int) (0));
 //BA.debugLineNum = 252;BA.debugLine="Panel2.Color=c1";
mostCurrent._panel2.setColor(_c1);
 };
 //BA.debugLineNum = 254;BA.debugLine="If kvs4.ContainsKey(\"1\")Then";
if (mostCurrent._kvs4._containskey("1")) { 
 //BA.debugLineNum = 255;BA.debugLine="Log(\"AC_true->2\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->2");
 //BA.debugLineNum = 256;BA.debugLine="ACSpinner1.SelectedIndex=1";
mostCurrent._acspinner1.setSelectedIndex((int) (1));
 //BA.debugLineNum = 257;BA.debugLine="Panel2.Color=c2";
mostCurrent._panel2.setColor(_c2);
 }else {
 };
 //BA.debugLineNum = 261;BA.debugLine="If kvs4.ContainsKey(\"2\")Then";
if (mostCurrent._kvs4._containskey("2")) { 
 //BA.debugLineNum = 262;BA.debugLine="Log(\"AC_true->3\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->3");
 //BA.debugLineNum = 263;BA.debugLine="Panel2.Color=c3";
mostCurrent._panel2.setColor(_c3);
 //BA.debugLineNum = 264;BA.debugLine="ACSpinner1.SelectedIndex=2";
mostCurrent._acspinner1.setSelectedIndex((int) (2));
 }else {
 };
 //BA.debugLineNum = 269;BA.debugLine="If kvs4.ContainsKey(\"3\")Then";
...
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 271;BA.debugLine="Panel2.Color=c4";
mostCurrent._panel2.setColor(_c4);
 //BA.debugLineNum = 272;BA.debugLine="ACSpinner1.SelectedIndex=3";
mostCurrent._acspinner1.setSelectedIndex((int) (3));
 }else {
 };
 //BA.debugLineNum = 277;BA.debugLine="If kvs4.ContainsKey(\"4\")Then";
if (mostCurrent._kvs4._containskey("4")) { 
 //BA.debugLineNum = 278;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 280;BA.debugLine="ACSpinner1.SelectedIndex=4";
mostCurrent._acspinner1.setSelectedIndex((int) (4));
 //BA.debugLineNum = 281;BA.debugLine="Panel2.Color=c5";
mostCurrent._panel2.setColor(_c5);
 }else {
 };
 //BA.debugLineNum = 285;BA.debugLine="If kvs4.ContainsKey(\"5\")Then";
if (mostCurrent._kvs4._containskey("5")) { 
 //BA.debugLineNum = 286;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 288;BA.debugLine="Panel2.Color=c6";
mostCurrent._panel2.setColor(_c6);
 //BA.debugLineNum = 289;BA.debugLine="ACSpinner1.SelectedIndex=5";
mostCurrent._acspinner1.setSelectedIndex((int) (5));
 }else {
 };
 //BA.debugLineNum = 293;BA.debugLine="If kvs4.ContainsKey(\"6\")Then";
if (mostCurrent._kvs4._containskey("6")) { 
 //BA.debugLineNum = 294;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 296;BA.debugLine="ACSpinner1.SelectedIndex=6";
mostCurrent._acspinner1.setSelectedIndex((int) (6));
 //BA.debugLineNum = 297;BA.debugLine="Panel2.Color=c7";
mostCurrent._panel2.setColor(_c7);
 }else {
 };
 //BA.debugLineNum = 301;BA.debugLine="If kvs4.ContainsKey(\"7\")Then";
if (mostCurrent._kvs4._containskey("7")) { 
 //BA.debugLineNum = 302;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 303;BA.debugLine="Panel2.Color=c8";
mostCurrent._panel2.setColor(_c8);
 //BA.debugLineNum = 305;BA.debugLine="ACSpinner1.SelectedIndex=7";
mostCurrent._acspinner1.setSelectedIndex((int) (7));
 }else {
 };
 //BA.debugLineNum = 309;BA.debugLine="If kvs4.ContainsKey(\"8\")Then";
if (mostCurrent._kvs4._containskey("8")) { 
 //BA.debugLineNum = 310;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 313;BA.debugLine="Panel2.Color=c9";
mostCurrent._panel2.setColor(_c9);
 //BA.debugLineNum = 314;BA.debugLine="ACSpinner1.SelectedIndex=8";
mostCurrent._acspinner1.setSelectedIndex((int) (8));
 }else {
 };
 //BA.debugLineNum = 318;BA.debugLine="If kvs4.ContainsKey(\"9\")Then";
if (mostCurrent._kvs4._containskey("9")) { 
 //BA.debugLineNum = 319;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 321;BA.debugLine="Panel2.Color=c10";
mostCurrent._panel2.setColor(_c10);
 //BA.debugLineNum = 322;BA.debugLine="ACSpinner1.SelectedIndex=9";
mostCurrent._acspinner1.setSelectedIndex((int) (9));
 }else {
 };
 //BA.debugLineNum = 327;BA.debugLine="If kvs4.ContainsKey(\"10\")Then";
if (mostCurrent._kvs4._containskey("10")) { 
 //BA.debugLineNum = 328;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 329;BA.debugLine="Panel2.Color=c11";
mostCurrent._panel2.setColor(_c11);
 //BA.debugLineNum = 330;BA.debugLine="ACSpinner1.SelectedIndex=10";
mostCurrent._acspinner1.setSelectedIndex((int) (10));
 }else {
 };
 //BA.debugLineNum = 335;BA.debugLine="If kvs4.ContainsKey(\"11\")Then";
if (mostCurrent._kvs4._containskey("11")) { 
 //BA.debugLineNum = 336;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 338;BA.debugLine="Panel2.Color=c12";
mostCurrent._panel2.setColor(_c12);
 //BA.debugLineNum = 339;BA.debugLine="ACSpinner1.SelectedIndex=11";
mostCurrent._acspinner1.setSelectedIndex((int) (11));
 }else {
 };
 //BA.debugLineNum = 344;BA.debugLine="If kvs4.ContainsKey(\"12\")Then";
if (mostCurrent._kvs4._containskey("12")) { 
 //BA.debugLineNum = 345;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 347;BA.debugLine="Panel2.Color=c13";
mostCurrent._panel2.setColor(_c13);
 //BA.debugLineNum = 348;BA.debugLine="ACSpinner1.SelectedIndex=12";
...
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 355;BA.debugLine="ACSpinner1.SelectedIndex=13";
mostCurrent._acspinner1.setSelectedIndex((int) (13));
 //BA.debugLineNum = 356;BA.debugLine="Panel2.Color=c14";
mostCurrent._panel2.setColor(_c14);
 }else {
 };
...
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 365;BA.debugLine="Panel2.Color=c15";
mostCurrent._panel2.setColor(_c15);
 //BA.debugLineNum = 366;BA.debugLine="ACSpinner1.SelectedIndex=14";
...
anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper _bdraw = null;
 //BA.debugLineNum = 221;BA.debugLine="Sub tab_settings";
 //BA.debugLineNum = 222;BA.debugLine="Dim liv As ListView";
_liv = new anywheresoftware.b4a.objects.ListViewWrapper();
 //BA.debugLineNum = 223;BA.debugLine="Dim draw As BitmapDrawable";
_draw = new anywheresoftware.b4a.objects.drawable.BitmapDrawable();
 //BA.debugLineNum = 224;BA.debugLine="Dim bdraw As Bitmap";
_bdraw = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper();
 //BA.debugLineNum = 225;BA.debugLine="bdraw.Initialize(File.DirAssets,\"ic_folder_specia";
_bdraw.Initialize(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_folder_special_black_48dp.png");
 //BA.debugLineNum = 226;BA.debugLine="draw.Initialize(bdraw)";
_draw.Initialize((android.graphics.Bitmap)(_bdraw.getObject()));
 //BA.debugLineNum = 227;BA.debugLine="liv.Initialize(\"liv\")";
_liv.Initialize(mostCurrent.activityBA,"liv");
 //BA.debugLineNum = 228;BA.debugLine="liv.Enabled=True";
_liv.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 229;BA.debugLine="liv.AddSingleLine(\"Text\")";
_liv.AddSingleLine(BA.ObjectToCharSequence("Text"));
 //BA.debugLineNum = 230;BA.debugLine="liv.AddTwoLines(\"Text\",\"Sub text..\")";
