...
public static String  _acbutton1_click() throws Exception{
 //BA.debugLineNum = 245;BA.debugLine="Sub ACButton1_Click";
 //BA.debugLineNum = 246;BA.debugLine="graph_clear";
_graph_clear();
 //BA.debugLineNum = 247;BA.debugLine="End Sub";
return "";
}
public static String  _acbutton2_click() throws Exception{
 //BA.debugLineNum = 372;BA.debugLine="Sub ACButton2_Click";
 //BA.debugLineNum = 373;BA.debugLine="ccl_click";
_ccl_click();
...
anywheresoftware.b4a.objects.drawable.BitmapDrawable _bd1 = null;
 ...
 //BA.debugLineNum = 53;BA.debugLine="Activity.LoadLayout(\"2\")";
mostCurrent._activity.LoadLayout("2",mostCurrent.activityBA);
 //BA.debugLineNum = 54;BA.debugLine="Activity.Title=pak1.GetApplicationLabel(\"com.batc";
mostCurrent._activity.setTitle(BA.ObjectToCharSequence(mostCurrent._pak1.GetApplicationLabel("com.batcat")+" - "+mostCurrent._pak1.GetVersionName("com.batcat")));
 //BA.debugLineNum = 55;BA.debugLine="Activity.AddMenuItem(\"Clear Stats\",\"ccl\")";
mostCurrent._activity.AddMenuItem(BA.ObjectToCharSequence("Clear Stats"),"ccl");
 //BA.debugLineNum = 56;BA.debugLine="Activity.AddMenuItem(\"Exit\",\"cl\")";
mostCurrent._activity.AddMenuItem(BA.ObjectToCharSequence("Exit"),"cl");
 //BA.debugLineNum = 57;BA.debugLine="suc.Initialize";
mostCurrent._suc.Initialize();
 //BA.debugLineNum = 58;BA.debugLine="l1.Initialize(\"l1\")";
mostCurrent._l1.Initialize(mostCurrent.activityBA,"l1");
 //BA.debugLineNum = 59;BA.debugLine="l2.Initialize(\"l2\")";
mostCurrent._l2.Initialize(mostCurrent.activityBA,"l2");
 //BA.debugLineNum = 60;BA.debugLine="l3.Initialize(\"l3\")";
mostCurrent._l3.Initialize(mostCurrent.activityBA,"l3");
 //BA.debugLineNum = 62;BA.debugLine="c1=mcl.md_light_blue_A700";
_c1 = mostCurrent._mcl.getmd_light_blue_A700();
 //BA.debugLineNum = 63;BA.debugLine="c2=mcl.md_amber_A700";
_c2 = mostCurrent._mcl.getmd_amber_A700();
 //BA.debugLineNum = 64;BA.debugLine="c3=mcl.md_lime_A700";
_c3 = mostCurrent._mcl.getmd_lime_A700();
 //BA.debugLineNum = 65;BA.debugLine="c4=mcl.md_teal_A700";
_c4 = mostCurrent._mcl.getmd_teal_A700();
 //BA.debugLineNum = 66;BA.debugLine="Activity.Color=c1";
mostCurrent._activity.setColor(_c1);
 //BA.debugLineNum = 69;BA.debugLine="dev.Initialize(\"dev\")";
mostCurrent._dev.Initialize(processBA,"dev");
 //BA.debugLineNum = 72;BA.debugLine="m.Initialize";
mostCurrent._m.Initialize();
 //BA.debugLineNum = 73;BA.debugLine="bat.Initialize";
mostCurrent._bat._initialize(processBA);
 //BA.debugLineNum = 75;BA.debugLine="kl.Initialize";
mostCurrent._kl.Initialize();
 //BA.debugLineNum = 76;BA.debugLine="dt.Initialize";
mostCurrent._dt.Initialize();
 //BA.debugLineNum = 77;BA.debugLine="ls.Initialize";
mostCurrent._ls.Initialize();
 //BA.debugLineNum = 88;BA.debugLine="volt=bat.BatteryInformation(7)/1000";
mostCurrent._volt = BA.NumberToString(mostCurrent._bat._getbatteryinformation()[(int) (7)]/(double)1000);
 //BA.debugLineNum = 89;BA.debugLine="temp=bat.BatteryInformation(6)/10";
mostCurrent._temp = BA.NumberToString(mostCurrent._bat._getbatteryinformation()[(int) (6)]/(double)10);
 //BA.debugLineNum = 90;BA.debugLine="usb =bat.BatteryInformation(9)";
mostCurrent._usb = BA.NumberToString(mostCurrent._bat._getbatteryinformation()[(int) (9)]);
 //BA.debugLineNum = 91;BA.debugLine="ac =bat.BatteryInformation(8)";
mostCurrent._ac = BA.NumberToString(mostCurrent._bat._getbatteryinformation()[(int) (8)]);
 //BA.debugLineNum = 92;BA.debugLine="G.Initialize";
mostCurrent._g.Initialize();
 //BA.debugLineNum = 107;BA.debugLine="If FirstTime=True Then";
if (_firsttime==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 108;BA.debugLine="Msgbox(\"Wenn die Statistik zum ersten Mal gelade";
...
mostCurrent._kvsvolt._initialize(processBA,anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal(),"datastore_volt");
 //BA.debugLineNum = 114;BA.debugLine="kvstemp.Initialize(File.DirDefaultExternal, \"data";
mostCurrent._kvstemp._initialize(processBA,anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal(),"datastore_temp");
 //BA.debugLineNum = 115;BA.debugLine="time2=DateTime.Time(DateTime.Now)";
mostCurrent._time2 = anywheresoftware.b4a.keywords.Common.DateTime.Time(anywheresoftware.b4a.keywords.Common.DateTime.getNow());
 //BA.debugLineNum = 116;BA.debugLine="batt=LoadBitmap(File.DirAssets,\"Battery Icons - W";
mostCurrent._batt = anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Battery Icons - White 64px (40).png");
 //BA.debugLineNum = 117;BA.debugLine="pl=LoadBitmap(File.DirAssets,\"Battery Icons - Whi";
mostCurrent._pl = anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Battery Icons - White 64px (28).png");
 //BA.debugLineNum = 119;BA.debugLine="popa.Initialize(\"popa\",Panel2)";
...
_bd1 = new anywheresoftware.b4a.objects.drawable.BitmapDrawable();
 //BA.debugLineNum = 121;BA.debugLine="bd.Initialize(LoadBitmap(File.DirAssets,\"ic_clear";
_bd.Initialize((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_clear_black_48dp.png").getObject()));
 //BA.debugLineNum = 122;BA.debugLine="bd1.Initialize(LoadBitmap(File.DirAssets,\"ic_auto";
...
mostCurrent._popa.AddMenuItem((int) (1),BA.ObjectToCharSequence("Schließen"),(android.graphics.drawable.Drawable)(_bd.getObject()));
 //BA.debugLineNum = 127;BA.debugLine="store_check";
_store_check();
 //BA.debugLineNum = 128;BA.debugLine="c_start";
_c_start();
 //BA.debugLineNum = 130;BA.debugLine="End Sub";
return "";
}
public static boolean  _activity_keypress(int _keycode) throws Exception{
 //BA.debugLineNum = 230;BA.debugLine="Sub Activity_KeyPress (KeyCode As Int) As Boolean";
 //BA.debugLineNum = 231;BA.debugLine="If KeyCode=KeyCodes.KEYCODE_BACK Then";
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK) { 
 //BA.debugLineNum = 232;BA.debugLine="Activity.Finish";
mostCurrent._activity.Finish();
 //BA.debugLineNum = 233;BA.debugLine="ToastMessageShow(\"BCT - Backround  Statistic sta";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("BCT - Backround  Statistic started.."),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 234;BA.debugLine="SetAnimation.setanimati(\"extra_in\", \"extra_out\"";
...
_c_start();
 //BA.debugLineNum = 134;BA.debugLine="store_check";
_store_check();
 //BA.debugLineNum = 135;BA.debugLine="End Sub";
return "";
}
public static String  _c_start() throws Exception{
 //BA.debugLineNum = 175;BA.debugLine="Sub c_start";
 //BA.debugLineNum = 176;BA.debugLine="If kvs2.IsInitialized Then";
if (mostCurrent._kvs2.IsInitialized()) { 
 //BA.debugLineNum = 177;BA.debugLine="Log(\"KVS -> true\")";
anywheresoftware.b4a.keywords.Common.Log("KVS -> true");
 }else {
 //BA.debugLineNum = 180;BA.debugLine="kvs2.Initialize(File.DirDefaultExternal, \"datast";
mostCurrent._kvs2._initialize(processBA,anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal(),"datastore_2");
 //BA.debugLineNum = 181;BA.debugLine="kvs3.Initialize(File.DirDefaultExternal, \"datast";
mostCurrent._kvs3._initialize(processBA,anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal(),"datastore_3");
 //BA.debugLineNum = 182;BA.debugLine="kvsvolt.Initialize(File.DirDefaultExternal, \"dat";
mostCurrent._kvsvolt._initialize(processBA,anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal(),"datastore_volt");
 //BA.debugLineNum = 183;BA.debugLine="kvstemp.Initialize(File.DirDefaultExternal, \"dat";
mostCurrent._kvstemp._initialize(processBA,anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal(),"datastore_temp");
 };
 //BA.debugLineNum = 186;BA.debugLine="get_log";
_get_log();
 //BA.debugLineNum = 187;BA.debugLine="chart_start";
_chart_start();
 //BA.debugLineNum = 188;BA.debugLine="End Sub";
return "";
}
public static String  _ccl_click() throws Exception{
 //BA.debugLineNum = 150;BA.debugLine="Sub ccl_click";
 //BA.debugLineNum = 152;BA.debugLine="volt=bat.BatteryInformation(7)";
mostCurrent._volt = BA.NumberToString(mostCurrent._bat._getbatteryinformation()[(int) (7)]);
 //BA.debugLineNum = 153;BA.debugLine="temp=bat.BatteryInformation(6)";
mostCurrent._temp = BA.NumberToString(mostCurrent._bat._getbatteryinformation()[(int) (6)]);
 //BA.debugLineNum = 155;BA.debugLine="kvstemp.DeleteAll";
mostCurrent._kvstemp._deleteall();
 //BA.debugLineNum = 156;BA.debugLine="kvsvolt.DeleteAll";
mostCurrent._kvsvolt._deleteall();
 //BA.debugLineNum = 158;BA.debugLine="kvstemp.PutSimple(temp,time2)";
mostCurrent._kvstemp._putsimple(mostCurrent._temp,(Object)(mostCurrent._time2));
 //BA.debugLineNum = 159;BA.debugLine="kvsvolt.PutSimple(volt,time2)";
mostCurrent._kvsvolt._putsimple(mostCurrent._volt,(Object)(mostCurrent._time2));
 //BA.debugLineNum = 160;BA.debugLine="ToastMessageShow(\"warte auf Aktuelle werte..!\",Fa";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("warte auf Aktuelle werte..!"),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 161;BA.debugLine="Log(kvs2.ListKeys&\" - clear\")";
anywheresoftware.b4a.keywords.Common.Log(BA.ObjectToString(mostCurrent._kvs2._listkeys())+" - clear");
 //BA.debugLineNum = 162;BA.debugLine="c_start";
_c_start();
...
String _h = "";
 //BA.debugLineNum = 197;BA.debugLine="Sub chart_start";
 //BA.debugLineNum = 198;BA.debugLine="level=bat.BatteryInformation(0)";
_level = mostCurrent._bat._getbatteryinformation()[(int) (0)];
 //BA.debugLineNum = 199;BA.debugLine="Dim fn As String";
_fn = "";
 //BA.debugLineNum = 200;BA.debugLine="Dim fg As Int";
_fg = 0;
 //BA.debugLineNum = 202;BA.debugLine="g.Initialize";
mostCurrent._g.Initialize();
 //BA.debugLineNum = 203;BA.debugLine="level=bat.BatteryInformation(0)";
_level = mostCurrent._bat._getbatteryinformation()[(int) (0)];
 //BA.debugLineNum = 204;BA.debugLine="Dim fn As String";
_fn = "";
 //BA.debugLineNum = 205;BA.debugLine="Dim fg As Int";
_fg = 0;
 //BA.debugLineNum = 206;BA.debugLine="Dim LD As LineData";
_ld = new com.batcat.charts._linedata();
 //BA.debugLineNum = 207;BA.debugLine="LD.Initialize";
_ld.Initialize();
 //BA.debugLineNum = 208;BA.debugLine="LD.Target =Panel2";
_ld.Target = mostCurrent._panel2;
 //BA.debugLineNum = 209;BA.debugLine="Charts.AddLineColor(LD, Colors.Red) 'First line c";
mostCurrent._charts._addlinecolor(mostCurrent.activityBA,_ld,anywheresoftware.b4a.keywords.Common.Colors.Red);
 //BA.debugLineNum = 210;BA.debugLine="Charts.AddLineColor(LD, Colors.Blue) 'Second line";
mostCurrent._charts._addlinecolor(mostCurrent.activityBA,_ld,anywheresoftware.b4a.keywords.Common.Colors.Blue);
 //BA.debugLineNum = 211;BA.debugLine="For Each h As String  In kvs2.ListKeys";
...
_h = BA.ObjectToString(group13.Get(index13));
 //BA.debugLineNum = 212;BA.debugLine="fg=h";
_fg = (int)(Double.parseDouble(_h));
 //BA.debugLineNum = 213;BA.debugLine="fn=kvs2.GetSimple(h)";
_fn = mostCurrent._kvs2._getsimple(_h);
 //BA.debugLineNum = 214;BA.debugLine="Log(\"Map Key-> \"&fg)";
anywheresoftware.b4a.keywords.Common.Log("Map Key-> "+BA.NumberToString(_fg));
 //BA.debugLineNum = 216;BA.debugLine="Charts.AddLinePoint(LD, fn,fg, True)";
mostCurrent._charts._addlinepoint(mostCurrent.activityBA,_ld,_fn,(float) (_fg),anywheresoftware.b4a.keywords.Common.True);
 }
;
 //BA.debugLineNum = 219;BA.debugLine="G.Title = \"BCT Power Chart\"";
mostCurrent._g.Title = "BCT Power Chart";
 //BA.debugLineNum = 220;BA.debugLine="G.XAxis = time2";
mostCurrent._g.XAxis = mostCurrent._time2;
 //BA.debugLineNum = 221;BA.debugLine="G.YAxis = \"Level:\"";
mostCurrent._g.YAxis = "Level:";
 //BA.debugLineNum = 222;BA.debugLine="G.YStart = 0";
mostCurrent._g.YStart = (float) (0);
 //BA.debugLineNum = 223;BA.debugLine="G.YEnd = 100";
mostCurrent._g.YEnd = (float) (100);
 //BA.debugLineNum = 224;BA.debugLine="G.YInterval = 5";
mostCurrent._g.YInterval = (float) (5);
 //BA.debugLineNum = 225;BA.debugLine="G.AxisColor = Colors.White";
mostCurrent._g.AxisColor = anywheresoftware.b4a.keywords.Common.Colors.White;
 //BA.debugLineNum = 227;BA.debugLine="Charts.DrawLineChart(G, LD, Colors.Transparent)";
...
public static String  _db_update() throws Exception{
 //BA.debugLineNum = 239;BA.debugLine="Sub db_update";
...
int _v = 0;
 //BA.debugLineNum = 250;BA.debugLine="Sub dev_BatteryChanged (level1 As Int, Scale As In";
 //BA.debugLineNum = 251;BA.debugLine="Dim vl As List";
_vl = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 252;BA.debugLine="vl.Initialize";
_vl.Initialize();
 //BA.debugLineNum = 253;BA.debugLine="For v = 0 To Scale Step 2";
{
final int step3 = (int) (2);
final int limit3 = _scale;
for (_v = (int) (0) ; (step3 > 0 && _v <= limit3) || (step3 < 0 && _v >= limit3); _v = ((int)(0 + _v + step3)) ) {
 //BA.debugLineNum = 254;BA.debugLine="vl.Add(v)";
_vl.Add((Object)(_v));
 //BA.debugLineNum = 255;BA.debugLine="If level1=v Then";
if (_level1==_v) { 
 //BA.debugLineNum = 256;BA.debugLine="store_check";
_store_check();
 //BA.debugLineNum = 257;BA.debugLine="c_start";
_c_start();
 };
 }
};
...
public static String  _get_log() throws Exception{
 //BA.debugLineNum = 191;BA.debugLine="Sub get_log";
...
public static String  _graph_clear() throws Exception{
 //BA.debugLineNum = 166;BA.debugLine="Sub graph_clear";
 //BA.debugLineNum = 167;BA.debugLine="kvs2.DeleteAll";
mostCurrent._kvs2._deleteall();
 //BA.debugLineNum = 168;BA.debugLine="level  = bat.BatteryInformation(0)";
_level = mostCurrent._bat._getbatteryinformation()[(int) (0)];
 //BA.debugLineNum = 169;BA.debugLine="Log(\"put-> \"&level&\"%\")";
anywheresoftware.b4a.keywords.Common.Log("put-> "+BA.NumberToString(_level)+"%");
 //BA.debugLineNum = 170;BA.debugLine="kvs2.PutSimple(level,time2)";
mostCurrent._kvs2._putsimple(BA.NumberToString(_level),(Object)(mostCurrent._time2));
 //BA.debugLineNum = 171;BA.debugLine="ToastMessageShow(\"warte auf Aktuelle werte..!\",Fa";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("warte auf Aktuelle werte..!"),anywheresoftware.b4a.keywords.Common.False);
...
public static String  _popa_itemclicked(de.amberhome.objects.appcompat.ACMenuItemWrapper _item) throws Exception{
 //BA.debugLineNum = 141;BA.debugLine="Sub popa_ItemClicked (Item As ACMenuItem)";
 //BA.debugLineNum = 142;BA.debugLine="If Item = popa.GetItem(0) Then";
if ((_item).equals((android.view.MenuItem)(mostCurrent._popa.GetItem((int) (0))))) { 
 //BA.debugLineNum = 143;BA.debugLine="ACButton1_Click";
_acbutton1_click();
 };
 //BA.debugLineNum = 145;BA.debugLine="If Item = popa.GetItem(1) Then";
...
public static String  _store_check() throws Exception{
 //BA.debugLineNum = 264;BA.debugLine="Sub store_check";
...
_c16 = mostCurrent._mcl.getmd_light_blue_A700();
 //BA.debugLineNum = 281;BA.debugLine="If kvs4.ContainsKey(\"0\")Then";
if (mostCurrent._kvs4._containskey("0")) { 
 //BA.debugLineNum = 282;BA.debugLine="Log(\"AC_true->1\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->1");
 //BA.debugLineNum = 283;BA.debugLine="Activity.Color=c1";
mostCurrent._activity.setColor(_c1);
 };
 //BA.debugLineNum = 285;BA.debugLine="If kvs4.ContainsKey(\"1\")Then";
if (mostCurrent._kvs4._containskey("1")) { 
 //BA.debugLineNum = 286;BA.debugLine="Log(\"AC_true->2\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->2");
 //BA.debugLineNum = 287;BA.debugLine="Activity.Color=c2";
mostCurrent._activity.setColor(_c2);
 }else {
 };
 //BA.debugLineNum = 291;BA.debugLine="If kvs4.ContainsKey(\"2\")Then";
if (mostCurrent._kvs4._containskey("2")) { 
 //BA.debugLineNum = 292;BA.debugLine="Log(\"AC_true->3\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->3");
 //BA.debugLineNum = 293;BA.debugLine="Activity.Color=c3";
mostCurrent._activity.setColor(_c3);
 }else {
 };
 //BA.debugLineNum = 297;BA.debugLine="If kvs4.ContainsKey(\"3\")Then";
...
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 299;BA.debugLine="Activity.Color=c4";
mostCurrent._activity.setColor(_c4);
 }else {
 };
 //BA.debugLineNum = 303;BA.debugLine="If kvs4.ContainsKey(\"4\")Then";
if (mostCurrent._kvs4._containskey("4")) { 
 //BA.debugLineNum = 304;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 305;BA.debugLine="Activity.Color=c5";
mostCurrent._activity.setColor(_c5);
 }else {
 };
 //BA.debugLineNum = 309;BA.debugLine="If kvs4.ContainsKey(\"5\")Then";
if (mostCurrent._kvs4._containskey("5")) { 
 //BA.debugLineNum = 310;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 311;BA.debugLine="Activity.Color=c6";
mostCurrent._activity.setColor(_c6);
 }else {
 };
 //BA.debugLineNum = 315;BA.debugLine="If kvs4.ContainsKey(\"6\")Then";
if (mostCurrent._kvs4._containskey("6")) { 
 //BA.debugLineNum = 316;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 317;BA.debugLine="Activity.Color=c7";
mostCurrent._activity.setColor(_c7);
 }else {
 };
 //BA.debugLineNum = 321;BA.debugLine="If kvs4.ContainsKey(\"7\")Then";
if (mostCurrent._kvs4._containskey("7")) { 
 //BA.debugLineNum = 322;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 323;BA.debugLine="Activity.Color=c8";
mostCurrent._activity.setColor(_c8);
 }else {
 };
 //BA.debugLineNum = 327;BA.debugLine="If kvs4.ContainsKey(\"8\")Then";
if (mostCurrent._kvs4._containskey("8")) { 
 //BA.debugLineNum = 328;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 329;BA.debugLine="Activity.Color=c9";
mostCurrent._activity.setColor(_c9);
 }else {
 };
 //BA.debugLineNum = 333;BA.debugLine="If kvs4.ContainsKey(\"9\")Then";
if (mostCurrent._kvs4._containskey("9")) { 
 //BA.debugLineNum = 334;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 335;BA.debugLine="Activity.Color=c10";
...
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 341;BA.debugLine="Activity.Color=c11";
mostCurrent._activity.setColor(_c11);
 }else {
 };
 //BA.debugLineNum = 345;BA.debugLine="If kvs4.ContainsKey(\"11\")Then";
if (mostCurrent._kvs4._containskey("11")) { 
 //BA.debugLineNum = 346;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 347;BA.debugLine="Activity.Color=c12";
mostCurrent._activity.setColor(_c12);
 }else {
 };
 //BA.debugLineNum = 351;BA.debugLine="If kvs4.ContainsKey(\"12\")Then";
if (mostCurrent._kvs4._containskey("12")) { 
 //BA.debugLineNum = 352;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 353;BA.debugLine="Activity.Color=c13";
mostCurrent._activity.setColor(_c13);
 }else {
 };
 //BA.debugLineNum = 357;BA.debugLine="If kvs4.ContainsKey(\"13\")Then";
if (mostCurrent._kvs4._containskey("13")) { 
 //BA.debugLineNum = 358;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 359;BA.debugLine="Activity.Color=c14";
mostCurrent._activity.setColor(_c14);
 }else {
 };
 //BA.debugLineNum = 363;BA.debugLine="If kvs4.ContainsKey(\"14\")Then";
if (mostCurrent._kvs4._containskey("14")) { 
 //BA.debugLineNum = 364;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 365;BA.debugLine="Activity.Color=c15";
mostCurrent._activity.setColor(_c15);
 }else {
 };
 //BA.debugLineNum = 369;BA.debugLine="Activity.Invalidate";
