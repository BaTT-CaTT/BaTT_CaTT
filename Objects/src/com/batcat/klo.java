...
public static String  _acbutton1_click() throws Exception{
 //BA.debugLineNum = 343;BA.debugLine="Sub ACButton1_Click";
 //BA.debugLineNum = 344;BA.debugLine="graph_clear";
_graph_clear();
...
anywheresoftware.b4a.objects.drawable.BitmapDrawable _bd1 = null;
 ...
 //BA.debugLineNum = 70;BA.debugLine="Activity.LoadLayout(\"2\")";
mostCurrent._activity.LoadLayout("2",mostCurrent.activityBA);
 //BA.debugLineNum = 71;BA.debugLine="Activity.Title=pak1.GetApplicationLabel(\"com.batc";
mostCurrent._activity.setTitle(BA.ObjectToCharSequence(mostCurrent._pak1.GetApplicationLabel("com.batcat")+" - "+mostCurrent._pak1.GetVersionName("com.batcat")));
 //BA.debugLineNum = 72;BA.debugLine="Activity.AddMenuItem(\"Clear Stats\",\"ccl\")";
mostCurrent._activity.AddMenuItem(BA.ObjectToCharSequence("Clear Stats"),"ccl");
 //BA.debugLineNum = 73;BA.debugLine="Activity.AddMenuItem(\"Exit\",\"cl\")";
mostCurrent._activity.AddMenuItem(BA.ObjectToCharSequence("Exit"),"cl");
 //BA.debugLineNum = 74;BA.debugLine="suc.Initialize";
...
mostCurrent._l2.Initialize(mostCurrent.activityBA,"l2");
 //BA.debugLineNum = 77;BA.debugLine="l3.Initialize(\"l3\")";
mostCurrent._l3.Initialize(mostCurrent.activityBA,"l3");
 //BA.debugLineNum = 78;BA.debugLine="device.Initialize(\"device\")";
mostCurrent._device.Initialize(processBA,"device");
 //BA.debugLineNum = 80;BA.debugLine="c1=mcl.md_light_blue_A700";
_c1 = mostCurrent._mcl.getmd_light_blue_A700();
 //BA.debugLineNum = 81;BA.debugLine="c2=mcl.md_amber_A700";
_c2 = mostCurrent._mcl.getmd_amber_A700();
 //BA.debugLineNum = 82;BA.debugLine="c3=mcl.md_lime_A700";
_c3 = mostCurrent._mcl.getmd_lime_A700();
 //BA.debugLineNum = 83;BA.debugLine="c4=mcl.md_teal_A700";
_c4 = mostCurrent._mcl.getmd_teal_A700();
 //BA.debugLineNum = 84;BA.debugLine="Activity.Color=mcl.md_white_1000";
mostCurrent._activity.setColor(mostCurrent._mcl.getmd_white_1000());
 //BA.debugLineNum = 86;BA.debugLine="t1.Initialize(\"t1\",1000)";
_t1.Initialize(processBA,"t1",(long) (1000));
 //BA.debugLineNum = 88;BA.debugLine="m.Initialize";
mostCurrent._m.Initialize();
 //BA.debugLineNum = 89;BA.debugLine="bat.Initialize";
mostCurrent._bat._initialize(processBA);
 //BA.debugLineNum = 91;BA.debugLine="kl.Initialize";
mostCurrent._kl.Initialize();
 //BA.debugLineNum = 92;BA.debugLine="dt.Initialize";
mostCurrent._dt.Initialize();
 //BA.debugLineNum = 93;BA.debugLine="ls.Initialize";
mostCurrent._ls.Initialize();
 //BA.debugLineNum = 94;BA.debugLine="kvs2.Initialize(File.DirDefaultExternal, \"datasto";
mostCurrent._kvs2._initialize(processBA,anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal(),"datastore_2");
 //BA.debugLineNum = 95;BA.debugLine="kvs3.Initialize(File.DirDefaultExternal, \"datasto";
mostCurrent._kvs3._initialize(processBA,anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal(),"datastore_3");
 //BA.debugLineNum = 96;BA.debugLine="kvs4.Initialize(File.DirDefaultExternal, \"datasto";
mostCurrent._kvs4._initialize(processBA,anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal(),"datastore_4");
 //BA.debugLineNum = 97;BA.debugLine="kvsvolt.Initialize(File.DirDefaultExternal, \"data";
mostCurrent._kvsvolt._initialize(processBA,anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal(),"datastore_volt");
 //BA.debugLineNum = 98;BA.debugLine="kvstemp.Initialize(File.DirDefaultExternal, \"data";
mostCurrent._kvstemp._initialize(processBA,anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal(),"datastore_temp");
 //BA.debugLineNum = 99;BA.debugLine="time2=DateTime.Time(DateTime.Now)";
mostCurrent._time2 = anywheresoftware.b4a.keywords.Common.DateTime.Time(anywheresoftware.b4a.keywords.Common.DateTime.getNow());
 //BA.debugLineNum = 100;BA.debugLine="Dim bbat As String = bat.BatteryInformation(0)";
_bbat = BA.NumberToString(mostCurrent._bat._getbatteryinformation()[(int) (0)]);
 //BA.debugLineNum = 101;BA.debugLine="volt=bat.BatteryInformation(7)/1000";
mostCurrent._volt = BA.NumberToString(mostCurrent._bat._getbatteryinformation()[(int) (7)]/(double)1000);
 //BA.debugLineNum = 102;BA.debugLine="temp=bat.BatteryInformation(6)/10";
mostCurrent._temp = BA.NumberToString(mostCurrent._bat._getbatteryinformation()[(int) (6)]/(double)10);
 //BA.debugLineNum = 103;BA.debugLine="usb =bat.BatteryInformation(9)";
mostCurrent._usb = BA.NumberToString(mostCurrent._bat._getbatteryinformation()[(int) (9)]);
 //BA.debugLineNum = 104;BA.debugLine="ac =bat.BatteryInformation(8)";
mostCurrent._ac = BA.NumberToString(mostCurrent._bat._getbatteryinformation()[(int) (8)]);
 //BA.debugLineNum = 105;BA.debugLine="G.Initialize";
mostCurrent._g.Initialize();
 //BA.debugLineNum = 106;BA.debugLine="g2.Initialize";
mostCurrent._g2.Initialize();
 //BA.debugLineNum = 107;BA.debugLine="If FirstTime=True Then";
if (_firsttime==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 108;BA.debugLine="kvs2.PutSimple(bbat,time2)";
mostCurrent._kvs2._putsimple(_bbat,(Object)(mostCurrent._time2));
 //BA.debugLineNum = 109;BA.debugLine="kvstemp.PutSimple(temp,time2)";
mostCurrent._kvstemp._putsimple(mostCurrent._temp,(Object)(mostCurrent._time2));
 //BA.debugLineNum = 110;BA.debugLine="Msgbox(\"Wenn die Statistik zum ersten Mal gelade";
anywheresoftware.b4a.keywords.Common.Msgbox(BA.ObjectToCharSequence("Wenn die Statistik zum ersten Mal geladen wird, kann es eine Weile dauern, bis die Werte korrekt angezeigt werden, zB: V,C°,% der letzten 10 Einträge. Bitte beachte das die Werte nur ca sind da sie immer leicht Zeit versetzt gespeichert werden und nicht  den 'Live' Zustand anzeigen!"),BA.ObjectToCharSequence("Wichtig!"),mostCurrent.activityBA);
 ...
 //BA.debugLineNum = 113;BA.debugLine="batt=LoadBitmap(File.DirAssets,\"Battery Icons - W";
mostCurrent._batt = anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Battery Icons - White 64px (40).png");
 //BA.debugLineNum = 114;BA.debugLine="pl=LoadBitmap(File.DirAssets,\"Battery Icons - Whi";
mostCurrent._pl = anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Battery Icons - White 64px (28).png");
 //BA.debugLineNum = 116;BA.debugLine="popa.Initialize(\"popa\",Panel3)";
mostCurrent._popa.Initialize(mostCurrent.activityBA,"popa",(android.view.View)(mostCurrent._panel3.getObject()));
 //BA.debugLineNum = 117;BA.debugLine="Dim bd,bd1 As BitmapDrawable";
_bd = new anywheresoftware.b4a.objects.drawable.BitmapDrawable();
_bd1 = new anywheresoftware.b4a.objects.drawable.BitmapDrawable();
 //BA.debugLineNum = 118;BA.debugLine="bd.Initialize(LoadBitmap(File.DirAssets,\"multiply";
_bd.Initialize((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"multiply-1.png").getObject()));
 //BA.debugLineNum = 119;BA.debugLine="bd1.Initialize(LoadBitmap(File.DirAssets,\"warning";
_bd1.Initialize((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"warning.png").getObject()));
 //BA.debugLineNum = 120;BA.debugLine="popa.AddMenuItem(0,\"Reload Stats\",bd1)";
mostCurrent._popa.AddMenuItem((int) (0),BA.ObjectToCharSequence("Reload Stats"),(android.graphics.drawable.Drawable)(_bd1.getObject()));
 //BA.debugLineNum = 121;BA.debugLine="popa.AddMenuItem(1,\"Schließen\",bd)";
mostCurrent._popa.AddMenuItem((int) (1),BA.ObjectToCharSequence("Schließen"),(android.graphics.drawable.Drawable)(_bd.getObject()));
 //BA.debugLineNum = 125;BA.debugLine="cb1.ButtonColor=mcl.md_lime_A200";
mostCurrent._cb1.setButtonColor(mostCurrent._mcl.getmd_lime_A200());
 //BA.debugLineNum = 126;BA.debugLine="cb1.ImageBitmap=LoadBitmap(File.DirAssets,\"Bar-ch";
...
_build();
 //BA.debugLineNum = 129;BA.debugLine="store_check";
_store_check();
 //BA.debugLineNum = 130;BA.debugLine="c_start";
_c_start();
 //BA.debugLineNum = 131;BA.debugLine="t1_Tick";
_t1_tick();
 //BA.debugLineNum = 132;BA.debugLine="End Sub";
return "";
}
public static boolean  _activity_keypress(int _keycode) throws Exception{
 //BA.debugLineNum = 328;BA.debugLine="Sub Activity_KeyPress (KeyCode As Int) As Boolean";
 //BA.debugLineNum = 329;BA.debugLine="If KeyCode=KeyCodes.KEYCODE_BACK Then";
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK) { 
 //BA.debugLineNum = 330;BA.debugLine="Activity.Finish";
mostCurrent._activity.Finish();
 //BA.debugLineNum = 331;BA.debugLine="ToastMessageShow(\"BCT - Backround  Statistic sta";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("BCT - Backround  Statistic started.."),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 332;BA.debugLine="SetAnimation.setanimati(\"extra_in\", \"extra_out\"";
...
public static String  _activity_resume() throws Exception{
 ...
 //BA.debugLineNum = 135;BA.debugLine="t1.Enabled=True";
_t1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 136;BA.debugLine="build";
_build();
 //BA.debugLineNum = 137;BA.debugLine="c_start";
_c_start();
 //BA.debugLineNum = 138;BA.debugLine="store_check";
_store_check();
...
anywheresoftware.b4a.objects.LabelWrapper _lvb = null;
 //BA.debugLineNum = 173;BA.debugLine="Sub build";
 //BA.debugLineNum = 174;BA.debugLine="Dim lv As ListView";
_lv = new anywheresoftware.b4a.objects.ListViewWrapper();
 //BA.debugLineNum = 175;BA.debugLine="lv.Initialize(\"lv\")";
_lv.Initialize(mostCurrent.activityBA,"lv");
 //BA.debugLineNum = 176;BA.debugLine="Dim lva,lvb As Label";
_lva = new anywheresoftware.b4a.objects.LabelWrapper();
_lvb = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 177;BA.debugLine="lva.Initialize(\"lva\")";
_lva.Initialize(mostCurrent.activityBA,"lva");
 //BA.debugLineNum = 178;BA.debugLine="lvb.Initialize(\"lvb\")";
_lvb.Initialize(mostCurrent.activityBA,"lvb");
 //BA.debugLineNum = 179;BA.debugLine="lva=lv.TwoLinesAndBitmap.Label";
_lva = _lv.getTwoLinesAndBitmap().Label;
 //BA.debugLineNum = 180;BA.debugLine="lvb=lv.TwoLinesAndBitmap.SecondLabel";
_lvb = _lv.getTwoLinesAndBitmap().SecondLabel;
 //BA.debugLineNum = 181;BA.debugLine="lva.TextSize=13";
_lva.setTextSize((float) (13));
 //BA.debugLineNum = 182;BA.debugLine="lva.TextColor=mcl.md_black_1000";
_lva.setTextColor(mostCurrent._mcl.getmd_black_1000());
 //BA.debugLineNum = 183;BA.debugLine="lvb.TextSize=11";
_lvb.setTextSize((float) (11));
 //BA.debugLineNum = 184;BA.debugLine="lvb.TextColor=mcl.md_grey_700";
_lvb.setTextColor(mostCurrent._mcl.getmd_grey_700());
 //BA.debugLineNum = 185;BA.debugLine="lv.TwoLinesAndBitmap.ImageView.Height=40dip";
_lv.getTwoLinesAndBitmap().ImageView.setHeight(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (40)));
 //BA.debugLineNum = 186;BA.debugLine="lv.TwoLinesAndBitmap.ImageView.Width=40dip";
_lv.getTwoLinesAndBitmap().ImageView.setWidth(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (40)));
 //BA.debugLineNum = 187;BA.debugLine="lv.TwoLinesAndBitmap.ItemHeight=60dip";
_lv.getTwoLinesAndBitmap().setItemHeight(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (60)));
 //BA.debugLineNum = 188;BA.debugLine="lv.Enabled=True";
_lv.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 189;BA.debugLine="Panel3.AddView(lv,0dip,0dip,60%x,100%y)";
mostCurrent._panel3.AddView((android.view.View)(_lv.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (0)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (0)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (60),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA));
 //BA.debugLineNum = 190;BA.debugLine="lv.AddTwoLinesAndBitmap2(\"Reset C°\",\"setzt alle W";
_lv.AddTwoLinesAndBitmap2(BA.ObjectToCharSequence("Reset C°"),BA.ObjectToCharSequence("setzt alle Werte wieder auf 0 und löscht die Temperatur Ansicht"),(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"warning.png").getObject()),(Object)(0));
 //BA.debugLineNum = 191;BA.debugLine="lv.AddTwoLinesAndBitmap2(\"Reset Level\",\"setzt all";
_lv.AddTwoLinesAndBitmap2(BA.ObjectToCharSequence("Reset Level"),BA.ObjectToCharSequence("setzt alle Werte wieder auf 0 und löscht die Batterie-Level Ansicht"),(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"warning.png").getObject()),(Object)(1));
 //BA.debugLineNum = 192;BA.debugLine="lv.AddTwoLinesAndBitmap2(\"OS Power\",\"Android Powe";
_lv.AddTwoLinesAndBitmap2(BA.ObjectToCharSequence("OS Power"),BA.ObjectToCharSequence("Android Power Menü"),(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Battery.png").getObject()),(Object)(2));
 //BA.debugLineNum = 193;BA.debugLine="lv.AddTwoLinesAndBitmap2(\"Close\",\"zurück zum Haup";
...
public static String  _c_start() throws Exception{
 //BA.debugLineNum = 247;BA.debugLine="Sub c_start";
 //BA.debugLineNum = 248;BA.debugLine="If kvs2.IsInitialized Then";
if (mostCurrent._kvs2.IsInitialized()) { 
 //BA.debugLineNum = 249;BA.debugLine="Log(\"KVS -> true\")";
anywheresoftware.b4a.keywords.Common.Log("KVS -> true");
 }else {
 //BA.debugLineNum = 251;BA.debugLine="kvs2.Initialize(File.DirDefaultExternal, \"datast";
mostCurrent._kvs2._initialize(processBA,anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal(),"datastore_2");
 //BA.debugLineNum = 252;BA.debugLine="kvs3.Initialize(File.DirDefaultExternal, \"datast";
mostCurrent._kvs3._initialize(processBA,anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal(),"datastore_3");
 //BA.debugLineNum = 253;BA.debugLine="kvsvolt.Initialize(File.DirDefaultExternal, \"dat";
mostCurrent._kvsvolt._initialize(processBA,anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal(),"datastore_volt");
 //BA.debugLineNum = 254;BA.debugLine="kvstemp.Initialize(File.DirDefaultExternal, \"dat";
mostCurrent._kvstemp._initialize(processBA,anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal(),"datastore_temp");
 };
 //BA.debugLineNum = 257;BA.debugLine="chart_2";
_chart_2();
 //BA.debugLineNum = 258;BA.debugLine="chart_start";
_chart_start();
 //BA.debugLineNum = 259;BA.debugLine="End Sub";
return "";
}
public static String  _cb1_click() throws Exception{
 //BA.debugLineNum = 157;BA.debugLine="Sub cb1_Click";
 //BA.debugLineNum = 158;BA.debugLine="If Not (Panel3.Visible=True) Then";
if (anywheresoftware.b4a.keywords.Common.Not(mostCurrent._panel3.getVisible()==anywheresoftware.b4a.keywords.Common.True)) { 
 //BA.debugLineNum = 160;BA.debugLine="Panel2.SendToBack";
mostCurrent._panel2.SendToBack();
 //BA.debugLineNum = 161;BA.debugLine="Panel1.SendToBack";
mostCurrent._panel1.SendToBack();
 //BA.debugLineNum = 162;BA.debugLine="Panel2.SetVisibleAnimated(550,False)";
mostCurrent._panel2.SetVisibleAnimated((int) (550),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 163;BA.debugLine="Panel1.SetVisibleAnimated(550,False)";
mostCurrent._panel1.SetVisibleAnimated((int) (550),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 164;BA.debugLine="Panel3.SetVisibleAnimated(550,True)";
mostCurrent._panel3.SetVisibleAnimated((int) (550),anywheresoftware.b4a.keywords.Common.True);
 }else {
 //BA.debugLineNum = 166;BA.debugLine="Panel2.SetVisibleAnimated(550,True)";
mostCurrent._panel2.SetVisibleAnimated((int) (550),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 167;BA.debugLine="Panel1.SetVisibleAnimated(550,True)";
mostCurrent._panel1.SetVisibleAnimated((int) (550),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 168;BA.debugLine="Panel3.SetVisibleAnimated(550,False)";
...
public static String  _ccl_click() throws Exception{
 //BA.debugLineNum = 229;BA.debugLine="Sub ccl_click";
 //BA.debugLineNum = 230;BA.debugLine="kvstemp.DeleteAll";
mostCurrent._kvstemp._deleteall();
 //BA.debugLineNum = 231;BA.debugLine="kvsvolt.DeleteAll";
mostCurrent._kvsvolt._deleteall();
 //BA.debugLineNum = 232;BA.debugLine="kvstemp.PutSimple(bat.BatteryInformation(6)/10,ti";
mostCurrent._kvstemp._putsimple(BA.NumberToString(mostCurrent._bat._getbatteryinformation()[(int) (6)]/(double)10),(Object)(mostCurrent._time2));
 //BA.debugLineNum = 233;BA.debugLine="ToastMessageShow(\"warte auf Aktuelle werte..!\",Fa";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("warte auf Aktuelle werte..!"),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 234;BA.debugLine="c_start";
_c_start();
 //BA.debugLineNum = 235;BA.debugLine="Activity.Invalidate";
...
Object _h = null;
 //BA.debugLineNum = 297;BA.debugLine="Sub chart_2";
 //BA.debugLineNum = 299;BA.debugLine="If LD2.IsInitialized Then";
if (mostCurrent._ld2.IsInitialized) { 
 }else {
 //BA.debugLineNum = 301;BA.debugLine="LD2.Initialize";
mostCurrent._ld2.Initialize();
 };
 //BA.debugLineNum = 303;BA.debugLine="LD2.Target =Panel1";
mostCurrent._ld2.Target = mostCurrent._panel1;
 //BA.debugLineNum = 307;BA.debugLine="Charts.AddlineColor(LD2, mcl.md_light_blue_A700)";
mostCurrent._charts._addlinecolor(mostCurrent.activityBA,mostCurrent._ld2,mostCurrent._mcl.getmd_light_blue_A700());
 //BA.debugLineNum = 308;BA.debugLine="For Each h Step 3  As String  In kvstemp.ListKeys";
...
_h = group7.Get(index7);
 //BA.debugLineNum = 309;BA.debugLine="fg2=h";
_fg2 = (int)(BA.ObjectToNumber(_h));
 //BA.debugLineNum = 310;BA.debugLine="fn2=kvstemp.GetSimple(h)";
mostCurrent._fn2 = mostCurrent._kvstemp._getsimple(BA.ObjectToString(_h));
 //BA.debugLineNum = 311;BA.debugLine="Log(\"Bar Key-> \"&h)";
anywheresoftware.b4a.keywords.Common.Log("Bar Key-> "+BA.ObjectToString(_h));
 //BA.debugLineNum = 313;BA.debugLine="Charts.AddLinePoint(LD2, fn2,fg2,True)";
...
;
 //BA.debugLineNum = 316;BA.debugLine="g2.Title = \"Temp. in C°\"";
mostCurrent._g2.Title = "Temp. in C°";
 //BA.debugLineNum = 317;BA.debugLine="g2.XAxis = \"\"";
mostCurrent._g2.XAxis = "";
 //BA.debugLineNum = 318;BA.debugLine="g2.YAxis = \"Temperature\"";
mostCurrent._g2.YAxis = "Temperature";
 //BA.debugLineNum = 319;BA.debugLine="g2.YStart = 10";
mostCurrent._g2.YStart = (float) (10);
 //BA.debugLineNum = 320;BA.debugLine="g2.YEnd = 60";
mostCurrent._g2.YEnd = (float) (60);
 //BA.debugLineNum = 321;BA.debugLine="g2.YInterval = 5";
mostCurrent._g2.YInterval = (float) (5);
 //BA.debugLineNum = 322;BA.debugLine="g2.AxisColor = Colors.White";
mostCurrent._g2.AxisColor = anywheresoftware.b4a.keywords.Common.Colors.White;
 //BA.debugLineNum = 324;BA.debugLine="Charts.DrawLineChart(g2, LD2, Colors.Transparent)";
...
Object _h = null;
 //BA.debugLineNum = 262;BA.debugLine="Sub chart_start";
 //BA.debugLineNum = 263;BA.debugLine="If LD.IsInitialized Then";
if (mostCurrent._ld.IsInitialized) { 
 }else {
 //BA.debugLineNum = 265;BA.debugLine="LD.Initialize";
mostCurrent._ld.Initialize();
 };
 //BA.debugLineNum = 267;BA.debugLine="LD.Target =Panel2";
mostCurrent._ld.Target = mostCurrent._panel2;
 //BA.debugLineNum = 268;BA.debugLine="If kvs4.ContainsKey(\"5\")Then";
...
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 271;BA.debugLine="Charts.AddLineColor(LD, Colors.Blue) 'First line";
mostCurrent._charts._addlinecolor(mostCurrent.activityBA,mostCurrent._ld,anywheresoftware.b4a.keywords.Common.Colors.Blue);
 ...
 //BA.debugLineNum = 273;BA.debugLine="Charts.AddLineColor(LD, Colors.Red) 'First line";
mostCurrent._charts._addlinecolor(mostCurrent.activityBA,mostCurrent._ld,anywheresoftware.b4a.keywords.Common.Colors.Red);
 };
 //BA.debugLineNum = 277;BA.debugLine="For Each h Step 3 As String  In kvs2.ListKeys";
...
_h = group12.Get(index12);
 //BA.debugLineNum = 278;BA.debugLine="fg=h";
_fg = (int)(BA.ObjectToNumber(_h));
 //BA.debugLineNum = 279;BA.debugLine="fn=kvs2.GetSimple(h)";
mostCurrent._fn = mostCurrent._kvs2._getsimple(BA.ObjectToString(_h));
 //BA.debugLineNum = 280;BA.debugLine="Log(\"Map Key-> \"&fg)";
anywheresoftware.b4a.keywords.Common.Log("Map Key-> "+BA.NumberToString(_fg));
 //BA.debugLineNum = 282;BA.debugLine="Charts.AddLinePoint(LD, fn,fg, True)";
...
;
 //BA.debugLineNum = 285;BA.debugLine="G.Title = \"Level in %\"";
mostCurrent._g.Title = "Level in %";
 //BA.debugLineNum = 286;BA.debugLine="G.XAxis = \"<- Battery Stats ->\"";
mostCurrent._g.XAxis = "<- Battery Stats ->";
 //BA.debugLineNum = 287;BA.debugLine="G.YAxis = \"Level\"";
mostCurrent._g.YAxis = "Level";
 //BA.debugLineNum = 288;BA.debugLine="G.YStart = 0";
mostCurrent._g.YStart = (float) (0);
 //BA.debugLineNum = 289;BA.debugLine="G.YEnd = 100";
mostCurrent._g.YEnd = (float) (100);
 //BA.debugLineNum = 290;BA.debugLine="G.YInterval = 5";
mostCurrent._g.YInterval = (float) (5);
 //BA.debugLineNum = 291;BA.debugLine="G.AxisColor = Colors.White";
mostCurrent._g.AxisColor = anywheresoftware.b4a.keywords.Common.Colors.White;
 //BA.debugLineNum = 293;BA.debugLine="Charts.DrawLineChart(G, LD, Colors.Transparent)";
...
public static String  _db_update() throws Exception{
 //BA.debugLineNum = 337;BA.debugLine="Sub db_update";
 //BA.debugLineNum = 339;BA.debugLine="End Sub";
return "";
}
public static String  _device_batterychanged(int _level1,int _scale,boolean _plugged,anywheresoftware.b4a.objects.IntentWrapper _intent) throws Exception{
 //BA.debugLineNum = 348;BA.debugLine="Sub device_BatteryChanged (level1 As Int, Scale As";
...
public static String  _graph_clear() throws Exception{
 //BA.debugLineNum = 238;BA.debugLine="Sub graph_clear";
 //BA.debugLineNum = 239;BA.debugLine="ProgressDialogShow(\"lade...\")";
anywheresoftware.b4a.keywords.Common.ProgressDialogShow(mostCurrent.activityBA,BA.ObjectToCharSequence("lade..."));
 //BA.debugLineNum = 240;BA.debugLine="kvs2.DeleteAll";
mostCurrent._kvs2._deleteall();
 //BA.debugLineNum = 241;BA.debugLine="kvs2.PutSimple(bat.BatteryInformation(0),time2)";
mostCurrent._kvs2._putsimple(BA.NumberToString(mostCurrent._bat._getbatteryinformation()[(int) (0)]),(Object)(mostCurrent._time2));
 //BA.debugLineNum = 242;BA.debugLine="ToastMessageShow(\"warte auf Aktuelle werte..!\",Fa";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("warte auf Aktuelle werte..!"),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 243;BA.debugLine="c_start";
_c_start();
 //BA.debugLineNum = 244;BA.debugLine="Activity.Invalidate";
mostCurrent._activity.Invalidate();
...
anywheresoftware.b4a.objects.IntentWrapper _ipo = null;
 //BA.debugLineNum = 196;BA.debugLine="Sub lv_ItemClick (Position As Int, Value As Object";
 //BA.debugLineNum = 197;BA.debugLine="Dim ipo As Intent";
_ipo = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 198;BA.debugLine="If Value=0 Then";
if ((_value).equals((Object)(0))) { 
 //BA.debugLineNum = 199;BA.debugLine="ProgressDialogShow(\"lade...\")";
anywheresoftware.b4a.keywords.Common.ProgressDialogShow(mostCurrent.activityBA,BA.ObjectToCharSequence("lade..."));
 //BA.debugLineNum = 200;BA.debugLine="ccl_click";
_ccl_click();
 //BA.debugLineNum = 201;BA.debugLine="cb1_Click";
_cb1_click();
 //BA.debugLineNum = 202;BA.debugLine="Activity.Invalidate";
mostCurrent._activity.Invalidate();
 };
 //BA.debugLineNum = 204;BA.debugLine="If Value=1 Then";
if ((_value).equals((Object)(1))) { 
 //BA.debugLineNum = 205;BA.debugLine="ProgressDialogShow(\"lade...\")";
anywheresoftware.b4a.keywords.Common.ProgressDialogShow(mostCurrent.activityBA,BA.ObjectToCharSequence("lade..."));
 //BA.debugLineNum = 206;BA.debugLine="graph_clear";
_graph_clear();
 //BA.debugLineNum = 207;BA.debugLine="cb1_Click";
_cb1_click();
 //BA.debugLineNum = 208;BA.debugLine="Activity.Invalidate";
mostCurrent._activity.Invalidate();
 };
 //BA.debugLineNum = 210;BA.debugLine="If Value=2 Then";
if ((_value).equals((Object)(2))) { 
 //BA.debugLineNum = 211;BA.debugLine="ipo.Initialize( \"android.intent.action.POWER_USA";
_ipo.Initialize("android.intent.action.POWER_USAGE_SUMMARY","");
 //BA.debugLineNum = 212;BA.debugLine="cb1_Click";
_cb1_click();
 //BA.debugLineNum = 213;BA.debugLine="Activity.Invalidate";
mostCurrent._activity.Invalidate();
 };
 //BA.debugLineNum = 215;BA.debugLine="If Value= 3 Then";
if ((_value).equals((Object)(3))) { 
 //BA.debugLineNum = 216;BA.debugLine="Activity_KeyPress(KeyCodes.KEYCODE_BACK)";
...
public static String  _mlc1_value_selected(int _index,float _value) throws Exception{
 //BA.debugLineNum = 492;BA.debugLine="Sub mlc1_value_selected(index As Int, value As Flo";
 //BA.debugLineNum = 494;BA.debugLine="End Sub";
return "";
}
public static String  _popa_itemclicked(de.amberhome.objects.appcompat.ACMenuItemWrapper _item) throws Exception{
 //BA.debugLineNum = 220;BA.debugLine="Sub popa_ItemClicked (Item As ACMenuItem)";
 //BA.debugLineNum = 221;BA.debugLine="If Item = popa.GetItem(0) Then";
if ((_item).equals((android.view.MenuItem)(mostCurrent._popa.GetItem((int) (0))))) { 
 //BA.debugLineNum = 222;BA.debugLine="ACButton1_Click";
_acbutton1_click();
 };
 //BA.debugLineNum = 224;BA.debugLine="If Item = popa.GetItem(1) Then";
...
public static String  _store_check() throws Exception{
 //BA.debugLineNum = 379;BA.debugLine="Sub store_check";
 //BA.debugLineNum = 380;BA.debugLine="c1=mcl.md_light_blue_A400";
_c1 = mostCurrent._mcl.getmd_light_blue_A400();
 //BA.debugLineNum = 381;BA.debugLine="c2=mcl.md_amber_A400";
_c2 = mostCurrent._mcl.getmd_amber_A400();
 //BA.debugLineNum = 382;BA.debugLine="c3=mcl.md_white_1000";
_c3 = mostCurrent._mcl.getmd_white_1000();
 //BA.debugLineNum = 383;BA.debugLine="c4=mcl.md_teal_A400";
_c4 = mostCurrent._mcl.getmd_teal_A400();
 //BA.debugLineNum = 384;BA.debugLine="c5=mcl.md_deep_purple_A400";
_c5 = mostCurrent._mcl.getmd_deep_purple_A400();
 //BA.debugLineNum = 385;BA.debugLine="c6=mcl.md_red_A700";
_c6 = mostCurrent._mcl.getmd_red_A700();
 //BA.debugLineNum = 386;BA.debugLine="c7=mcl.md_indigo_A400";
_c7 = mostCurrent._mcl.getmd_indigo_A400();
 //BA.debugLineNum = 387;BA.debugLine="c8=mcl.md_blue_A400";
_c8 = mostCurrent._mcl.getmd_blue_A400();
 //BA.debugLineNum = 388;BA.debugLine="c9=mcl.md_orange_A700";
_c9 = mostCurrent._mcl.getmd_orange_A700();
 //BA.debugLineNum = 389;BA.debugLine="c10=mcl.md_grey_600";
_c10 = mostCurrent._mcl.getmd_grey_600();
 //BA.debugLineNum = 390;BA.debugLine="c11=mcl.md_green_A400";
_c11 = mostCurrent._mcl.getmd_green_A400();
 //BA.debugLineNum = 391;BA.debugLine="c12=mcl.md_black_1000";
_c12 = mostCurrent._mcl.getmd_black_1000();
 //BA.debugLineNum = 392;BA.debugLine="c13=mcl.md_light_green_A400";
_c13 = mostCurrent._mcl.getmd_light_green_A400();
 //BA.debugLineNum = 393;BA.debugLine="c14=mcl.md_cyan_A400";
_c14 = mostCurrent._mcl.getmd_cyan_A400();
 //BA.debugLineNum = 394;BA.debugLine="c15=mcl.md_blue_grey_400";
_c15 = mostCurrent._mcl.getmd_blue_grey_400();
 //BA.debugLineNum = 395;BA.debugLine="c16=mcl.md_light_blue_A400";
_c16 = mostCurrent._mcl.getmd_light_blue_A400();
 //BA.debugLineNum = 396;BA.debugLine="If kvs4.ContainsKey(\"0\")Then";
if (mostCurrent._kvs4._containskey("0")) { 
 //BA.debugLineNum = 397;BA.debugLine="Log(\"AC_true->1\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->1");
 //BA.debugLineNum = 398;BA.debugLine="Activity.Color=c1";
mostCurrent._activity.setColor(_c1);
 };
 //BA.debugLineNum = 400;BA.debugLine="If kvs4.ContainsKey(\"1\")Then";
if (mostCurrent._kvs4._containskey("1")) { 
 //BA.debugLineNum = 401;BA.debugLine="Log(\"AC_true->2\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->2");
 //BA.debugLineNum = 402;BA.debugLine="Activity.Color=c2";
mostCurrent._activity.setColor(_c2);
 }else {
 };
 //BA.debugLineNum = 406;BA.debugLine="If kvs4.ContainsKey(\"2\")Then";
if (mostCurrent._kvs4._containskey("2")) { 
 //BA.debugLineNum = 407;BA.debugLine="Log(\"AC_true->3\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->3");
 //BA.debugLineNum = 408;BA.debugLine="Activity.Color=c3";
mostCurrent._activity.setColor(_c3);
 //BA.debugLineNum = 409;BA.debugLine="g.AxisColor = Colors.Black";
mostCurrent._g.AxisColor = anywheresoftware.b4a.keywords.Common.Colors.Black;
 //BA.debugLineNum = 410;BA.debugLine="g2.AxisColor = Colors.Black";
mostCurrent._g2.AxisColor = anywheresoftware.b4a.keywords.Common.Colors.Black;
 }else {
 };
 //BA.debugLineNum = 414;BA.debugLine="If kvs4.ContainsKey(\"3\")Then";
if (mostCurrent._kvs4._containskey("3")) { 
 //BA.debugLineNum = 415;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 416;BA.debugLine="Activity.Color=c4";
mostCurrent._activity.setColor(_c4);
 }else {
 };
 //BA.debugLineNum = 420;BA.debugLine="If kvs4.ContainsKey(\"4\")Then";
if (mostCurrent._kvs4._containskey("4")) { 
 //BA.debugLineNum = 421;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 422;BA.debugLine="Activity.Color=c5";
mostCurrent._activity.setColor(_c5);
 }else {
 };
 //BA.debugLineNum = 426;BA.debugLine="If kvs4.ContainsKey(\"5\")Then";
if (mostCurrent._kvs4._containskey("5")) { 
 //BA.debugLineNum = 427;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 428;BA.debugLine="Activity.Color=c6";
mostCurrent._activity.setColor(_c6);
 }else {
 };
 //BA.debugLineNum = 433;BA.debugLine="If kvs4.ContainsKey(\"6\")Then";
if (mostCurrent._kvs4._containskey("6")) { 
 //BA.debugLineNum = 434;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 435;BA.debugLine="Activity.Color=c7";
mostCurrent._activity.setColor(_c7);
 }else {
 };
 //BA.debugLineNum = 439;BA.debugLine="If kvs4.ContainsKey(\"7\")Then";
if (mostCurrent._kvs4._containskey("7")) { 
 //BA.debugLineNum = 440;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 441;BA.debugLine="Activity.Color=c8";
...
mostCurrent._activity.setColor(_c9);
 ...
 //BA.debugLineNum = 451;BA.debugLine="If kvs4.ContainsKey(\"9\")Then";
if (mostCurrent._kvs4._containskey("9")) { 
 //BA.debugLineNum = 452;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 453;BA.debugLine="Activity.Color=c10";
mostCurrent._activity.setColor(_c10);
 }else {
 };
 //BA.debugLineNum = 457;BA.debugLine="If kvs4.ContainsKey(\"10\")Then";
if (mostCurrent._kvs4._containskey("10")) { 
 //BA.debugLineNum = 458;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 459;BA.debugLine="Activity.Color=c11";
...
mostCurrent._activity.setColor(_c12);
 ...
 //BA.debugLineNum = 469;BA.debugLine="If kvs4.ContainsKey(\"12\")Then";
if (mostCurrent._kvs4._containskey("12")) { 
 //BA.debugLineNum = 470;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 471;BA.debugLine="Activity.Color=c13";
mostCurrent._activity.setColor(_c13);
 }else {
 };
 //BA.debugLineNum = 475;BA.debugLine="If kvs4.ContainsKey(\"13\")Then";
if (mostCurrent._kvs4._containskey("13")) { 
 //BA.debugLineNum = 476;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 477;BA.debugLine="Activity.Color=c14";
mostCurrent._activity.setColor(_c14);
 }else {
 };
 //BA.debugLineNum = 481;BA.debugLine="If kvs4.ContainsKey(\"14\")Then";
if (mostCurrent._kvs4._containskey("14")) { 
 //BA.debugLineNum = 482;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 483;BA.debugLine="Activity.Color=c15";
mostCurrent._activity.setColor(_c15);
 }else {
 };
 //BA.debugLineNum = 487;BA.debugLine="Activity.Invalidate";
mostCurrent._activity.Invalidate();
...
public static String  _t1_tick() throws Exception{
 ...
 //BA.debugLineNum = 149;BA.debugLine="count=count+1";
_count = (int) (_count+1);
 //BA.debugLineNum = 150;BA.debugLine="If count = 100 Then";
if (_count==100) { 
 //BA.debugLineNum = 151;BA.debugLine="Log(\"200\")";
anywheresoftware.b4a.keywords.Common.Log("200");
 //BA.debugLineNum = 152;BA.debugLine="ToastMessageShow(\"lade neue werte...\",False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("lade neue werte..."),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 153;BA.debugLine="c_start";
_c_start();
 };
