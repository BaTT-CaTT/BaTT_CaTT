...
public static String  _acbutton1_click() throws Exception{
 //BA.debugLineNum = 255;BA.debugLine="Sub ACButton1_Click";
 //BA.debugLineNum = 256;BA.debugLine="graph_clear";
_graph_clear();
 //BA.debugLineNum = 257;BA.debugLine="End Sub";
return "";
}
public static String  _acbutton2_click() throws Exception{
 //BA.debugLineNum = 382;BA.debugLine="Sub ACButton2_Click";
 //BA.debugLineNum = 383;BA.debugLine="ccl_click";
_ccl_click();
...
anywheresoftware.b4a.objects.drawable.BitmapDrawable _bd1 = null;
 ...
 //BA.debugLineNum = 50;BA.debugLine="Activity.LoadLayout(\"2\")";
mostCurrent._activity.LoadLayout("2",mostCurrent.activityBA);
 //BA.debugLineNum = 51;BA.debugLine="Activity.Title=pak1.GetApplicationLabel(\"com.batc";
mostCurrent._activity.setTitle(BA.ObjectToCharSequence(mostCurrent._pak1.GetApplicationLabel("com.batcat")+" - "+mostCurrent._pak1.GetVersionName("com.batcat")));
 //BA.debugLineNum = 52;BA.debugLine="Activity.AddMenuItem(\"Clear Stats\",\"ccl\")";
mostCurrent._activity.AddMenuItem(BA.ObjectToCharSequence("Clear Stats"),"ccl");
 //BA.debugLineNum = 53;BA.debugLine="Activity.AddMenuItem(\"Exit\",\"cl\")";
mostCurrent._activity.AddMenuItem(BA.ObjectToCharSequence("Exit"),"cl");
 //BA.debugLineNum = 54;BA.debugLine="suc.Initialize";
...
mostCurrent._l1.Initialize(mostCurrent.activityBA,"l1");
 //BA.debugLineNum = 56;BA.debugLine="l2.Initialize(\"l2\")";
mostCurrent._l2.Initialize(mostCurrent.activityBA,"l2");
 //BA.debugLineNum = 57;BA.debugLine="l3.Initialize(\"l3\")";
mostCurrent._l3.Initialize(mostCurrent.activityBA,"l3");
 //BA.debugLineNum = 59;BA.debugLine="c1=mcl.md_light_blue_A700";
_c1 = mostCurrent._mcl.getmd_light_blue_A700();
 //BA.debugLineNum = 60;BA.debugLine="c2=mcl.md_amber_A700";
_c2 = mostCurrent._mcl.getmd_amber_A700();
 //BA.debugLineNum = 61;BA.debugLine="c3=mcl.md_lime_A700";
_c3 = mostCurrent._mcl.getmd_lime_A700();
 //BA.debugLineNum = 62;BA.debugLine="c4=mcl.md_teal_A700";
_c4 = mostCurrent._mcl.getmd_teal_A700();
 //BA.debugLineNum = 63;BA.debugLine="Activity.Color=c1";
mostCurrent._activity.setColor(_c1);
 //BA.debugLineNum = 66;BA.debugLine="dev.Initialize(\"dev\")";
mostCurrent._dev.Initialize(processBA,"dev");
 //BA.debugLineNum = 69;BA.debugLine="m.Initialize";
mostCurrent._m.Initialize();
 //BA.debugLineNum = 70;BA.debugLine="bat.Initialize";
mostCurrent._bat._initialize(processBA);
 //BA.debugLineNum = 72;BA.debugLine="kl.Initialize";
mostCurrent._kl.Initialize();
 //BA.debugLineNum = 73;BA.debugLine="dt.Initialize";
mostCurrent._dt.Initialize();
 //BA.debugLineNum = 74;BA.debugLine="ls.Initialize";
mostCurrent._ls.Initialize();
 //BA.debugLineNum = 75;BA.debugLine="l1=ListView1.SingleLineLayout.Label";
mostCurrent._l1 = mostCurrent._listview1.getSingleLineLayout().Label;
 //BA.debugLineNum = 76;BA.debugLine="l1.TextSize=15";
mostCurrent._l1.setTextSize((float) (15));
 //BA.debugLineNum = 77;BA.debugLine="l1.TextColor=Colors.White";
mostCurrent._l1.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 78;BA.debugLine="l2=ListView1.TwoLinesLayout.Label";
mostCurrent._l2 = mostCurrent._listview1.getTwoLinesLayout().Label;
 //BA.debugLineNum = 79;BA.debugLine="l3=ListView1.TwoLinesLayout.SecondLabel";
mostCurrent._l3 = mostCurrent._listview1.getTwoLinesLayout().SecondLabel;
 //BA.debugLineNum = 80;BA.debugLine="l2.TextSize=18";
mostCurrent._l2.setTextSize((float) (18));
 //BA.debugLineNum = 81;BA.debugLine="l3.TextSize=12";
mostCurrent._l3.setTextSize((float) (12));
 //BA.debugLineNum = 82;BA.debugLine="l2.TextColor=Colors.Black";
mostCurrent._l2.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 83;BA.debugLine="l3.TextColor=Colors.Cyan";
mostCurrent._l3.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Cyan);
 //BA.debugLineNum = 84;BA.debugLine="ListView1.SingleLineLayout.ItemHeight=90";
mostCurrent._listview1.getSingleLineLayout().setItemHeight((int) (90));
 //BA.debugLineNum = 85;BA.debugLine="volt=bat.BatteryInformation(7)/1000";
mostCurrent._volt = BA.NumberToString(mostCurrent._bat._getbatteryinformation()[(int) (7)]/(double)1000);
 //BA.debugLineNum = 86;BA.debugLine="temp=bat.BatteryInformation(6)/10";
mostCurrent._temp = BA.NumberToString(mostCurrent._bat._getbatteryinformation()[(int) (6)]/(double)10);
 //BA.debugLineNum = 87;BA.debugLine="usb =bat.BatteryInformation(9)";
mostCurrent._usb = BA.NumberToString(mostCurrent._bat._getbatteryinformation()[(int) (9)]);
 //BA.debugLineNum = 88;BA.debugLine="ac =bat.BatteryInformation(8)";
...
mostCurrent._g.Initialize();
 //BA.debugLineNum = 91;BA.debugLine="Dim la,la1,la2 As Label";
...
_la2 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 92;BA.debugLine="la.Initialize(\"la\")";
_la.Initialize(mostCurrent.activityBA,"la");
 //BA.debugLineNum = 93;BA.debugLine="la1.Initialize(\"la1\")";
_la1.Initialize(mostCurrent.activityBA,"la1");
 //BA.debugLineNum = 94;BA.debugLine="la2.Initialize(\"la2\")";
_la2.Initialize(mostCurrent.activityBA,"la2");
 //BA.debugLineNum = 95;BA.debugLine="la2=ListView1.TwoLinesLayout.SecondLabel";
_la2 = mostCurrent._listview1.getTwoLinesLayout().SecondLabel;
 //BA.debugLineNum = 96;BA.debugLine="la2.TextSize=11";
_la2.setTextSize((float) (11));
 //BA.debugLineNum = 97;BA.debugLine="la2.TextColor=Colors.ARGB(240,255,255,255)";
_la2.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (240),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 98;BA.debugLine="la1=ListView1.TwoLinesAndBitmap.SecondLabel";
_la1 = mostCurrent._listview1.getTwoLinesAndBitmap().SecondLabel;
 //BA.debugLineNum = 99;BA.debugLine="la1.TextSize=10";
_la1.setTextSize((float) (10));
 //BA.debugLineNum = 100;BA.debugLine="la1.TextColor=Colors.LightGray";
_la1.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.LightGray);
 //BA.debugLineNum = 101;BA.debugLine="ListView1.TwoLinesAndBitmap.ImageView.Height=32di";
mostCurrent._listview1.getTwoLinesAndBitmap().ImageView.setHeight(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (32)));
 //BA.debugLineNum = 102;BA.debugLine="ListView1.TwoLinesAndBitmap.ImageView.Width=32dip";
mostCurrent._listview1.getTwoLinesAndBitmap().ImageView.setWidth(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (32)));
 //BA.debugLineNum = 103;BA.debugLine="ListView1.TwoLinesAndBitmap.ItemHeight=50dip";
mostCurrent._listview1.getTwoLinesAndBitmap().setItemHeight(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50)));
 //BA.debugLineNum = 104;BA.debugLine="If FirstTime=True Then";
if (_firsttime==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 105;BA.debugLine="Msgbox(\"Wenn die Statistik zum ersten Mal gelade";
...
mostCurrent._kvsvolt._initialize(processBA,anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal(),"datastore_volt");
 //BA.debugLineNum = 111;BA.debugLine="kvstemp.Initialize(File.DirDefaultExternal, \"data";
mostCurrent._kvstemp._initialize(processBA,anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal(),"datastore_temp");
 //BA.debugLineNum = 112;BA.debugLine="time2=DateTime.Time(DateTime.Now)";
...
mostCurrent._pl = anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Battery Icons - White 64px (28).png");
 //BA.debugLineNum = 116;BA.debugLine="popa.Initialize(\"popa\",Panel2)";
...
_bd1 = new anywheresoftware.b4a.objects.drawable.BitmapDrawable();
 //BA.debugLineNum = 118;BA.debugLine="bd.Initialize(LoadBitmap(File.DirAssets,\"ic_clear";
_bd.Initialize((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_clear_black_48dp.png").getObject()));
 //BA.debugLineNum = 119;BA.debugLine="bd1.Initialize(LoadBitmap(File.DirAssets,\"ic_auto";
...
mostCurrent._popa.AddMenuItem((int) (1),BA.ObjectToCharSequence("Schließen"),(android.graphics.drawable.Drawable)(_bd.getObject()));
 //BA.debugLineNum = 124;BA.debugLine="store_check";
_store_check();
...
mostCurrent._activity.Finish();
 //BA.debugLineNum = 243;BA.debugLine="ToastMessageShow(\"BCT - Backround  Statistic sta";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("BCT - Backround  Statistic started.."),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 244;BA.debugLine="SetAnimation.setanimati(\"extra_in\", \"extra_out\"";
...
_c_start();
 //BA.debugLineNum = 131;BA.debugLine="store_check";
_store_check();
 //BA.debugLineNum = 132;BA.debugLine="End Sub";
return "";
}
public static String  _c_start() throws Exception{
 //BA.debugLineNum = 172;BA.debugLine="Sub c_start";
 //BA.debugLineNum = 173;BA.debugLine="If kvs2.IsInitialized Then";
if (mostCurrent._kvs2.IsInitialized()) { 
 //BA.debugLineNum = 174;BA.debugLine="Log(\"KVS -> true\")";
anywheresoftware.b4a.keywords.Common.Log("KVS -> true");
 }else {
 //BA.debugLineNum = 177;BA.debugLine="kvs2.Initialize(File.DirDefaultExternal, \"datast";
mostCurrent._kvs2._initialize(processBA,anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal(),"datastore_2");
 //BA.debugLineNum = 178;BA.debugLine="kvs3.Initialize(File.DirDefaultExternal, \"datast";
mostCurrent._kvs3._initialize(processBA,anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal(),"datastore_3");
 //BA.debugLineNum = 179;BA.debugLine="kvsvolt.Initialize(File.DirDefaultExternal, \"dat";
mostCurrent._kvsvolt._initialize(processBA,anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal(),"datastore_volt");
 //BA.debugLineNum = 180;BA.debugLine="kvstemp.Initialize(File.DirDefaultExternal, \"dat";
mostCurrent._kvstemp._initialize(processBA,anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal(),"datastore_temp");
 };
 //BA.debugLineNum = 183;BA.debugLine="get_log";
_get_log();
 //BA.debugLineNum = 184;BA.debugLine="chart_start";
_chart_start();
 //BA.debugLineNum = 185;BA.debugLine="End Sub";
return "";
}
public static String  _ccl_click() throws Exception{
 //BA.debugLineNum = 147;BA.debugLine="Sub ccl_click";
 //BA.debugLineNum = 149;BA.debugLine="volt=bat.BatteryInformation(7)";
mostCurrent._volt = BA.NumberToString(mostCurrent._bat._getbatteryinformation()[(int) (7)]);
 //BA.debugLineNum = 150;BA.debugLine="temp=bat.BatteryInformation(6)";
mostCurrent._temp = BA.NumberToString(mostCurrent._bat._getbatteryinformation()[(int) (6)]);
 //BA.debugLineNum = 152;BA.debugLine="kvstemp.DeleteAll";
mostCurrent._kvstemp._deleteall();
 //BA.debugLineNum = 153;BA.debugLine="kvsvolt.DeleteAll";
mostCurrent._kvsvolt._deleteall();
 //BA.debugLineNum = 155;BA.debugLine="kvstemp.PutSimple(temp,time2)";
mostCurrent._kvstemp._putsimple(mostCurrent._temp,(Object)(mostCurrent._time2));
 //BA.debugLineNum = 156;BA.debugLine="kvsvolt.PutSimple(volt,time2)";
mostCurrent._kvsvolt._putsimple(mostCurrent._volt,(Object)(mostCurrent._time2));
 //BA.debugLineNum = 157;BA.debugLine="ToastMessageShow(\"warte auf Aktuelle werte..!\",Fa";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("warte auf Aktuelle werte..!"),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 158;BA.debugLine="Log(kvs2.ListKeys&\" - clear\")";
anywheresoftware.b4a.keywords.Common.Log(BA.ObjectToString(mostCurrent._kvs2._listkeys())+" - clear");
 //BA.debugLineNum = 159;BA.debugLine="c_start";
_c_start();
 //BA.debugLineNum = 160;BA.debugLine="get_log";
_get_log();
...
String _h = "";
 //BA.debugLineNum = 207;BA.debugLine="Sub chart_start";
 //BA.debugLineNum = 208;BA.debugLine="level=bat.BatteryInformation(0)";
_level = mostCurrent._bat._getbatteryinformation()[(int) (0)];
 //BA.debugLineNum = 209;BA.debugLine="Dim fn As String";
_fn = "";
 //BA.debugLineNum = 210;BA.debugLine="Dim fg As Int";
_fg = 0;
 //BA.debugLineNum = 212;BA.debugLine="g.Initialize";
mostCurrent._g.Initialize();
 //BA.debugLineNum = 213;BA.debugLine="level=bat.BatteryInformation(0)";
_level = mostCurrent._bat._getbatteryinformation()[(int) (0)];
 //BA.debugLineNum = 214;BA.debugLine="Dim fn As String";
_fn = "";
 //BA.debugLineNum = 215;BA.debugLine="Dim fg As Int";
_fg = 0;
 //BA.debugLineNum = 216;BA.debugLine="Dim LD As LineData";
_ld = new com.batcat.charts._linedata();
 //BA.debugLineNum = 217;BA.debugLine="LD.Initialize";
_ld.Initialize();
 //BA.debugLineNum = 218;BA.debugLine="LD.Target =Panel2";
_ld.Target = mostCurrent._panel2;
 //BA.debugLineNum = 219;BA.debugLine="Charts.AddLineColor(LD, Colors.Red) 'First line c";
mostCurrent._charts._addlinecolor(mostCurrent.activityBA,_ld,anywheresoftware.b4a.keywords.Common.Colors.Red);
 //BA.debugLineNum = 220;BA.debugLine="Charts.AddLineColor(LD, Colors.Blue) 'Second line";
mostCurrent._charts._addlinecolor(mostCurrent.activityBA,_ld,anywheresoftware.b4a.keywords.Common.Colors.Blue);
 //BA.debugLineNum = 221;BA.debugLine="For Each h As String  In kvs2.ListKeys";
...
_h = BA.ObjectToString(group13.Get(index13));
 //BA.debugLineNum = 222;BA.debugLine="fg=h";
_fg = (int)(Double.parseDouble(_h));
 //BA.debugLineNum = 223;BA.debugLine="fn=kvs2.GetSimple(h)";
_fn = mostCurrent._kvs2._getsimple(_h);
 //BA.debugLineNum = 224;BA.debugLine="Log(\"Map Key-> \"&fg)";
anywheresoftware.b4a.keywords.Common.Log("Map Key-> "+BA.NumberToString(_fg));
 //BA.debugLineNum = 226;BA.debugLine="Charts.AddLinePoint(LD, fn,fg, True)";
mostCurrent._charts._addlinepoint(mostCurrent.activityBA,_ld,_fn,(float) (_fg),anywheresoftware.b4a.keywords.Common.True);
 }
;
 //BA.debugLineNum = 229;BA.debugLine="G.Title = \"BCT Power Chart\"";
mostCurrent._g.Title = "BCT Power Chart";
 //BA.debugLineNum = 230;BA.debugLine="G.XAxis = time2";
mostCurrent._g.XAxis = mostCurrent._time2;
 //BA.debugLineNum = 231;BA.debugLine="G.YAxis = \"Level:\"";
mostCurrent._g.YAxis = "Level:";
 //BA.debugLineNum = 232;BA.debugLine="G.YStart = 0";
mostCurrent._g.YStart = (float) (0);
 //BA.debugLineNum = 233;BA.debugLine="G.YEnd = 100";
mostCurrent._g.YEnd = (float) (100);
 //BA.debugLineNum = 234;BA.debugLine="G.YInterval = 5";
mostCurrent._g.YInterval = (float) (5);
 //BA.debugLineNum = 235;BA.debugLine="G.AxisColor = Colors.White";
mostCurrent._g.AxisColor = anywheresoftware.b4a.keywords.Common.Colors.White;
 //BA.debugLineNum = 237;BA.debugLine="Charts.DrawLineChart(G, LD, Colors.Transparent)";
...
public static String  _db_update() throws Exception{
 //BA.debugLineNum = 249;BA.debugLine="Sub db_update";
...
int _v = 0;
 //BA.debugLineNum = 260;BA.debugLine="Sub dev_BatteryChanged (level1 As Int, Scale As In";
 //BA.debugLineNum = 261;BA.debugLine="Dim vl As List";
_vl = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 262;BA.debugLine="vl.Initialize";
_vl.Initialize();
 //BA.debugLineNum = 263;BA.debugLine="For v = 0 To Scale Step 2";
{
final int step3 = (int) (2);
final int limit3 = _scale;
for (_v = (int) (0) ; (step3 > 0 && _v <= limit3) || (step3 < 0 && _v >= limit3); _v = ((int)(0 + _v + step3)) ) {
 //BA.debugLineNum = 264;BA.debugLine="vl.Add(v)";
_vl.Add((Object)(_v));
 //BA.debugLineNum = 265;BA.debugLine="If level1=v Then";
if (_level1==_v) { 
 //BA.debugLineNum = 266;BA.debugLine="store_check";
_store_check();
 //BA.debugLineNum = 267;BA.debugLine="c_start";
_c_start();
 };
 }
};
...
String _h = "";
String _t = "";
 //BA.debugLineNum = 188;BA.debugLine="Sub get_log";
 //BA.debugLineNum = 189;BA.debugLine="If ListView1.Size>5 Then";
if (mostCurrent._listview1.getSize()>5) { 
 //BA.debugLineNum = 190;BA.debugLine="ListView1.Clear";
mostCurrent._listview1.Clear();
 };
 //BA.debugLineNum = 192;BA.debugLine="Dim tm,vm As String";
_tm = "";
_vm = "";
 //BA.debugLineNum = 194;BA.debugLine="For Each h As String   In  kvsvolt.ListKeys";
final anywheresoftware.b4a.BA.IterableList group5 = mostCurrent._kvsvolt._listkeys();
final int groupLen5 = group5.getSize();
for (int index5 = 0;index5 < groupLen5 ;index5++){
_h = BA.ObjectToString(group5.Get(index5));
 //BA.debugLineNum = 195;BA.debugLine="Log(h)";
anywheresoftware.b4a.keywords.Common.Log(_h);
 //BA.debugLineNum = 196;BA.debugLine="For Each t As String In kvstemp.ListKeys";
...
_t = BA.ObjectToString(group7.Get(index7));
 //BA.debugLineNum = 198;BA.debugLine="Log(t)";
anywheresoftware.b4a.keywords.Common.Log(_t);
 //BA.debugLineNum = 199;BA.debugLine="tm=kvstemp.GetSimple(t)";
_tm = mostCurrent._kvstemp._getsimple(_t);
 //BA.debugLineNum = 200;BA.debugLine="ListView1.AddTwoLinesAndBitmap(\"@: \"&tm,\"Temp: \"";
mostCurrent._listview1.AddTwoLinesAndBitmap(BA.ObjectToCharSequence("@: "+_tm),BA.ObjectToCharSequence("Temp: "+_t+"C° | Volt: "+_h+"V"),(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Bar-chart48.png").getObject()));
 }
;
 }
;
...
public static String  _graph_clear() throws Exception{
 //BA.debugLineNum = 163;BA.debugLine="Sub graph_clear";
 //BA.debugLineNum = 164;BA.debugLine="kvs2.DeleteAll";
mostCurrent._kvs2._deleteall();
 //BA.debugLineNum = 165;BA.debugLine="level  = bat.BatteryInformation(0)";
_level = mostCurrent._bat._getbatteryinformation()[(int) (0)];
 //BA.debugLineNum = 166;BA.debugLine="Log(\"put-> \"&level&\"%\")";
anywheresoftware.b4a.keywords.Common.Log("put-> "+BA.NumberToString(_level)+"%");
 //BA.debugLineNum = 167;BA.debugLine="kvs2.PutSimple(level,time2)";
mostCurrent._kvs2._putsimple(BA.NumberToString(_level),(Object)(mostCurrent._time2));
 //BA.debugLineNum = 168;BA.debugLine="ToastMessageShow(\"warte auf Aktuelle werte..!\",Fa";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("warte auf Aktuelle werte..!"),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 169;BA.debugLine="c_start";
_c_start();
 //BA.debugLineNum = 170;BA.debugLine="End Sub";
return "";
}
public static String  _popa_itemclicked(de.amberhome.objects.appcompat.ACMenuItemWrapper _item) throws Exception{
 //BA.debugLineNum = 138;BA.debugLine="Sub popa_ItemClicked (Item As ACMenuItem)";
 //BA.debugLineNum = 139;BA.debugLine="If Item = popa.GetItem(0) Then";
if ((_item).equals((android.view.MenuItem)(mostCurrent._popa.GetItem((int) (0))))) { 
 //BA.debugLineNum = 140;BA.debugLine="ACButton1_Click";
_acbutton1_click();
 };
 //BA.debugLineNum = 142;BA.debugLine="If Item = popa.GetItem(1) Then";
...
public static String  _store_check() throws Exception{
 //BA.debugLineNum = 274;BA.debugLine="Sub store_check";
 //BA.debugLineNum = 275;BA.debugLine="c1=mcl.md_light_blue_A700";
_c1 = mostCurrent._mcl.getmd_light_blue_A700();
 //BA.debugLineNum = 276;BA.debugLine="c2=mcl.md_amber_A700";
_c2 = mostCurrent._mcl.getmd_amber_A700();
 //BA.debugLineNum = 277;BA.debugLine="c3=mcl.md_white_1000";
_c3 = mostCurrent._mcl.getmd_white_1000();
 //BA.debugLineNum = 278;BA.debugLine="c4=mcl.md_teal_A700";
_c4 = mostCurrent._mcl.getmd_teal_A700();
 //BA.debugLineNum = 279;BA.debugLine="c5=mcl.md_deep_purple_A700";
_c5 = mostCurrent._mcl.getmd_deep_purple_A700();
 //BA.debugLineNum = 280;BA.debugLine="c6=mcl.md_red_A700";
_c6 = mostCurrent._mcl.getmd_red_A700();
 //BA.debugLineNum = 281;BA.debugLine="c7=mcl.md_indigo_A700";
_c7 = mostCurrent._mcl.getmd_indigo_A700();
 //BA.debugLineNum = 282;BA.debugLine="c8=mcl.md_blue_A700";
_c8 = mostCurrent._mcl.getmd_blue_A700();
 //BA.debugLineNum = 283;BA.debugLine="c9=mcl.md_orange_A700";
_c9 = mostCurrent._mcl.getmd_orange_A700();
 //BA.debugLineNum = 284;BA.debugLine="c10=mcl.md_grey_700";
_c10 = mostCurrent._mcl.getmd_grey_700();
 //BA.debugLineNum = 285;BA.debugLine="c11=mcl.md_green_A700";
_c11 = mostCurrent._mcl.getmd_green_A700();
 //BA.debugLineNum = 286;BA.debugLine="c12=mcl.md_black_1000";
_c12 = mostCurrent._mcl.getmd_black_1000();
 //BA.debugLineNum = 287;BA.debugLine="c13=mcl.md_yellow_A700";
_c13 = mostCurrent._mcl.getmd_yellow_A700();
 //BA.debugLineNum = 288;BA.debugLine="c14=mcl.md_cyan_A700";
_c14 = mostCurrent._mcl.getmd_cyan_A700();
 //BA.debugLineNum = 289;BA.debugLine="c15=mcl.md_blue_grey_700";
_c15 = mostCurrent._mcl.getmd_blue_grey_700();
 //BA.debugLineNum = 290;BA.debugLine="c16=mcl.md_light_blue_A700";
_c16 = mostCurrent._mcl.getmd_light_blue_A700();
 //BA.debugLineNum = 291;BA.debugLine="If kvs4.ContainsKey(\"0\")Then";
if (mostCurrent._kvs4._containskey("0")) { 
 //BA.debugLineNum = 292;BA.debugLine="Log(\"AC_true->1\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->1");
 //BA.debugLineNum = 293;BA.debugLine="Activity.Color=c1";
mostCurrent._activity.setColor(_c1);
 };
 //BA.debugLineNum = 295;BA.debugLine="If kvs4.ContainsKey(\"1\")Then";
if (mostCurrent._kvs4._containskey("1")) { 
 //BA.debugLineNum = 296;BA.debugLine="Log(\"AC_true->2\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->2");
 //BA.debugLineNum = 297;BA.debugLine="Activity.Color=c2";
mostCurrent._activity.setColor(_c2);
 }else {
 };
 //BA.debugLineNum = 301;BA.debugLine="If kvs4.ContainsKey(\"2\")Then";
if (mostCurrent._kvs4._containskey("2")) { 
 //BA.debugLineNum = 302;BA.debugLine="Log(\"AC_true->3\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->3");
 //BA.debugLineNum = 303;BA.debugLine="Activity.Color=c3";
mostCurrent._activity.setColor(_c3);
 }else {
 };
 //BA.debugLineNum = 307;BA.debugLine="If kvs4.ContainsKey(\"3\")Then";
...
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 309;BA.debugLine="Activity.Color=c4";
mostCurrent._activity.setColor(_c4);
 }else {
 };
 //BA.debugLineNum = 313;BA.debugLine="If kvs4.ContainsKey(\"4\")Then";
if (mostCurrent._kvs4._containskey("4")) { 
 //BA.debugLineNum = 314;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 315;BA.debugLine="Activity.Color=c5";
mostCurrent._activity.setColor(_c5);
 }else {
 };
 //BA.debugLineNum = 319;BA.debugLine="If kvs4.ContainsKey(\"5\")Then";
if (mostCurrent._kvs4._containskey("5")) { 
 //BA.debugLineNum = 320;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 321;BA.debugLine="Activity.Color=c6";
mostCurrent._activity.setColor(_c6);
 }else {
 };
 //BA.debugLineNum = 325;BA.debugLine="If kvs4.ContainsKey(\"6\")Then";
if (mostCurrent._kvs4._containskey("6")) { 
 //BA.debugLineNum = 326;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 327;BA.debugLine="Activity.Color=c7";
mostCurrent._activity.setColor(_c7);
 }else {
 };
 //BA.debugLineNum = 331;BA.debugLine="If kvs4.ContainsKey(\"7\")Then";
if (mostCurrent._kvs4._containskey("7")) { 
 //BA.debugLineNum = 332;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 333;BA.debugLine="Activity.Color=c8";
mostCurrent._activity.setColor(_c8);
 }else {
 };
 //BA.debugLineNum = 337;BA.debugLine="If kvs4.ContainsKey(\"8\")Then";
if (mostCurrent._kvs4._containskey("8")) { 
 //BA.debugLineNum = 338;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 339;BA.debugLine="Activity.Color=c9";
mostCurrent._activity.setColor(_c9);
 }else {
 };
 //BA.debugLineNum = 343;BA.debugLine="If kvs4.ContainsKey(\"9\")Then";
if (mostCurrent._kvs4._containskey("9")) { 
 //BA.debugLineNum = 344;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 345;BA.debugLine="Activity.Color=c10";
mostCurrent._activity.setColor(_c10);
 }else {
 };
 //BA.debugLineNum = 349;BA.debugLine="If kvs4.ContainsKey(\"10\")Then";
if (mostCurrent._kvs4._containskey("10")) { 
 //BA.debugLineNum = 350;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 351;BA.debugLine="Activity.Color=c11";
mostCurrent._activity.setColor(_c11);
 }else {
 };
 //BA.debugLineNum = 355;BA.debugLine="If kvs4.ContainsKey(\"11\")Then";
if (mostCurrent._kvs4._containskey("11")) { 
 //BA.debugLineNum = 356;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 357;BA.debugLine="Activity.Color=c12";
mostCurrent._activity.setColor(_c12);
 }else {
 };
 //BA.debugLineNum = 361;BA.debugLine="If kvs4.ContainsKey(\"12\")Then";
if (mostCurrent._kvs4._containskey("12")) { 
 //BA.debugLineNum = 362;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 363;BA.debugLine="Activity.Color=c13";
mostCurrent._activity.setColor(_c13);
 }else {
 };
 //BA.debugLineNum = 367;BA.debugLine="If kvs4.ContainsKey(\"13\")Then";
if (mostCurrent._kvs4._containskey("13")) { 
 //BA.debugLineNum = 368;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 369;BA.debugLine="Activity.Color=c14";
mostCurrent._activity.setColor(_c14);
 }else {
 };
 //BA.debugLineNum = 373;BA.debugLine="If kvs4.ContainsKey(\"14\")Then";
if (mostCurrent._kvs4._containskey("14")) { 
 //BA.debugLineNum = 374;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 375;BA.debugLine="Activity.Color=c15";
mostCurrent._activity.setColor(_c15);
 }else {
 };
 //BA.debugLineNum = 379;BA.debugLine="Activity.Invalidate";
