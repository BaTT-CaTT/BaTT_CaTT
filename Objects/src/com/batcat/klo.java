...
public static String  _acbutton1_click() throws Exception{
 //BA.debugLineNum = 363;BA.debugLine="Sub ACButton1_Click";
 //BA.debugLineNum = 364;BA.debugLine="ccl_click";
_ccl_click();
...
anywheresoftware.b4a.objects.drawable.BitmapDrawable _bd1 = null;
 ...
 //BA.debugLineNum = 48;BA.debugLine="Activity.LoadLayout(\"2\")";
mostCurrent._activity.LoadLayout("2",mostCurrent.activityBA);
 //BA.debugLineNum = 49;BA.debugLine="Activity.Title=pak1.GetApplicationLabel(\"com.batc";
mostCurrent._activity.setTitle(BA.ObjectToCharSequence(mostCurrent._pak1.GetApplicationLabel("com.batcat")+" - "+mostCurrent._pak1.GetVersionName("com.batcat")));
 //BA.debugLineNum = 50;BA.debugLine="Activity.AddMenuItem(\"Clear Stats\",\"ccl\")";
mostCurrent._activity.AddMenuItem(BA.ObjectToCharSequence("Clear Stats"),"ccl");
 //BA.debugLineNum = 51;BA.debugLine="Activity.AddMenuItem(\"Exit\",\"cl\")";
mostCurrent._activity.AddMenuItem(BA.ObjectToCharSequence("Exit"),"cl");
 //BA.debugLineNum = 52;BA.debugLine="suc.Initialize";
mostCurrent._suc.Initialize();
 //BA.debugLineNum = 53;BA.debugLine="l1.Initialize(\"l1\")";
mostCurrent._l1.Initialize(mostCurrent.activityBA,"l1");
 //BA.debugLineNum = 54;BA.debugLine="l2.Initialize(\"l2\")";
mostCurrent._l2.Initialize(mostCurrent.activityBA,"l2");
 //BA.debugLineNum = 55;BA.debugLine="l3.Initialize(\"l3\")";
mostCurrent._l3.Initialize(mostCurrent.activityBA,"l3");
 //BA.debugLineNum = 57;BA.debugLine="c1=mcl.md_light_blue_A700";
_c1 = mostCurrent._mcl.getmd_light_blue_A700();
 //BA.debugLineNum = 58;BA.debugLine="c2=mcl.md_amber_A700";
_c2 = mostCurrent._mcl.getmd_amber_A700();
 //BA.debugLineNum = 59;BA.debugLine="c3=mcl.md_lime_A700";
_c3 = mostCurrent._mcl.getmd_lime_A700();
 //BA.debugLineNum = 60;BA.debugLine="c4=mcl.md_teal_A700";
_c4 = mostCurrent._mcl.getmd_teal_A700();
 //BA.debugLineNum = 61;BA.debugLine="Activity.Color=c1";
mostCurrent._activity.setColor(_c1);
 //BA.debugLineNum = 64;BA.debugLine="dev.Initialize(\"dev\")";
mostCurrent._dev.Initialize(processBA,"dev");
 //BA.debugLineNum = 67;BA.debugLine="m.Initialize";
mostCurrent._m.Initialize();
 //BA.debugLineNum = 68;BA.debugLine="bat.Initialize";
mostCurrent._bat._initialize(processBA);
 //BA.debugLineNum = 70;BA.debugLine="kl.Initialize";
mostCurrent._kl.Initialize();
 //BA.debugLineNum = 71;BA.debugLine="dt.Initialize";
mostCurrent._dt.Initialize();
 //BA.debugLineNum = 72;BA.debugLine="ls.Initialize";
mostCurrent._ls.Initialize();
 //BA.debugLineNum = 73;BA.debugLine="l1=ListView1.SingleLineLayout.Label";
mostCurrent._l1 = mostCurrent._listview1.getSingleLineLayout().Label;
 //BA.debugLineNum = 74;BA.debugLine="l1.TextSize=15";
mostCurrent._l1.setTextSize((float) (15));
 //BA.debugLineNum = 75;BA.debugLine="l1.TextColor=Colors.White";
mostCurrent._l1.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 76;BA.debugLine="l2=ListView1.TwoLinesLayout.Label";
mostCurrent._l2 = mostCurrent._listview1.getTwoLinesLayout().Label;
 //BA.debugLineNum = 77;BA.debugLine="l3=ListView1.TwoLinesLayout.SecondLabel";
mostCurrent._l3 = mostCurrent._listview1.getTwoLinesLayout().SecondLabel;
 //BA.debugLineNum = 78;BA.debugLine="l2.TextSize=18";
mostCurrent._l2.setTextSize((float) (18));
 //BA.debugLineNum = 79;BA.debugLine="l3.TextSize=12";
mostCurrent._l3.setTextSize((float) (12));
 //BA.debugLineNum = 80;BA.debugLine="l2.TextColor=Colors.Black";
mostCurrent._l2.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 81;BA.debugLine="l3.TextColor=Colors.Cyan";
mostCurrent._l3.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Cyan);
 //BA.debugLineNum = 82;BA.debugLine="ListView1.SingleLineLayout.ItemHeight=90";
mostCurrent._listview1.getSingleLineLayout().setItemHeight((int) (90));
 //BA.debugLineNum = 83;BA.debugLine="volt=bat.BatteryInformation(7)/1000";
mostCurrent._volt = BA.NumberToString(mostCurrent._bat._getbatteryinformation()[(int) (7)]/(double)1000);
 //BA.debugLineNum = 84;BA.debugLine="temp=bat.BatteryInformation(6)/10";
mostCurrent._temp = BA.NumberToString(mostCurrent._bat._getbatteryinformation()[(int) (6)]/(double)10);
 //BA.debugLineNum = 85;BA.debugLine="usb =bat.BatteryInformation(9)";
mostCurrent._usb = BA.NumberToString(mostCurrent._bat._getbatteryinformation()[(int) (9)]);
 //BA.debugLineNum = 86;BA.debugLine="ac =bat.BatteryInformation(8)";
...
mostCurrent._g.Initialize();
 //BA.debugLineNum = 89;BA.debugLine="Dim la,la1,la2 As Label";
...
_la2 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 90;BA.debugLine="la.Initialize(\"la\")";
_la.Initialize(mostCurrent.activityBA,"la");
 //BA.debugLineNum = 91;BA.debugLine="la1.Initialize(\"la1\")";
_la1.Initialize(mostCurrent.activityBA,"la1");
 //BA.debugLineNum = 92;BA.debugLine="la2.Initialize(\"la2\")";
_la2.Initialize(mostCurrent.activityBA,"la2");
 //BA.debugLineNum = 93;BA.debugLine="la2=ListView1.TwoLinesLayout.SecondLabel";
_la2 = mostCurrent._listview1.getTwoLinesLayout().SecondLabel;
 //BA.debugLineNum = 94;BA.debugLine="la2.TextSize=11";
_la2.setTextSize((float) (11));
 //BA.debugLineNum = 95;BA.debugLine="la2.TextColor=Colors.ARGB(240,255,255,255)";
_la2.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (240),(int) (255),(int) (255),(int) (255)));
 //BA.debugLineNum = 96;BA.debugLine="la1=ListView1.TwoLinesAndBitmap.SecondLabel";
_la1 = mostCurrent._listview1.getTwoLinesAndBitmap().SecondLabel;
 //BA.debugLineNum = 97;BA.debugLine="la1.TextSize=10";
_la1.setTextSize((float) (10));
 //BA.debugLineNum = 98;BA.debugLine="la1.TextColor=Colors.LightGray";
_la1.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.LightGray);
 //BA.debugLineNum = 99;BA.debugLine="ListView1.TwoLinesAndBitmap.ImageView.Height=32di";
mostCurrent._listview1.getTwoLinesAndBitmap().ImageView.setHeight(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (32)));
 //BA.debugLineNum = 100;BA.debugLine="ListView1.TwoLinesAndBitmap.ImageView.Width=32dip";
mostCurrent._listview1.getTwoLinesAndBitmap().ImageView.setWidth(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (32)));
 //BA.debugLineNum = 101;BA.debugLine="ListView1.TwoLinesAndBitmap.ItemHeight=50dip";
mostCurrent._listview1.getTwoLinesAndBitmap().setItemHeight(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50)));
 //BA.debugLineNum = 102;BA.debugLine="If FirstTime=True Then";
if (_firsttime==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 103;BA.debugLine="Msgbox(\"If the statistics is loaded for the firs";
...
mostCurrent._time2 = anywheresoftware.b4a.keywords.Common.DateTime.Time(anywheresoftware.b4a.keywords.Common.DateTime.getNow());
 //BA.debugLineNum = 109;BA.debugLine="batt=LoadBitmap(File.DirAssets,\"Battery Icons - W";
mostCurrent._batt = anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Battery Icons - White 64px (40).png");
 //BA.debugLineNum = 110;BA.debugLine="pl=LoadBitmap(File.DirAssets,\"Battery Icons - Whi";
mostCurrent._pl = anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Battery Icons - White 64px (28).png");
 //BA.debugLineNum = 112;BA.debugLine="popa.Initialize(\"popa\",Panel2)";
mostCurrent._popa.Initialize(mostCurrent.activityBA,"popa",(android.view.View)(mostCurrent._panel2.getObject()));
 //BA.debugLineNum = 113;BA.debugLine="Dim bd,bd1 As BitmapDrawable";
_bd = new anywheresoftware.b4a.objects.drawable.BitmapDrawable();
_bd1 = new anywheresoftware.b4a.objects.drawable.BitmapDrawable();
 //BA.debugLineNum = 114;BA.debugLine="bd.Initialize(LoadBitmap(File.DirAssets,\"ic_clear";
_bd.Initialize((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_clear_black_48dp.png").getObject()));
 //BA.debugLineNum = 115;BA.debugLine="bd1.Initialize(LoadBitmap(File.DirAssets,\"ic_auto";
_bd1.Initialize((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_autorenew_black_48dp.png").getObject()));
 //BA.debugLineNum = 116;BA.debugLine="popa.AddMenuItem(0,\"Reload Stats\",bd1)";
mostCurrent._popa.AddMenuItem((int) (0),BA.ObjectToCharSequence("Reload Stats"),(android.graphics.drawable.Drawable)(_bd1.getObject()));
 //BA.debugLineNum = 117;BA.debugLine="popa.AddMenuItem(1,\"Schließen\",bd)";
mostCurrent._popa.AddMenuItem((int) (1),BA.ObjectToCharSequence("Schließen"),(android.graphics.drawable.Drawable)(_bd.getObject()));
 //BA.debugLineNum = 119;BA.debugLine="store_check";
_store_check();
 //BA.debugLineNum = 120;BA.debugLine="c_start";
_c_start();
 //BA.debugLineNum = 122;BA.debugLine="End Sub";
return "";
}
public static boolean  _activity_keypress(int _keycode) throws Exception{
 //BA.debugLineNum = 242;BA.debugLine="Sub Activity_KeyPress (KeyCode As Int) As Boolean";
...
mostCurrent._activity.Finish();
 //BA.debugLineNum = 245;BA.debugLine="ToastMessageShow(\"BCT - Backround  Statistic sta";
...
public static String  _activity_resume() throws Exception{
 ...
 //BA.debugLineNum = 125;BA.debugLine="c_start";
_c_start();
...
public static String  _bat_acusb() throws Exception{
 //BA.debugLineNum = 181;BA.debugLine="Sub bat_acusb";
 //BA.debugLineNum = 182;BA.debugLine="pk=LoadBitmap(File.DirAssets,\"Battery Icons - Whi";
mostCurrent._pk = anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Battery Icons - White 64px (35).png");
 //BA.debugLineNum = 183;BA.debugLine="If ac=1 Then";
if ((mostCurrent._ac).equals(BA.NumberToString(1))) { 
 //BA.debugLineNum = 184;BA.debugLine="ListView1.AddTwoLinesAndBitmap(\"Bat. AC-Plugged:";
mostCurrent._listview1.AddTwoLinesAndBitmap(BA.ObjectToCharSequence("Bat. AC-Plugged:"),BA.ObjectToCharSequence("@: "+mostCurrent._volt+" V"),(android.graphics.Bitmap)(mostCurrent._pk.getObject()));
 ...
 //BA.debugLineNum = 186;BA.debugLine="If ac = 0 Or usb=0 Then";
if ((mostCurrent._ac).equals(BA.NumberToString(0)) || (mostCurrent._usb).equals(BA.NumberToString(0))) { 
 //BA.debugLineNum = 187;BA.debugLine="ListView1.AddTwoLinesAndbitmap(\"Bat. Discharge:\"";
mostCurrent._listview1.AddTwoLinesAndBitmap(BA.ObjectToCharSequence("Bat. Discharge:"),BA.ObjectToCharSequence("@: "+mostCurrent._volt+" V"),(android.graphics.Bitmap)(mostCurrent._pl.getObject()));
 ...
 //BA.debugLineNum = 190;BA.debugLine="If usb=1 Then";
if ((mostCurrent._usb).equals(BA.NumberToString(1))) { 
 //BA.debugLineNum = 191;BA.debugLine="ListView1.AddTwoLinesandbitmap(\"Bat. USB-Plugged";
...
public static String  _bat_health() throws Exception{
 //BA.debugLineNum = 197;BA.debugLine="Sub bat_health";
 //BA.debugLineNum = 198;BA.debugLine="If bat.BatteryInformation(2)=1 Then";
if (mostCurrent._bat._getbatteryinformation()[(int) (2)]==1) { 
 //BA.debugLineNum = 199;BA.debugLine="ListView1.AddTwoLines(\"Bat. Health:\",\"Super\")";
mostCurrent._listview1.AddTwoLines(BA.ObjectToCharSequence("Bat. Health:"),BA.ObjectToCharSequence("Super"));
 }else {
 //BA.debugLineNum = 201;BA.debugLine="If 	bat.BatteryInformation(2) = 2 Then";
if (mostCurrent._bat._getbatteryinformation()[(int) (2)]==2) { 
 //BA.debugLineNum = 202;BA.debugLine="ListView1.AddTwoLinesandbitmap(\"Bat. Health:\",\"";
mostCurrent._listview1.AddTwoLinesAndBitmap(BA.ObjectToCharSequence("Bat. Health:"),BA.ObjectToCharSequence("Good"),(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Battery icons - Colorful 64px (32).png").getObject()));
 ...
 //BA.debugLineNum = 204;BA.debugLine="If bat.BatteryInformation(2) < 2 Then";
if (mostCurrent._bat._getbatteryinformation()[(int) (2)]<2) { 
 //BA.debugLineNum = 205;BA.debugLine="ListView1.AddTwoLines(\"Bat. Health:\",\"Your Bat";
...
public static String  _c_start() throws Exception{
 //BA.debugLineNum = 153;BA.debugLine="Sub c_start";
 //BA.debugLineNum = 154;BA.debugLine="If kvs2.IsInitialized Then";
if (mostCurrent._kvs2.IsInitialized()) { 
 //BA.debugLineNum = 155;BA.debugLine="Log(\"KVS -> true\")";
anywheresoftware.b4a.keywords.Common.Log("KVS -> true");
 }else {
 //BA.debugLineNum = 158;BA.debugLine="kvs2.Initialize(File.DirDefaultExternal, \"datast";
mostCurrent._kvs2._initialize(processBA,anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal(),"datastore_2");
 //BA.debugLineNum = 159;BA.debugLine="kvs3.Initialize(File.DirDefaultExternal, \"datast";
mostCurrent._kvs3._initialize(processBA,anywheresoftware.b4a.keywords.Common.File.getDirDefaultExternal(),"datastore_3");
 };
 //BA.debugLineNum = 163;BA.debugLine="get_log";
_get_log();
 //BA.debugLineNum = 164;BA.debugLine="bat_acusb";
_bat_acusb();
 //BA.debugLineNum = 165;BA.debugLine="bat_health";
_bat_health();
 //BA.debugLineNum = 166;BA.debugLine="chart_start";
_chart_start();
 //BA.debugLineNum = 167;BA.debugLine="End Sub";
return "";
}
public static String  _ccl_click() throws Exception{
 //BA.debugLineNum = 143;BA.debugLine="Sub ccl_click";
 //BA.debugLineNum = 144;BA.debugLine="level  = bat.BatteryInformation(0)";
_level = mostCurrent._bat._getbatteryinformation()[(int) (0)];
 //BA.debugLineNum = 145;BA.debugLine="kvs2.DeleteAll";
mostCurrent._kvs2._deleteall();
 //BA.debugLineNum = 146;BA.debugLine="Log(\"put-> \"&level&\"%\")";
anywheresoftware.b4a.keywords.Common.Log("put-> "+BA.NumberToString(_level)+"%");
 //BA.debugLineNum = 147;BA.debugLine="kvs2.PutSimple(level,time2)";
mostCurrent._kvs2._putsimple(BA.NumberToString(_level),(Object)(mostCurrent._time2));
 //BA.debugLineNum = 148;BA.debugLine="ToastMessageShow(\"stats bitte neustarten für Akt";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("stats bitte neustarten für Aktuelle werte..!"),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 149;BA.debugLine="Log(kvs2.ListKeys&\" - clear\")";
...
String _fn = "";
String _fg = "";
com.batcat.charts._bardata _bd = null;
String _h = "";
 //BA.debugLineNum = 213;BA.debugLine="Sub chart_start";
 //BA.debugLineNum = 214;BA.debugLine="g.Initialize";
mostCurrent._g.Initialize();
 //BA.debugLineNum = 215;BA.debugLine="level=bat.BatteryInformation(0)";
_level = mostCurrent._bat._getbatteryinformation()[(int) (0)];
 //BA.debugLineNum = 216;BA.debugLine="Dim fn As String";
_fn = "";
 //BA.debugLineNum = 217;BA.debugLine="Dim fg As String";
_fg = "";
 //BA.debugLineNum = 219;BA.debugLine="Dim BD As BarData";
_bd = new com.batcat.charts._bardata();
 //BA.debugLineNum = 220;BA.debugLine="BD.Initialize";
_bd.Initialize();
 //BA.debugLineNum = 221;BA.debugLine="BD.Target = Panel2";
_bd.Target = mostCurrent._panel2;
 //BA.debugLineNum = 222;BA.debugLine="BD.BarsWidth = 5dip";
_bd.BarsWidth = anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5));
 //BA.debugLineNum = 223;BA.debugLine="BD.Stacked = True 'Makes it a stacked bars chart";
_bd.Stacked = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 224;BA.debugLine="Charts.AddBarColor(BD, MakeTransparent(Colors.whi";
mostCurrent._charts._addbarcolor(mostCurrent.activityBA,_bd,_maketransparent(anywheresoftware.b4a.keywords.Common.Colors.White,(int) (180)));
 //BA.debugLineNum = 225;BA.debugLine="For Each h As String  In kvs2.ListKeys";
...
_h = BA.ObjectToString(group11.Get(index11));
 //BA.debugLineNum = 227;BA.debugLine="fg=h";
_fg = _h;
 //BA.debugLineNum = 228;BA.debugLine="fn=kvs2.GetSimple(h)";
_fn = mostCurrent._kvs2._getsimple(_h);
 //BA.debugLineNum = 229;BA.debugLine="Log(\"Map Key-> \"&fg)";
anywheresoftware.b4a.keywords.Common.Log("Map Key-> "+_fg);
 //BA.debugLineNum = 230;BA.debugLine="Charts.AddBarPoint(BD, fn, Array As Float(fg))";
mostCurrent._charts._addbarpoint(mostCurrent.activityBA,_bd,_fn,new float[]{(float)(Double.parseDouble(_fg))});
 }
;
 //BA.debugLineNum = 232;BA.debugLine="G.Title = \"Power Chart\"";
mostCurrent._g.Title = "Power Chart";
 //BA.debugLineNum = 233;BA.debugLine="G.XAxis = \"\"";
mostCurrent._g.XAxis = "";
 //BA.debugLineNum = 234;BA.debugLine="G.YAxis = \"Values\"";
mostCurrent._g.YAxis = "Values";
 //BA.debugLineNum = 235;BA.debugLine="G.YStart = 0";
mostCurrent._g.YStart = (float) (0);
 //BA.debugLineNum = 236;BA.debugLine="G.YEnd = 100";
mostCurrent._g.YEnd = (float) (100);
 //BA.debugLineNum = 237;BA.debugLine="G.YInterval = 10";
mostCurrent._g.YInterval = (float) (10);
 //BA.debugLineNum = 238;BA.debugLine="G.AxisColor = Colors.White";
mostCurrent._g.AxisColor = anywheresoftware.b4a.keywords.Common.Colors.White;
 //BA.debugLineNum = 239;BA.debugLine="Charts.DrawBarsChart(G, BD, Colors.Transparent)";
mostCurrent._charts._drawbarschart(mostCurrent.activityBA,mostCurrent._g,_bd,anywheresoftware.b4a.keywords.Common.Colors.Transparent);
...
int _v = 0;
 //BA.debugLineNum = 368;BA.debugLine="Sub dev_BatteryChanged (level1 As Int, Scale As In";
 //BA.debugLineNum = 369;BA.debugLine="If kvs3.ListKeys.Size>20 Then";
if (mostCurrent._kvs3._listkeys().getSize()>20) { 
 //BA.debugLineNum = 370;BA.debugLine="kvs3.DeleteAll";
mostCurrent._kvs3._deleteall();
 //BA.debugLineNum = 371;BA.debugLine="c_start";
_c_start();
 };
 //BA.debugLineNum = 373;BA.debugLine="Dim vl As List";
_vl = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 374;BA.debugLine="vl.Initialize";
_vl.Initialize();
 //BA.debugLineNum = 375;BA.debugLine="For v = 0 To Scale Step 2";
{
final int step7 = (int) (2);
final int limit7 = _scale;
for (_v = (int) (0) ; (step7 > 0 && _v <= limit7) || (step7 < 0 && _v >= limit7); _v = ((int)(0 + _v + step7)) ) {
 //BA.debugLineNum = 376;BA.debugLine="vl.Add(v)";
_vl.Add((Object)(_v));
 //BA.debugLineNum = 377;BA.debugLine="If level1=v Then";
if (_level1==_v) { 
 //BA.debugLineNum = 378;BA.debugLine="store_check";
_store_check();
 //BA.debugLineNum = 379;BA.debugLine="c_start";
_c_start();
 };
 }
};
...
public static String  _get_log() throws Exception{
 //BA.debugLineNum = 173;BA.debugLine="Sub get_log";
 //BA.debugLineNum = 174;BA.debugLine="level=bat.BatteryInformation(0)";
_level = mostCurrent._bat._getbatteryinformation()[(int) (0)];
 //BA.debugLineNum = 175;BA.debugLine="ListView1.Clear";
mostCurrent._listview1.Clear();
 //BA.debugLineNum = 176;BA.debugLine="ListView1.AddTwoLinesAndBitmap(\"Bat. Level:\",leve";
mostCurrent._listview1.AddTwoLinesAndBitmap(BA.ObjectToCharSequence("Bat. Level:"),BA.ObjectToCharSequence(BA.NumberToString(_level)+"%"),(android.graphics.Bitmap)(mostCurrent._batt.getObject()));
 //BA.debugLineNum = 177;BA.debugLine="ListView1.AddTwoLinesAndBitmap(\"Bat. Temperature:";
...
public static int  _maketransparent(int _color,int _alpha) throws Exception{
 //BA.debugLineNum = 358;BA.debugLine="Sub MakeTransparent(Color As Int, Alpha As Int) As";
 //BA.debugLineNum = 359;BA.debugLine="Return Bit.And(Color, Bit.Or(0x00FFFFFF, Bit.Shif";
...
public static String  _popa_itemclicked(de.amberhome.objects.appcompat.ACMenuItemWrapper _item) throws Exception{
 //BA.debugLineNum = 134;BA.debugLine="Sub popa_ItemClicked (Item As ACMenuItem)";
 //BA.debugLineNum = 135;BA.debugLine="If Item = popa.GetItem(0) Then";
if ((_item).equals((android.view.MenuItem)(mostCurrent._popa.GetItem((int) (0))))) { 
 //BA.debugLineNum = 136;BA.debugLine="ACButton1_Click";
_acbutton1_click();
 };
 //BA.debugLineNum = 138;BA.debugLine="If Item = popa.GetItem(1) Then";
...
public static String  _store_check() throws Exception{
 //BA.debugLineNum = 251;BA.debugLine="Sub store_check";
 //BA.debugLineNum = 252;BA.debugLine="c1=mcl.md_light_blue_A700";
_c1 = mostCurrent._mcl.getmd_light_blue_A700();
 //BA.debugLineNum = 253;BA.debugLine="c2=mcl.md_amber_A700";
_c2 = mostCurrent._mcl.getmd_amber_A700();
 //BA.debugLineNum = 254;BA.debugLine="c3=mcl.md_lime_A700";
_c3 = mostCurrent._mcl.getmd_lime_A700();
 //BA.debugLineNum = 255;BA.debugLine="c4=mcl.md_teal_A700";
_c4 = mostCurrent._mcl.getmd_teal_A700();
 //BA.debugLineNum = 256;BA.debugLine="c5=mcl.md_deep_purple_A700";
_c5 = mostCurrent._mcl.getmd_deep_purple_A700();
 //BA.debugLineNum = 257;BA.debugLine="c6=mcl.md_red_A700";
_c6 = mostCurrent._mcl.getmd_red_A700();
 //BA.debugLineNum = 258;BA.debugLine="c7=mcl.md_indigo_A700";
_c7 = mostCurrent._mcl.getmd_indigo_A700();
 //BA.debugLineNum = 259;BA.debugLine="c8=mcl.md_blue_A700";
_c8 = mostCurrent._mcl.getmd_blue_A700();
 //BA.debugLineNum = 260;BA.debugLine="c9=mcl.md_orange_A700";
_c9 = mostCurrent._mcl.getmd_orange_A700();
 //BA.debugLineNum = 261;BA.debugLine="c10=mcl.md_grey_700";
_c10 = mostCurrent._mcl.getmd_grey_700();
 //BA.debugLineNum = 262;BA.debugLine="c11=mcl.md_green_A700";
_c11 = mostCurrent._mcl.getmd_green_A700();
 //BA.debugLineNum = 263;BA.debugLine="c12=mcl.md_light_green_A700";
_c12 = mostCurrent._mcl.getmd_light_green_A700();
 //BA.debugLineNum = 264;BA.debugLine="c13=mcl.md_yellow_A700";
_c13 = mostCurrent._mcl.getmd_yellow_A700();
 //BA.debugLineNum = 265;BA.debugLine="c14=mcl.md_cyan_A700";
_c14 = mostCurrent._mcl.getmd_cyan_A700();
 //BA.debugLineNum = 266;BA.debugLine="c15=mcl.md_blue_grey_700";
_c15 = mostCurrent._mcl.getmd_blue_grey_700();
 //BA.debugLineNum = 267;BA.debugLine="If kvs4.ContainsKey(\"0\")Then";
if (mostCurrent._kvs4._containskey("0")) { 
 //BA.debugLineNum = 268;BA.debugLine="Log(\"AC_true->1\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->1");
 //BA.debugLineNum = 269;BA.debugLine="Activity.Color=c1";
mostCurrent._activity.setColor(_c1);
 };
 //BA.debugLineNum = 271;BA.debugLine="If kvs4.ContainsKey(\"1\")Then";
if (mostCurrent._kvs4._containskey("1")) { 
 //BA.debugLineNum = 272;BA.debugLine="Log(\"AC_true->2\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->2");
 //BA.debugLineNum = 273;BA.debugLine="Activity.Color=c2";
mostCurrent._activity.setColor(_c2);
 }else {
 };
 //BA.debugLineNum = 277;BA.debugLine="If kvs4.ContainsKey(\"2\")Then";
if (mostCurrent._kvs4._containskey("2")) { 
 //BA.debugLineNum = 278;BA.debugLine="Log(\"AC_true->3\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->3");
 //BA.debugLineNum = 279;BA.debugLine="Activity.Color=c3";
mostCurrent._activity.setColor(_c3);
 }else {
 };
 //BA.debugLineNum = 283;BA.debugLine="If kvs4.ContainsKey(\"3\")Then";
if (mostCurrent._kvs4._containskey("3")) { 
 //BA.debugLineNum = 284;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 285;BA.debugLine="Activity.Color=c4";
...
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 291;BA.debugLine="Activity.Color=c5";
mostCurrent._activity.setColor(_c5);
 }else {
 };
 //BA.debugLineNum = 295;BA.debugLine="If kvs4.ContainsKey(\"5\")Then";
if (mostCurrent._kvs4._containskey("5")) { 
 //BA.debugLineNum = 296;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 297;BA.debugLine="Activity.Color=c6";
mostCurrent._activity.setColor(_c6);
 }else {
 };
 //BA.debugLineNum = 301;BA.debugLine="If kvs4.ContainsKey(\"6\")Then";
if (mostCurrent._kvs4._containskey("6")) { 
 //BA.debugLineNum = 302;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 303;BA.debugLine="Activity.Color=c7";
mostCurrent._activity.setColor(_c7);
 }else {
 };
 //BA.debugLineNum = 307;BA.debugLine="If kvs4.ContainsKey(\"7\")Then";
if (mostCurrent._kvs4._containskey("7")) { 
 //BA.debugLineNum = 308;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 309;BA.debugLine="Activity.Color=c8";
mostCurrent._activity.setColor(_c8);
 }else {
 };
 //BA.debugLineNum = 313;BA.debugLine="If kvs4.ContainsKey(\"8\")Then";
if (mostCurrent._kvs4._containskey("8")) { 
 //BA.debugLineNum = 314;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 315;BA.debugLine="Activity.Color=c9";
mostCurrent._activity.setColor(_c9);
 }else {
 };
 //BA.debugLineNum = 319;BA.debugLine="If kvs4.ContainsKey(\"9\")Then";
if (mostCurrent._kvs4._containskey("9")) { 
 //BA.debugLineNum = 320;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 321;BA.debugLine="Activity.Color=c10";
mostCurrent._activity.setColor(_c10);
 }else {
 };
 //BA.debugLineNum = 325;BA.debugLine="If kvs4.ContainsKey(\"10\")Then";
if (mostCurrent._kvs4._containskey("10")) { 
 //BA.debugLineNum = 326;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 327;BA.debugLine="Activity.Color=c11";
mostCurrent._activity.setColor(_c11);
 }else {
 };
 //BA.debugLineNum = 331;BA.debugLine="If kvs4.ContainsKey(\"11\")Then";
if (mostCurrent._kvs4._containskey("11")) { 
 //BA.debugLineNum = 332;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 333;BA.debugLine="Activity.Color=c12";
mostCurrent._activity.setColor(_c12);
 }else {
 };
 //BA.debugLineNum = 337;BA.debugLine="If kvs4.ContainsKey(\"12\")Then";
if (mostCurrent._kvs4._containskey("12")) { 
 //BA.debugLineNum = 338;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 339;BA.debugLine="Activity.Color=c13";
...
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 345;BA.debugLine="Activity.Color=c14";
mostCurrent._activity.setColor(_c14);
 }else {
 };
 //BA.debugLineNum = 349;BA.debugLine="If kvs4.ContainsKey(\"14\")Then";
if (mostCurrent._kvs4._containskey("14")) { 
 //BA.debugLineNum = 350;BA.debugLine="Log(\"AC_true->4\")";
anywheresoftware.b4a.keywords.Common.Log("AC_true->4");
 //BA.debugLineNum = 351;BA.debugLine="Activity.Color=c15";
mostCurrent._activity.setColor(_c15);
 }else {
 };
 //BA.debugLineNum = 355;BA.debugLine="Activity.Invalidate";
