...
views.get("p1").vw.setLeft((int)((10d / 100 * width)));
views.get("p1").vw.setWidth((int)((90d / 100 * width) - ((10d / 100 * width))));
views.get("p1").vw.setTop((int)((0d / 100 * height)));
views.get("p1").vw.setHeight((int)((60d / 100 * height) - ((0d / 100 * height))));
...
//BA.debugLineNum = 8;BA.debugLine="ImageView1.SetTopAndBottom(15%y,40%y)"[5/General script]
views.get("imageview1").vw.setTop((int)((15d / 100 * height)));
views.get("imageview1").vw.setHeight((int)((40d / 100 * height) - ((15d / 100 * height))));
