...
views.get("dpm1").vw.setLeft((int)(0d));
views.get("dpm1").vw.setWidth((int)((100d / 100 * width) - (0d)));
views.get("dpm1").vw.setTop((int)(0d));
views.get("dpm1").vw.setHeight((int)((60d / 100 * height) - (0d)));
...
//BA.debugLineNum = 6;BA.debugLine="Panel1.SetTopAndBottom(0,60%y)"[5/General script]
views.get("panel1").vw.setTop((int)(0d));
views.get("panel1").vw.setHeight((int)((60d / 100 * height) - (0d)));
//BA.debugLineNum = 7;BA.debugLine="Panel2.SetTopAndBottom(60%y,100%y)"[5/General script]
views.get("panel2").vw.setTop((int)((60d / 100 * height)));
views.get("panel2").vw.setHeight((int)((100d / 100 * height) - ((60d / 100 * height))));
//BA.debugLineNum = 8;BA.debugLine="ImageView1.SetLeftAndRight(30%x,70%x)"[5/General script]
